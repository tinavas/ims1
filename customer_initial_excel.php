...
<form id="form1" name="form1" method="post" action="oc_savecreditnote_excel.php">
...
<?php $query = "SELECT distinct(name) FROM contactdetails where (type = 'party' OR type = 'vendor and party') and client = '$client'  ORDER BY name ASC"; $result = mysql_query($query,$conn);
