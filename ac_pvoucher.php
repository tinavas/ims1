...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			...
			<button type="button" onClick="document.location='dashboardsub.php?page=ac_addpvoucher'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
<!--<th style="text-align:left">Control type</th>--><th style="text-align:left"><span class="column-sort">
									<a href="javascript:void(0)" title="Sort up" class="sort-up"></a>
									<a href="javascript:void(0)" title="Sort down" class="sort-down"></a>
								</span>COA Code</th><th style="text-align:left"><span class="column-sort">
									<a href="javascript:void(0)" title="Sort up" class="sort-up"></a>
									<a href="javascript:void(0)" title="Sort down" class="sort-down"></a>
								</span>Amount</th><th style="text-align:left"><span class="column-sort">
									<a href="javascript:void(0)" title="Sort up" class="sort-up"></a>
									<a href="javascript:void(0)" title="Sort down" class="sort-down"></a>
...
<tbody>
	  <?php
	   ...
	   $sectorlist = $_SESSION['sectorlist'];
	     $query = "SELECT * FROM ac_gl where voucher = 'P' and vstatus <> 'R' and date >= '$fromdate' and date <= '$todate'  AND warehouse IN ($sectorlist) group by transactioncode ORDER BY transactioncode  desc ";
	   }
...
<?php if(($_SESSION['superadmin']=="1") ||($_SESSION['admin']=="1") ){?> 
		   ...
		   <a href="dashboardsub.php?page=ac_editpvouchern&id=<?php echo $row1['transactioncode']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a>&nbsp;
			  <a onclick="if(confirm('Are you sure,want to delete')) document.location ='ac_deletepvouchern.php?id=<?php echo $row1['transactioncode']; ?>'"><img src="images/icons/fugue/cross-circle.png" style="border:0px" title="Delete" /></a>&nbsp;&nbsp;
...
<?php  }?>
			...
			<a href="ac_pvoucherprint.php?id=<?php echo $row1['transactioncode']; ?>" target="_new"><img src="images/icons/fugue/report.png" style="border:0px" title="print" /></a>&nbsp;&nbsp; 		  
		  </td>
		   </tr>
           <?php 
           }
...
document.location = "dashboardsub.php?page=ac_pvoucher&month=" + month + "&year=" + year;
}
</script>
