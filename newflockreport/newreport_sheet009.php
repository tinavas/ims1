...
<center>
  <table><tr><td style="font-size:13px"><b>H.Egg % Graph For Flock <?php session_start(); echo $_SESSION['displayflock']; ?></b></td></tr></table>
</center>
...
?>
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl676 align=right><?php echo $_SESSION['heper'][$age]; ?></td>
  <td class=xl673 align=right><?php echo number_format($row1['heggper'],1); ?></td>
 </tr>
<?php }
else
{
...
$tothe = 0;
 ...
 <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl671 style='height:12.75pt'><?php echo $age = $row1['age']; ?></td>
  <td class=xl676 align=right><?php echo round(($tothe/$totprod)*100,1); ?></td>
...
[<?php echo $age = $row1['age']; ?>,<?php echo $_SESSION['heper'][$age]; ?>],
<?php }
else
{
...
$tothe = 0;
  ...
  ?>
[<?php echo $age = $row1['age']; ?>,<?php echo round(($tothe/$totprod)*100,1); ?>],
<?php
...
[<?php echo $age; ?>,<?php echo $_SESSION['heper'][$age]; ?>]];
...
[<?php echo $age = $row1['age']; ?>,<?php echo $row1['heggper']; ?>],
<?php //}
        } ?>
[<?php echo $age; ?>,<?php echo $row1['heggper']; ?>]];
...
<!-- , dashes: { show: true }, hoverable: true  -->
           ...
           { 
            ...
            points: { show: true },
             ...
             xaxis: { min: 22,tickSize: 2,max:<?php echo $maxage; ?>,label: "test"},
             yaxis: { min: 0, tickSize: 10, max:120 },
