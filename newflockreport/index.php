<?php 
 session_start();
 $flockw = $_GET['flock'];
 //$flockw = explode("-",$flockw);
if($_SESSION['client'] == "GOLDEN")
{
$_SESSION['flockcode'] = "-".$flockw;
$_SESSION['displayflock'] = $flockw;
}
else
{
 $_SESSION['flockcode'] = $flockw;
...
<link id="shLink" href="newreport_sheet015.php">
<link id="shLink" href="newreport_sheet016.php">
...
<!--
 ...
 c_rgszSh[0] = "Brooder/Grower";
 c_rgszSh[1] = "Laying";
 c_rgszSh[2] = "Wkly";
 c_rgszSh[3] = "Dr.Format";
 //c_rgszSh[4] = "wkl-print";
 c_rgszSh[4] = "Vaccination";
 c_rgszSh[5] = "Body&nbsp;Wts";
 c_rgszSh[6] = "Prod%&nbsp;Graph";
 c_rgszSh[7] = "H.Egg&nbsp;%&nbsp;Graph";
 c_rgszSh[8] = "Egg/Bird&nbsp;Graph";
 c_rgszSh[9] = "Grade Wise&nbsp;B.W";
 c_rgszSh[10] = "Body&nbsp;Wt&nbsp;Graph";
c_rgszSh[11] = "Mortality&nbsp;Graph";
c_rgszSh[12] = "Flock&nbsp;Costing";
