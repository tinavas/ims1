...
<center>
  <table><tr><td style="font-size:13px"><b>Production Graph For Flock <?php session_start(); echo $_SESSION['displayflock']; ?></b></td></tr></table>
</center>
...
<?php
include "../config.php";
$query = "SELECT * FROM breeder_initial where flock like '%$flockget' ORDER BY age ASC LIMIT 1 ";
$result = mysql_query($query,$conn); 
while($row1 = mysql_fetch_assoc($result))
{ 
 $strtfemale = $row1['female'];
 $strtmale = $row1['male'];
}
if($breedi != "")
{
$query = "SELECT * FROM breeder_standards where client = '$client' and breed = '$breedi' and age <= '$maxage' ORDER BY age ASC ";
}
else
{
...
?>
 <tr height=12 style='height:12.75pt'>
  <td height=12 class=xl671 style='height:12.75pt'><?php echo $age = $row1['age']; ?></td>
  <td class=xl676 align=right><?php echo $_SESSION['hd'][$age]; ?></td>
  <td class=xl673 align=right><?php echo number_format($row1['productionper'],1); ?></td>
 </tr>
<?php }
else
{
...
$tothe = 0;
 ...
 <tr height=12 style='height:12.75pt'>
  <td height=12 class=xl671 style='height:12.75pt'><?php echo $age = $row1['age']; ?></td>
  <td class=xl676 align=right><?php echo round((($totprod/7)/$strtfemale)*100,1); ?></td>
  <td class=xl673 align=right><?php echo number_format($row1['productionper'],1); ?></td>
 </tr>
<?php
...
[<?php echo $age = $row1['age']; ?>,<?php echo $_SESSION['hd'][$age]; ?>],
<?php }
else
{
...
$tothe = 0;
  ...
  ?>
[<?php echo $age = $row1['age']; ?>,<?php echo round((($totprod/7)/$strtfemale)*100,1); ?>],
<?php
 $strtfemale = $strtfemale - $row11['fmort'] - $row11['fcull'];
...
[<?php echo $age; ?>,<?php echo $_SESSION['hd'][$age]; ?>]];
...
[<?php echo $age = $row1['age']; ?>,<?php echo $row1['productionper']; ?>],
<?php //}
        } ?>
[<?php echo $age; ?>,<?php echo $row1['productionper']; ?>]];
...
<!-- , dashes: { show: true }, hoverable: true  -->
           ...
           { 
            ...
            points: { show: true },
             ...
             xaxis: { min: 24,tickSize: 2,max:<?php echo $maxage; ?>,label: "test"},
