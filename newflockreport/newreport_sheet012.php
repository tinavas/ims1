...
<center>
  <table><tr><td style="font-size:13px"><b>Body Weight Graph For Flock <?php session_start(); echo $_SESSION['displayflock']; ?></b></td></tr></table>
</center>
...
while($row11 = mysql_fetch_assoc($result11))
{
 ?>
  <tr  >
  <td height=17 class=xl671 style='height:12.75pt'><?php echo $age = $row1['age']; ?></td>
  <td class=xl676 align=right style="color:#00FF00"><?php if($row11['fweight'] <= 0) { echo $oldfb1; } else { echo $oldfb1 = $row11['fweight']; } ?>,</td>
  <td class=xl673 align=right style="color:#006600"><?php echo $row1['fweight']; ?></td>
 </tr>
...
while($row11 = mysql_fetch_assoc($result11))
{
 ?>
  <tr  >
  <td height=17 class=xl671 style='height:12.75pt'><?php echo $age = $row1['age']; ?></td>
  <td class=xl676 align=right style="color:#FF9999"><?php if($row11['mweight'] <= 0) { echo $oldfb1; } else { echo $oldfb1 = $row11['mweight']; } ?>,</td>
  <td class=xl673 align=right style="color:#CC0000"><?php echo $row1['fweight']; ?></td>
 </tr>
...
while($row11 = mysql_fetch_assoc($result11))
{
  ...
  ?>
[<?php echo $age = $row1['age']; ?>,<?php if($row11['fweight'] <= 0) { echo $oldfb; } else { echo $oldfb = $row11['fweight']; } ?>],
<?php
}
}
 } ?>
...
while($row11 = mysql_fetch_assoc($result11))
{
  ...
  ?>
[<?php echo $age = $row1['age']; ?>,<?php if($row11['mweight'] <= 0) { echo $oldfb; } else { echo $oldfb = $row11['mweight']; } ?>],
<?php
}
}
} ?>
...
[<?php echo $age; ?>,<?php echo $row1['mweight']; ?>],<?php echo $row1['mweight']; ?>];
...
<!-- , dashes: { show: true }, hoverable: true  -->
           ...
           { 
            ...
            points: { show: true },
             ...
             yaxis: { min: 0, tickSize: 200, max:6000 },
             y2axis: { min: 0, tickSize: 200, max:6000 },
