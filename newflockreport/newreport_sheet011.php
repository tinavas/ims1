...
if($breedi != "")
{
$query34 = "SELECT * FROM breeder_standards where breed = '$breedi'  and client = '$client' ORDER BY age ASC ";
}
else
{
...
<center>
  <table><tr><td style="font-size:13px"><b>Body Weight Comparision For Flock <?php session_start(); echo $_SESSION['displayflock']; ?></b></td></tr></table>
</center>
<center>
