...
<td width="10px">&nbsp;</td>
<td>
<input type="text" id="date" name="date" size="15" value="<?php echo date("d.m.Y"); ?>" class="datepicker" />
</td>
<!--<td width="10px">&nbsp;</td>
...
<?php 
	...
	{
?>
<option value="<?php echo $qr['farmcode']; ?>" <?php if($farmer == $qr['farmcode']) { ?> selected="selected" <?php } ?> ><?php echo $qr['farmcode']; ?></option>
<?php } ?>
</select>
</td>
<td width="10px">&nbsp;</td>
