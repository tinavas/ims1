...
$(function () {
    ...
    var d2 = [
        <?php
           include "config.php";
           $query3 = "SELECT h1.flock, sum( h2.noofeggsset ) AS totaleggset, sum( h2.hatch ) AS hatch FROM `hatchery_traysetting` h1, hatchery_hatchrecord h2 WHERE h1.flock = h2.flock AND h1.hatchdate = h2.hatchdate GROUP BY h1.flock ASC ";
           $result3 = mysql_query($query3,$conn1); 
           $i = 2;
           while($row3 = mysql_fetch_assoc($result3))
           {
    ...
    var d1 = [
        <?php
           include "config.php";
           $query3 = "SELECT h1.flock, sum( h2.noofeggsset ) AS totaleggset, sum( h2.saleablechicks ) AS saleablechicks FROM `hatchery_traysetting` h1, hatchery_hatchrecord h2 WHERE h1.flock = h2.flock AND h1.hatchdate = h2.hatchdate GROUP BY h1.flock ASC ";
           $result3 = mysql_query($query3,$conn1); 
           $j = 3;
           while($row3 = mysql_fetch_assoc($result3))
           {
