...
$EW_REPORT_TABLE_SQL_WHERE = "date1 between '$fdate' and '$tdate' and client = '$client' and itemcode in(select distinct(code) from ims_itemcodes where cat in ('Hatch Eggs','Eggs') and client = '$client')";
...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Cost Per Egg<br/>From&nbsp;<?php echo $fdatedump; ?> &nbsp;To&nbsp;<?php echo $tdatedump;?></font></strong></td>
</tr>
</table>
...
<?php $datecur=date("d-m-Y",strtotime($x_date1));
        echo $datecur; ?>
		<?php $x_date1 = $t_date1; ?></td>
		<td<?php echo $sItemRowClass; ?>>
		
<?php $totaleggs+=$x_quantity; echo ewrpt_ViewValue($x_quantity) ?>
</td>
<?php
include "config.php";
...
?>
		<td<?php echo $sItemRowClass; ?>>
		  ...
		  <?php $totalfeed+=$quantity;
		   echo round($quantity,2); ?>
		</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo round(($totprice/$x_quantity),2); ?>
</td>
	</tr>
<?php
...
<td <?php echo $sItemRowClass; ?>><b><?php echo $totaleggs; ?></b></td>
<td <?php echo $sItemRowClass; ?>><b><?php echo round($totalfeed,2); ?></b></td>
<td <?php echo $sItemRowClass; ?>><b> <?php echo round((($totalfeed * $feedcost)/$totaleggs),2); ?></b></td></tr>
	</tbody>
