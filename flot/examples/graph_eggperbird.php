...
if(uni == "all")
{<?php $c1=0;
$q = "select count(*)  as c1 from breeder_flock where  client='$client' ";
...
ccc = 0;
<?php $c2=0;
$q = "select * from breeder_flock where  client='$client' ";
 $qrs = mysql_query($q,$conn);
  while($qr = mysql_fetch_assoc($qrs))
  {
...
window.open('flot/graphs/eggperbirdgraph.php?unit=' + unitval + '&type=' + type); 
