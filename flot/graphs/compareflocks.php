...
$(function () {
 ...
 var d4 = [
  ...
  var plot =   $.plot($("#placeholder"),
           ...
           [  { data: d2, label: "CLA Hatchability % " },{ data: d3, label: "F15 Hatchability % " },

             { data: d1, label: "CLA Saleable Chicks % "} ,{ data: d4, label: "F15 Saleable Chicks % "}],
