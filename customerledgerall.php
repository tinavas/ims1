...
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">Customer Ledger</font></strong></td>
</tr>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="customerledgerall.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="customerledgerall.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="customerledgerall.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php
	...
	$totbalcr = 0;
include "config.php";
    $q111 = "select name,code from contactdetails  where type = 'party' or type = 'vendor and party' order by name ";
...
?>
	<tr>
		...
		<td class="ewRptGrpField1">
		<?php if($vendorcode=='') echo '&nbsp;'; else echo $vendorcode; ?>
		</td>
		<?php } ?>
