...
define("EW_REPORT_TABLE_VAR", "servicealerts", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "servicealerts_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "servicealerts_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "servicealerts_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "servicealerts_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "servicealerts_orderby", TRUE);
...
$af_servicedate = NULL; // Popup filter for servicedate
...
$o_servicedate = NULL; $t_servicedate = NULL; $ft_servicedate = 133; $rf_servicedate = NULL; $rt_servicedate = NULL;
...
ewrpt_CreatePopup("servicealerts_unit", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_vtype, $sel_vtype, $ft_vtype) ?>
ewrpt_CreatePopup("servicealerts_vtype", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_vnumber, $sel_vnumber, $ft_vnumber) ?>
ewrpt_CreatePopup("servicealerts_vnumber", [<?php echo $jsdata ?>]);
</script>
<div id="servicealerts_unit_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="servicealerts_vtype_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="servicealerts_vnumber_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Service Alerts<br /> </font></strong></td>
</tr>
</table>
<br/>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="servicealertssmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="servicealertssmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="servicealertssmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="servicealertssmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="servicealertssmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="servicealertssmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="servicealertssmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="servicealertssmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="servicealertssmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Unit</td>
			<td style="width: 20px;" align="right"><?php /*?><a href="#" onClick="ewrpt_ShowPopup(this.name, 'servicealerts_unit', false, '<?php echo $rf_unit; ?>', '<?php echo $rt_unit; ?>');return false;" name="x_unit<?php echo $cnt[0][0]; ?>" id="x_unit<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a><?php */?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Vehicle Type</td>
			<td style="width: 20px;" align="right"><?php /*?><a href="#" onClick="ewrpt_ShowPopup(this.name, 'servicealerts_vtype', false, '<?php echo $rf_vtype; ?>', '<?php echo $rt_vtype; ?>');return false;" name="x_vtype<?php echo $cnt[0][0]; ?>" id="x_vtype<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a><?php */?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
//	echo "sql: " . $sSql . "<br>";
	...
	$dumm = 0;
	$dumm1 = 0;	
 $q= "select * from vehicle_servicing where vehicletype LIKE '%$x_vtype%' and vehiclenumber = '$x_vnumber' order by date desc LIMIT 1";
$r = mysql_query($q,$conn1);
while($qr = mysql_fetch_assoc($r))
{
$latestdate = $qr['date'];
$scode = $qr['servicecode'];
$tlatestdate = $qr['tnextservicedate'];
...
<?php echo ewrpt_ViewValue($scode) ?>
</td>
<?php
$q1= "select * from vehicle_servicemaster where servicecode = '$scode' and vehicletype LIKE '%$x_vtype%'";
$r1 = mysql_query($q1,$conn1);
while($qr = mysql_fetch_assoc($r1))
{
$desc = $qr['servicedescription'];
...
<?php } ?>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(ewrpt_FormatDateTime($latestdate,7)) ?>
</td>
<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(ewrpt_FormatDateTime($tlatestdate,7)) ?>
</td>
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_servicealerts_unit"])) {
		LoadSelectionFromSession('unit');
	} elseif (@$_SESSION["sel_servicealerts_unit"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_unit"] = "";
	}

	// Get Vtype selected values
	if (is_array(@$_SESSION["sel_servicealerts_vtype"])) {
		LoadSelectionFromSession('vtype');
	} elseif (@$_SESSION["sel_servicealerts_vtype"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_vtype"] = "";
	}

	// Get Vnumber selected values
	if (is_array(@$_SESSION["sel_servicealerts_vnumber"])) {
		LoadSelectionFromSession('vnumber');
	} elseif (@$_SESSION["sel_servicealerts_vnumber"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_vnumber"] = "";
	}
}
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_servicealerts_$parm"] = "";
	$_SESSION["rf_servicealerts_$parm"] = "";
	$_SESSION["rt_servicealerts_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_servicealerts_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_servicealerts_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_servicealerts_$parm"];
}
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_servicealerts_unit"] = "";
			$_SESSION["sort_servicealerts_vtype"] = "";
			$_SESSION["sort_servicealerts_vnumber"] = "";
			$_SESSION["sort_servicealerts_servicecode"] = "";
			$_SESSION["sort_servicealerts_servicedate"] = "";
			$_SESSION["sort_servicealerts_warranty"] = "";
		}
