...
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Salary Report for <?php echo $montharr[$month-1]; ?>, <?php echo $year; ?></font></strong></td>
</tr>
...
?>
&nbsp;&nbsp;<a href="Salaryreport.php?<?php echo $genlinkm; ?>&export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="Salaryreport.php?<?php echo $genlinkm; ?>&export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="Salaryreport.php?<?php echo $genlinkm; ?>&export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="Salaryreport.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<p align="right">
...
<form action="Salaryreport.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" align="center" class="ewTableHeader" title="Days Present">
		Days Present
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" align="center" class="ewTableHeaderBtn" title="Days Present"><tr>
			<td align="center" style="font-size:11px">Days Present</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" align="center" class="ewTableHeader" title="">
	    Salary
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" align="center" class="ewTableHeaderBtn"><tr>
			<td title="" align="center" style="font-size:11px">Salary</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="" align="center" style="font-size:11px">Bonus</td>
			</tr></table>
		</td>
<?php } ?>

<?php if (@$sExport <> "") { ?>
		<td valign="bottom" align="center" class="ewTableHeader" title="Previous Balance Cleared">
		P.B. Cl
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn" title="Previous Balance Cleared"><tr>
			<td align="center" style="font-size:11px">P.B. Cl</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td title="" align="center" style="font-size:11px">Deduction</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn" align="center"><tr>
			<td title="" align="center" style="font-size:11px">Total Deductions</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0"  class="ewTableHeaderBtn"><tr>
			<td title="" align="center" style="font-size:11px" >Salary Paid</td>
			</tr></table>
		</td>
<?php } ?>
...
$sbonus = 0;$spbonus = 0;$sdeduction = 0;$sadvdeduction = 0;$spaid = 0;$stotded = 0;
    	/*$q1 = "SELECT hr_payment.date as date, hr_employee.sector as sector, hr_employee.employeeid as eid, hr_employee.name as name, hr_employee.designation as designation, hr_employee.salary as sal, hr_payment.paid as paid, hr_payment.bonus as bonus, hr_payment.deduction as deduction, hr_employee.salarytype as salarytype,hr_payment.pbonus as pbonus,hr_payment.advdeduction as advdeduction
		FROM hr_employee INNER JOIN hr_payment ON hr_employee.employeeid = hr_payment.eid
        WHERE hr_employee.sector$sc '$_GET[sector]' AND hr_employee.name $nc '$_GET[empname]' AND hr_payment.date >= '$fd' and hr_payment.date <= '$td' 
        GROUP BY hr_employee.sector, hr_employee.employeeid, hr_employee.name, hr_employee.designation, hr_employee.salary
ORDER BY hr_employee.sector ASC";*/
$q1 = "SELECT hr_payment.date as date, hr_employee.sector as sector, hr_employee.employeeid as eid, hr_employee.name as name, hr_employee.designation as designation, hr_employee.salary as sal, hr_payment.paid as paid, hr_payment.bonus as bonus, hr_payment.deduction as deduction, hr_employee.salarytype as salarytype,hr_payment.pbonus as pbonus,hr_payment.advdeduction as advdeduction
		FROM hr_employee INNER JOIN hr_payment ON hr_employee.employeeid = hr_payment.eid
        WHERE hr_employee.sector$sc '$_GET[sector]' AND hr_employee.name $nc '$_GET[empname]' AND hr_payment.month1 = '$month' and  hr_payment.year1 = '$year'  
        GROUP BY hr_employee.sector, hr_employee.employeeid, hr_employee.name, hr_employee.designation, hr_employee.salary
ORDER BY hr_employee.sector ASC";
...
$qtt ="SELECT count(*) as noofdays FROM `hr_attendance` where eid='$eid' and month1='$month' and year1='$year' and daytype='Full' and client='$client'";
 $qttr = mysql_query($qtt,$conn1) or die(mysql_error());
	  if($qttrs = mysql_fetch_assoc($qttr))
	  {
	  $nooffull = $qttrs['noofdays'];
	  }
	  $qtt ="SELECT count(*) as noofdays FROM `hr_attendance` where eid='$eid' and month1='$month' and year1='$year' and daytype='Half' and client='$client'";
 $qttr = mysql_query($qtt,$conn1) or die(mysql_error());
	  if($qttrs = mysql_fetch_assoc($qttr))
	  {
	  ...
	  $totaldays = $nooffull + ($noofhalf/2);
		...
		$salarytype = $q1r['salarytype'];
		if( $salarytype  == "Daily")
		{
		$sal = $q1r['sal'] * $totaldays;
		}
		else
		{
		$sal = $q1r['sal'];
		...
		$totded =0;
		$totded = $sal - $q1r['deduction'] - $q1r['advdeduction'] + $q1r['pbonus'] + $q1r['bonus']; 
		
		$bonus = $q1r['bonus'];$pbonus = $q1r['pbonus']; $deduction = $q1r['deduction'];$advdeduction = $q1r['advdeduction'];$paid = $q1r['paid'];
		?>
		<tr>
		...
		<td class="ewRptGrpField3"><?php echo $q1r['sector']; ?></td>
		
		<td<?php echo $sItemRowClass; ?> style="font-size:11px"><?php echo $q1r['name']; ?></td>
        <td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $q1r['designation']; ?></td>
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $totaldays; ?></td>
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $sal; ?></td>
 
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $bonus; ?></td>		
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $pbonus; ?></td>
        <td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $deduction; ?></td>        
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $advdeduction; ?></td>
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $totded; ?></td>       
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $paid; ?></td>
		

		</tr>
		<?php
		$sbonus = $sbonus + $bonus;
		$spbonus =$spbonus + $pbonus; 
		$sdeduction = $sdeduction + $deduction;
		$sadvdeduction = $sadvdeduction + $advdeduction;
		$spaid = $spaid + $paid;
		$stotded = $stotded + $totded;
		}   
...
<tr>
	<td class="ewRptGrpField1" style="font-size:11px">Total</td>
		...
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $sbonus; ?></td>		
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $spbonus; ?></td>
        <td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $sdeduction; ?></td>        
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $sadvdeduction; ?></td>
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $stotded; ?></td>       
		<td<?php echo $sItemRowClass; ?> align="right" style="font-size:11px"><?php echo $spaid; ?></td>
...
<!--first page button-->
	...
	<td><a href="Salaryreport.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="Salaryreport.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="Salaryreport.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="Salaryreport.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
function reloadpage()
{
	...
	document.location = "Salaryreport.php?cullflag=" + cullflag ;
}
</script>
