...
<b>Add Stock Issue To Distributor</b><br/><br/>
...
{
?>
<option value="<?php echo $allnames[$i];?>" title="<?php echo $allnames[$i];?>"><?php echo $allnames[$i];?></option>
...
<td>
<select name="code[]" id="code@0" style="width:150px" onChange="selectcode(this.id,this.value), getprice(this.id)">
<option value="">-Select-</option>
...
<td>
<select name="description[]" id="description@0" style="width:150px" onChange="selectdesc(this.id,this.value),getprice(this.id)">
<option value="">-Select-</option>
...
<td>
<input type="text" name="rateperunit[]" id="rateperunit@0" style="width:100px;border:none;background:none" readonly="readonly"  />
</td>
...
<strong>Narration:</strong><textarea name="narration" id="narration"></textarea><br/><br/><br/>
...
var ind=id.split("@");
document.getElementById('rateperunit@'+ind[1]).value='0';
...
if(document.getElementById('rateperunit@'+ind[1]).value=="" || document.getElementById('rateperunit@'+ind[1]).value==0)
{
...
document.location="dashboardsub.php?page=distribution_addstockissuedistributor&superstockist="+superstockist+"&date="+date+"&docno="+docno;
