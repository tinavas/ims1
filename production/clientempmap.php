...
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">Client Assesment</font></strong></td>
</tr>
</table>
...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "om_clientempmap";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT om_clientempmap.clientname, om_clientempmap.type, om_clientempmap.employee, om_clientempmap.datefrom, om_clientempmap.dateto FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
$af_datefrom = NULL; // Popup filter for datefrom
$af_dateto = NULL; // Popup filter for dateto
?>
<?php
...
?>
<?php
$EW_REPORT_FIELD_CLIENTNAME_SQL_SELECT = "SELECT DISTINCT om_clientempmap.clientname FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_CLIENTNAME_SQL_ORDERBY = "om_clientempmap.clientname";
$EW_REPORT_FIELD_EMPLOYEE_SQL_SELECT = "SELECT DISTINCT om_clientempmap.employee FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_EMPLOYEE_SQL_ORDERBY = "om_clientempmap.employee";
?>
<?php
...
$o_datefrom = NULL; $t_datefrom = NULL; $ft_datefrom = 133; $rf_datefrom = NULL; $rt_datefrom = NULL;
$o_dateto = NULL; $t_dateto = NULL; $ft_dateto = 133; $rf_dateto = NULL; $rt_dateto = NULL;
?>
<?php
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="clientempmap.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="clientempmap.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="clientempmap.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="clientempmap.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="clientempmap.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="clientempmap.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="clientempmap.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="clientempmap.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="clientempmap.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php echo ewrpt_ViewValue($x_employee) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(date("d-m-Y",strtotime($x_datefrom))); ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(date("d-m-Y",strtotime($x_dateto))) ?>
</td>
	</tr>
<?php
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$GLOBALS['x_datefrom'] = $rs->fields('datefrom');
		$GLOBALS['x_dateto'] = $rs->fields('dateto');
		$val[1] = $GLOBALS['x_clientname'];
		$val[2] = $GLOBALS['x_type'];
		$val[3] = $GLOBALS['x_employee'];
		$val[4] = $GLOBALS['x_datefrom'];
		$val[5] = $GLOBALS['x_dateto'];
	} else {
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_clientname"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_clientname"], "om_clientempmap.clientname", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_clientname"]);
	}
	if (is_array($GLOBALS["sel_employee"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_employee"], "om_clientempmap.employee", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_employee"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_Report1_datefrom"] = "";
			$_SESSION["sort_Report1_dateto"] = "";
		}
