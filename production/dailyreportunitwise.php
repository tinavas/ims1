...
<center>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="dailyreportunitwise.php?export=html&date=<?php echo $_GET['date']; ?>&flock=<?php echo $_GET['flock']; ?>&unit=<?php echo $_GET['unit']; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="dailyreportunitwise.php?export=excel&date=<?php echo $_GET['date']; ?>&flock=<?php echo $_GET['flock']; ?>&unit=<?php echo $_GET['unit']; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="dailyreportunitwise.php?export=word&date=<?php echo $_GET['date']; ?>&flock=<?php echo $_GET['flock']; ?>&unit=<?php echo $_GET['unit']; ?>">Export to Word</a>
<?php } else { ?>
<center>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<form action="dailyreportunitwise.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
document.location="dailyreportunitwise.php?flock=<?php echo $_GET['flock']; ?>&date=" + a + "&unit=" + unitcode; 
}
function selectunit(a)
{

var date1=document.getElementById("date1").value;
document.location="dailyreportunitwise.php?unit=" + a + "&date=" + date1; 
}
</script>
...
<!--first page button-->
	...
	<td><a href="dailyreportunitwise.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="dailyreportunitwise.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="dailyreportunitwise.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="dailyreportunitwise.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
