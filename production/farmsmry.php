...
<br/>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="farmsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="farmsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="farmsmry.php?export=word">Export to Word</a><br /><br />
<?php } ?>
...
<form action="farmsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<?php echo ewrpt_ViewValue(changequantity($x_capacity)); $total+=$x_capacity; ?>
</td>
	</tr>
<?php
...
<?php if ($nTotalGrps > 0) { ?>
	...
	<tr class="ewRptGrandSummary"><td colspan="2" align="right"><b>Total</b> </td>
	<td align="right"><?php echo changequantity($total); ?></td></tr>
<?php } ?>
	</tfoot>
</table>
</div>
