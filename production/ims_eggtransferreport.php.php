...
$EW_REPORT_TABLE_SQL_SELECT = "SELECT ims_eggtransfer.towarehouse, ims_eggtransfer.date, ims_eggtransfer.fromwarehouse, ims_eggtransfer.fromeggs, ims_eggtransfer.price, ims_eggtransfer.todescription, ims_eggtransfer.toeggs, ims_eggtransfer.wastage FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "ims_eggtransfer.towarehouse";
...
<?php if(($x_towarehouse <> $oldcode) or ($dumm == 0)){ echo ewrpt_ViewValue($x_towarehouse);
     $oldcode = $x_towarehouse; $dumm = 1; }
	 else{
...
<?php echo ewrpt_ViewValue($x_toeggs) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_wastage) ?>
</td>
	</tr>
<?php
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$val[1] = $GLOBALS['x_towarehouse'];
		$val[2] = $GLOBALS['x_date'];
		$val[3] = $GLOBALS['x_fromwarehouse'];
		$val[4] = $GLOBALS['x_fromeggs'];
		$val[5] = $GLOBALS['x_price'];
		$val[6] = $GLOBALS['x_todescription'];
		$val[7] = $GLOBALS['x_toeggs'];
		$val[8] = $GLOBALS['x_wastage'];
	} else {
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_Report1_fromeggs"] = "";
			$_SESSION["sort_Report1_price"] = "";
			$_SESSION["sort_Report1_todescription"] = "";
			$_SESSION["sort_Report1_toeggs"] = "";
			$_SESSION["sort_Report1_wastage"] = "";
		}
