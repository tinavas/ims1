...
define("EW_REPORT_TABLE_VAR", "oc_creditnotereport", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "oc_creditnotereport_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "oc_creditnotereport_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "oc_creditnotereport_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "oc_creditnotereport_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "oc_creditnotereport_orderby", TRUE);
...
$EW_REPORT_TABLE_SQL_WHERE = "(ac_crdrnote.date >= '$fdate' and ac_crdrnote.date<='$tdate') and (ac_crdrnote.mode = 'CCN')";
...
$EW_REPORT_TABLE_SQL_FROM = "ac_crdrnote";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT ac_crdrnote.date, ac_crdrnote.crnum, ac_crdrnote.vcode, ac_crdrnote.vpcode, ac_crdrnote.coa, ac_crdrnote.description, ac_crdrnote.dramount, ac_crdrnote.cramount , ac_crdrnote.vpcode FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "(ac_crdrnote.date >= '$fdate' and ac_crdrnote.date<='$tdate') and (ac_crdrnote.mode = 'CCN') and (ac_crdrnote.vcode = '$name') ";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Customer Name : <?php echo $name;?> </font></strong></td>
</tr>
<?php if(($_SESSION[db]=='albustan' || $_SESSION[db]=='albustanlayer') && $name != 'All') {  $r= mysql_query("select code from contactdetails where name='$name'");
   $a=mysql_fetch_assoc($r);
   $vendorcode=$a['code']; ?>
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Customer code : <?php echo $vendorcode;?></font></strong></td>
</tr>
<?php } ?>
</table>
<?php 
...
<center>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="customercreditnote.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="customercreditnote.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="customercreditnote.php?export=word">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<form action="customercreditnote.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="customercreditnote.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="customercreditnote.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="customercreditnote.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="customercreditnote.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_oc_creditnotereport_date"] = "";
			$_SESSION["sort_oc_creditnotereport_crnum"] = "";
			$_SESSION["sort_oc_creditnotereport_vcode"] = "";
			$_SESSION["sort_oc_creditnotereport_coa"] = "";
			$_SESSION["sort_oc_creditnotereport_description"] = "";
			$_SESSION["sort_oc_creditnotereport_dramount"] = "";
			$_SESSION["sort_oc_creditnotereport_cramount"] = "";
		}
