...
<td align="right"><?php  echo ewrpt_ViewValue( changeprice($obval)) ?></td>
	...
	$isval = 0;
	 include "config.php";
    $query1 = "SELECT type,trnum,date,quantity,amount,crdr from ac_financialpostings where itemcode = '$code' and coacode = '$itemcode'  and date >= '$fdate' and date <= '$tdate' AND warehouse = '$warehouse' order by date ";
