...
if($_SESSION['db'] == 'fortress' or $_SESSION['db'] == 'golden' or $_SESSION['db'] == 'mlcf' or $_SESSION['db'] == 'maharashtra' or $_SESSION['db'] == 'mbcf')
...
<tr>
 ...
 <td colspan="2" align="center"><strong><font color="#3e3276">Non Inventory Sales Report</font></strong></td>
...
<tr>
 ...
 <td colspan="2" align="center"><strong><font color="#3e3276">Party : </font></strong><?php echo $vendor; ?></td>
...
&nbsp;&nbsp;<a href="oc_noninv_ds.php?export=word&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&vendor=<?php echo $vendor; ?>&code=<?php echo $code; ?>&description=<?php echo $description; ?>">Printer Friendly</a>

&nbsp;&nbsp;<a href="oc_noninv_ds.php?export=word&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&vendor=<?php echo $vendor; ?>&code=<?php echo $code; ?>&description=<?php echo $description; ?>">Export to Excel</a>

&nbsp;&nbsp;<a href="oc_noninv_ds.php?export=word&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&vendor=<?php echo $vendor; ?>&code=<?php echo $code; ?>&description=<?php echo $description; ?>">Export to Word</a>

<?php if ($bFilterApplied) { ?>

&nbsp;&nbsp;<a href="oc_noninv_ds.php?cmd=reset&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&vendor=<?php echo $vendor; ?>&code=<?php echo $code; ?>&description=<?php echo $description; ?>">Reset All Filters</a>
...
$q = "select distinct(party) as party from oc_cobi where niflag='1' order by party";
...
<option value="<?php echo $qr['party']; ?>" <?php if($vendor == $qr['party']) { ?> selected="selected" <?php } ?> ><?php echo $qr['party']; ?></option>
...
$q = "select distinct(code) as code,description from oc_cobi where niflag='1' order by code";
...
$q = "select distinct(description) from oc_cobi where niflag='1' order by description";
...
if($i=='1')
{
$qall = "SELECT party,date,finaltotal,invoice,code , description FROM oc_cobi where party $vc '$vendor' and code $cod '$code' and description $desc '$description'and date >= '$fdate' and date <= '$tdate' and niflag='1' group by party,date,invoice, finaltotal,code,description order by  date ASC ";

 
$rall=mysql_query($qall);

while($r1=mysql_fetch_array($rall))
{
...
$code = $description = $quantity = $price =$gr = $binvoice = ""; $totqty = 0;

  $q = "select * from oc_cobi where date = '$x_date' and party = '$x_vendor' and invoice = '$x_so' and niflag='1'  $cond22    order by date,code";
...
$sobiflag=$qr['flag'];
	if($sobiflag==0)
	{
	$temp1="COBI Not Authorized";
	}
	else
	{
	$temp1="COBI  Authorized";
	}
  ...
  { 
	...
	$quantity.= changeprice1($qr['total']) . "/<br>";

	$price.= $qr['discountamount'] . "/<br>";

	$itemunits.=$qr['warehouse']. "/<br>";
	//$gr.= $qr['gr']."/<br>";
	...
	$quantity.= changeprice1($qr['total']) . "/";

	$price.= $qr['discountamount'] . "/";

	$itemunits.=$qr['warehouse']. "/";
	//$gr.= $qr['gr']."/";

	}

	$binvoice = $qr['bookinvoice'];
	//$gr = $qr['gr'];
	$totqty += $qr['total'];

	//$x_grandtotal += $qr['receivedquantity'] * $qr['rateperunit'];
...
<?php if($dg_vendor=="" || $dg_vendor==" ")
$x_vendor=$v1;  echo ewrpt_ViewValue($t_vendor) ?>
...
<?php if((date("d.m.Y",strtotime($x_date)) <> "01.01.1970") && (date("d.m.Y",strtotime($x_date)) <> "31.12.1969")) echo ewrpt_ViewValue(date($datephp,strtotime($x_date))); else echo ewrpt_ViewValue(); ?>
...
<form action="oc_noninv_ds.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="oc_noninv_ds.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
...
<!--previous page button-->
	...
	<td><a href="oc_noninv_ds.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
...
<!--next page button-->
	...
	<td><a href="oc_noninv_ds.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
...
<!--last page button-->
	...
	<td><a href="oc_noninv_ds.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
...
var date = document.getElementById('date').value;
	...
	document.location = "oc_noninv_ds.php?fdate=" + date + "&tdate=" + date1 + "&vendor=" + vendor + "&code=" + code + "&description=" + "All";
...
var date = document.getElementById('date').value;
   ...
   //var sobi = document.getElementById('sobi').value;
	...
	document.location = "oc_noninv_ds.php?fdate=" + date + "&tdate=" + date1 + "&vendor=" + vendor + "&code=" +"All" + "&description=" + "All";
...

{
	...
	document.location = "oc_noninv_ds.php?fdate=" + date + "&tdate=" + date1 + "&vendor=" + vendor + "&code=" + code + "&description=" + description;
