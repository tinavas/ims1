...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Supplier Credit Note</font></strong></td>
</tr>
...
<center>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="suppliercreditnote.php?export=html&fromdate=<?php echo $_GET['fromdate']; ?>&todate=<?php echo $_GET['todate']; ?>&name=<?php echo $_GET['name']; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="suppliercreditnote.php?export=excel&fromdate=<?php echo $_GET['fromdate']; ?>&todate=<?php echo $_GET['todate']; ?>&name=<?php echo $_GET['name']; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="suppliercreditnote.php?export=word&fromdate=<?php echo $_GET['fromdate']; ?>&todate=<?php echo $_GET['todate']; ?>&name=<?php echo $_GET['name']; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<form action="suppliercreditnote.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="suppliercreditnote.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="suppliercreditnote.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="suppliercreditnote.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="suppliercreditnote.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php echo ewrpt_ViewValue($x_vcode) ?>
 ...
 <?php if($_SESSION[db]=='albustan' || $_SESSION[db]=='albustanlayer'){ ?><td<?php echo $sItemRowClass; ?>>
