...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "`pp_gateentry`";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT * FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "pp_gateentry.grflag <> 1";
...
$af_desc1 = NULL; // Popup filter for desc1
...
<?php } ?>
<center>
<h5>Gate Entry Report</h5>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="pendinggesmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="pendinggesmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="pendinggesmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="pendinggesmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="pendinggesmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="pendinggesmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="pendinggesmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="pendinggesmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="pendinggesmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Gate Entry No</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendinggrl_ge', false, '<?php echo $rf_ge; ?>', '<?php echo $rt_ge; ?>');return false;" name="x_ge<?php echo $cnt[0][0]; ?>" id="x_ge<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendinggrl_vendor', false, '<?php echo $rf_vendor; ?>', '<?php echo $rt_vendor; ?>');return false;" name="x_vendor<?php echo $cnt[0][0]; ?>" id="x_vendor<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Item Code</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendinggrl_code', false, '<?php echo $rf_code; ?>', '<?php echo $rt_code; ?>');return false;" name="x_code<?php echo $cnt[0][0]; ?>" id="x_code<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendinggrl_desc1', false, '<?php echo $rf_desc1; ?>', '<?php echo $rt_desc1; ?>');return false;" name="x_desc1<?php echo $cnt[0][0]; ?>" id="x_desc1<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
...
<?php echo ewrpt_ViewValue($x_code) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_desc1) ?>
</td>
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$GLOBALS['x_grflag'] = $rs->fields('grflag');
		...
		$val[3] = $GLOBALS['x_desc1'];
		$val[4] = $GLOBALS['x_vendor'];
		$val[5] = $GLOBALS['x_ge'];
...
function SetupPopup() {
	...
	while ($rswrk && !$rswrk->EOF) {
		...
		if (is_null($x_desc1)) {
			...
			$t_desc1 = $x_desc1;
			ewrpt_SetupDistinctValues($GLOBALS["val_desc1"], $x_desc1, $t_desc1, FALSE);
		}
		$rswrk->MoveNext();
	}
	if ($rswrk)
	...
	while ($rswrk && !$rswrk->EOF) {
		...
		if (is_null($x_ge)) {
			...
			$t_ge = $x_ge;
			ewrpt_SetupDistinctValues($GLOBALS["val_ge"], $x_ge, $t_ge, FALSE);
		}
		$rswrk->MoveNext();
	}
	if ($rswrk)
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_desc1"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_desc1"], "`desc1`", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_desc1"]);
	}
	if (is_array($GLOBALS["sel_vendor"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
	...
	if (is_array($GLOBALS["sel_ge"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_ge"], "`ge`", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_ge"]);
	}
	return $sWrk;
}
?>
