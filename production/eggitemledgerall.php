...
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">Egg Centre Item Ledger</font></strong></td>
</tr>
<tr>
...
<?php
	...
	include "config.php";
	$q11 = "select code,description,sunits from ims_itemcodes WHERE cat Like '%Eggs' order by code  ";
...
$q = "select * from ims_itemcodes where code  = '$code' AND cat LIKE '%Eggs' ";
...
?>
<?php if (($totrcvqty > 0) or ($totissqty > 0) or ($totemqty > 0)) { ?>
<tr>
		<td class="ewRptGrpField1">
