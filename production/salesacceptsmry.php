...
<tr>
 <td colspan="2" align="center"><strong><font color="#3e3276">Sales Accept Summary</font></strong></td>
</tr>
...
if($_SESSION['db']=="singhsatrang") { 
    $EW_REPORT_TABLE_SQL_WHERE = "oc_cobi.party $pc '$party' and oc_cobi.code $cod '$code' and oc_cobi.description $desc '$description' and oc_cobi.date >= '$fdate' and oc_cobi.date <= '$tdate' $cond1 ";
}
else
{
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="salesacceptsmry.php?export=html&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&party=<?php echo $party; ?>&warehouse=<?php echo $warehouse; ?>&code=<?php echo $code; ?>&description=<?php echo $description; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="salesacceptsmry.php?export=excel&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&party=<?php echo $party; ?>&warehouse=<?php echo $warehouse; ?>&code=<?php echo $code; ?>&description=<?php echo $description; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="salesacceptsmry.php?export=word&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&party=<?php echo $party; ?>&warehouse=<?php echo $warehouse; ?>&code=<?php echo $code; ?>&description=<?php echo $description; ?>">Export to Word</a>
<?php } ?>
...
<?php 
$code = $description = $quantity = $price  = $flock = $length= $width="" ;
$count = 0;
$weight = 0;
$weightqty = 0;
$freequantity="";
...
$x_totalquantity = 0;
 ...
 $q = "select * from oc_cobi where date = '$x_date' and party = '$x_party' and invoice = '$x_invoice' $cond order by code";
...
{ 
 ...
 $x_totalquantity += $qr['totalquantity'];
...
<?php if($_SESSION['db']=="singhsatrang")
{
$query12 = "SELECT trnum FROM distribution_salesreceipt WHERE invoice = '$x_invoice' AND client = '$client'";
$result12 = mysql_query($query12,$conn1) or die(mysql_error());
$rows12 = mysql_fetch_assoc($result12);
$trnum = $rows12['trnum'];
}
?>	
...
<?php  if($trnum <>"") echo $trnum; else echo"&nbsp;"; ?>
</td>
<?php } ?>
		<td<?php echo $sItemRowClass; ?> align="left">
<?php echo $code; ?>
...
<?php } else { ?>
	<td<?php echo $sItemRowClass; ?> align="left">
<?php echo $length; $tlen += $quantity; ?>
</td>
	<td<?php echo $sItemRowClass; ?> align="left">
<?php echo $width; $twid += $quantity; ?>
</td>
<?php } if($_SESSION['db']!="mew") {?>
   <td<?php echo $sItemRowClass; ?> align="left">
...
<td colspan="1" class="ewRptGrpSummary1" align="left"><b>GRAND TOTAL</b></td>	
		...
		<td class="ewRptGrpSummary1">&nbsp;</td>
		 ...
		 if($_SESSION['db']=="singhsatrang")
		{ 	?>
			<td class="ewRptGrpSummary1" align="right">&nbsp;</td>
	<?php }	?>
	   
		<?php if($_SESSION[db]=='mew'){ ?><td class="ewRptGrpSummary1">&nbsp;</td> <?php } else { ?>
...
<form action="salesacceptsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="salesacceptsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="salesacceptsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="salesacceptsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="salesacceptsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
function reloadpage()
{
	...
	document.location = "salesacceptsmry.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" + description;
...
var date = document.getElementById('fdate').value;
	...
	document.location = "salesacceptsmry.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" + "All";
...
var date = document.getElementById('fdate').value;
	...
	document.location = "salesacceptsmry.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + "All" + "&description=" + description;
...
<?php
	...
	{
	?>
	var status=document.getElementById('srflag').value;
	<?php }?>
	var date = document.getElementById('fdate').value;
	var date1 = document.getElementById('tdate').value;
	var party = document.getElementById('party').value;
	...
	document.location = "salesacceptsmry.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" +description <?php if($_SESSION['db']=="singhsatrang"){?>+ "&status=" + status<?php }?> ;
...
<?php
	...
	document.location = "salesacceptsmry.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" + description + "&warehouse=" + warehouse<?php if($_SESSION['db']=="singhsatrang"){?>+ "&status=" + status<?php }?>;
