...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Fattener Daily Entry</font></strong></td>
</tr>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="fattenerdailyentry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="fattenerdailyentry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="fattenerdailyentry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="fattenerdailyentry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="fattenerdailyentry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="fattenerdailyentry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="fattenerdailyentry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="fattenerdailyentry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="fattenerdailyentry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php echo ewrpt_ViewValue($cummfeed) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($feedstd) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($feedperbird) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($cumfeedstd) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($cumfeedperbird) ?>
</td>
		
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($stdwt) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
...
<?php echo ewrpt_ViewValue($stdfcr) ?>
		...
		<td<?php echo $sItemRowClass; ?><?php if($fcr > $stdfcr) { ?> style="color:#FF0000" <?php } else { ?> style="color:#009900"<?php } ?>><?php echo $fcr ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
...
?>
	<tr>
		<td colspan="22" class="ewRptGrpSummary1"><b>Summary for Flock: <?php $t_flock = $x_flock; $x_flock = $o_flock; ?>
<?php echo ewrpt_ViewValue($x_flock) ?>
