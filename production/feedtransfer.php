...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Feed Transfer</font></strong></td>
</tr>
...
$EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.cat = 'Female Feed' or ims_stocktransfer.cat = 'Male Feed' or ims_stocktransfer.cat = 'Broiler Feed' ";
...
?>
	...
	<tr>
		<td colspan="4" class="ewRptGrpSummary1">Summary for Date: <?php $t_date = $x_date; $x_date = $o_date; ?>
<?php if(date("d.m.Y",strtotime($x_date)) <> "01.01.1970") echo ewrpt_ViewValue(date($datephp,strtotime($x_date))); else echo ewrpt_ViewValue(); ?>
