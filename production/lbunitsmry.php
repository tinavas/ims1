...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "layerbreeder_unit";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT layerbreeder_unit.unitcode, layerbreeder_unit.unitdescription, layerbreeder_unit.farmcode, layerbreeder_unit.farmdescription, layerbreeder_unit.ohtcapacity, layerbreeder_unit.sumpcapacity, layerbreeder_unit.labour FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "layerbreeder_unit.farmcode ASC, layerbreeder_unit.farmdescription ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "layerbreeder_unit.farmcode", TRUE);
...
$EW_REPORT_TABLE_SQL_SELECT_AGG = "SELECT SUM(layerbreeder_unit.ohtcapacity) AS SUM_ohtcapacity, SUM(layerbreeder_unit.sumpcapacity) AS SUM_sumpcapacity, SUM(layerbreeder_unit.labour) AS SUM_labour FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
?>
<?php
$EW_REPORT_FIELD_FARMCODE_SQL_SELECT = "SELECT DISTINCT layerbreeder_unit.farmcode FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_FARMCODE_SQL_ORDERBY = "layerbreeder_unit.farmcode";
?>
<?php
...
<br/>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="lbunitsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="lbunitsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="lbunitsmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="lbunitsmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<br /><br />
<?php } ?>
...
<form action="lbunitsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="lbunitsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="lbunitsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="lbunitsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="lbunitsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php
	...
	//}
$query = "select * from layerbreeder_unit order by farmcode,unitcode";
...
?>
 ...
 <?php if($farmcode <> $ofarmcode) { echo ewrpt_ViewValue($farmcode); } else { echo ewrpt_ViewValue(); }?>
		...
		<td class="ewRptGrpField1">
 <?php if($farmcode <> $ofarmcode) { echo ewrpt_ViewValue($rows['farmdescription']); } else { echo ewrpt_ViewValue(); }?>
		</td>
		<td class="ewRptGrpField2">
<?php if($unitcode <> $ounitcode) { echo ewrpt_ViewValue($unitcode); } else { echo ewrpt_ViewValue(); }?>
		</td>
		<td class="ewRptGrpField2">
<?php if($unitcode <> $ounitcode) { echo ewrpt_ViewValue($rows['unitdescription']); } else { echo ewrpt_ViewValue(); }?>
		</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($rows['ohtcapacity']) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($rows['sumpcapacity']) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($rows['labour']) ?>
</td>
	</tr>
<?php
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_farmcode"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_farmcode"], "layerbreeder_unit.farmcode", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_farmcode"], $GLOBALS["gb_farmcode"], $GLOBALS["gi_farmcode"], $GLOBALS["gq_farmcode"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] = "layerbreeder_unit.unitcode ASC";
