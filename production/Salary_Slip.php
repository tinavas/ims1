...
define("EW_REPORT_TABLE_VAR", "Salary_Slip", TRUE);
...
&nbsp;&nbsp;<a href="Salary_Slip.php?<?php echo $genlinkm; ?>&export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="Salary_Slip.php?<?php echo $genlinkm; ?>&export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="Salary_Slip.php?<?php echo $genlinkm; ?>&export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="Salary_Slip.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br /> 
...
<br />
<?php } ?>
<table  cellspacing="0" border="0" bordercolor="#FFFFFF" width="100%"><tr>
	<td>
<!-- Report Grid (Begin) -->
<div >
<table  cellspacing="0" border="0" bordercolor="#FFFFFF" width="100%" >
<?php
...
<?php
	...
	$nRecCount++;
     ...
     $result = mysql_query($query,$conn1); 
      while($row1 = mysql_fetch_assoc($result)) { $address = $row1['address'];$image = $row1['image'];}
?>
<tr>
<!--&nbsp;&nbsp;&nbsp;&nbsp;<strong>Feedatives Pharma Pvt. Ltd</strong><br/>
&nbsp;&nbsp;&nbsp;&nbsp;46, Chanditala Street, Uttarpara - 7122 58, Hooghly, W.B. India<br/><br/>-->

<img src="../logo/thumbnails/<?php echo $image; ?>" border="0px" />
...
<tr>
&nbsp;&nbsp;&nbsp;<strong style="text-decoration:underline; font-size:11px">Salary Slip / Money Receipt</strong>
</tr>
	<tr>
	<center><span style=" font-size:11px; width:205px"></span>&nbsp;&nbsp;&nbsp;<span style="text-decoration:underline; font-size:11px">Name : <b><?php echo ewrpt_ViewValue(str_replace(chr(10), "<br>", $x_name)); ?></b></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="text-decoration:underline; font-size:11px"><b>A/c :</b></span>&nbsp;&nbsp;&nbsp;<span style="text-decoration:underline; font-size:11px"> Salary for month of <?php echo $montharr[$month-1]; ?>, <?php echo $cyear; ?></span>&nbsp;&nbsp;</center>
	</tr>
	<tr>
	<center>&nbsp;&nbsp;&nbsp;<span style="text-decoration:underline; font-size:11px"><b>INCOME</b> </span></center>
	</tr>
	<tr>
	<center>&nbsp;&nbsp;&nbsp;<span style="font-size:9px; width:132px">Basic ( Incl. of D.A.) Rs. : </span>&nbsp;<span style=" font-size:9px;"><b><?php echo ewrpt_ViewValue(number_format($x_bfix,2)); ?></b></span>&nbsp;&nbsp;<span style="font-size:9px; width:85px">Comp Allow Rs. :</span>&nbsp;<span style=" font-size:9px;"><b><?php echo ewrpt_ViewValue(number_format($x_compallowance,2)) ?></b></span>&nbsp;&nbsp;<span style="font-size:9px; width:78px">H.R. Allow Rs. :</span>&nbsp;<span style=" font-size:9px; "><b><?php echo ewrpt_ViewValue(number_format($x_hrafix,2)) ?></b></span>&nbsp;&nbsp;<span style="font-size:9px; width:100x">Transport Allow Rs. :</span>&nbsp;<span style=" font-size:9px"><b><?php echo ewrpt_ViewValue(number_format($x_tafix,2)) ?></b></span>&nbsp;&nbsp;<span style="font-size:9px; width:165px">Dress Maintain/Wash Allow Rs. :</span>&nbsp;<span style=" font-size:9px; "><b><?php echo ewrpt_ViewValue(number_format($x_dressmaintain,2)) ?></b></span>&nbsp;&nbsp;<br/>
	<span style="width:850px">&nbsp;</span><span style="font-size:9px">Total Rs. :</span>&nbsp;<span style=" font-size:11px; width:50px; text-align:right"><?php echo ewrpt_ViewValue(number_format($x_bfix + $x_compallowance + $x_hrafix + $x_tafix  + $x_dressmaintain,2)) ?></span> </center>
	</tr>
	<tr>
	<center>&nbsp;&nbsp;&nbsp;<span style="text-decoration:underline; font-size:11px"><b>DEDUCTIONS</b> </span></center>
	</tr>
	<tr>
	<center>&nbsp;&nbsp;&nbsp;<span style="font-size:9px; width:135px">P.Fund Rs. : </span>&nbsp;<span style=" font-size:9px; width:25px"><b><?php echo ewrpt_ViewValue(number_format($x_pffix,2)); ?></b></span>&nbsp;&nbsp;<span style="font-size:9px; width:95px">P.Tax Rs. :</span>&nbsp;<span style=" font-size:9px; width:25px"><b><?php echo ewrpt_ViewValue(number_format($x_ptaxfix,2)) ?></b></span>&nbsp;&nbsp;<span style="font-size:9px; width:100px">Loan Rs. :</span>&nbsp;<span style=" font-size:8px; width:25px"><b>&nbsp;&nbsp;&nbsp;</b></span>&nbsp;&nbsp;<span style="font-size:9px; width:120px">E S I C Rs. :</span>&nbsp;<span style=" font-size:9px"><b><?php echo ewrpt_ViewValue(number_format(ceil($x_esic),2)) ?></b></span>&nbsp;&nbsp;<span style="font-size:9px; width:175px">&nbsp;</span>&nbsp;&nbsp;&nbsp;<span style="font-size:9px">Total Rs. :</span>&nbsp;<span style=" font-size:11px; width:50px; text-align:right"><?php echo ewrpt_ViewValue(number_format($x_pffix + $x_ptaxfix + $x_esic,2)) 
	//ewrpt_ViewValue(number_format(round(round($x_pffix + $x_ptaxfix + $x_esic,1)),2))?></span> </center>
	</tr>
	<tr>
	<center>&nbsp;&nbsp;&nbsp;<span style="font-size:9px; width:820px">&nbsp; </span><span style="font-size:9px">Net Amt. Rs. :</span>&nbsp;<span style=" font-size:10px; width:50px; text-align:right"><b><?php echo ewrpt_ViewValue(number_format($x_finalsal,2)) ?></b></span> </center>
	</tr>
	<tr>
	<center>&nbsp;&nbsp;&nbsp;<span style="font-size:11px; width:135px">Rupees. : </span>&nbsp;<span style=" font-size:9px; width:325px"><b>&nbsp;</b></span>&nbsp;&nbsp;<span style="font-size:11px; ">Paid by Cash/Cheque/Draft No. :</span>&nbsp;<span style=" font-size:11px; width:125px"><b>&nbsp;</b></span>&nbsp;&nbsp;<span style="font-size:11px; width:100px">Date :</span>&nbsp;</center>
	</tr>
	<tr>
	<center>&nbsp;&nbsp;&nbsp;<span style="font-size:11px; width:85px ">&nbsp;</span>&nbsp;<span style=" font-size:11px; width:55px">of</span>&nbsp;&nbsp;<span style=" font-size:11px; width:185px"></span><span style="font-size:11px; ">by letter dtd.</span>&nbsp;</center><br/>
	</tr>
	<tr>
	<center>&nbsp;&nbsp;&nbsp;<span style="font-size:11px; ">Date : </span>&nbsp;&nbsp;&nbsp;&nbsp;<span style=" font-size:9px; width:75px"><b>&nbsp;</b></span>&nbsp;&nbsp;<span style="font-size:11px; ">Prepared by :</span>&nbsp;<span style=" font-size:11px; width:225px"><b>&nbsp;</b></span>&nbsp;&nbsp;<span style="font-size:11px; ">received by :</span>&nbsp;<span style=" font-size:12px; width:225px"><b>&nbsp;</b></span></center>
	</tr>
	<tr>
	<span style="color:#000000; font-weight:bold">&nbsp;&nbsp;&nbsp;________________________________________________________________________________________</span><br/>
	<span style="font-size:9px; padding-left:20px"> Note : Please return three copies of this receipt immediately on receipt at your end duly putting your signature. In case of non-receipt of the same within next 15 days from the date of issue, </span><br/><span style="font-size:9px; padding-left:20px">automatically it will be treated as accepted by you<br/></span>
...
<?php if ($nTotalGrps > 0) { ?>
	...
	<?php /*?><tr class="ewRptGrandSummary"><td colspan="18">Grand Total (<?php echo ewrpt_FormatNumber($rstotcnt,0,-2,-2,-2); ?> Detail Records)</td></tr>
...
<?php if (@$sExport == "") { ?>
<?php /*?><div class="ewGridLowerPanel">
<form action="Salary_Slip.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="Salary_Slip.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="Salary_Slip.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="Salary_Slip.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="Salary_Slip.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
