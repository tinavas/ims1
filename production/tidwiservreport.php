...
<tr>
 <td colspan="2" align="center"><strong><font color="#3e3276">Receipt Vouchers Summary</font></strong></td>
</tr>
<tr height="5px"></tr>
<tr>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="tidwiservreport.php?export=html&from=<?php echo $from; ?>&to=<?php echo $to; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="tidwiservreport.php?export=excel&from=<?php echo $from; ?>&to=<?php echo $to; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="tidwiservreport.php?export=word&from=<?php echo $from; ?>&to=<?php echo $to; ?>">Export to Word</a>
...
<table>
 <tr>
 <td>From Date</td>
 <td><input type="text" name="from" id="from" value="<?php echo date("d.m.Y",strtotime($from)); ?>" size="11" class="datepicker" onchange="reloadpage();" /></td>
 <td>To Date</td>
 <td><input type="text" name="to" id="to" value="<?php echo date("d.m.Y",strtotime($to)); ?>" size="11" class="datepicker" onchange="reloadpage();" /></td>
...
<?php } ?>
	...
	<tbody>
<?php
$query = "SELECT * FROM ac_gl WHERE date BETWEEN '$from' AND '$to' AND voucher = 'R' ORDER BY date";
...
<br/><br/>
<p>
<b>Bank Depositor Name:<br/><br/>
Date of Deposit:<br/><br/>
...
function reloadpage()
{
	...
	document.location = "tidwiservreport.php?from=" + from + "&to=" + to;
}
</script>