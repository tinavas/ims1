...
<tr>
<td colspan="2" align="center"><font size="2">Till Date&nbsp;<?php echo date($datephp,strtotime($tdatedump)); ?></font></td>
</tr>
</table>
<br/>
...
<?php } ?>
	<?php if($_SESSION[db]=='albustan') if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Supplier Code
		</td>
<?php } else { ?>
...
$onacctot = 0;
$grandtot = 0;
  $q111 = "select name,code from contactdetails where type = 'vendor' or type = 'vendor and party' order by name ";
...
$nubal = 0;
		...
		$fibal = 0;
		$eibal = 0;
	 $q = "select adate,grandtotal,so from pp_sobi where vendor = '$ven' and adate <= '$tdate' group by so order by so   ";
...
<?php if($_SESSION['db']=='albustan') { ?><td>&nbsp;</td> <?php } ?>
<td align="right">
