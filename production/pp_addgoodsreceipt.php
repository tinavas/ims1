...
<?php if($_SESSION['db'] == "central" or $_SESSION['db'] == "alwadi") { ?>
 ...
 <?php } else { ?>
<form id="form1" name="form1" method="post" action="pp_savegoodsreceipt.php"> 
 <?php } ?>
...
<td width="10px"></td>
<td align="center"><input readonly size="7" type="text" style="background:none; border:none;text-align:right;" name="bird[]" id="bird<?php echo $i; ?>" value="<?php echo $row1['bird'];?>" /></td>
...
<td align="right"><?php if($ge != "" && $vendor != "") { ?><input  size="7" type="text"  value="<?php echo $row1['rateperunit']; ?>"  id="rateperunit<?php echo $i; ?>" name="rateperunit[]"  style="text-align:right" /><?php } ?></td>
<td width="10px"></td>
...
<input type="submit" id="save" value="Save" />&nbsp;&nbsp;<input type="button" id="cancel" value="Cancel" onClick="document.location='dashboardsub.php?page=pp_goodsreceipt'"/>
