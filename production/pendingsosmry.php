...
define("EW_REPORT_TABLE_VAR", "pendingso", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "pendingso_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "pendingso_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "pendingso_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "pendingso_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "pendingso_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "`oc_salesorder`";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT oc_salesorder.po,oc_salesorder.vendor,oc_salesorder.date,oc_salesorder.code,oc_salesorder.description,oc_salesorder.quantity,oc_salesorder.deliverydate,oc_salesorder.warehouse FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "oc_salesorder.psflag <> 1";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "oc_salesorder.deliverydate DESC";
...
$EW_REPORT_FIELD_warehouse_SQL_SELECT = "SELECT DISTINCT `warehouse` FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_warehouse_SQL_ORDERBY = "`warehouse`";
?>
<?php
...
$o_warehouse = NULL; $t_warehouse = NULL; $ft_warehouse = 200; $rf_warehouse = NULL; $rt_warehouse = NULL;
?>
<?php
...
ewrpt_CreatePopup("pendingso_po", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_vendor, $sel_vendor, $ft_vendor) ?>
ewrpt_CreatePopup("pendingso_vendor", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_date, $sel_date, $ft_date) ?>
ewrpt_CreatePopup("pendingso_date", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_code, $sel_code, $ft_code) ?>
ewrpt_CreatePopup("pendingso_code", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_description, $sel_description, $ft_description) ?>
ewrpt_CreatePopup("pendingso_description", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_deliverydate, $sel_deliverydate, $ft_deliverydate) ?>
ewrpt_CreatePopup("pendingso_deliverydate", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_warehouse, $sel_warehouse, $ft_warehouse) ?>
ewrpt_CreatePopup("pendingso_warehouse", [<?php echo $jsdata ?>]);
</script>
<div id="pendingso_po_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingso_vendor_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingso_date_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingso_code_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingso_description_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingso_deliverydate_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingso_warehouse_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="pendingsosmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="pendingsosmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="pendingsosmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="pendingsosmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="pendingsosmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="pendingsosmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="pendingsosmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="pendingsosmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="pendingsosmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Delivery Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingso_deliverydate', false, '<?php echo $rf_deliverydate; ?>', '<?php echo $rt_deliverydate; ?>');return false;" name="x_deliverydate<?php echo $cnt[0][0]; ?>" id="x_deliverydate<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>

<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="Sales Order" align="center">
		SO
		</td>
<?php } else { ?>
		<td class="ewTableHeader" align="center">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Sales Order">SO</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingso_po', false, '<?php echo $rf_po; ?>', '<?php echo $rt_po; ?>');return false;" name="x_po<?php echo $cnt[0][0]; ?>" id="x_po<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader" align="center">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Customer</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingso_vendor', false, '<?php echo $rf_vendor; ?>', '<?php echo $rt_vendor; ?>');return false;" name="x_vendor<?php echo $cnt[0][0]; ?>" id="x_vendor<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Item Code</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingso_code', false, '<?php echo $rf_code; ?>', '<?php echo $rt_code; ?>');return false;" name="x_code<?php echo $cnt[0][0]; ?>" id="x_code<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingso_date', false, '<?php echo $rf_date; ?>', '<?php echo $rt_date; ?>');return false;" name="x_date<?php echo $cnt[0][0]; ?>" id="x_date<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader" align="center">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Warehouse</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingso_warehouse', false, '<?php echo $rf_warehouse; ?>', '<?php echo $rt_warehouse; ?>');return false;" name="x_warehouse<?php echo $cnt[0][0]; ?>" id="x_warehouse<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
	</tr>
...
<?php echo ewrpt_ViewValue(ewrpt_FormatDateTime($x_date,7)) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_warehouse) ?>
</td>
	</tr>
<?php
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$GLOBALS['x_warehouse'] = $rs->fields('warehouse');
		...
		$GLOBALS['x_psflag'] = $rs->fields('psflag');
...
function SetupPopup() {
	...
	while ($rswrk && !$rswrk->EOF) {
		...
		if (is_null($x_warehouse)) {
			...
			$t_warehouse = $x_warehouse;
			ewrpt_SetupDistinctValues($GLOBALS["val_warehouse"], $x_warehouse, $t_warehouse, FALSE);
		}
		$rswrk->MoveNext();
	}
	if ($rswrk)
	...
	if (is_array(@$_SESSION["sel_pendingso_po"])) {
		LoadSelectionFromSession('po');
	} elseif (@$_SESSION["sel_pendingso_po"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_po"] = "";
	}

	// Get Vendor selected values
	if (is_array(@$_SESSION["sel_pendingso_vendor"])) {
		LoadSelectionFromSession('vendor');
	} elseif (@$_SESSION["sel_pendingso_vendor"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_vendor"] = "";
	}

	// Get Date selected values
	if (is_array(@$_SESSION["sel_pendingso_date"])) {
		LoadSelectionFromSession('date');
	} elseif (@$_SESSION["sel_pendingso_date"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_date"] = "";
	}

	// Get Code selected values
	if (is_array(@$_SESSION["sel_pendingso_code"])) {
		LoadSelectionFromSession('code');
	} elseif (@$_SESSION["sel_pendingso_code"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_code"] = "";
	}

	// Get Description selected values
	if (is_array(@$_SESSION["sel_pendingso_description"])) {
		LoadSelectionFromSession('description');
	} elseif (@$_SESSION["sel_pendingso_description"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_description"] = "";
	}

	// Get Deliverydate selected values
	if (is_array(@$_SESSION["sel_pendingso_deliverydate"])) {
		LoadSelectionFromSession('deliverydate');
	} elseif (@$_SESSION["sel_pendingso_deliverydate"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_deliverydate"] = "";
	}

	// Get warehouse selected values
	if (is_array(@$_SESSION["sel_pendingso_warehouse"])) {
		LoadSelectionFromSession('warehouse');
	} elseif (@$_SESSION["sel_pendingso_warehouse"] == EW_REPORT_INIT_VALUE) { // Select all
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_pendingso_$parm"] = "";
	$_SESSION["rf_pendingso_$parm"] = "";
	$_SESSION["rt_pendingso_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_pendingso_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_pendingso_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_pendingso_$parm"];
}
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_warehouse"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_warehouse"], "`warehouse`", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_warehouse"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_pendingso_po"] = "";
			$_SESSION["sort_pendingso_vendor"] = "";
			$_SESSION["sort_pendingso_date"] = "";
			$_SESSION["sort_pendingso_code"] = "";
			$_SESSION["sort_pendingso_description"] = "";
			$_SESSION["sort_pendingso_quantity"] = "";
			$_SESSION["sort_pendingso_deliverydate"] = "";
			$_SESSION["sort_pendingso_warehouse"] = "";
		}
