...
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">Chicken Centre Item Ledger</font></strong></td>
</tr>
<tr>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="itemledgerall.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="itemledgerall.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="itemledgerall.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php
	...
	include "config.php";
	$q11 = "select code,description,sunits,iac from ims_itemcodes WHERE cat in ( select distinct(cat) from chicken_category) and client = '$client' order by code  ";
...
$q = "select * from ims_itemcodes where code  = '$code' AND (cat in (select distinct(cat) from chicken_category) or cat LIKE '%Birds') ";
 ...
 $query1 = "SELECT sum(quantity) as itotqty,sum(amount) as itotamt from ac_financialpostings where itemcode = '$code' and crdr = 'Dr' and coacode = '$itemcode' and date >= '$fdate' and date <= '$tdate'  AND warehouse = '$warehouse' ";
  ...
  $query1 = "SELECT sum(quantity) as itotqty,sum(amount) as itotamt from ac_financialpostings where itemcode = '$code' and crdr = 'Cr' and coacode = '$itemcode' and date >= '$fdate' and date <= '$tdate'  AND warehouse = '$warehouse' ";
	...
	<tr>
		...
		<td align="right">
<?php echo ewrpt_ViewValue(changeprice($obqty)) ?>
</td>
		<td align="right">
<?php echo ewrpt_ViewValue(changeprice($obval)) ?>
</td>
