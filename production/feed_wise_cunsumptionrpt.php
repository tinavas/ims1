...
$EW_REPORT_TABLE_SQL_ORDERBY = "f.formulae,f.ingredient ";
...
<?php $nobatches = 0;
$q="select sum(batches) as bat from feed_productionunit where date >= '$fromdate' and date <= '$todate' and client='$client' $condb";
...
To Date&nbsp;
<input type="text" class="datepicker" id="todate" name="todate" value="<?php if($_GET['todate']) { echo $_GET['todate']; } else { echo date($datephp); }  ?>" onchange="reload1('','')" />
&nbsp;&nbsp;&nbsp;
<b>Total No Batches Produced :&nbsp;<?php echo $nobatches;?></b>


</div>
<div class="ewGridUpperPanel">
Feedtype <select id="feedtype" onchange="reload1('','')">
<option <?php if($_GET[feedtype]=='all') echo 'selected="selected"'; ?> value="all">All</option>
<?php 
$q="select distinct(feedtype) from feed_itemwise where flag=0 and date >= '$fromdate' and date <= '$todate' and client='$client' order by feedtype";
$r=mysql_query($q,$conn1);
while($a=mysql_fetch_assoc($r))
{ ?>
<option <?php if($_GET[feedtype]==$a['feedtype']) echo 'selected="selected"'; ?>  value="<?php echo $a['feedtype'] ?>"><?php echo $a['feedtype'] ?></option>
<?php
}
?>
</select>
...
Feed Formula <select id="formulae" onchange="reload1('','')">
<option <?php if($_GET[formulae]=='all') echo 'selected="selected"'; ?> value="all">All</option>
<?php 
$q="select distinct(formulae) from feed_itemwise where flag=0 and date >= '$fromdate' and date <= '$todate' and client='$client' order by formulae";
$r=mysql_query($q,$conn1);
while($a=mysql_fetch_assoc($r))
{ ?>
<option <?php if($_GET[formulae]==$a['formulae']) echo 'selected="selected"'; ?> value="<?php echo $a['formulae'] ?>"><?php echo $a['formulae'] ?></option>
<?php
}
?>
</select>

Item Code <select id="ingredient" onchange="reload1('','')">
<option <?php if($_GET[ingredient]=='all') echo 'selected="selected"'; ?>  value="all">All</option>
<?php 
$q="select distinct(ingredient) from feed_itemwise where flag=0 and date >= '$fromdate' and date <= '$todate' and client='$client' order by ingredient";
$r=mysql_query($q,$conn1);
while($a=mysql_fetch_assoc($r))
{ ?>
<option <?php if($_GET[ingredient]==$a['ingredient']) echo 'selected="selected"'; ?> value="<?php echo $a['ingredient'] ?>"><?php echo $a['ingredient'] ?></option>
<?php
}
?>
</select>
...
<?php 
//echo $q="select description,code from ims_itemcodes where code in (select distinct(ingredient) from feed_itemwise where flag=0 and date >= '$fromdate' and date <= '$todate' and client='$client' order by ingredient) and client='$client' order by description";
?>
Description <select id="desc" onchange="document.getElementById('ingredient').value=this.value;reload1('','');">
<option <?php if($_GET[ingredient]=='all') echo 'selected="selected"'; ?>  value="all">All</option>
<?php 
$q="select description,code from ims_itemcodes where client='$client' order by description";
$r=mysql_query($q,$conn1);
while($a=mysql_fetch_assoc($r))
{ ?>
<option <?php if($_GET[ingredient]==$a['code']) echo 'selected="selected"'; ?> value="<?php echo $a['code'] ?>"><?php echo $a['description'] ?></option>
<?php
}
?>
</select>
...
<?php if($_GET['feedmill']=='all'||$_GET['feedmill']=='') if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Feedmill		</td>
<?php } else { ?>
		<td class="ewTableHeader">
...
<?php if($_GET['feedtype']=='all'||$_GET['feedtype']=='') if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Feedtype		</td>
<?php } else { ?>
		<td class="ewTableHeader">
...
<?php } ?>
<?php if($_GET['formulae']=='all'||$_GET['formulae']=='') if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Formulae		</td>
<?php } else { ?>
		<td class="ewTableHeader">
...
<?php } ?>
<?php if($_GET['ingredient']=='all'||$_GET['ingredient']=='') { if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Item Code		</td>
<?php } else { ?>
		<td class="ewTableHeader">
...
<?php
	...
	$nRecCount++;
		...
		if ($nRecCount % 2 <> 1)
		 ...
		 $q11 = "SELECT distinct(f.formulae) from feed_itemwise f  where f.flag=0  and f.date >= '$fromdate' and f.date <= '$todate' and f.client='$client' $cond";
			$r11=mysql_query($q11,$conn1);
			while($a11=mysql_fetch_assoc($r11))
			{ 
			$form = "";
			$form = $a11['formulae'];
			$q12 = "SELECT f.feedtype,f.ingredient,f.feedmill,i.description,sum(f.quantity) as quantity FROM feed_itemwise f,ims_itemcodes i  where f.flag=0  and i.code=f.ingredient and f.date >= '$fromdate' and f.date <= '$todate' and f.formulae = '$form' and f.client='$client' $cond group by f.ingredient";
			$r12=mysql_query($q12,$conn1);
			while($a12=mysql_fetch_assoc($r12))
			{
			$a_feedmill = $a12['feedmill'];
			$a_feedtype = $a12['feedtype'];
			$a_formulae = $form;
			$a_ingredient = $a12['ingredient'];
			$a_description = $a12['description'];
			$a_quantity = $a12['quantity'];
			 ?>
			<tr>
		
<?php if($_GET['feedmill']=='all'||$_GET['feedmill']=='') { ?>
		<td<?php echo $sItemRowClass; ?>>
<?php $x4=ewrpt_ViewValue(str_replace(chr(10), "<br>", $a_feedmill)); if($dup_feedmill!=$x4)  echo $x4; else echo "&nbsp;" ; ?></td>
<?php } ?>


<?php if($_GET['feedtype']=='all'||$_GET['feedtype']=='') { ?>
		<td<?php echo $sItemRowClass; ?>>
<?php $x2=ewrpt_ViewValue(str_replace(chr(10), "<br>", $a_feedtype)); if($dup_feed!=$x2)  echo $x2; else echo "&nbsp;" ; ?></td>
<?php } ?>
<?php if($_GET['formulae']=='all'||$_GET['formulae']=='') { ?>
		<td<?php echo $sItemRowClass; ?>>
<?php $x3=ewrpt_ViewValue($a_formulae); if($dup_formulae!=$x3)  echo $x3; else echo "&nbsp;" ;  ?></td>
<?php } ?>
<?php if($_GET['ingredient']=='all'||$_GET['ingredient']=='') { ?>
		<td <?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(str_replace(chr(10), "<br>", $a_ingredient)); ?></td> 
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($a_description) ?></td> <?php } ?>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php if($a_quantity == 0){ echo ewrpt_ViewValue("0"); } else { echo ewrpt_ViewValue(round($a_quantity,2)); } ?></td>
</tr>
<?php
     $dup_feed=$x2 ; $dup_feedmill=$x4 ; $dup_formulae=$x3;
...
<?php /*?>	<tr>
		<td<?php echo $sItemRowClass; ?>>
<?php $x=ewrpt_ViewValue(ewrpt_FormatDateTime($x_date,7)); if($dup_date!=$x)  echo $x; else echo "&nbsp;" ; ?></td>

<?php if($_GET['feedmill']=='all'||$_GET['feedmill']=='') { ?>
		<td<?php echo $sItemRowClass; ?>>
<?php $x4=ewrpt_ViewValue(str_replace(chr(10), "<br>", $x_feedmill)); if($dup_feedmill!=$x4||$dup_date!=$x)  echo $x4; else echo "&nbsp;" ; ?></td>
<?php } ?>


<?php if($_GET['feedtype']=='all'||$_GET['feedtype']=='') { ?>
		<td<?php echo $sItemRowClass; ?>>
<?php $x2=ewrpt_ViewValue(str_replace(chr(10), "<br>", $x_feedtype)); if($dup_feed!=$x2||$dup_date!=$x)  echo $x2; else echo "&nbsp;" ; ?></td>
<?php } ?>
<?php if($_GET['formulae']=='all'||$_GET['formulae']=='') { ?>
		<td<?php echo $sItemRowClass; ?>>
<?php $x3=ewrpt_ViewValue($x_formulae); if($dup_formulae!=$x3||$dup_date!=$x)  echo $x3; else echo "&nbsp;" ;  ?></td>
<?php } ?>
<?php if($_GET['ingredient']=='all'||$_GET['ingredient']=='') { ?>
		<td <?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(str_replace(chr(10), "<br>", $x_ingredient)); ?></td> 
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_description) ?></td> <?php } ?>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_quantity) ?></td>
	</tr><?php */?>
<?php
...
<form action="feed_wise_cunsumptionrpt.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="feed_wise_cunsumptionrpt.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="feed_wise_cunsumptionrpt.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="feed_wise_cunsumptionrpt.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="feed_wise_cunsumptionrpt.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
{
path='feed_wise_cunsumptionrpt.php?feedtype='+feedtype+'&feedmill='+feedmill+'&formulae='+formulae+'&ingredient='+ingredient+'&todate='+todate+'&fromdate='+fromdate+'&desc='+desc;
if(value='export')
