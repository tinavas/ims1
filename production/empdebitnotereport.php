...
<tr height="5px"></tr>
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Employee Name : <?php echo $name;?></font></strong></td>
</tr>
<?php } ?>
<tr height="5px"></tr>
<tr>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="empdebitnotereport.php?export=html&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&name=<?php echo $name;?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="empdebitnotereport.php?export=excel&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&name=<?php echo $name;?>">Export to Excel</a>
&nbsp;&nbsp;<a href="empdebitnotereport.php?export=word&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&name=<?php echo $name;?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="empdebitnotereport.php?cmd=reset&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&name=<?php echo $name;?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
function reloadpage()
{
	...
	document.location = "empdebitnotereport.php?fromdate=" + fdate + "&todate=" + tdate + "&name="+name ;
}
</script>