...
<tr>
 <td colspan="2" align="center"><strong><font color="#3e3276">Category Wise Processing</font></strong></td>
</tr>
<tr height="5px"></tr>
<tr>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="chickencatproduction.php?export=html&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&cat=<?php echo $cat; ?>&unit=<?php echo $unit; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="chickencatproduction.php?export=excel&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&cat=<?php echo $cat; ?>&unit=<?php echo $unit; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="chickencatproduction.php?export=word&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&cat=<?php echo $cat; ?>&unit=<?php echo $unit; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="chickencatproduction.php?cmd=reset&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&cat=<?php echo $cat; ?>&unit=<?php echo $unit; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
$query = " select distinct(date) from chicken_chickentransfer where unit = '$unit' and tocode in (select distinct(code) from ims_itemcodes where cat = '$cat') and date between '$fromdate' and '$todate' order by tocode";
$result = mysql_query($query,$conn1) or die(mysql_error());
while($rows = mysql_fetch_assoc($result))
{
 $date = $rows['date'];
...
<?php
 ...
 {
 $query2 = "select sum(quantity) as quantity from chicken_chickentransfer where unit = '$unit' and tocode = '$array[$i]' and date = '$date'";
...
document.location = "chickencatproduction.php?fromdate=" + fromdate + "&todate=" + todate + "&cat=" + cat + "&unit=" + unit1; 
}
</script>