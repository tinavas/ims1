...
{
 $q2 = "select sum(kgs) as qt,weight  from chicken_chickentransfer where  client = '$client'  and date='$datenew' group by tid";


$r2 = mysql_query($q2,$conn1) or die(mysql_error());
while($rows2 = mysql_fetch_array($r2)){
$shrinkage=$shrinkage+$rows2['qt'];
	$per=$per+$rows2['weight'];
	//$weight=$rows2[2];
  } } 
...
define("EW_REPORT_TABLE_VAR", "chickendaysheet", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "chickendaysheet_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "chickendaysheet_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "chickendaysheet_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "chickendaysheet_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "chickendaysheet_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "chicken_chickentransfer";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT chicken_chickentransfer.date, chicken_chickentransfer.unit, chicken_chickentransfer.birds, chicken_chickentransfer.fromtype, chicken_chickentransfer.category, chicken_chickentransfer.tocode, chicken_chickentransfer.todescription, chicken_chickentransfer.units, chicken_chickentransfer.quantity,chicken_chickentransfer.kgs FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "chicken_chickentransfer.date = '$datenew'";
...
ewrpt_CreatePopup("chickendaysheet_date", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_unit, $sel_unit, $ft_unit) ?>
ewrpt_CreatePopup("chickendaysheet_unit", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_fromtype, $sel_fromtype, $ft_fromtype) ?>
ewrpt_CreatePopup("chickendaysheet_fromtype", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_category, $sel_category, $ft_category) ?>
ewrpt_CreatePopup("chickendaysheet_category", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_tocode, $sel_tocode, $ft_tocode) ?>
ewrpt_CreatePopup("chickendaysheet_tocode", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_todescription, $sel_todescription, $ft_todescription) ?>
ewrpt_CreatePopup("chickendaysheet_todescription", [<?php echo $jsdata ?>]);
</script>
<div id="chickendaysheet_date_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="chickendaysheet_unit_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="chickendaysheet_fromtype_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="chickendaysheet_category_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="chickendaysheet_tocode_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="chickendaysheet_todescription_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="chickendaysheet.php?export=html&fromdate=<?php echo $_GET['fromdate'];?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="chickendaysheet.php?export=excel&fromdate=<?php echo $_GET['fromdate'];?>">Export to Excel</a>
&nbsp;&nbsp;<a href="chickendaysheet.php?export=word&fromdate=<?php echo $_GET['fromdate'];?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="chickendaysheet.php?cmd=reset&fromdate=<?php echo $_GET['fromdate'];?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="chickendaysheet.php" name="ewpagerform" id="ewpagerform" class="ewForm">
<table border="0" cellspacing="0" cellpadding="0">
	<tr><td>Date</td>
	<td><input type="text" class="datepicker" id="date" name="date" value="<?php echo $date; ?>" onchange="reloadpage()" /></td>
<?php if($_SESSION['db']=="vista") { ?><td><strong>Shrinkage</strong></td><td><?php echo $ab=$per-$shrinkage;?></td>
<td></td><td><strong>Shrinkage Percent</strong></td>
<td><?php echo round(($ab/$per)*100,2);?></td>
<?php } ?>
	</tr>
</table>
</form>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'chickendaysheet_date', false, '<?php echo $rf_date; ?>', '<?php echo $rt_date; ?>');return false;" name="x_date<?php echo $cnt[0][0]; ?>" id="x_date<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Unit</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'chickendaysheet_unit', false, '<?php echo $rf_unit; ?>', '<?php echo $rt_unit; ?>');return false;" name="x_unit<?php echo $cnt[0][0]; ?>" id="x_unit<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Fromtype</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'chickendaysheet_fromtype', false, '<?php echo $rf_fromtype; ?>', '<?php echo $rt_fromtype; ?>');return false;" name="x_fromtype<?php echo $cnt[0][0]; ?>" id="x_fromtype<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Category</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'chickendaysheet_category', false, '<?php echo $rf_category; ?>', '<?php echo $rt_category; ?>');return false;" name="x_category<?php echo $cnt[0][0]; ?>" id="x_category<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Tocode</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'chickendaysheet_tocode', false, '<?php echo $rf_tocode; ?>', '<?php echo $rt_tocode; ?>');return false;" name="x_tocode<?php echo $cnt[0][0]; ?>" id="x_tocode<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Todescription</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'chickendaysheet_todescription', false, '<?php echo $rf_todescription; ?>', '<?php echo $rt_todescription; ?>');return false;" name="x_todescription<?php echo $cnt[0][0]; ?>" id="x_todescription<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td><?php if($_SESSION['db']=="vista") {?>Pieces <?php } else { ?> Quantity<?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td><?php if($_SESSION['db']=="vista") {?>Weight($kgs) <?php } else { ?> kgs<?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
...
<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_kgs) ?>
</td>
<?php } ?>
	</tr>
<?php
...
<tr>
   ...
   <td><b>Total Weight</b></td><td width="15px"></td>
    <td><b>Price</b></td><td width="15px"></td>
    <td><b>Amount</b></td><td width="15px"></td>
</tr>
<?php 
$q43 = "SELECT pp_sobi.vendor, pp_sobi.date, pp_sobi.so, pp_sobi.weight, pp_sobi.grandtotal FROM pp_sobi where pp_sobi.date = '$datenew' and client = '$client' group by pp_sobi.vendor, pp_sobi.date, pp_sobi.so, pp_sobi.totalquantity, pp_sobi.grandtotal order by pp_sobi.vendor ASC, pp_sobi.date ASC"; 
...
<tr>
    ...
    <td><?php echo changeprice($quantity); ?></td><td width="15px"></td>
	 <td><?php echo changeprice($qr43['weight']); ?></td><td width="15px"></td>
...
<tr>
    ...
    <td><b>Price</b></td><td width="15px"></td>
    <td><b>Amount</b></td><td width="15px"></td>
	<td><b>Total Amount</b></td><td width="15px"></td>
</tr>
<?php
$fintotal = 0; 
$q43 = "SELECT finaltotal,party,invoice,code,description,quantity,price FROM oc_cobi where oc_cobi.date = '$datenew' and client = '$client' "; 
$qrs43 = mysql_query($q43,$conn1) or die(mysql_error());
while($qr43 = mysql_fetch_assoc($qrs43))
{
$fintotal = $qr43['quantity'] * $qr43['price'];
?>
<tr height="2px"><td></td></tr>
<tr>
<td<?php echo $sItemRowClass; ?>>
<?php if(($qr43['party'] <> $oldcode) or ($dumm == 0)){ echo ewrpt_ViewValue($qr43['party']);
     $oldcode = $qr43['party']; $dumm = 1; }
	 else{
...
<td<?php echo $sItemRowClass; ?>>
<?php if(($qr43['invoice'] <> $oldcode1) or ($dumm1 == 0)){ echo ewrpt_ViewValue($qr43['invoice']);
     $oldcode1 = $qr43['invoice']; $dumm1 = 1; }
	 else{
	 echo ewrpt_ViewValue("&nbsp;");
	 } ?>
</td>
   <td width="15px"></td> 
    ...
    <td><?php echo changeprice($qr43['quantity']); ?></td><td width="15px"></td>
    <td><?php echo changeprice($qr43['price']); ?></td><td width="15px"></td>
	<td><?php echo changeprice($fintotal); ?></td><td width="15px"></td>
	<td<?php echo $sItemRowClass; ?>>
<?php if(($qr43['finaltotal'] <> $oldcode2) or ($dumm2 == 0)){ echo ewrpt_ViewValue($qr43['finaltotal']);
     $oldcode2 = $qr43['finaltotal']; $dumm2 = 1; }
	 else{
	 echo ewrpt_ViewValue("&nbsp;");
	 } ?>
</td>
	</tr>
<?php $ttq = $ttq + $fintotal; $tgt = $tgt + $qr43['finaltotal']; } ?>
<tr height="2px"><td></td></tr>
<tr>
    <td></td><td width="15px"></td>
    <td></td><td width="15px"></td>
...
<tr>
    ...
    <td></td><td width="15px"></td>
    <td></td><td width="15px"></td>
    <td><?php echo changeprice($ttq); ?></td>
	<td></td><td><?php echo changeprice($ttq); ?></td>
</tr>
</table>
<br />
...
<tr>
    ...
    <td><b>Cash Code</b></td><td width="15px"></td>
	<td><b>Amount</b></td><td width="15px"></td>
    <td><b>Cheque</b></td><td width="15px"></td>
   
</tr>
<?php
$fintotal = 0; 
$q = "SELECT * FROM pp_payment where pp_payment.date = '$datenew' and client = '$client' "; 
$qrs = mysql_query($q,$conn1) or die(mysql_error());
while($qr = mysql_fetch_assoc($qrs))
{
$doc = $qr['tid'];
...
<tr>
<td<?php echo $sItemRowClass; ?>>
<?php if(($doc <> $oldcode) or ($dumm == 0)){ echo ewrpt_ViewValue($doc);
     $oldcode = $doc; $dumm = 1; }
	 else{
	 echo ewrpt_ViewValue("&nbsp;");
	 } ?>
...
<td><?php echo $pm; ?></td>
   <td width="15px"></td> 
    <td><?php echo $cashcode; ?></td><td width="15px"></td>
    <td><?php echo changeprice($amount); ?></td><td width="15px"></td>
	<td><?php echo $cheque; ?></td><td width="15px"></td>
	</tr>
<?php $tta = $tta + $amount;  } ?>
<tr height="2px"><td></td></tr>
<tr>
...
<tr>
    ...
    <td></td><td width="15px"></td>
    <td></td><td width="15px"></td>
    <td><?php echo changeprice($tta); ?></td>
...
<?php
$fintotal = 0; 
$q = "SELECT * FROM oc_receipt where oc_receipt.date = '$datenew' and client = '$client' "; 
$qrs = mysql_query($q,$conn1) or die(mysql_error());
while($qr = mysql_fetch_assoc($qrs))
{
$doc = $qr['tid'];
...
<tr>
    ...
    <td></td><td width="15px"></td>
    <td></td><td width="15px"></td>
    <td><?php echo changeprice($tta1); ?></td>
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_chickendaysheet_date"])) {
		LoadSelectionFromSession('date');
	} elseif (@$_SESSION["sel_chickendaysheet_date"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_date"] = "";
	}

	// Get Unit selected values
	if (is_array(@$_SESSION["sel_chickendaysheet_unit"])) {
		LoadSelectionFromSession('unit');
	} elseif (@$_SESSION["sel_chickendaysheet_unit"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_unit"] = "";
	}

	// Get Fromtype selected values
	if (is_array(@$_SESSION["sel_chickendaysheet_fromtype"])) {
		LoadSelectionFromSession('fromtype');
	} elseif (@$_SESSION["sel_chickendaysheet_fromtype"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_fromtype"] = "";
	}

	// Get Category selected values
	if (is_array(@$_SESSION["sel_chickendaysheet_category"])) {
		LoadSelectionFromSession('category');
	} elseif (@$_SESSION["sel_chickendaysheet_category"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_category"] = "";
	}

	// Get Tocode selected values
	if (is_array(@$_SESSION["sel_chickendaysheet_tocode"])) {
		LoadSelectionFromSession('tocode');
	} elseif (@$_SESSION["sel_chickendaysheet_tocode"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_tocode"] = "";
	}

	// Get Todescription selected values
	if (is_array(@$_SESSION["sel_chickendaysheet_todescription"])) {
		LoadSelectionFromSession('todescription');
	} elseif (@$_SESSION["sel_chickendaysheet_todescription"] == EW_REPORT_INIT_VALUE) { // Select all
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_chickendaysheet_$parm"] = "";
	$_SESSION["rf_chickendaysheet_$parm"] = "";
	$_SESSION["rt_chickendaysheet_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_chickendaysheet_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_chickendaysheet_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_chickendaysheet_$parm"];
}
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_chickendaysheet_date"] = "";
			$_SESSION["sort_chickendaysheet_unit"] = "";
			$_SESSION["sort_chickendaysheet_fromtype"] = "";
			$_SESSION["sort_chickendaysheet_category"] = "";
			$_SESSION["sort_chickendaysheet_birds"] = "";
			$_SESSION["sort_chickendaysheet_tocode"] = "";
			$_SESSION["sort_chickendaysheet_todescription"] = "";
			$_SESSION["sort_chickendaysheet_units"] = "";
			$_SESSION["sort_chickendaysheet_quantity"] = "";
		}
...
function reloadpage()
{
	...
	document.location = "chickendaysheet.php?fromdate="+date;
}
</script>
