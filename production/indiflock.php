...
<?php
$ceggs = 0;
 $q1 = "select * from breeder_flock where flockcode = '$flock' and client = '$client'";
...
$qyu = "select * from breeder_consumption where flock = '$flock' and client = '$client'";
...
$bweight = 0;
$eweight = 0;
$query1 = "SELECT * FROM breeder_standards where client = '$client' and (age >  '$fage' and age <= '$tage') and breed = '$breed' ORDER BY age ASC ";
$r = mysql_query($query1,$conn1);
while($qr = mysql_fetch_assoc($r))
{
if($qr['age'] == " ")
{
$q = "select * from breeder_flock where flock = '$flock' and client = '$client'";
