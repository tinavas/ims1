...
{
           include "config.php";
			$q = "select sum(quantity) as quantity from ims_stocktransfer where cat = 'Quail Female Birds' and fromwarehouse = '$a' and date < '$b'"; 
...
{
           include "config.php";
             $q = "select quantity from ims_stocktransfer where cat = 'Quail Female Birds' and towarehouse = '$a' and date < '$b'"; 
    		 $qrs = mysql_query($q,$conn1) or die(mysql_error());
             if(mysql_num_rows($qrs))
             {
               $toplusfemales = "0";
...
function getsalebirdsfemale($a,$b)
{
           include "config.php";
           $birdscodes = "''";
           $query12 = "SELECT * from ims_itemcodes where cat like 'Quail Female Birds'";
...
function getsenderbirdsfemale($a,$b)
{include "config.php";
           $query12 = "SELECT sum(birds) as `num` FROM quail_breeder_sender where flock='$a' and date < '$b'  and cat = 'Quail Female Feed' ORDER BY date DESC ";
...
{
           include "config.php";
             $q = "select * from ims_stocktransfer where cat like 'Quail Male Birds' and fromwarehouse = '$a' and date < '$b'"; 
    		 $qrs = mysql_query($q,$conn1) or die(mysql_error());
             if(mysql_num_rows($qrs))
             {
               $fromlessfemales = "0";
...
{ include "config.php";
             ...
             $q = "select * from ims_stocktransfer where cat like 'Quail Male Birds' and towarehouse = '$a' and date < '$b'"; 
    		 $qrs = mysql_query($q,$conn1) or die(mysql_error());
             if(mysql_num_rows($qrs))
             {
               $toplusfemales = "0";
...
function getsalebirdsmale($a,$b)
{
           include "config.php";
           $birdscodes = "''";
           $query12 = "SELECT * from ims_itemcodes where cat like 'Quail Male Birds'";
           $result12 = mysql_query($query12,$conn1); 
           while($row12 = mysql_fetch_assoc($result12))
           {
               $birdscodes =  $birdscodes . ",'" .$row12['code'] . "'";                
...
function getsenderbirdsmale($a,$b)
{ include "config.php";
           $query12 = "SELECT sum(birds) as `num` FROM quail_breeder_sender where flock='$a' and date < '$b'  and cat = 'Quail Male Feed' ORDER BY date DESC ";
           $result12 = mysql_query($query12,$conn1); 
           $row12 = mysql_fetch_assoc($result12);
              return $row12['num'];    
}
...
var mortality = [
     <?php 
           $w = 0;
           $querya = "SELECT * FROM quail_flock where flockcode = '$c'";
           ...
           while($row1a = mysql_fetch_assoc($resulta))
           {
			...
			$femalesender = getsenderbirdsfemale($c,$odate);

 
                  //$getremainingfemale = $female + $femalepur($femaleplus - $femaleminus) - ($femalesale + $mort);
				   $birds = $birds + $femalepur + ($femaleplus - $femaleminus - $femalesender) ;

           $query12 = "SELECT * FROM quail_consumption where flock = '$c' GROUP BY date2 ";
           $result12 = mysql_query($query12,$conn1); 
           while($row12 = mysql_fetch_assoc($result12))
           {
           ...
           while($row12 = mysql_fetch_assoc($result12))
           {
              ...
              {
                  $w1 = 0;
                  $query12a = "SELECT distinct(date2),mmort,fmort FROM quail_consumption where flock = '$c' and date2 <= '$row12[date2]' ";
...
var mortalitymale = [
     <?php 
		   ...
		   $odate = $date;
			...
			$malesender = getsenderbirdsmale($c,$odate);
 
                  //$getremainingfemale = $female + $femalepur($femaleplus - $femaleminus) - ($femalesale + $mort);
				   $birds = $birds + $malepur + ($maleplus - $maleminus - $malesender) ;
...
var feed = [
 ...
 $odate = $date;
           ...
           $startage = $nrWeeksPassed;
                  ...
                  $feedtype = "'dummy'";
                  $q = "select * from ims_itemcodes where cat like 'Quail Female Feed'"; 
      		$qrs = mysql_query($q,$conn1) or die(mysql_error());
		      while($qr = mysql_fetch_assoc($qrs))
		      {
           ...
           while($row12 = mysql_fetch_assoc($result12))
           {
              ...
              if ($nrDaysPassed == 0)
              {
                  ...
                  $mort = 0;
                    $querya = "SELECT distinct(date2),mmort,fmort,fcull,mcull FROM quail_consumption where flock = '$c' and date2 < '$odate' ";
                  $resulta = mysql_query($querya,$conn1); 
                  while($row1a = mysql_fetch_assoc($resulta))
                  {
                  ...
                  //$getremainingfemale = $female + $femalepur($femaleplus - $femaleminus) - ($femalesale + $mort);
				   $getremainingfemale = $female + $femalepur + ($femaleplus - $femaleminus - $femalesender) - ( $mort);
                 $query12a = "SELECT sum(quantity) as `fm` FROM quail_consumption where flock = '$c' and date2 >= '$odate' and date2 <= '$row12[date2]' and itemcode in ($feedtype)";
                  $result12a = mysql_query($query12a,$conn1); 
                  while($row12a = mysql_fetch_assoc($result12a))
                  {
				
				  $inc = 0;
				  $queryi = "SELECT distinct(date2) FROM quail_consumption where flock = '$c' and date2 >= '$odate' and date2 <= '$row12[date2]'";
...
var feedmale = [
 ...
 $odate = $date;
           ...
           $startage = $nrWeeksPassed;
                  ...
                  $feedtype = "'dummy'";
                  $q = "select * from ims_itemcodes where cat like 'Quail Male Feed'"; 
      		$qrs = mysql_query($q,$conn1) or die(mysql_error());
		      while($qr = mysql_fetch_assoc($qrs))
		      {
                     $feedtype = $feedtype . ",'" . $qr['code'] . "'";
           ...
           while($row12 = mysql_fetch_assoc($result12))
           {
              ...
              if ($nrDaysPassed == 0)
              {
                  ...
                  //$getremainingfemale = $female + $femalepur($femaleplus - $femaleminus) - ($femalesale + $mort);
				   $getremainingmale = $male + $malepur + ($maleplus - $maleminus - $malesender) - ( $mort);
                 $query12a = "SELECT sum(quantity) as `fm` FROM quail_consumption where flock = '$c' and date2 >= '$odate' and date2 <= '$row12[date2]' and itemcode in ($feedtype)";
                  $result12a = mysql_query($query12a,$conn1); 
                  while($row12a = mysql_fetch_assoc($result12a))
                  {
...
var ew = [
     <?php 
           ...
           while($row12 = mysql_fetch_assoc($result12))
           {
              ...
              if ($nrDaysPassed == 0)
              {
                  $query12ab = "SELECT max(eggwt) as `ew` FROM quail_consumption where flock = '$c' and date2 <= '$row12[date2]' ";
     ...
     <?php 
           ...
           while($row12 = mysql_fetch_assoc($result12))
           {
              ...
              if ($nrDaysPassed == 0)
              {
                  ...
                  $mort = 0;
                  $querya = "SELECT distinct(date2),fmort,fcull FROM quail_consumption where flock = '$c' and date2 < '$odate' ";
                  $resulta = mysql_query($querya,$conn1); 
                  while($row1a = mysql_fetch_assoc($resulta))
                  {
                     $mort = $mort + $row1a['fmort'] + $row1a['fcull'];
		      ...
		      while($qr = mysql_fetch_assoc($qrs))
		      {
                  ...
                  $query12a = "SELECT sum(quantity) as 'totaleggs' FROM quail_production where flock = '$c' and date1 >= '$odate' and date1 <= '$row12[date2]' and itemcode in ($eggtype) ";
                  $result12a = mysql_query($query12a,$conn1); 
                  while($row12a = mysql_fetch_assoc($result12a))
                  {
				   $inc = 0;
...
if(document.getElementById("all").checked)
{
  ...
  var plot =   $.plot($("#placeholder"),
		   ...
		   { data: mstandard, label: "Male Mortality Standard", color:'#00AA00' ,yaxis: 2},
             ...
             { data: fm, label: "Quail Female Feed Consumed Standard", color:'#000099',yaxis: 2 },
			 { data: m, label: "Quail Male Feed Consumed Standard", color:'#CC33FF',yaxis: 2 },
             ...
             { data: feed, label: "Quail Female Feed Consumed Actual", color:'#9999FF', yaxis: 2 },
			 { data: feedmale, label: "Quail Male Feed Consumed Actual", color:'#9900FF', yaxis: 2 },
