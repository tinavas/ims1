...
<html>
 ...
 $query111 = "SELECT sum(receivedquantity) as chicks FROM pp_sobi where flock = '$rowfrmhead[flock]' and warehouse = '$rowplhead[farm]'  and description = 'Broiler Chicks'  ";  $result111 = mysql_query($query111,$conn1);   $rows = mysql_num_rows($result111);
  if ( $rows > 0) {  while($row111 = mysql_fetch_assoc($result111))  {   $b = $b + $row111['chicks'];  } }
