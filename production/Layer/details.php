...
$totmedvacc = 0;
$finalmedvacctotal = 0;
$q4="select sum(quantity) as quantity,itemcode from layer_consumption where date2='$date' and itemcode in(select distinct(code) from ims_itemcodes where cat In ('Medicines','Vaccines') ) group by itemcode";
