...
define("EW_REPORT_TABLE_VAR", "layershed", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "layershed_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "layershed_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "layershed_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "layershed_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "layershed_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "`layer_shed`";
...
$o_farmcode = NULL; $t_farmcode = NULL; $ft_farmcode = 200; $rf_farmcode = NULL; $rt_farmcode = NULL;
$o_farmdescription = NULL; $t_farmdescription = NULL; $ft_farmdescription = 200; $rf_farmdescription = NULL; $rt_farmdescription = NULL;
?>
<?php
...
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">House Report</font></strong></td>
</tr>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="layershedsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="layershedsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="layershedsmry.php?export=word">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<form action="layershedsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="layershedsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="layershedsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="layershedsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="layershedsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php echo ewrpt_ViewValue(changeprice1($x_shedcapacity)); $total+=$x_shedcapacity; ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
...
<?php if ($nTotalGrps > 0) { ?>
	...
	<tr class="ewRptGrandSummary"><td colspan="3" align="right"><b>Total</b></td>
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$GLOBALS['x_farmcode'] = $rs->fields('farmcode');
		...
		$val[5] = $GLOBALS['x_farmcode'];
		$val[6] = $GLOBALS['x_farmdescription'];
	} else {
		$GLOBALS['x_id'] = "";
		$GLOBALS['x_shedcode'] = "";
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_layershed_shedcode"] = "";
			$_SESSION["sort_layershed_sheddescription"] = "";
			$_SESSION["sort_layershed_shedtype"] = "";
			$_SESSION["sort_layershed_shedcapacity"] = "";
			$_SESSION["sort_layershed_farmcode"] = "";
			$_SESSION["sort_layershed_farmdescription"] = "";
		}
