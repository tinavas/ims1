...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "`layer_production`";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT layer_production.date1,sum(layer_production.quantity) as quantity, sum(layer_production.price) as price FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="layer_eggcostprice.php?<?php echo $url; ?>&export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="layer_eggcostprice.php?<?php echo $url; ?>&export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="layer_eggcostprice.php?<?php echo $url; ?>&export=word">Export to Word</a><br /><br />
<?php } ?>
...
$productionflocks = "'";
 $query = "select distinct(flock) from layer_production where date1 = '$x_date1'";
...
$qu="select sum(materialcost) as mcost,sum(production) as production from feed_productionunit where date >= '$fdate' and date<='$x_date1' and mash in(select distinct(code) from ims_itemcodes where cat In ('Layer Feed')) ";
$re1=mysql_query($qu,$conn1);
$re1=mysql_fetch_assoc($re1);
$mcost=$re1['mcost'];
$production=$re1['production'];
...
{
$qu="select sum(materialcost) as mcost,sum(production) as production from feed_productionunit where date <= '$x_date1' and mash in(select distinct(code) from ims_itemcodes where cat In ('Layer Feed')) ";
$re1=mysql_query($qu,$conn1);
$re1=mysql_fetch_assoc($re1);
$mcost=$re1['mcost'];
$production=$re1['production'];
...
if($feedcost=='' or $feedcost==0) {
$qu="select sum(receivedquantity*rateperunit) as mcost,sum(receivedquantity) as production from pp_sobi where date >= '$fdate' and date<='$x_date1' and code in(select distinct(code) from ims_itemcodes where cat In ('Layer Feed')) ";
...
if($feedcost=='' or $feedcost==0) {
$qu="select sum(receivedquantity*rateperunit) as mcost,sum(receivedquantity) as production from pp_sobi where date <= '$x_date1' and code in(select distinct(code) from ims_itemcodes where cat In ('Layer Feed')) ";
$re1=mysql_query($qu,$conn1) or die(mysql_error());
$re1=mysql_fetch_assoc($re1);
$mcost=$re1['mcost'];
$production=$re1['production'];
...
$q="select sum(quantity) as quantity from layer_consumption where date2='$x_date1' and itemcode in(select distinct(code) from ims_itemcodes where cat In ('Layer Feed') ) ";
...
$medvacc = 0;
$medvacctotal = 0;
$q4="select sum(quantity) as quantity,itemcode from layer_consumption where date2='$x_date1' and itemcode in(select distinct(code) from ims_itemcodes where cat In ('Medicines','Vaccines') ) group by itemcode";
...
$qu="select sum(materialcost) as mcost,sum(production) as production from feed_productionunit where date >= '$fdate' and date<='$x_date1' and mash in(select distinct(code) from ims_itemcodes where description <> 'chick' and description <> 'grower' and cat In ('Layer Feed')) ";
$re1=mysql_query($qu,$conn1);
$re1=mysql_fetch_assoc($re1);
$cgmcost=$re1['mcost'];
...
{
$qu="select sum(materialcost) as mcost,sum(production) as production from feed_productionunit where date<='$x_date1' and mash in(select distinct(code) from ims_itemcodes where description <> 'chick' and description <> 'grower' and cat In ('Layer Feed')) ";
$re1=mysql_query($qu,$conn1);
$re1=mysql_fetch_assoc($re1);
$cgmcost=$re1['mcost'];
$cgproduction=$re1['production'];
...
if($cgfeedcost=='' or $cgfeedcost==0) {
$qu="select sum(receivedquantity*rateperunit) as mcost,sum(receivedquantity) as production from pp_sobi where date >='$fdate' and date<='$x_date1' and code in(select distinct(code) from ims_itemcodes where description <> 'chick' and description <> 'grower' and cat In ('Layer Feed')) ";
$re1=mysql_query($qu,$conn1) or die(mysql_error());
$re1=mysql_fetch_assoc($re1);
$cgmcost=$re1['mcost'];
$cgproduction=$re1['production'];
...
if($cgfeedcost=='' or $cgfeedcost==0) {
$qu="select sum(receivedquantity*rateperunit) as mcost,sum(receivedquantity) as production from pp_sobi where date<='$x_date1' and code in(select distinct(code) from ims_itemcodes where description <> 'chick' and description <> 'grower' and cat In ('Layer Feed')) ";
$re1=mysql_query($qu,$conn1) or die(mysql_error());
$re1=mysql_fetch_assoc($re1);
$cgmcost=$re1['mcost'];
$cgproduction=$re1['production'];
...
$q = "select sum(quantity) as quantity from layer_consumption  where date2 = '$x_date1' and itemcode in(select distinct(code) from ims_itemcodes where description <> 'chick' and description <> 'grower' and cat in('Layer Feed')) and flock in ($productionflocks)";
...
$cgfeedmedvacc = 0;
$cgfeedtotmedvacc = 0;
$q8 = "select sum(quantity) as quantity,itemcode from layer_consumption  where date2 = '$x_date1' and itemcode in(select distinct(code) from ims_itemcodes where description <> 'chick' and description <> 'grower' and cat in('Medicines','Vaccines')) and flock in ($productionflocks) group by itemcode";
