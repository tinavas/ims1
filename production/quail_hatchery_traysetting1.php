...
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quail_hatchery_traysetting1.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="quail_hatchery_traysetting1.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="quail_hatchery_traysetting1.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="quail_hatchery_traysetting1.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<br /><br />
<?php } ?>
...
<form action="quail_hatchery_traysetting1.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="quail_hatchery_traysetting1.php?start=<?php echo $Pager->FirstButton->Start ?><?php echo $url; ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quail_hatchery_traysetting1.php?start=<?php echo $Pager->PrevButton->Start ?><?php echo $url; ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quail_hatchery_traysetting1.php?start=<?php echo $Pager->NextButton->Start ?><?php echo $url; ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quail_hatchery_traysetting1.php?start=<?php echo $Pager->LastButton->Start ?><?php echo $url; ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		<?php if($_SESSION['db'] == "alkhumasiyabrd") { ?>Unit<?php } else {?> Setting No. <?php }?>
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td><?php if($_SESSION['db'] == "alkhumasiyabrd") { ?>Unit<?php } else {?> Setting No. <?php }?></td>
...
?>
	<tr>
	<?php 
	$qtt ="SELECT hetype from quail_hatchery_traysetting where id='$x_id'";
...
?>
	<tr style="display:none">
		<td colspan="13" class="ewRptGrpSummary1" >Summary for Settingdate: <?php $t_settingdate = $x_settingdate; $x_settingdate = $o_settingdate; ?>
...
<?php if ($nTotalGrps > 0) { ?>
	...
	<tr class="ewRptGrandSummary" style="display:none"><td colspan="13">Grand Total (<?php echo ewrpt_FormatNumber($rstotcnt,0,-2,-2,-2); ?> Detail Records)</td></tr>
<?php } ?>
	</tfoot>
</table>
</div>
