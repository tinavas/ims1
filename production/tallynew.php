...
////////for Current Assets
$qury1 = "select sum(amount) as amt from ac_financialpostings where coacode in (select distinct(code) from ac_coa where type = 'Asset') and crdr = 'Cr'";
...
$qury1 = "select sum(amount) as amt1 from ac_financialpostings where coacode in (select distinct(code) from ac_coa where type = 'Asset') and crdr = 'Dr'";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
...
$casset = round(($dramount - $cramount),2);


///////for current liabilities
$qury1 = "select sum(amount) as amt from ac_financialpostings where coacode in (select distinct(code) from ac_coa where type = 'Liability') and crdr = 'Cr'";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
...
$qury1 = "select sum(amount) as amt1 from ac_financialpostings where coacode in (select distinct(code) from ac_coa where type = 'Liability') and crdr = 'Dr'";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
...
$qury1 = "select sum(amount) as amt from ac_financialpostings where coacode in (select vca from ac_vgrmap where flag = 'C' ) and crdr = 'Cr'";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
...
$qury1 = "select sum(amount) as amt from ac_financialpostings where coacode in (select vca from ac_vgrmap where flag = 'C' ) and crdr = 'Dr'";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
...
$qury1 = "select sum(amount) as amt from ac_financialpostings where coacode in (select vppac from ac_vgrmap where flag = 'C' ) and crdr = 'Cr'";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
...
$qury1 = "select sum(amount) as amt from ac_financialpostings where coacode in (select vppac from ac_vgrmap where flag = 'C' ) and crdr = 'Dr'";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
...
$sdryd = ($vcaamt - $vppacamt);
///////////Sundry Creditors


$qury1 = "select sum(amount) as amt from ac_financialpostings where coacode in (select vca from ac_vgrmap where flag = 'V' ) and crdr = 'Cr'";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
...
$qury1 = "select sum(amount) as amt from ac_financialpostings where coacode in (select vca from ac_vgrmap where flag = 'V' ) and crdr = 'Dr'";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
...
//////////Sales Account
$qury1 = "select sum(amount) as amt from ac_financialpostings where coacode in (select distinct(sac) from ims_itemcodes ) and crdr = 'Cr'";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
...
$qury1 = "select sum(amount) as amt from ac_financialpostings where coacode in (select distinct(sac) from ims_itemcodes ) and crdr = 'Dr'";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
 $dramount = $r1['amt'];
...
/////////Purchases Account
 $dramount = 0;
$qury1 = "SELECT sum( totalamount ) as amt FROM pp_sobi GROUP BY so WITH rollup";
$res1 = mysql_query($qury1,$conn1) or die(mysql_error());
	   while($r1 = mysql_fetch_assoc($res1))
	   {
...
<td<?php echo $sItemRowClass; ?> >
<?php echo ewrpt_ViewValue($workcap) ?>
</td>
...
<td<?php echo $sItemRowClass; ?> >
<?php echo ewrpt_ViewValue($cratio) ?>
</td>
...
<?php echo "Sundry Debtors</br> (due till today)"; ?>
		...
		<td<?php echo $sItemRowClass; ?> >
<?php echo ewrpt_ViewValue($sdryd) ?>
</td>
...
(due till today)"; ?>
		...
		<td<?php echo $sItemRowClass; ?> rowspan="2">
<?php echo ewrpt_ViewValue($sdryc) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
