...
ob_start();
include "config.php";
$date = date($datephp,strtotime($_GET['date']));
if(($_GET['date']) == "")
{
$date = date("d.m.Y");
}
...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Broiler Day Sheet<br/> Date : <?php echo $date;?></font></strong></td>
</tr>
...
<script type="text/javascript" src="broiler/phprptjs/ewrpt.js"></script>
<?php } ?>
<?php if (@$sExport == "") { ?>
<script src="broiler/phprptjs/popup.js" type="text/javascript"></script>
<script src="broiler/phprptjs/ewrptpop.js" type="text/javascript"></script>
<script src="broiler/FusionChartsFree/JSClass/FusionCharts.js" type="text/javascript"></script>
<script type="text/javascript">
...
<?php if (@$sExport == "") { ?>
<center>
&nbsp;&nbsp;<a href="broilerdaysheet.php?export=html&date=<?php echo $date;?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="broilerdaysheet.php?export=excel&date=<?php echo $date;?>">Export to Excel</a>
&nbsp;&nbsp;<a href="broilerdaysheet.php?export=word&date=<?php echo $date;?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="broilerdaysheet.php?cmd=reset&date=<?php echo $date;?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="broilerdaysheet.php" name="ewpagerform" id="ewpagerform" class="ewForm">
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
	<td>
<span class="phpreportmaker">
Date&nbsp;
<input type="text" class="datepicker" id="date" name="date" value="<?php if($_GET['date']) { echo $_GET['date']; } else { echo date("d.m.Y"); }  ?>" onchange="reloadfunc(this.id);" />
&nbsp;&nbsp;&nbsp;
</span>
		<td nowrap>
...
<!--first page button-->
	...
	<td><a href="broilerdaysheet.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="broiler/phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="broiler/phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="broilerdaysheet.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="broiler/phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="broiler/phprptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } ?>
<!--current page number-->
	<td><input type="text" name="pageno" id="pageno" value="<?php echo $Pager->CurrentPage ?>" size="4"></td>
<!--next page button-->
	<?php if ($Pager->NextButton->Enabled) { ?>
	<td><a href="broilerdaysheet.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="broiler/phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="broiler/phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="broilerdaysheet.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="broiler/phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="broiler/phprptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } ?>
...
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="Cumulative Mortality">
		Cum.Mort
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn" title="Cumulative Mortality"><tr>
			<td>Cum.Mort</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn" title="Average Weight"><tr>
			<td >Avg.Wt</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="Daily Consumption">
		Daily.Cons
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td  title="Daily Consumption">Daily.Cons</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="Feed Balance">
		Feed.Bal
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Feed Balance" >Feed.Bal</td>
			</tr></table>
		</td>
<?php } 
$query7 = "select distinct(code),description from ims_itemcodes where client = '$client' and cat LIKE 'Broiler Feed'";
$result7 = mysql_query($query7,$conn1) or die(mysql_error());
$n = mysql_num_rows($result7);
?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" colspan="<?php echo $n;?>" align="center" >
		Farm Stock
		</td>
<?php } else { ?>
		<td class="ewTableHeader" colspan="<?php echo $n;?>" align="center">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td  colspan="<?php echo $n;?>" align="center">Farm Stock</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="Mortality Reason">
		Mort.Reason
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Mortality Reason" >Mort.Reason</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Mortality Reason">PO Report</td>
			</tr></table>
		</td>
<?php } ?>
	</tr>
...
<?php } ?>
<?php 	$query6 = "select distinct(code) from ims_itemcodes where client = '$client' and cat LIKE 'Broiler Feed'";
...
$q = "select * from broiler_daily_entry where entrydate = '$newdate'";
$r = mysql_query($q,$conn1) or die(mysql_error());
while($qr = mysql_fetch_assoc($r))
{
$flock = $qr['flock'];
$farm = $qr['farm'];
$dailycons = $qr['feedconsumed'];
$age = $qr['age'];
$farmer = $qr['farm'];
$vil = $qr['place'];
$mort = $qr['mortality'];
...
$farmvill = $farmer."-".$vil;
$birds = 0;
$query = "SELECT (sum(quantity) - sum(tmort) - sum(shortage)) as chicks FROM ims_stocktransfer where aflock = '$flock' and towarehouse = '$farm' AND cat = 'Broiler Chicks'";
$result = mysql_query($query,$conn1);
while($row1 = mysql_fetch_assoc($result)){ $birds = $birds + $row1['chicks']; }

$query111 = "SELECT sum(receivedquantity) as chicks FROM pp_sobi where flock = '$flock and code in (select distinct(code) from ims_itemcodes where (cat = 'Broiler Chicks' || cat = 'Broiler Day Old Chicks')) and client = '$client'";  
...
$q2 = "select sum(birds) as birds from oc_cobi where flock = '$flock' and code in (select distinct(code) from ims_itemcodes where cat = 'Broiler Chicks' and client = '$client') and client = '$client' and date < '$newdate'";
$r2 = mysql_query($q2,$conn1) or die(mysql_error());
$qr2 = mysql_fetch_assoc($r2);
$sales = $qr2['birds'];

$query1 = "SELECT sum(feedconsumed) as feedcons,max(average_weight) as avw,sum(mortality) as cmortality,sum(cull) as ccull FROM broiler_daily_entry WHERE flock = '$flock' and client = '$client' and entrydate < '$newdate'";
$result1 = mysql_query($query1,$conn1);
$row1 = mysql_fetch_assoc($result1);
$opcmort = $row1['cmortality'];
$opcculls = $row1['ccull'];
$opfeedcons = $row1['feedcons'];
$opavw = $row1['avw'];

$q2 = "select sum(birds) as birds,sum(weight) as weight from oc_cobi where flock = '$flock' and code in (select distinct(code) from ims_itemcodes where cat = 'Broiler Chicks' and client = '$client') and client = '$client' and date <= '$newdate'";
$r2 = mysql_query($q2,$conn1) or die(mysql_error());
$qr2 = mysql_fetch_assoc($r2);
$sales = $qr2['birds'];
$weight = $qr2['weight'];
...
$result1 = mysql_query($query1,$conn1);
$row1 = mysql_fetch_assoc($result1);
$cmort = $row1['cmortality'];
$cculls = $row1['ccull'];
$feedcons = $row1['feedcons'];
$avw = $row1['avw'];


//$birds."/".$cmort."/".$cculls; echo "<br/>";
$opening = $birds - ($opcmort + $opcculls + $opsales);
$closing = $birds - ($cmort + $cculls + $sales);
$fperbcalc = $closing + $mort + $cull;
$feedperbird = round((($dailycons/$fperbcalc)*1000),2);
$cummfeedperbird = round((($feedcons/$fperbcalc)*1000),2);
$fcr = round($feedcons / $weight, 2);

///////////////////////////////////////Feed Balance
$query4 = "SELECT SUM(quantity) as inqty FROM ims_stocktransfer where cat = 'Broiler Feed' and aflock = '$flock' and towarehouse = '$farm' AND client='$client' and adate <= '$newdate'";
$result4 = mysql_query($query4,$conn1);
while($row4 = mysql_fetch_assoc($result4)){ $stfeedin = $row4['inqty']; }
$query5 = "SELECT SUM(quantity) as outqty FROM ims_stocktransfer where  cat = 'Broiler Feed' and aflock = '$flock' and fromwarehouse = '$farm' AND client='$client' and adate <= '$newdate'";
$result5 = mysql_query($query5,$conn1);
while($row5 = mysql_fetch_assoc($result5)){  $stfeedout = $row4['outqty'];  }
//echo $stfeedin."/".$feedcons."/".$stfeedout; echo "<br/>";
$feedbal = $stfeedin -($feedcons + $stfeedout);
...
<?php echo ewrpt_ViewValue(changequantity($birds)) ?>
		</td>
...
<?php echo ewrpt_ViewValue($farmvill) ?>
		</td>
		
	<td class="ewRptGrpField3" align="right">		
<?php echo ewrpt_ViewValue(changequantity($opening)); $coplive = $coplive + $opening; ?>
		</td>
		
<td <?php echo $sItemRowClass; ?> align="right">
<?php if($sales <> "") { echo ewrpt_ViewValue($sales); } else { echo "0"; } $cumsales = $cumsales + $sales  ?>
</td>
<td<?php echo $sItemRowClass; ?> align="right">
<?php if($mort <> "") { echo ewrpt_ViewValue($mort); } else {echo "0";} $cummort = $cummort + $mort;  ?>
</td>
<td<?php echo $sItemRowClass; ?> align="right">
<?php if($cmort <> "") { echo ewrpt_ViewValue($cmort); } else { echo "0";} ?>
</td>
<?php $mortpercen = round((($mort/$birds)*100),2);?>
<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($mortpercen);?>
</td>	
<?php $cummortpercen = round((($cmort/$birds)*100),2);?>
<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($cummortpercen); ?>
</td>
	<td class="ewRptGrpField3" align="right">		
<?php echo ewrpt_ViewValue(changequantity($closing)); $clive = $clive + $closing; ?>
		</td>
<td <?php echo $sItemRowClass; ?> align="right">
<?php if($fcr <> "") { echo ewrpt_ViewValue($fcr); } else { echo "0"; } //$cumsales = $cumsales + $sales  ?>
</td>

<td <?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($feedperbird); ?>
</td>
<td <?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($cummfeedperbird); ?>
</td>
<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($avw); $cumavg = $cumavg + $avw;?>
</td>
<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($dailycons); $cumdc = $cumdc + $dailycons;?>
</td>
<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($feedbal); $cumbal = $cumbal + $feedbal;?>
</td>
<?php
$query7 = "select distinct(code),description from ims_itemcodes where client = '$client' and cat LIKE 'Broiler Feed'";
$result7 = mysql_query($query7,$conn1) or die(mysql_error());
...
{
$code = $row7['code'];
$query1 = "SELECT sum(feedconsumed) as feedcons FROM broiler_daily_entry WHERE flock = '$flock' and client = '$client' and feedtype = '$code' and entrydate <= '$newdate'";
$result1 = mysql_query($query1,$conn1);
$row1 = mysql_fetch_assoc($result1);
$feedc = $row1['feedcons']; ?>
<td<?php echo $sItemRowClass; ?> align="right">
<?php if($feedc <> "") { echo ewrpt_ViewValue($feedc); } else { echo "0";} ?>
</td>
<?php 
}?>
	<td <?php echo $sItemRowClass; ?> align="right">&nbsp;</td>
	<td <?php echo $sItemRowClass; ?> align="right">&nbsp;</td>
	<td <?php echo $sItemRowClass; ?> align="right">&nbsp;</td>
</tr>
<?php		 
...
<td <?php echo $sItemRowClass; ?> align="right"><b><?php echo changequantity($coplive);?></b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b><?php echo changequantity($cumsales);?></b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b><?php echo changequantity($cummort);?></b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b>&nbsp;</b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b>&nbsp;</b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b>&nbsp;</b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b><?php echo changequantity($clive);?></b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b>&nbsp;</b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b>&nbsp;</b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b>&nbsp;</b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b><?php  echo $cumavg;?></b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b><?php  echo changequantity($cumdc);?></b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b><?php  echo changequantity($cumbal);?></b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b>&nbsp;</b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b>&nbsp;</b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b>&nbsp;</b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b>&nbsp;</b></td>
...
<script type="text/javascript">
function reloadfunc(a)
{
var fdate = document.getElementById(a).value;
document.location='broilerdaysheet.php?date=' + fdate ;
}
</script>