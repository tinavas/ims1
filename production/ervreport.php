...
$EW_REPORT_TABLE_SQL_WHERE = "crdr = 'Cr' and voucher = 'ERV' and date between '$datef' and '$datet'";
...
<?php }?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="ervreport.php?export=html&from=<?php echo $datef;?>&to=<?php echo $datet;?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="ervreport.php?export=excel&from=<?php echo $datef;?>&to=<?php echo $datet;?>">Export to Excel</a>
&nbsp;&nbsp;<a href="ervreport.php?export=word&from=<?php echo $datef;?>&to=<?php echo $datet;?>">Export to Word</a><br /><br />
<?php } ?>
...
document.location = 'ervreport.php?from=' + fdate + '&to=' + tdate;
}
</script>
...
<form action="ervreport.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<?php echo ewrpt_ViewValue($x_description) ?>
		...
		<?php 
$query = "select code,description from ac_gl where transactioncode = '$x_transactioncode' and date = '$x_date' and bccodeno = '$x_bccodeno' and crdr = 'Dr' and voucher = 'ERV'";
$result = mysql_query($query,$conn1) or die(mysql_error());
$res = mysql_fetch_assoc($result);
?>
<td<?php echo $sItemRowClass; ?>>
