...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td style="width:100px;" align="center">Credit Term</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php echo ewrpt_ViewValue($a[cterm]).' Days'; ?></td>
...
?>
    ...
    <tr>
		<td align="right" colspan="5" title="Total Pending Amount(As per Credit Term)"> Total Pending Amount(As per CT)</td>
		<td  align="right">
<?php echo changeprice($totalamount); ?></td>
	</tr>
	
	<tr>
		<td align="right" colspan="5"> Total Debited Amount</td>
		<td  align="right">
<?php echo changeprice($a1[Dramount]); ?></td>
	</tr>
	
	<tr>
		<td align="right" colspan="5"> Total Credited Amount</td>
		<td  align="right">
<?php echo changeprice($a2[Cramount]); ?></td>
	</tr>
	
	<tr>
		<td align="right" colspan="5"> Balance Amount Amount</td>
		<td  align="right">
