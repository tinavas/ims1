...
$EW_REPORT_TABLE_SQL_SELECT = "SELECT Distinct (layerbreeder_consumption.flock), layerbreeder_consumption.wo FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "(layerbreeder_consumption.flock) ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "(layerbreeder_consumption.flock)", TRUE);
...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Layer Breeder Feed Per Egg/Bird Report</font></strong></td>
</tr>
</table>
<br/>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="lbfeedeggbird.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="lbfeedeggbird.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="lbfeedeggbird.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="lbfeedeggbird.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<?php if (@$sExport == "") { ?>
<br /><br />
...
<form action="lbfeedeggbird.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="lbfeedeggbird.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="lbfeedeggbird.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="lbfeedeggbird.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="lbfeedeggbird.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php 
            ...
            include "config.php";
            $q = "select age,date2 from layerbreeder_consumption where flock = '$x_flock' order by date2 DESC "; 
		...
		if($qr = mysql_fetch_assoc($qrs))
		{
		  ...
		  $mindate = "";
		  $maxdate = "";
	          $query14 = "SELECT min(date2) as mindate,max(date2) as maxdate FROM layerbreeder_consumption where flock = '$x_flock'";
			  ...
			  $flockdate = date("d.m.Y",strtotime($maxdate));
         ?>
		<td class="ewRptGrpField1">
...
<?php
              ...
              $query14 = "SELECT * FROM layerbreeder_flock where flockcode = '$x_flock'";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
			  ...
			  $fpur = 0;
			  $mpur = 0;
			  $query14 = "SELECT sum(quantity) as ftin from ims_stocktransfer where towarehouse = '$x_flock' and date <= '$mindate' and cat = 'LB Female Birds' ";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
                 $ftin = $row14['ftin'];
              }
			  $q = "SELECT sum(receivedquantity) as quant FROM pp_sobi WHERE flock = '$x_flock' AND date <= '$mindate' AND code IN (SELECT code FROM ims_itemcodes WHERE cat = 'LB Female Birds')";  
		   ...
		   while($qr = mysql_fetch_assoc($r))
             ...
             else
             {
			  ...
			  $query14 = "SELECT sum(quantity) as mtin from ims_stocktransfer where towarehouse = '$x_flock' and date <= '$mindate' and cat = 'LB Male Birds' ";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
                 $mtin = $row14['mtin'];
              }
			   $q = "SELECT sum(receivedquantity) as quant FROM pp_sobi WHERE flock = '$x_flock' AND date <= '$mindate' AND code IN (SELECT code FROM ims_itemcodes WHERE cat = 'LB Male Birds')";  
             $r = mysql_query($q,$conn1) or die(mysql_error());
			 if(mysql_num_rows($r))
             {
		   while($qr = mysql_fetch_assoc($r))
             ...
             else
             {
              ...
              $query14 = "SELECT * FROM ims_itemcodes where cat LIKE '%Female Feed'";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
              ...
              $query14 = "SELECT * FROM ims_itemcodes where cat LIKE '%Male Feed'";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
                 $feedtypes = $feedtypes . ",'" . $row14['code'] . "'";
              ...
              $query14 = "SELECT * FROM ims_itemcodes where cat = 'Layer Breeder Eggs'";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
              ...
              $query14 = "SELECT * FROM ims_itemcodes where cat = 'Layer Hatch Eggs'";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
              ...
              $totalfeed = 0;
              $query14 = "SELECT sum(quantity) as 'feed' FROM layerbreeder_consumption where flock = '$x_flock' and itemcode in ($feedtypes)";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
              ...
              $totaleggs = 0;
              $query14 = "SELECT sum(quantity) as 'eggs' FROM layerbreeder_production where flock = '$x_flock' and itemcode in ($eggtypes)";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
              ...
              $totalhatcheggs = 0;
             $query14 = "SELECT sum(quantity) as 'hatcheggs' FROM layerbreeder_production where flock = '$x_flock' and itemcode in ($hatchegg)";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
...
<?php  echo ($femaleopening + $ftin + $fpur); ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right" >
<?php  echo ($maleopening + $mtin + $mpur); ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right" >
<?php echo round($totalfeed,2); ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right" >
<?php echo $totalhatcheggs; ?>
</td>
		<td<?php echo $sItemRowClass; ?>  align="right" >
<?php echo $totaleggs; ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right" >
<?php echo $totaleggs + $totalhatcheggs; ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right" >
<?php echo round(($totalfeed * 1000)/($femaleopening + $maleopening + $ftin + $fpur  + $mtin + $mpur),2); ?>
</td>
<?php
$q1 = "SELECT min(date1) as mindate FROM layerbreeder_production WHERE flock = '$x_flock' AND itemcode in (select distinct(code) from ims_itemcodes where cat LIKE '%Layer Eggs%') AND client = '$client'";
$r1 = mysql_query($q1,$conn1) or die(mysql_error());
$rows1 = mysql_fetch_assoc($r1);
$mindate = $rows1['mindate'];

$q2 = "SELECT SUM(quantity) as quantity FROM layerbreeder_consumption WHERE flock = '$x_flock' AND date2 >= '$mindate' AND itemcode in ($feedtypes) AND client = '$client'";
...
?>
		<td<?php echo $sItemRowClass; ?> align="right" >
<?php echo round(($totalfeed2 * 1000)/$totalhatcheggs,2); ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right" >
<?php echo round(($totalfeed2 * 1000)/($totaleggs + $totalhatcheggs),2); ?>
</td>
	</tr>
<?php
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_flock"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_flock"], "(layerbreeder_consumption.flock)", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_flock"], $GLOBALS["gb_flock"], $GLOBALS["gi_flock"], $GLOBALS["gq_flock"]);
	}
	return $sWrk;
}
?>
