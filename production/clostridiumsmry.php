...
define("EW_REPORT_TABLE_VAR", "clostridium", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "clostridium_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "clostridium_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "clostridium_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "clostridium_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "clostridium_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "lab_clostridium";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT lab_clostridium.sampledate, lab_clostridium.reportdate, lab_clostridium.source, lab_clostridium.collectedby, lab_clostridium.sample, lab_clostridium.bloodagar, lab_clostridium.observation FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "lab_clostridium.sampledate ASC, lab_clostridium.reportdate ASC, lab_clostridium.source ASC, lab_clostridium.collectedby ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "lab_clostridium.sampledate", TRUE);
...
?>
<?php
$EW_REPORT_FIELD_SAMPLEDATE_SQL_SELECT = "SELECT DISTINCT lab_clostridium.sampledate FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SAMPLEDATE_SQL_ORDERBY = "lab_clostridium.sampledate";
$EW_REPORT_FIELD_SOURCE_SQL_SELECT = "SELECT DISTINCT lab_clostridium.source FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SOURCE_SQL_ORDERBY = "lab_clostridium.source";
$EW_REPORT_FIELD_COLLECTEDBY_SQL_SELECT = "SELECT DISTINCT lab_clostridium.collectedby FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_COLLECTEDBY_SQL_ORDERBY = "lab_clostridium.collectedby";
$EW_REPORT_FIELD_SAMPLE_SQL_SELECT = "SELECT DISTINCT lab_clostridium.sample FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SAMPLE_SQL_ORDERBY = "lab_clostridium.sample";
?>
<?php
...
ewrpt_CreatePopup("clostridium_sampledate", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_source, $sel_source, $ft_source) ?>
ewrpt_CreatePopup("clostridium_source", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_collectedby, $sel_collectedby, $ft_collectedby) ?>
ewrpt_CreatePopup("clostridium_collectedby", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_sample, $sel_sample, $ft_sample) ?>
ewrpt_CreatePopup("clostridium_sample", [<?php echo $jsdata ?>]);
</script>
<div id="clostridium_sampledate_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="clostridium_source_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="clostridium_collectedby_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="clostridium_sample_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="clostridiumsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="clostridiumsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="clostridiumsmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="clostridiumsmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="clostridiumsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="clostridiumsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="clostridiumsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="clostridiumsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="clostridiumsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Sample Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'clostridium_sampledate', false, '<?php echo $rf_sampledate; ?>', '<?php echo $rt_sampledate; ?>');return false;" name="x_sampledate<?php echo $cnt[0][0]; ?>" id="x_sampledate<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Source</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'clostridium_source', false, '<?php echo $rf_source; ?>', '<?php echo $rt_source; ?>');return false;" name="x_source<?php echo $cnt[0][0]; ?>" id="x_source<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Collected By</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'clostridium_collectedby', false, '<?php echo $rf_collectedby; ?>', '<?php echo $rt_collectedby; ?>');return false;" name="x_collectedby<?php echo $cnt[0][0]; ?>" id="x_collectedby<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Sample</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'clostridium_sample', false, '<?php echo $rf_sample; ?>', '<?php echo $rt_sample; ?>');return false;" name="x_sample<?php echo $cnt[0][0]; ?>" id="x_sample<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$val[2] = $GLOBALS['x_bloodagar'];
		$val[3] = $GLOBALS['x_observation'];
	} else {
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_clostridium_sampledate"])) {
		LoadSelectionFromSession('sampledate');
	} elseif (@$_SESSION["sel_clostridium_sampledate"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_sampledate"] = "";
	}

	// Get Source selected values
	if (is_array(@$_SESSION["sel_clostridium_source"])) {
		LoadSelectionFromSession('source');
	} elseif (@$_SESSION["sel_clostridium_source"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_source"] = "";
	}

	// Get Collectedby selected values
	if (is_array(@$_SESSION["sel_clostridium_collectedby"])) {
		LoadSelectionFromSession('collectedby');
	} elseif (@$_SESSION["sel_clostridium_collectedby"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_collectedby"] = "";
	}

	// Get Sample selected values
	if (is_array(@$_SESSION["sel_clostridium_sample"])) {
		LoadSelectionFromSession('sample');
	} elseif (@$_SESSION["sel_clostridium_sample"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_sample"] = "";
	}
}
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_clostridium_$parm"] = "";
	$_SESSION["rf_clostridium_$parm"] = "";
	$_SESSION["rt_clostridium_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_clostridium_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_clostridium_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_clostridium_$parm"];
}
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_sampledate"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_sampledate"], "lab_clostridium.sampledate", EW_REPORT_DATATYPE_DATE, $GLOBALS["af_sampledate"], $GLOBALS["gb_sampledate"], $GLOBALS["gi_sampledate"], $GLOBALS["gq_sampledate"]);
	}
	if (is_array($GLOBALS["sel_source"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_source"], "lab_clostridium.source", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_source"], $GLOBALS["gb_source"], $GLOBALS["gi_source"], $GLOBALS["gq_source"]);
	}
	if (is_array($GLOBALS["sel_collectedby"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_collectedby"], "lab_clostridium.collectedby", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_collectedby"], $GLOBALS["gb_collectedby"], $GLOBALS["gi_collectedby"], $GLOBALS["gq_collectedby"]);
	}
	if (is_array($GLOBALS["sel_sample"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_sample"], "lab_clostridium.sample", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_sample"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_clostridium_sampledate"] = "";
			$_SESSION["sort_clostridium_reportdate"] = "";
			$_SESSION["sort_clostridium_source"] = "";
			$_SESSION["sort_clostridium_collectedby"] = "";
			$_SESSION["sort_clostridium_sample"] = "";
			$_SESSION["sort_clostridium_bloodagar"] = "";
			$_SESSION["sort_clostridium_observation"] = "";
		}
