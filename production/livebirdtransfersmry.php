...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Live Birds Transfer</font></strong></td>
</tr>
</table>
<?php
...
define("EW_REPORT_TABLE_VAR", "livebirdtransfer", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "livebirdtransfer_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "livebirdtransfer_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "livebirdtransfer_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "livebirdtransfer_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "livebirdtransfer_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "ims_stocktransfer";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT ims_stocktransfer.date, ims_stocktransfer.fromwarehouse, ims_stocktransfer.towarehouse, ims_stocktransfer.tmno, ims_stocktransfer.code, ims_stocktransfer.sendquantity, ims_stocktransfer.tmort, ims_stocktransfer.quantity, ims_stocktransfer.price FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "(fromwarehouse in (select sector from tbl_sector where type1='Chicken Center' or type1='Processing Unit') or towarehouse in (select sector from tbl_sector where type1='Chicken Center' or type1='Processing Unit'))";
...
$af_sendquantity = NULL; // Popup filter for sendquantity
...
$o_sendquantity = NULL; $t_sendquantity = NULL; $ft_sendquantity = 3; $rf_sendquantity = NULL; $rt_sendquantity = NULL;
...
ewrpt_CreatePopup("livebirdtransfer_date", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_fromwarehouse, $sel_fromwarehouse, $ft_fromwarehouse) ?>
ewrpt_CreatePopup("livebirdtransfer_fromwarehouse", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_towarehouse, $sel_towarehouse, $ft_towarehouse) ?>
ewrpt_CreatePopup("livebirdtransfer_towarehouse", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_code, $sel_code, $ft_code) ?>
ewrpt_CreatePopup("livebirdtransfer_code", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_tmno, $sel_tmno, $ft_tmno) ?>
ewrpt_CreatePopup("livebirdtransfer_tmno", [<?php echo $jsdata ?>]);
</script>
<div id="livebirdtransfer_date_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="livebirdtransfer_fromwarehouse_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="livebirdtransfer_towarehouse_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="livebirdtransfer_code_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="livebirdtransfer_tmno_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="livebirdtransfersmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="livebirdtransfersmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="livebirdtransfersmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="livebirdtransfersmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="livebirdtransfersmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'livebirdtransfer_date', false, '<?php echo $rf_date; ?>', '<?php echo $rt_date; ?>');return false;" name="x_date<?php echo $cnt[0][0]; ?>" id="x_date<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>DC</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'livebirdtransfer_tmno', false, '<?php echo $rf_tmno; ?>', '<?php echo $rt_tmno; ?>');return false;" name="x_tmno<?php echo $cnt[0][0]; ?>" id="x_tmno<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Code</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'livebirdtransfer_code', false, '<?php echo $rf_code; ?>', '<?php echo $rt_code; ?>');return false;" name="x_code<?php echo $cnt[0][0]; ?>" id="x_code<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php echo ewrpt_ViewValue($x_sendquantity) ?>
<?php $totsendquant = $totsendquant + $x_sendquantity; ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right">
...
<td <?php echo $sItemRowClass; ?>><b>&nbsp;</b></td>
<td <?php echo $sItemRowClass; ?>><b>&nbsp;</b></td>
<td <?php echo $sItemRowClass; ?> align="right"><b><?php echo $totsendquant; ?></b></td>
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_livebirdtransfer_date"])) {
		LoadSelectionFromSession('date');
	} elseif (@$_SESSION["sel_livebirdtransfer_date"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_date"] = "";
	}

	// Get Fromwarehouse selected values
	if (is_array(@$_SESSION["sel_livebirdtransfer_fromwarehouse"])) {
		LoadSelectionFromSession('fromwarehouse');
	} elseif (@$_SESSION["sel_livebirdtransfer_fromwarehouse"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_fromwarehouse"] = "";
	}

	// Get Towarehouse selected values
	if (is_array(@$_SESSION["sel_livebirdtransfer_towarehouse"])) {
		LoadSelectionFromSession('towarehouse');
	} elseif (@$_SESSION["sel_livebirdtransfer_towarehouse"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_towarehouse"] = "";
	}

	// Get Code selected values
	if (is_array(@$_SESSION["sel_livebirdtransfer_code"])) {
		LoadSelectionFromSession('code');
	} elseif (@$_SESSION["sel_livebirdtransfer_code"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_code"] = "";
	}

	// Get Tmno selected values
	if (is_array(@$_SESSION["sel_livebirdtransfer_tmno"])) {
		LoadSelectionFromSession('tmno');
	} elseif (@$_SESSION["sel_livebirdtransfer_tmno"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_tmno"] = "";
	}
}
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_livebirdtransfer_$parm"] = "";
	$_SESSION["rf_livebirdtransfer_$parm"] = "";
	$_SESSION["rt_livebirdtransfer_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_livebirdtransfer_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_livebirdtransfer_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_livebirdtransfer_$parm"];
}
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_livebirdtransfer_date"] = "";
			$_SESSION["sort_livebirdtransfer_fromwarehouse"] = "";
			$_SESSION["sort_livebirdtransfer_towarehouse"] = "";
			$_SESSION["sort_livebirdtransfer_code"] = "";
			$_SESSION["sort_livebirdtransfer_tmno"] = "";
			$_SESSION["sort_livebirdtransfer_sendquantity"] = "";
			$_SESSION["sort_livebirdtransfer_tmort"] = "";
			$_SESSION["sort_livebirdtransfer_quantity"] = "";
			$_SESSION["sort_livebirdtransfer_price"] = "";
		}
