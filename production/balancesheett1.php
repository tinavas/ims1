...
<?php } else { ?>
		<td class="ewTableHeader" colspan="2" align="center">
			...
			<td align="center">EQUITY AND LIABILITIES</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
	...
	/*$quer="select ass.type,ass.pschedule,ass.schedule,ac.code,ac.description from ac_coa ac,ac_schedule ass where ass.type =ac.type and ass.schedule=ac.schedule and ( ac.type = 'Liability' or ac.type = 'Capital' or ac.type = 'Asset') order by ass.type,ass.pschedule,ass.schedule,ac.code";*/
	          $quers = mysql_query($quer,$conn1) or die(mysql_error());
               ...
               $sc = $row1['schedule'];*/
				...
				{ 
				?>
		<tr><td colspan="2" align="right"><?php echo $osc." Total"; ?></td><td align="right"><b><?php echo changeprice($sctotal); ?></b></td><td align="right"><b><?php echo changeprice($lsctotal); ?></b></td></tr>
				<?php $sctotal = 0; $lsctotal = 0; } ?>
				<!--<tr><td colspan="3" align="center"><b><?php echo $row1['schedule']; ?></b></td></tr>-->
				
				
				<?php $osc = $row1['schedule']; }	
		...
		if($opsc != $parent)
				...
				{ 
				?>
		<tr><td colspan="2" align="right"><?php echo $opsc." Total"; ?></td><td align="right"><b><?php echo changeprice($psctotal); ?></b></td><td align="right"><b><?php echo changeprice($lpsctotal); ?></b></td></tr>
				<?php $psctotal = 0; $lpsctotal = 0; } ?>
				<tr><td colspan="4" align="center"><b><?php echo $parent; ?></b></td></tr>
...
<tr>
<td colspan="2" align="right"><b>Total</b></td><td><b><?php echo changeprice($lsum); ?></b></td><td><b><?php echo changeprice($llsum); ?></b></td>
</tr>
<tr><td colspan="3">&nbsp;</td>
	</tbody>
...
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" align="center" colspan="2">
		Amount
		</td>
<?php } else { ?>
		<td class="ewTableHeader" colspan="2">
...
<tr><td colspan="2" align="right"><?php echo $osc." Total"; ?></td><td align="right"><b><?php echo changeprice($sctotal); ?></b></td><td align="right"><b><?php echo changeprice($lsctotal); ?></b></td></tr>
<?php $sctotal = 0; $lsctotal = 0; } ?>
<!--<tr> <td colspan="3" align="center"><b><?php echo $scarr[$i]; ?></b></td></tr>-->
<?php 
$osc = $scarr[$i];
} 
...
if($opsc != $pscarr[$i])
		...
		<tr><td colspan="2" align="right"><?php echo $opsc." Total"; ?></td><td align="right"><b><?php echo changeprice($psctotal); ?></b></td><td align="right"><b><?php echo changeprice($lpsctotal); ?></b></td></tr>
				<?php $psctotal = 0; $lpsctotal = 0; } ?>
				<tr><td colspan="4" align="center"><b><?php echo $pscarr[$i]; ?></b></td></tr>
...
<tr><td colspan="2" align="right"><?php echo $osc." Total"; ?></td><td align="right"><b><?php echo changeprice($sctotal); ?></b></td><td align="right"><b><?php echo changeprice($lsctotal); ?></b></td></tr>
<tr><td colspan="2" align="right"><?php echo $opsc." Total"; ?></td><td align="right"><b><?php echo changeprice($psctotal); ?></b></td><td align="right"><b><?php echo changeprice($psctotal); ?></b></td></tr>
<?php
