...
<td style="vertical-align:left;"><input type="text" id="bird/0" name="bird[]"  size="10" value="<?php echo $gres['bird'];?>" readonly style="background:none; border:none; text-align:left"  /></td>
<?php } ?>
...
<td style="vertical-align:middle;"><input type="text" id="price/0" name="price[]" value="<?php echo $gres['rateperunit'];?>" size="10" style="text-align:left" /></td>
<td width="10px"></td>
<?php } ?>
...
<?php $query1 = "select distinct(code),vendor from pp_purchaseorder WHERE flag = '1' AND geflag = '0' order by code ASC"; $result1 = mysql_query($query1,$conn);
      while($row1 = mysql_fetch_assoc($result1)) {
		...
		if($_SESSION['db']=="vista")
  	      $query2 = "select distinct(description),po,(quantity - receivedquantity) as balqty,rateperunit,bird from pp_purchaseorder where code = '$row1[code]' and vendor ='$row1[vendor]' AND flag = '1' AND geflag = '0' AND (quantity <> receivedquantity or receivedquantity = '' or receivedquantity = 0)";
		  else
   ...
   <?php if($_SESSION['db']=="vista") {?>
   theOption1.value = "<?php echo $row2['po']."@".$row2['balqty']."@".$row2['rateperunit']."@".$row2['bird']; ?>";
   <?php } else {?>
...
<?php $query1 = "select distinct(description),vendor from pp_purchaseorder WHERE flag = '1' AND geflag = '0' order by code ASC"; $result1 = mysql_query($query1,$conn);
      while($row1 = mysql_fetch_assoc($result1)) {
		...
		if($_SESSION['db']=="vista")
  	      ...
  	      $query2 = "select distinct(code),po,(quantity - receivedquantity) as balqty,rateperunit,bird from pp_purchaseorder where description = '$row1[description]' and vendor ='$row1[vendor]' AND flag = '1' AND geflag = '0' AND (quantity <> receivedquantity or receivedquantity = '' or receivedquantity = 0)";
...
<?php $query1 = "select distinct(code),broker from pp_purchaseorder WHERE flag = '1' AND geflag = '0' order by code ASC"; 
      ...
      while($row1 = mysql_fetch_assoc($result1)) {
	    echo "if((document.getElementById('itemcode/' + index1).value == '$row1[code]') && (document.getElementById('vendor').value == '$row1[broker]')) { ";
		  ...
		  if($_SESSION['db']=="vista") 
		  $query2 = "select distinct(description),po,(quantity - receivedquantity) as balqty,rateperunit,bird from pp_purchaseorder where code = '$row1[code]' and broker ='$row1[broker]' AND flag = '1' AND geflag = '0' AND (quantity <> receivedquantity or receivedquantity = '' or receivedquantity = 0)";
		  else
...
<?php $query1 = "select distinct(description),broker from pp_purchaseorder WHERE flag = '1' AND geflag = '0' order by code ASC"; $result1 = mysql_query($query1,$conn);
	...
	if($_SESSION['db']=="vista")	  
		  $query2 = "select distinct(code),po,(quantity - receivedquantity) as balqty,rateperunit,bird from pp_purchaseorder where description = '$row1[description]' and broker ='$row1[broker]' AND flag = '1' AND geflag = '0' AND (quantity <> receivedquantity or receivedquantity = '' or receivedquantity = 0)";
		  else
