...
define("EW_REPORT_TABLE_VAR", "Report2394", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "Report2394_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "Report2394_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "Report2394_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "Report2394_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "Report2394_orderby", TRUE);
...
$EW_REPORT_TABLE_SQL_SELECT = "SELECT ac_crdrnote.date, ac_crdrnote.crnum, ac_crdrnote.vcode, ac_crdrnote.coa, ac_crdrnote.description, ac_crdrnote.dramount, ac_crdrnote.cramount FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "(ac_crdrnote.date >= '$fdate' and ac_crdrnote.date<='$tdate') and (ac_crdrnote.mode = 'VCN')";
...
$EW_REPORT_TABLE_SQL_FROM = "ac_crdrnote";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT ac_crdrnote.date, ac_crdrnote.crnum, ac_crdrnote.vcode, ac_crdrnote.coa, ac_crdrnote.description, ac_crdrnote.dramount, ac_crdrnote.cramount FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "(ac_crdrnote.date >= '$fdate' and ac_crdrnote.date<='$tdate') and (ac_crdrnote.mode = 'VCN') and (ac_crdrnote.vcode = '$name') ";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
...
<?php 
$ven = $_GET['name'];
$query = "select currencyflag,currency from contactdetails where name = '$ven' and type LIKE '%vendor%'";
...
<center>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="suppliercreditnote2.php?export=html&fromdate=<?php echo $_GET['fromdate']; ?>&todate=<?php echo $_GET['todate']; ?>&name=<?php echo $_GET['name']; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="suppliercreditnote2.php?export=excel&fromdate=<?php echo $_GET['fromdate']; ?>&todate=<?php echo $_GET['todate']; ?>&name=<?php echo $_GET['name']; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="suppliercreditnote2.php?export=word&fromdate=<?php echo $_GET['fromdate']; ?>&todate=<?php echo $_GET['todate']; ?>&name=<?php echo $_GET['name']; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<form action="suppliercreditnote2.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="suppliercreditnote2.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="suppliercreditnote2.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="suppliercreditnote2.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="suppliercreditnote2.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php echo ewrpt_ViewValue(ewrpt_FormatDateTime(date("d.m.Y",strtotime($x_date)),5)) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
...
<?php
$query = "select camount from ac_crdrnote where crnum = '$x_crnum' and mode = 'VCN'";
$result = mysql_query($query,$conn1) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$conversion = $rows['camount'];
?>
		<td<?php echo $sItemRowClass; ?> style="text-align:right">
<?php echo ewrpt_ViewValue($x_dramount / $conversion) ?>
</td>
		<td<?php echo $sItemRowClass; ?> style="text-align:right">
<?php echo ewrpt_ViewValue($x_cramount / $conversion) ?>
</td>


<?php
$dramnt = $dramnt + ($x_dramount / $conversion);
$cramnt = $cramnt + ($x_cramount / $conversion);
$diff1 = $dramnt - $cramnt;
?>
	</tr>
<?php
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_Report2394_date"] = "";
			$_SESSION["sort_Report2394_crnum"] = "";
			$_SESSION["sort_Report2394_vcode"] = "";
			$_SESSION["sort_Report2394_coa"] = "";
			$_SESSION["sort_Report2394_description"] = "";
			$_SESSION["sort_Report2394_dramount"] = "";
			$_SESSION["sort_Report2394_cramount"] = "";
		}
