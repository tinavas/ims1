...
<tr>
 <td colspan="2" align="center"><strong><font color="#3e3276">Chicken Deboning Report</font></strong></td>
</tr>
<tr height="5px"></tr>
<tr>
...
<tr>
 ...
 <td colspan="4" align="center"><strong><font color="#3e3276">Unit: </font></strong><?php echo $unit; ?></td></tr><?php } ?>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="chicken_chickendeboning.php?export=html&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&unit=<?php echo $unit;?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="chicken_chickendeboning.php?export=excel&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&unit=<?php echo $unit;?>">Export to Excel</a>
&nbsp;&nbsp;<a href="chicken_chickendeboning.php?export=word&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&unit=<?php echo $unit;?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="chicken_chickendeboning.php?cmd=reset&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&unit=<?php echo $unit;?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
$okgs=0;
$count1=0;
$query="SELECT distinct(tid),date,unit FROM  `chicken_chickentransferdeboningip`  $cond order by date asc ";
...
{$count1=1;
 ...
 $query1 ="SELECT * FROM `chicken_chickentransferdeboningip` where tid='$row[tid]' ";
$result1=mysql_query($query1,$conn1);
$iprows=mysql_num_rows($result1);
 $query2 ="SELECT * FROM `chicken_chickentransferdeboningop` where tid='$row[tid]' ";
...
?>
      <tr>
        ...
        <td align="left"><?php if($yeild!=0)echo ewrpt_ViewValue(changeprice($yeild)); else   echo "&nbsp";  ?></td>
...
function reloadpage()
{
	...
	document.location = "chicken_chickendeboning.php?fromdate=" + fdate + "&todate=" + tdate+"&unit="+units;
}
</script>