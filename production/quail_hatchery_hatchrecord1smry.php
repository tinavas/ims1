...
ewrpt_CreatePopup("quail_hatchery_hatchrecord1_hatchery", [<?php echo $jsdata ?>]);
...
<div id="quail_hatchery_hatchrecord1_quail_hatchery_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
...
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quail_hatchery_hatchrecord1smry.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="quail_hatchery_hatchrecord1smry.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="quail_hatchery_hatchrecord1smry.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="quail_hatchery_hatchrecord1smry.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<br /><br />
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<form action="quail_hatchery_hatchrecord1smry.php<?php echo $url1; ?>" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="quail_hatchery_hatchrecord1smry.php?start=<?php echo $Pager->FirstButton->Start ?><?php echo $url; ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quail_hatchery_hatchrecord1smry.php?start=<?php echo $Pager->PrevButton->Start ?><?php echo $url; ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quail_hatchery_hatchrecord1smry.php?start=<?php echo $Pager->NextButton->Start ?><?php echo $url; ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quail_hatchery_hatchrecord1smry.php?start=<?php echo $Pager->LastButton->Start ?><?php echo $url; ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Hatchery</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_hatchrecord1_hatchery', false, '<?php echo $rf_hatchery; ?>', '<?php echo $rt_hatchery; ?>');return false;" name="x_hatchery<?php echo $cnt[0][0]; ?>" id="x_hatchery<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php }*/ ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Unit</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_hatchrecord1_unit', false, '<?php echo $rf_unit; ?>', '<?php echo $rt_unit; ?>');return false;" name="x_unit<?php echo $cnt[0][0]; ?>" id="x_unit<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if($_SESSION[db]!='alkhumasiyabrd') if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Shed</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_hatchrecord1_shed', false, '<?php echo $rf_shed; ?>', '<?php echo $rt_shed; ?>');return false;" name="x_shed<?php echo $cnt[0][0]; ?>" id="x_shed<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Flock</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_hatchrecord1_flock', false, '<?php echo $rf_flock; ?>', '<?php echo $rt_flock; ?>');return false;" name="x_flock<?php echo $cnt[0][0]; ?>" id="x_flock<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php 
$q1 = "select * from quail_hatchery_traysetting where flock = '$x_flock' and unit = '$x_unit' and client = '$client'";
...
<?php
$q = "select hatcher from quail_hatchery_hatchrecord where hatchdate = '$x_hatchdate' and unit = '$x_unit' and flock = '$x_flock' and shed = '$x_shed' and client = '$client'";
$r = mysql_query($q,$conn1) or die(mysql_error());
while($qr = mysql_fetch_assoc($r))
{
$machinenum = $qr['hatcher'];
?>
<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($machinenum) ?>
</td><?php } ?>
		<td<?php echo $sItemRowClass; ?> align="right">
...
$sdih = 0;
$sdihper = 0;
$q = "select * from quail_hatchery_hatchrecord where settingno = '$x_settingno' order by code";
$qrs = mysql_query($q,$conn1) or die(mysql_error());
while($qr = mysql_fetch_assoc($qrs))
{
 $dih = $qr['dih'];
...
$q = "select sum(dih) as sdih from quail_hatchery_hatchrecord where hatchdate = '$x_hatchdate'";
$qrs = mysql_query($q,$conn1) or die(mysql_error());
while($qr = mysql_fetch_assoc($qrs))
{
 $sdih = $qr['sdih'];
...
$q = "select sum(dih) as gdih from quail_hatchery_hatchrecord  where hatchdate = '$x_hatchdate'";
$qrs = mysql_query($q,$conn1) or die(mysql_error());
while($qr = mysql_fetch_assoc($qrs))
{
 $gdih = $qr['gdih'];
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_quail_hatchery_hatchrecord1_hatchery"])) {
		LoadSelectionFromSession('hatchery');
	} elseif (@$_SESSION["sel_quail_hatchery_hatchrecord1_hatchery"] == EW_REPORT_INIT_VALUE) { // Select all
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_hatchery"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_hatchery"], "quail_hatchery_hatchrecord.hatchery", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_hatchery"]);
	}
	if (is_array($GLOBALS["sel_unit"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_quail_hatchery_hatchrecord1_hatchery"] = "";
