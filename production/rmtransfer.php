...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Raw Material Transfer</font></strong></td>
</tr>
...
$EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.cat = 'Female Feed' or ims_stocktransfer.cat = 'Male Feed' or ims_stocktransfer.cat = 'Ingredients' ";
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="feedtransfer.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="feedtransfer.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="feedtransfer.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="feedtransfer.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="feedtransfer.php" name="ewpagerform" id="ewpagerform" class="ewForm"><center>
