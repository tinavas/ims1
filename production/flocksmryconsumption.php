...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Flock Consumption Report</font></strong></td>
</tr>
</table>
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="flocksmryconsumption.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="flocksmryconsumption.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="flocksmryconsumption.php?export=word">Export to Word</a><br /><br />
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="flocksmryconsumption.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
...
<form action="flocksmryconsumption.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="flocksmryconsumption.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="flocksmryconsumption.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="flocksmryconsumption.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="flocksmryconsumption.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Egg Weight">Temp In <br />
Min</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Egg Weight">Temp Out <br />
Min</td>
			</tr></table>
		</td>
<?php } ?>
...
?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo $remaining; $xbirds = $xbirds + $remaining; ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
...
?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo $tsale; $xsales = $xsales + $tsale; ?>
</td>

<?php
//////////// Closing Birds //////////////////

$cremaining = ($remaining - ($x_fmort + $x_fcull) - $ftransfer + $ttransfer) - $tsale;

?>
		<td<?php echo $sItemRowClass; ?>>
<?php echo $cremaining; $xclose = $xclose + $cremaining; ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_itemcode) . "-" . $x_description; ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_quantity) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo round(($x_quantity / $remaining) * 1000,2); ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
...
<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_tempinmin) ?>
</td>
<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_tempinmax) ?>
</td>
<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_tempoutmin) ?>
</td>
<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_tempoutmax) ?>
</td>
      	<td<?php echo $sItemRowClass; ?>>
...
<?php echo ewrpt_ViewValue($x_fcull) ?>
		...
		<td class="ewRptGrpSummary1">&nbsp;</td>
		<td class="ewRptGrpSummary1">&nbsp;</td>
		<td class="ewRptGrpSummary1"><?php echo $xsales; ?></td>
		<td class="ewRptGrpSummary1">&nbsp;</td>
		<td class="ewRptGrpSummary1">&nbsp;</td>
		<td class="ewRptGrpSummary1">
		<?php $t_quantity = $x_quantity; ?>
		<?php $x_quantity = $smry[1][13]; // Load SUM ?>
<?php echo ewrpt_ViewValue($x_quantity) ?>
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$GLOBALS['x_tempinmax'] = $rs->fields('tempinmax');
		$GLOBALS['x_tempoutmax'] = $rs->fields('tempoutmax');
		$GLOBALS['x_tempinmin'] = $rs->fields('tempinmin');
		$GLOBALS['x_tempoutmin'] = $rs->fields('tempoutmin');
		$val[1] = $GLOBALS['x_age'];
		...
		$val[16] =$GLOBALS['x_tempinmax'] ;
		$val[17] =$GLOBALS['x_tempoutmax'] ;
		$val[18] =$GLOBALS['x_tempinmin'];
		$val[19] =$GLOBALS['x_tempoutmin'];
	} else {
		$GLOBALS['x_wo'] = "";
		$GLOBALS['x_age'] = "";
		$GLOBALS['x_date2'] = "";
