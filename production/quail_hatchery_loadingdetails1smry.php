...
define("EW_REPORT_TABLE_VAR", "quail_hatchery_loadingdetails1", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "quail_hatchery_loadingdetails1_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "quail_hatchery_loadingdetails1_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "quail_hatchery_loadingdetails1_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "quail_hatchery_loadingdetails1_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "quail_hatchery_loadingdetails1_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "quail_hatchery_loadingdetails";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT quail_hatchery_loadingdetails.grade, quail_hatchery_loadingdetails.unit, quail_hatchery_loadingdetails.shed, quail_hatchery_loadingdetails.flock, quail_hatchery_loadingdetails.date, quail_hatchery_loadingdetails.time, quail_hatchery_loadingdetails.settingno, quail_hatchery_loadingdetails.setterno, quail_hatchery_loadingdetails.partitionno, quail_hatchery_loadingdetails.eggsset, quail_hatchery_loadingdetails.eggspertray, quail_hatchery_loadingdetails.eggweight, quail_hatchery_loadingdetails.avgegg, quail_hatchery_loadingdetails.loadedby FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "'$fromdate' <= quail_hatchery_loadingdetails.date and quail_hatchery_loadingdetails.date <= '$todate'";
$EW_REPORT_TABLE_SQL_GROUPBY = "quail_hatchery_loadingdetails.grade, quail_hatchery_loadingdetails.unit, quail_hatchery_loadingdetails.shed, quail_hatchery_loadingdetails.flock, quail_hatchery_loadingdetails.date, quail_hatchery_loadingdetails.time, quail_hatchery_loadingdetails.settingno, quail_hatchery_loadingdetails.setterno, quail_hatchery_loadingdetails.partitionno, quail_hatchery_loadingdetails.eggsset, quail_hatchery_loadingdetails.eggspertray, quail_hatchery_loadingdetails.eggweight, quail_hatchery_loadingdetails.avgegg, quail_hatchery_loadingdetails.loadedby";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "quail_hatchery_loadingdetails.grade ASC, quail_hatchery_loadingdetails.date ASC, quail_hatchery_loadingdetails.settingno ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "quail_hatchery_loadingdetails.grade", TRUE);
...
$EW_REPORT_TABLE_SQL_SELECT_AGG = "SELECT SUM(quail_hatchery_loadingdetails.eggsset) AS SUM_eggsset FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
?>
<?php
$EW_REPORT_FIELD_GRADE_SQL_SELECT = "SELECT DISTINCT quail_hatchery_loadingdetails.grade FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_GRADE_SQL_ORDERBY = "quail_hatchery_loadingdetails.grade";
...
$EW_REPORT_FIELD_SETTINGNO_SQL_SELECT = "SELECT DISTINCT quail_hatchery_loadingdetails.settingno FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SETTINGNO_SQL_ORDERBY = "quail_hatchery_loadingdetails.settingno";
...
ewrpt_CreatePopup("quail_hatchery_loadingdetails1_grade", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_date, $sel_date, $ft_date) ?>
ewrpt_CreatePopup("quail_hatchery_loadingdetails1_date", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_settingno, $sel_settingno, $ft_settingno) ?>
ewrpt_CreatePopup("quail_hatchery_loadingdetails1_settingno", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_unit, $sel_unit, $ft_unit) ?>
ewrpt_CreatePopup("quail_hatchery_loadingdetails1_unit", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_shed, $sel_shed, $ft_shed) ?>
ewrpt_CreatePopup("quail_hatchery_loadingdetails1_shed", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_flock, $sel_flock, $ft_flock) ?>
ewrpt_CreatePopup("quail_hatchery_loadingdetails1_flock", [<?php echo $jsdata ?>]);
</script>
<div id="quail_hatchery_loadingdetails1_grade_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="quail_hatchery_loadingdetails1_date_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="quail_hatchery_loadingdetails1_settingno_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="quail_hatchery_loadingdetails1_unit_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="quail_hatchery_loadingdetails1_shed_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="quail_hatchery_loadingdetails1_flock_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quail_hatchery_loadingdetails1smry.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="quail_hatchery_loadingdetails1smry.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="quail_hatchery_loadingdetails1smry.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="quail_hatchery_loadingdetails1smry.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<?php if (@$sExport == "") { ?>
<br /><br />
...
<form action="quail_hatchery_loadingdetails1smry.php<?php echo $url1; ?>" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="quail_hatchery_loadingdetails1smry.php?start=<?php echo $Pager->FirstButton->Start ?><?php echo $url; ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quail_hatchery_loadingdetails1smry.php?start=<?php echo $Pager->PrevButton->Start ?><?php echo $url; ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quail_hatchery_loadingdetails1smry.php?start=<?php echo $Pager->NextButton->Start ?><?php echo $url; ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quail_hatchery_loadingdetails1smry.php?start=<?php echo $Pager->LastButton->Start ?><?php echo $url; ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Grade</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_loadingdetails1_grade', false, '<?php echo $rf_grade; ?>', '<?php echo $rt_grade; ?>');return false;" name="x_grade<?php echo $cnt[0][0]; ?>" id="x_grade<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_loadingdetails1_date', false, '<?php echo $rf_date; ?>', '<?php echo $rt_date; ?>');return false;" name="x_date<?php echo $cnt[0][0]; ?>" id="x_date<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Unit</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_loadingdetails1_unit', false, '<?php echo $rf_unit; ?>', '<?php echo $rt_unit; ?>');return false;" name="x_unit<?php echo $cnt[0][0]; ?>" id="x_unit<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Shed</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_loadingdetails1_shed', false, '<?php echo $rf_shed; ?>', '<?php echo $rt_shed; ?>');return false;" name="x_shed<?php echo $cnt[0][0]; ?>" id="x_shed<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Flock</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_loadingdetails1_flock', false, '<?php echo $rf_flock; ?>', '<?php echo $rt_flock; ?>');return false;" name="x_flock<?php echo $cnt[0][0]; ?>" id="x_flock<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_quail_hatchery_loadingdetails1_grade"])) {
		LoadSelectionFromSession('grade');
	} elseif (@$_SESSION["sel_quail_hatchery_loadingdetails1_grade"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_grade"] = "";
	}

	// Get Date selected values
	if (is_array(@$_SESSION["sel_quail_hatchery_loadingdetails1_date"])) {
		LoadSelectionFromSession('date');
	} elseif (@$_SESSION["sel_quail_hatchery_loadingdetails1_date"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_date"] = "";
	}

	// Get Settingno selected values
	if (is_array(@$_SESSION["sel_quail_hatchery_loadingdetails1_settingno"])) {
		LoadSelectionFromSession('settingno');
	} elseif (@$_SESSION["sel_quail_hatchery_loadingdetails1_settingno"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_settingno"] = "";
	}

	// Get Unit selected values
	if (is_array(@$_SESSION["sel_quail_hatchery_loadingdetails1_unit"])) {
		LoadSelectionFromSession('unit');
	} elseif (@$_SESSION["sel_quail_hatchery_loadingdetails1_unit"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_unit"] = "";
	}

	// Get Shed selected values
	if (is_array(@$_SESSION["sel_quail_hatchery_loadingdetails1_shed"])) {
		LoadSelectionFromSession('shed');
	} elseif (@$_SESSION["sel_quail_hatchery_loadingdetails1_shed"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_shed"] = "";
	}

	// Get Flock selected values
	if (is_array(@$_SESSION["sel_quail_hatchery_loadingdetails1_flock"])) {
		LoadSelectionFromSession('flock');
	} elseif (@$_SESSION["sel_quail_hatchery_loadingdetails1_flock"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_flock"] = "";
	}
}
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_quail_hatchery_loadingdetails1_$parm"] = "";
	$_SESSION["rf_quail_hatchery_loadingdetails1_$parm"] = "";
	$_SESSION["rt_quail_hatchery_loadingdetails1_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_quail_hatchery_loadingdetails1_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_quail_hatchery_loadingdetails1_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_quail_hatchery_loadingdetails1_$parm"];
}
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_grade"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_grade"], "quail_hatchery_loadingdetails.grade", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_grade"], $GLOBALS["gb_grade"], $GLOBALS["gi_grade"], $GLOBALS["gq_grade"]);
	}
	if (is_array($GLOBALS["sel_unit"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
	...
	if (is_array($GLOBALS["sel_flock"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_flock"], "quail_hatchery_loadingdetails.flock", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_flock"]);
	}
	if (is_array($GLOBALS["sel_date"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
	...
	if (is_array($GLOBALS["sel_settingno"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_settingno"], "quail_hatchery_loadingdetails.settingno", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_settingno"], $GLOBALS["gb_settingno"], $GLOBALS["gi_settingno"], $GLOBALS["gq_settingno"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_quail_hatchery_loadingdetails1_grade"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_date"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_settingno"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_unit"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_shed"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_flock"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_time"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_setterno"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_partitionno"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_eggsset"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_eggspertray"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_eggweight"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_avgegg"] = "";
			$_SESSION["sort_quail_hatchery_loadingdetails1_loadedby"] = "";
		}
