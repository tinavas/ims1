...
define("EW_REPORT_TABLE_VAR", "hatchery_settingdetails1", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "hatchery_settingdetails1_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "hatchery_settingdetails1_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "hatchery_settingdetails1_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "hatchery_settingdetails1_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "hatchery_settingdetails1_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "hatchery_settingdetails";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT hatchery_settingdetails.unit, hatchery_settingdetails.shed, hatchery_settingdetails.flock, hatchery_settingdetails.date, hatchery_settingdetails.lot, hatchery_settingdetails.lotno, hatchery_settingdetails.grade, hatchery_settingdetails.eggs FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "'$fromdate' <= hatchery_settingdetails.date and hatchery_settingdetails.date <= '$todate'";
$EW_REPORT_TABLE_SQL_GROUPBY = "hatchery_settingdetails.unit, hatchery_settingdetails.shed, hatchery_settingdetails.flock, hatchery_settingdetails.date, hatchery_settingdetails.lot, hatchery_settingdetails.lotno, hatchery_settingdetails.grade, hatchery_settingdetails.eggs";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "hatchery_settingdetails.unit ASC, hatchery_settingdetails.shed ASC, hatchery_settingdetails.flock ASC, hatchery_settingdetails.date ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "hatchery_settingdetails.unit", TRUE);
...
$EW_REPORT_TABLE_SQL_SELECT_AGG = "SELECT SUM(hatchery_settingdetails.eggs) AS SUM_eggs FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
?>
<?php
$EW_REPORT_FIELD_UNIT_SQL_SELECT = "SELECT DISTINCT hatchery_settingdetails.unit FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_UNIT_SQL_ORDERBY = "hatchery_settingdetails.unit";
$EW_REPORT_FIELD_SHED_SQL_SELECT = "SELECT DISTINCT hatchery_settingdetails.shed FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SHED_SQL_ORDERBY = "hatchery_settingdetails.shed";
$EW_REPORT_FIELD_FLOCK_SQL_SELECT = "SELECT DISTINCT hatchery_settingdetails.flock FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_FLOCK_SQL_ORDERBY = "hatchery_settingdetails.flock";
$EW_REPORT_FIELD_DATE_SQL_SELECT = "SELECT DISTINCT hatchery_settingdetails.date FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_DATE_SQL_ORDERBY = "hatchery_settingdetails.date";
$EW_REPORT_FIELD_LOT_SQL_SELECT = "SELECT DISTINCT hatchery_settingdetails.lot FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_LOT_SQL_ORDERBY = "hatchery_settingdetails.lot";
$EW_REPORT_FIELD_LOTNO_SQL_SELECT = "SELECT DISTINCT hatchery_settingdetails.lotno FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_LOTNO_SQL_ORDERBY = "hatchery_settingdetails.lotno";
$EW_REPORT_FIELD_GRADE_SQL_SELECT = "SELECT DISTINCT hatchery_settingdetails.grade FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_GRADE_SQL_ORDERBY = "hatchery_settingdetails.grade";
?>
<?php
...
ewrpt_CreatePopup("hatchery_settingdetails1_unit", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_shed, $sel_shed, $ft_shed) ?>
ewrpt_CreatePopup("hatchery_settingdetails1_shed", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_flock, $sel_flock, $ft_flock) ?>
ewrpt_CreatePopup("hatchery_settingdetails1_flock", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_date, $sel_date, $ft_date) ?>
ewrpt_CreatePopup("hatchery_settingdetails1_date", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_lot, $sel_lot, $ft_lot) ?>
ewrpt_CreatePopup("hatchery_settingdetails1_lot", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_lotno, $sel_lotno, $ft_lotno) ?>
ewrpt_CreatePopup("hatchery_settingdetails1_lotno", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_grade, $sel_grade, $ft_grade) ?>
ewrpt_CreatePopup("hatchery_settingdetails1_grade", [<?php echo $jsdata ?>]);
</script>
<div id="hatchery_settingdetails1_unit_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_settingdetails1_shed_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_settingdetails1_flock_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_settingdetails1_date_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_settingdetails1_lot_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_settingdetails1_lotno_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_settingdetails1_grade_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="hatchery_settingdetails1smry.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="hatchery_settingdetails1smry.php?export=excelv">Export to Excel</a>
&nbsp;&nbsp;<a href="hatchery_settingdetails1smry.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="hatchery_settingdetails1smry.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<?php if (@$sExport == "") { ?>
<br /><br />
...
<form action="hatchery_settingdetails1smry.php<?php echo $url1;?>" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="hatchery_settingdetails1smry.php?start=<?php echo $Pager->FirstButton->Start ?><?php echo $url;?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="hatchery_settingdetails1smry.php?start=<?php echo $Pager->PrevButton->Start ?><?php echo $url;?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="hatchery_settingdetails1smry.php?start=<?php echo $Pager->NextButton->Start ?><?php echo $url;?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="hatchery_settingdetails1smry.php?start=<?php echo $Pager->LastButton->Start ?><?php echo $url;?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Unit</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_settingdetails1_unit', false, '<?php echo $rf_unit; ?>', '<?php echo $rt_unit; ?>');return false;" name="x_unit<?php echo $cnt[0][0]; ?>" id="x_unit<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Shed</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_settingdetails1_shed', false, '<?php echo $rf_shed; ?>', '<?php echo $rt_shed; ?>');return false;" name="x_shed<?php echo $cnt[0][0]; ?>" id="x_shed<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Flock</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_settingdetails1_flock', false, '<?php echo $rf_flock; ?>', '<?php echo $rt_flock; ?>');return false;" name="x_flock<?php echo $cnt[0][0]; ?>" id="x_flock<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_settingdetails1_date', false, '<?php echo $rf_date; ?>', '<?php echo $rt_date; ?>');return false;" name="x_date<?php echo $cnt[0][0]; ?>" id="x_date<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<!--
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Lot</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_settingdetails1_lot', false, '<?php echo $rf_lot; ?>', '<?php echo $rt_lot; ?>');return false;" name="x_lot<?php echo $cnt[0][0]; ?>" id="x_lot<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
-->
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Lot No.</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_settingdetails1_lotno', false, '<?php echo $rf_lotno; ?>', '<?php echo $rt_lotno; ?>');return false;" name="x_lotno<?php echo $cnt[0][0]; ?>" id="x_lotno<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Grade</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_settingdetails1_grade', false, '<?php echo $rf_grade; ?>', '<?php echo $rt_grade; ?>');return false;" name="x_grade<?php echo $cnt[0][0]; ?>" id="x_grade<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_hatchery_settingdetails1_unit"])) {
		LoadSelectionFromSession('unit');
	} elseif (@$_SESSION["sel_hatchery_settingdetails1_unit"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_unit"] = "";
	}

	// Get Shed selected values
	if (is_array(@$_SESSION["sel_hatchery_settingdetails1_shed"])) {
		LoadSelectionFromSession('shed');
	} elseif (@$_SESSION["sel_hatchery_settingdetails1_shed"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_shed"] = "";
	}

	// Get Flock selected values
	if (is_array(@$_SESSION["sel_hatchery_settingdetails1_flock"])) {
		LoadSelectionFromSession('flock');
	} elseif (@$_SESSION["sel_hatchery_settingdetails1_flock"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_flock"] = "";
	}

	// Get Date selected values
	if (is_array(@$_SESSION["sel_hatchery_settingdetails1_date"])) {
		LoadSelectionFromSession('date');
	} elseif (@$_SESSION["sel_hatchery_settingdetails1_date"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_date"] = "";
	}

	// Get Lot selected values
	if (is_array(@$_SESSION["sel_hatchery_settingdetails1_lot"])) {
		LoadSelectionFromSession('lot');
	} elseif (@$_SESSION["sel_hatchery_settingdetails1_lot"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_lot"] = "";
	}

	// Get Lotno selected values
	if (is_array(@$_SESSION["sel_hatchery_settingdetails1_lotno"])) {
		LoadSelectionFromSession('lotno');
	} elseif (@$_SESSION["sel_hatchery_settingdetails1_lotno"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_lotno"] = "";
	}

	// Get Grade selected values
	if (is_array(@$_SESSION["sel_hatchery_settingdetails1_grade"])) {
		LoadSelectionFromSession('grade');
	} elseif (@$_SESSION["sel_hatchery_settingdetails1_grade"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_grade"] = "";
	}
}
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_hatchery_settingdetails1_$parm"] = "";
	$_SESSION["rf_hatchery_settingdetails1_$parm"] = "";
	$_SESSION["rt_hatchery_settingdetails1_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_hatchery_settingdetails1_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_hatchery_settingdetails1_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_hatchery_settingdetails1_$parm"];
}
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_unit"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_unit"], "hatchery_settingdetails.unit", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_unit"], $GLOBALS["gb_unit"], $GLOBALS["gi_unit"], $GLOBALS["gq_unit"]);
	}
	if (is_array($GLOBALS["sel_shed"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_shed"], "hatchery_settingdetails.shed", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_shed"], $GLOBALS["gb_shed"], $GLOBALS["gi_shed"], $GLOBALS["gq_shed"]);
	}
	if (is_array($GLOBALS["sel_flock"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_flock"], "hatchery_settingdetails.flock", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_flock"], $GLOBALS["gb_flock"], $GLOBALS["gi_flock"], $GLOBALS["gq_flock"]);
	}
	if (is_array($GLOBALS["sel_date"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_date"], "hatchery_settingdetails.date", EW_REPORT_DATATYPE_DATE, $GLOBALS["af_date"], $GLOBALS["gb_date"], $GLOBALS["gi_date"], $GLOBALS["gq_date"]);
	}
	if (is_array($GLOBALS["sel_lot"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_lot"], "hatchery_settingdetails.lot", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_lot"]);
	}
	if (is_array($GLOBALS["sel_lotno"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_lotno"], "hatchery_settingdetails.lotno", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_lotno"]);
	}
	if (is_array($GLOBALS["sel_grade"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_grade"], "hatchery_settingdetails.grade", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_grade"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_hatchery_settingdetails1_unit"] = "";
			$_SESSION["sort_hatchery_settingdetails1_shed"] = "";
			$_SESSION["sort_hatchery_settingdetails1_flock"] = "";
			$_SESSION["sort_hatchery_settingdetails1_date"] = "";
			$_SESSION["sort_hatchery_settingdetails1_lot"] = "";
			$_SESSION["sort_hatchery_settingdetails1_lotno"] = "";
			$_SESSION["sort_hatchery_settingdetails1_grade"] = "";
			$_SESSION["sort_hatchery_settingdetails1_eggs"] = "";
		}
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] = "hatchery_settingdetails.lot ASC, hatchery_settingdetails.lotno ASC";
		$_SESSION["sort_hatchery_settingdetails1_lot"] = "ASC";
		$_SESSION["sort_hatchery_settingdetails1_lotno"] = "ASC";
	}
