...
else if($_SESSION['db']=="singhsatrang") { 
...
?>
Status
<select id="srflag"  name="srflag" onchange="reloadpage()" >
...
{ 
 ...
 // $x_totalquantity += $qr['freequantity'];
 // if($selectedcode == "All")
$x_totalquantity += $qr['length']* $qr['width'];
...
?>
<td<?php echo $sItemRowClass; ?> align="right">
<?php  if($srflag=='1') {echo "Sales Receipt Done"; }else {  echo "Sales Receipt Pending"; }?>
</td>
...
<?php echo changeprice($grandamount);  #ewrpt_ViewValue($x_finaltotal) ?></b>
		...
		<?php if($_SESSION['db']!="cps" && $_SESSION['db']!="apf" && $_SESSION['db']!="mew") { ?>
...
function reloadpage()
{
	...
	document.location = "salesreportsmry.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" + description <?php if($_SESSION['db']=="singhsatrang"){?>+ "&status=" + status<?php }?>;
...
var date = document.getElementById('fdate').value;
	...
	document.location = "salesreportsmry.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" + "All"<?php if($_SESSION['db']=="singhsatrang"){?>+ "&status=" + status<?php }?> ;
...
var date = document.getElementById('fdate').value;
	...
	document.location = "salesreportsmry.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + "All" + "&description=" + description<?php if($_SESSION['db']=="singhsatrang"){?>+ "&status=" + status<?php }?> ;
...
<?php
	...
	document.location = "salesreportsmry.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" + description + "&warehouse=" + warehouse<?php if($_SESSION['db']=="singhsatrang"){?>+ "&status=" + status<?php }?>;
