...
define("EW_REPORT_TABLE_VAR", "oc_debitnotereport", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "oc_debitnotereport_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "oc_debitnotereport_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "oc_debitnotereport_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "oc_debitnotereport_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "oc_debitnotereport_orderby", TRUE);
...
$EW_REPORT_TABLE_SQL_WHERE = "(ac_crdrnote.date >= '$fdate' and ac_crdrnote.date<='$tdate') and (ac_crdrnote.mode = 'CDN')";
...
$EW_REPORT_TABLE_SQL_FROM = "ac_crdrnote";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT ac_crdrnote.date, ac_crdrnote.crnum, ac_crdrnote.vcode, ac_crdrnote.coa, ac_crdrnote.description, ac_crdrnote.dramount, ac_crdrnote.cramount ,ac_crdrnote.vpcode FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "(ac_crdrnote.date >= '$fdate' and ac_crdrnote.date<='$tdate') and (ac_crdrnote.mode = 'CDN') and (ac_crdrnote.vcode = '$name') ";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
...
<center>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="customerdebitnote.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="customerdebitnote.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="customerdebitnote.php?export=word">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<form action="customerdebitnote.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="customerdebitnote.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="customerdebitnote.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="customerdebitnote.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="customerdebitnote.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php echo ewrpt_ViewValue(changeprice($x_dramount)) ?>
</td>
		<td<?php echo $sItemRowClass; ?> style="text-align:right">
<?php echo ewrpt_ViewValue(changeprice($x_cramount)) ?>
</td>
<?php 
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_oc_debitnotereport_date"] = "";
			$_SESSION["sort_oc_debitnotereport_crnum"] = "";
			$_SESSION["sort_oc_debitnotereport_vcode"] = "";
			$_SESSION["sort_oc_debitnotereport_coa"] = "";
			$_SESSION["sort_oc_debitnotereport_description"] = "";
			$_SESSION["sort_oc_debitnotereport_dramount"] = "";
			$_SESSION["sort_oc_debitnotereport_cramount"] = "";
		}
