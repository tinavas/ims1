...
$EW_REPORT_TABLE_SQL_WHERE = "quail_broiler_daily_entry.cullflag = 0";
// Get page start time
...
&nbsp;&nbsp;<a href="quail_tentativechickstransfersmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="quail_tentativechickstransfersmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="quail_tentativechickstransfersmry.php?start=<?php echo $Pager->FirstButton->Start ?>&cullage=<?php echo  $_GET['cullage']; ?>&gapdays=<?php echo $_GET['gapdays'];?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quail_tentativechickstransfersmry.php?start=<?php echo $Pager->PrevButton->Start ?>&cullage=<?php echo  $_GET['cullage']; ?>&gapdays=<?php echo $_GET['gapdays'];?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quail_tentativechickstransfersmry.php?start=<?php echo $Pager->NextButton->Start ?>&cullage=<?php echo  $_GET['cullage']; ?>&gapdays=<?php echo $_GET['gapdays'];?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quail_tentativechickstransfersmry.php?start=<?php echo $Pager->LastButton->Start ?>&cullage=<?php echo  $_GET['cullage']; ?>&gapdays=<?php echo $_GET['gapdays'];?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
document.location = 'quail_tentativechickstransfersmry.php?&cullage=' + document.getElementById("cullage").value + '&gapdays=' + document.getElementById("gapdays").value;
}
...
?>
	...
	<tr>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" style="display:none">
		Supervisior
		</td>
<?php } else { ?>
		<td class="ewTableHeader" style="display:none">
...
?>
	<tr>
		<td class="ewRptGrpField1"  style="display:none">
...
<?php echo ewrpt_ViewValue($x_flock) ?>
		...
		<?php
		$query = "select max(age) as age,max(entrydate) as date from quail_broiler_daily_entry where ( flock = '$x_flock' and supervisior = '$x_supervisior' and farm = '$x_farm')";
...
{
document.location = 'quail_tentativechickstransfersmry.php?export=' + a + '&cullage=' + document.getElementById("cullage").value + '&gapdays=' + document.getElementById("gapdays").value;
}
</script>