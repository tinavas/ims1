...
$url = "&fromdate=" . $fromdate . "&todate=" . $todate . "&warehouse=" . $warehouse ."&etype=" . $etype;
$url1 = "?fromdate=" . $fromdate . "&todate=" . $todate . "&warehouse=" . $warehouse ."&etype=" . $etype;
...
&nbsp;&nbsp;<a href="eggstocksmrynew.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="eggstocksmrynew.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="eggstocksmrynew.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="eggstocksmrynew.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
...
<?php
$q = "select distinct(warehouse) as warehouse  from tbl_sector where warehouse <> '' ";
$qrs = mysql_query($q,$conn1);
$n1 = mysql_num_rows($qrs);
while($qr = mysql_fetch_assoc($qrs))
{
?>
<option  value="<?php echo $qr['warehouse']; ?>" <?php if($warehouse == $qr['warehouse']) { ?> selected="selected" <?php } ?> ><?php echo $qr['warehouse']; ?></option>
<?php } ?>
</select>
&nbsp;&nbsp;&nbsp;
Type&nbsp;
<select id="etype" name="etype" onChange="reloadpage();">
<?php
echo $q1 = "SELECT distinct(cat) as d FROM `ims_itemcodes` where cat like '%egg%'";
$qrs1 = mysql_query($q1,$conn1);
$n11 = mysql_num_rows($qrs1);
while($qr1 = mysql_fetch_assoc($qrs1))
{
?>
<option  value="<?php echo $qr1['d']; ?>" <?php if($etype == $qr1['d']) { ?> selected="selected" <?php } ?> ><?php echo $qr1['d']; ?></option>
<?php } ?>
</select>
&nbsp;&nbsp;&nbsp;
From Date&nbsp;
...
<form action="eggstocksmrynew.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="eggstocksmrynew.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="eggstocksmrynew.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="eggstocksmrynew.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="eggstocksmrynew.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } ?>
<?php
if($etype=='Layer Breeder Eggs')
{ 
 $getop = "SELECT * FROM ims_itemcodes WHERE cat like '%Breeder Eggs%'  order by code";
 }
 else if($etype=='Layer Hatch Eggs')
{ 
 $getop = "SELECT * FROM ims_itemcodes WHERE cat like '%Hatch Eggs%'  order by code";
 }
 else
 {
 $getop = "SELECT * FROM ims_itemcodes WHERE cat like '%Layer Eggs%' order by code";
 }
...
if($etype=='Layer Breeder Eggs')
{
$getop1 = "SELECT * FROM ims_itemcodes WHERE cat like '%Breeder Eggs%'  order by code";
}
else if($etype=='Layer Hatch Eggs')
{
$getop1 = "SELECT * FROM ims_itemcodes WHERE cat like '%Hatch Eggs%' order by code";
}
else
{
$getop1 = "SELECT * FROM ims_itemcodes WHERE cat like '%Layer Eggs%'  order by code";
}
 ...
 if($etype=='Layer Breeder Eggs')
{ 
$getop2 = "SELECT * FROM ims_itemcodes WHERE cat like '%Breeder Eggs%' order by code";
}
else if($etype=='Layer Hatch Eggs')
{ 
$getop2 = "SELECT * FROM ims_itemcodes WHERE cat like '%Hatch Eggs%'   order by code";
}
else
{
$getop2 = "SELECT * FROM ims_itemcodes WHERE cat like '%Layer Eggs%'  order by code";
}
...
if($etype=='Layer Breeder Eggs' || $etype=='Layer Hatch Eggs')
{		
 $get = "SELECT distinct(flockcode) as flkmain from layerbreeder_flock";
}
else
{
$get = "SELECT distinct(flock) as flkmain from layer_flock   order by flkmain";
}
...
$getop1 = "SELECT * FROM ims_itemcodes WHERE cat like '%Layer Eggs%'  order by code";
  ...
  //Opening Calculation
   ...
   $getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE riflag = 'R' AND code = '$rowop1[code]' AND date < '$fromdate'   and flock = '$row[flkmain]' and warehouse='$warehouse'";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
  ...
  $getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE code = '$rowop1[code]' AND date < '$fromdate'  AND  flock = '$row[flkmain]' AND type = 'Add' ";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $obrec = $obrec +  $rowop['quantity'];
...
if($etype=='Layer Breeder Eggs')
   {
 $getop = "SELECT SUM(quantity) as quantity FROM layerbreeder_production WHERE itemcode = '$rowop1[code]' AND date1 <'$fromdate' AND flock in (select flockcode from layerbreeder_flock where flockcode = '$row[flkmain]' and farmdescription in (select sector from tbl_sector where warehouse='$warehouse')) ";
  }
  else if($etype=='Layer Hatch Eggs')
  {
  $getop = "SELECT SUM(quantity) as quantity FROM layerbreeder_production WHERE itemcode = '$rowop1[code]' AND date1 < '$fromdate' AND flock in (select flockcode from layerbreeder_flock where flockcode = '$row[flkmain]' and farmdescription in (select sector from tbl_sector where warehouse='$warehouse'))";
  ...
  {
  $getop = "SELECT SUM(quantity) as quantity FROM layer_production WHERE itemcode = '$rowop1[code]' AND date1 > '$fromdate' AND flock  = '$row[flkmain]'";
  }
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
  ...
  $getop = "SELECT SUM(toeggs) as quantity FROM ims_eggtransfer WHERE tocode in (select distinct(code) from ims_itemcodes where cat like '%Eggs%' ) AND date <'$fromdate' AND towarehouse = '$row[flkmain]'";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
    $obrec = $obrec +  $rowop['quantity'];
  }
    $getop = "SELECT SUM(fromeggs) as quantity FROM ims_eggtransfer WHERE fromcode in (select distinct(code) from ims_itemcodes where cat like '%Eggs%' ) AND date < '$fromdate' AND fromwarehouse  = '$row[flkmain]'";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
    $obiss = $obiss +  $rowop['quantity'];
  }
   $getop = "SELECT SUM(quantity) as quantity FROM oc_cobi where code in (select distinct(code) from ims_itemcodes where cat like '%Eggs%') AND date < '$fromdate' and warehouse='$warehouse' AND flock = '$row[flkmain]'";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $obiss = $obiss +  $rowop['quantity']; 
   ...
   $getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE riflag = 'I' AND code = '$rowop1[code]' AND date  <'$fromdate' and flock = '$row[flkmain]' and warehouse='$warehouse'";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $obiss = $obiss +  $rowop['quantity'];
  ...
  $query = "SELECT sum(eggsset) as eggsset FROM hatchery_traysetting WHERE flock = '$row[flkmain]'  AND client = '$client' AND settingdate < '$fromdate'";
  $result = mysql_query($query,$conn1);
  $rows = mysql_fetch_assoc($result);
  
   $getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE code = '$rowop1[code]' AND date < '$fromdate'  AND  flock = '$row[flkmain]' AND type = 'Deduct' ";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $obiss = $obiss +  $rowop['quantity'];
...
$getop1 = "SELECT * FROM ims_itemcodes WHERE cat like '%Layer Eggs%'  order by code";
 ...
 $getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE riflag = 'R' AND code = '$rowop1[code]' AND date >= '$fromdate' and date <= '$todate' and flock = '$row[flkmain]' and warehouse='$warehouse'";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
...
if($etype=='Layer Breeder eggs')
   {
     $getop = "SELECT SUM(quantity) as quantity,flock FROM layerbreeder_production WHERE itemcode = '$rowop1[code]' AND date1 >= '$fromdate' and date1 <= '$todate' AND flock in (select flockcode from layerbreeder_flock where flockcode = '$row[flkmain]' and farmdescription in (select sector from tbl_sector where warehouse='$warehouse')) ";
	 }
	 else if($etype=='Layer Hatch Eggs')
   {
   $getop = "SELECT SUM(quantity) as quantity,flock FROM layerbreeder_production WHERE itemcode = '$rowop1[code]' AND date1 >= '$fromdate' and date1 <= '$todate' AND flock in (select flockcode from layerbreeder_flock where flockcode = '$row[flkmain]' and farmdescription in (select sector from tbl_sector where warehouse='$warehouse')) ";
	 ...
	 {
	 $getop = "SELECT SUM(quantity) as quantity,flock FROM layer_production WHERE itemcode = '$rowop1[code]' AND date1 >= '$fromdate' and date1 <= '$todate' AND flock  = '$row[flkmain]'";
	 }
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
 ...
 $getop = "SELECT SUM(toeggs) as quantity FROM ims_eggtransfer WHERE tocode in (select distinct(code) from ims_itemcodes where cat = 'Hatch Eggs' ) AND date >= '$fromdate' and date <= '$todate' AND towarehouse = '$row[flkmain]')";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
 ...
 $query = "SELECT sum(eggsset) as eggsset FROM hatchery_traysetting WHERE flock = '$row[flkmain]' AND client = '$client' AND settingdate >= '$fromdate' and settingdate <= '$todate'";
  $result = mysql_query($query,$conn1);
  $rows = mysql_fetch_assoc($result);
  
  $rrec[$rowop1['code']] += $rows['eggsset'];
  
   $getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE code = '$rowop1[code]' AND date BETWEEN '$fromdate' AND '$todate'  and flock = '$row[flkmain]' AND type = 'Add' ";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
...
$getop1 = "SELECT * FROM ims_itemcodes WHERE cat like '%Layer Eggs%'  order by code";
  ...
  $getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE code = '$rowop1[code]' AND date >= '$fromdate' and date <= '$todate' and flock = '$row[flkmain]' AND type = 'Deduct'";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $issue[$rowop1['code']] = $issue[$rowop1['code']] +  $rowop['quantity'];
  ...
  $getop = "SELECT sum(quantity) as quant from oc_cobi where date >= '$fromdate' and date <= '$todate' and flock = '$row[flkmain]'  and warehouse='$warehouse' and code in (select distinct(code) from ims_itemcodes where cat like '%Eggs%') ";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
  //echo $rowop['quant'];
  $issue[$rowop1['code']] = $issue[$rowop1['code']] +  $rowop['quant'];
   ...
   $getop = "SELECT SUM(fromeggs) as quant FROM ims_eggtransfer WHERE fromcode in (select distinct(code) from ims_itemcodes where cat like '%Eggs%' ) AND date >= '$fromdate' and date <= '$todate' AND fromwarehouse = '$row[flkmain]')";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $issue[$rowop1['code']] = $issue[$rowop1['code']] +  $rowop['quant'];
...
$getop1 = "SELECT * FROM ims_itemcodes WHERE cat like '%Layer Eggs%'  order by code";
 ...
 $query = "SELECT sum(eggsset) as eggsset FROM hatchery_traysetting WHERE flock = '$row[flkmain]' AND client = '$client'";
  $result = mysql_query($query,$conn1);
  $rows = mysql_fetch_assoc($result);
...
<?php if($final[$rowop1['code']] <> 0 || $final[$rowop1['code']] <> ""){ echo ewrpt_ViewValue(changequantity($final[$rowop1['code']])); } else { echo ewrpt_ViewValue("0"); } ?></td>
...
function reloadpage()
{
	...
	//document.location = "eggstocksmrynew.php?fromdate=" + fromdate + "&todate=" + todate + "&warehouse=" + warehouse;
...
if(Date.parse(date1) < Date.parse(date2))
	{
	document.location = "eggstocksmrynew.php?fromdate=" + fromdate + "&todate=" + todate + "&warehouse=" + warehouse + "&etype=" + etype;
	}
	else
	{
