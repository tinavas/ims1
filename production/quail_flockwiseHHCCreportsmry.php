...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quail_flockwiseHHCCreportsmry.php?flock=<?php echo $flock; ?>&export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="quail_flockwiseHHCCreportsmry.php?flock=<?php echo $flock; ?>&export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="quail_flockwiseHHCCreportsmry.php?flock=<?php echo $flock; ?>&export=word">Export to Word</a><br /><br />
<?php } ?>
...
$cummeggsset = 0;	
$cummhatch = 0;
//$query1 = "SELECT age from quail_flock WHERE flockcode = '$flock' AND client = '$client' ORDER BY age ASC";
$query1 = "SELECT DISTINCT (b2.date2), b2.age FROM quail_production b1, quail_consumption b2 WHERE b2.flock = '$flock' AND b1.flock = '$flock' AND b1.date1 = b2.date2 ORDER BY `b2`.`age` ASC LIMIT 1";
...
//Get Production
$query2 = "SELECT sum(quantity) quantity FROM quail_production WHERE date1 >= '$from_date' AND date1 <= '$to_date' AND flock = '$flock' AND client = '$client'";
...
$query3 = "SELECT sum(reject) reject, sum(eggsset) eggsset FROM quail_hatchery_traysetting WHERE settingdate >= '$from_date' AND settingdate <= '$to_date' AND flock = '$flock' AND client = '$client'";
...
//Get Chicks hatched
$query4 = "SELECT sum(hatch) hatch FROM quail_hatchery_hatchrecord WHERE settingdate >= '$from_date' AND settingdate <= '$to_date' AND flock = '$flock' AND client = '$client'";
...
$query5 = "SELECT chicksperweek,cumchicks FROM quail_standards WHERE age = '$age' and client = '$client'";
...
$query6 = "SELECT femaleopening FROM quail_flock WHERE flockcode = '$flock' and client = '$client'";
$result6 = mysql_query($query6,$conn1) or die(mysql_error());
$rows6 = mysql_fetch_assoc($result6);
$femaleopen = $rows6['femaleopening'];

$query7 = "SELECT fmort,fcull FROM quail_consumption WHERE flock = '$flock' AND date2 = '$from_date' AND client = '$client' LIMIT 1";
...
<?php
	//Manual Coding Starts Here
$query = "SELECT max(date1) maxdate FROM quail_production WHERE flock = '$flock' AND client = '$client'";	
