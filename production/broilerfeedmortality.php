...
define("EW_REPORT_TABLE_VAR", "daywisefm", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "daywisefm_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "daywisefm_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "daywisefm_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "daywisefm_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "daywisefm_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "broiler_daily_entry";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT broiler_daily_entry.place, broiler_daily_entry.supervisior, broiler_daily_entry.farm, broiler_daily_entry.flock, broiler_daily_entry.entrydate, broiler_daily_entry.age, broiler_daily_entry.feedtype, broiler_daily_entry.feedconsumed, broiler_daily_entry.mortality, broiler_daily_entry.birds FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "";
$EW_REPORT_TABLE_SQL_GROUPBY = "broiler_daily_entry.place, broiler_daily_entry.supervisior, broiler_daily_entry.farm, broiler_daily_entry.flock, broiler_daily_entry.entrydate, broiler_daily_entry.age, broiler_daily_entry.feedtype, broiler_daily_entry.feedconsumed, broiler_daily_entry.mortality, broiler_daily_entry.birds";
...
ewrpt_CreatePopup("daywisefm_place", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_supervisior, $sel_supervisior, $ft_supervisior) ?>
ewrpt_CreatePopup("daywisefm_supervisior", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_farm, $sel_farm, $ft_farm) ?>
ewrpt_CreatePopup("daywisefm_farm", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_flock, $sel_flock, $ft_flock) ?>
ewrpt_CreatePopup("daywisefm_flock", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_entrydate, $sel_entrydate, $ft_entrydate) ?>
ewrpt_CreatePopup("daywisefm_entrydate", [<?php echo $jsdata ?>]);
</script>
<div id="daywisefm_place_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="daywisefm_supervisior_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="daywisefm_farm_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="daywisefm_flock_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="daywisefm_entrydate_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<a name="top"></a>
<?php } ?>
<b>Day wise Feed & Mortality</b>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="../../daywisefmsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="../../daywisefmsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="../../daywisefmsmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="../../daywisefmsmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="../../daywisefmsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="../../daywisefmsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="../../phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="../../phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="../../daywisefmsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="../../phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="../../daywisefmsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="../../phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="../../phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="../../daywisefmsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="../../phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Place</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'daywisefm_place', false, '<?php echo $rf_place; ?>', '<?php echo $rt_place; ?>');return false;" name="x_place<?php echo $cnt[0][0]; ?>" id="x_place<?php echo $cnt[0][0]; ?>"><img src="../../phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Supervisior</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'daywisefm_supervisior', false, '<?php echo $rf_supervisior; ?>', '<?php echo $rt_supervisior; ?>');return false;" name="x_supervisior<?php echo $cnt[0][0]; ?>" id="x_supervisior<?php echo $cnt[0][0]; ?>"><img src="../../phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Farm</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'daywisefm_farm', false, '<?php echo $rf_farm; ?>', '<?php echo $rt_farm; ?>');return false;" name="x_farm<?php echo $cnt[0][0]; ?>" id="x_farm<?php echo $cnt[0][0]; ?>"><img src="../../phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Flock</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'daywisefm_flock', false, '<?php echo $rf_flock; ?>', '<?php echo $rt_flock; ?>');return false;" name="x_flock<?php echo $cnt[0][0]; ?>" id="x_flock<?php echo $cnt[0][0]; ?>"><img src="../../phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Cumulative Feedconsumed
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Cumulative <br />Feedconsumed</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
$query111a = "SELECT sum(quantity) as chicks FROM ims_stocktransfer where aflock = '$x_flock' and towarehouse = '$x_farm' and date = '$x_entrydate' ";
...
$query111a = "SELECT sum(receivedquantity) as chicks FROM pp_sobi where flock = '$x_flock' and warehouse = '$x_farm' and adate = '$x_entrydate' and category = 'Broiler Chicks' ";
$result111a = mysql_query($query111a,$conn1); 
$rowsa = mysql_num_rows($result111a);
if ( $rowsa > 0)
{
...
$query111a = "SELECT sum(quantity) as birds FROM oc_cobi where flock = '$x_flock' and warehouse = '$x_farm' and adate = '$x_entrydate' and category = 'Broiler Birds' ";
$result111a = mysql_query($query111a,$conn1); 
$rowsa = mysql_num_rows($result111a);
if ( $rowsa > 0)
{
...
$b = 0;
$birds = $b;
$query111 = "SELECT sum(quantity) as chicks FROM ims_stocktransfer where aflock = '$x_flock' and towarehouse = '$x_farm' and date <= '$x_entrydate'  ";
$result111 = mysql_query($query111,$conn1); 
$rows = mysql_num_rows($result111);
if ( $rows > 0)
{
  while($row111 = mysql_fetch_assoc($result111))
  {
   $birds = $birds + $row111['chicks'];
  }
...
$query111 = "SELECT sum(receivedquantity) as chicks FROM pp_sobi where flock = '$x_flock' and warehouse = '$x_farm' and adate <= '$x_entrydate' and category = 'Broiler Chicks'  ";
$result111 = mysql_query($query111,$conn1); 
$rows = mysql_num_rows($result111);
if ( $rows > 0)
{
...
$query111b = "SELECT SUM(birds) as birds FROM broiler_birdsale where flock = '$x_flock' and farm = '$x_farm' and date = '$x_entrydate' ORDER BY flock ASC ";
$result111b = mysql_query($query111b,$conn1); 
$rowsb = mysql_num_rows($result111b);
if ( $rowsb > 0)
{
  while($row111b = mysql_fetch_assoc($result111b))
  {
    $birds = $birds - $row111b['birds'];
  }
}
else
{
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$val[2] = $GLOBALS['x_age'];
		$val[3] = $GLOBALS['x_feedtype'];
		$val[4] = $GLOBALS['x_feedconsumed'];
		$val[5] = $GLOBALS['x_mortality'];
		$val[6] = $GLOBALS['x_birds'];
	} else {
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_daywisefm_place"])) {
		LoadSelectionFromSession('place');
	} elseif (@$_SESSION["sel_daywisefm_place"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_place"] = "";
	}

	// Get Supervisior selected values
	if (is_array(@$_SESSION["sel_daywisefm_supervisior"])) {
		LoadSelectionFromSession('supervisior');
	} elseif (@$_SESSION["sel_daywisefm_supervisior"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_supervisior"] = "";
	}

	// Get Farm selected values
	if (is_array(@$_SESSION["sel_daywisefm_farm"])) {
		LoadSelectionFromSession('farm');
	} elseif (@$_SESSION["sel_daywisefm_farm"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_farm"] = "";
	}

	// Get Flock selected values
	if (is_array(@$_SESSION["sel_daywisefm_flock"])) {
		LoadSelectionFromSession('flock');
	} elseif (@$_SESSION["sel_daywisefm_flock"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_flock"] = "";
	}

	// Get Entrydate selected values
	if (is_array(@$_SESSION["sel_daywisefm_entrydate"])) {
		LoadSelectionFromSession('entrydate');
	} elseif (@$_SESSION["sel_daywisefm_entrydate"] == EW_REPORT_INIT_VALUE) { // Select all
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_daywisefm_$parm"] = "";
	$_SESSION["rf_daywisefm_$parm"] = "";
	$_SESSION["rt_daywisefm_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_daywisefm_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_daywisefm_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_daywisefm_$parm"];
}
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_daywisefm_place"] = "";
			$_SESSION["sort_daywisefm_supervisior"] = "";
			$_SESSION["sort_daywisefm_farm"] = "";
			$_SESSION["sort_daywisefm_flock"] = "";
			$_SESSION["sort_daywisefm_entrydate"] = "";
			$_SESSION["sort_daywisefm_age"] = "";
			$_SESSION["sort_daywisefm_feedtype"] = "";
			$_SESSION["sort_daywisefm_feedconsumed"] = "";
			$_SESSION["sort_daywisefm_mortality"] = "";
			$_SESSION["sort_daywisefm_birds"] = "";
		}
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		...
		$_SESSION["sort_daywisefm_entrydate"] = "ASC";
	}
