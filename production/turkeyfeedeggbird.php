...
$EW_REPORT_TABLE_SQL_SELECT = "SELECT Distinct (turkey_consumption.flock), turkey_consumption.wo FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "(turkey_consumption.flock) ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "(turkey_consumption.flock)", TRUE);
...
?>
<?php
$EW_REPORT_FIELD_FLOCK_SQL_SELECT = "SELECT DISTINCT (turkey_consumption.flock) FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_FLOCK_SQL_ORDERBY = "(turkey_consumption.flock)";
?>
<?php
...
<a name="top"></a>
<?php } ?>
<br /><center><strong>Feed Per Egg/Bird Report</strong></center><br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="turkeyfeedeggbird.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="turkeyfeedeggbird.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="turkeyfeedeggbird.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="turkeyfeedeggbird.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<?php if (@$sExport == "") { ?>
<br /><br />
...
<form action="turkeyfeedeggbird.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="turkeyfeedeggbird.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="turkeyfeedeggbird.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="turkeyfeedeggbird.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="turkeyfeedeggbird.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php 
            ...
            include "config.php";
            $q = "select age,date2 from turkey_consumption where flock = '$x_flock' order by date2 DESC "; 
...
<?php
              ...
              $query14 = "SELECT * FROM turkey_flock where flockcode = '$x_flock'";
              ...
              $query14 = "SELECT * FROM ims_itemcodes where cat = 'Turkey Female Feed'";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
              ...
              $query14 = "SELECT * FROM ims_itemcodes where cat = 'Turkey Male Feed'";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
                 $feedtypes = $feedtypes . ",'" . $row14['code'] . "'";
              ...
              $query14 = "SELECT * FROM ims_itemcodes where cat = 'Turkey Eggs'";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
              ...
              $query14 = "SELECT * FROM ims_itemcodes where cat = 'Turkey Hatch Eggs'";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
                 $hatchegg = $row14['code'];
              ...
              $totalfeed = 0;
              $query14 = "SELECT sum(quantity) as 'feed' FROM turkey_consumption where flock = '$x_flock' and itemcode in ($feedtypes)";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
              ...
              $totaleggs = 0;
              $query14 = "SELECT sum(quantity) as 'eggs' FROM turkey_production where flock = '$x_flock' and itemcode in ($eggtypes)";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
              ...
              $totalhatcheggs = 0;
              $query14 = "SELECT sum(quantity) as 'hatcheggs' FROM turkey_production where flock = '$x_flock' and itemcode = '$hatchegg'";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
...
<?php  echo $femaleopening; ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php  echo $maleopening; ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo $totalfeed; ?>
</td>
...
<?php echo $totaleggs + $totalhatcheggs; ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo round($totalfeed/($femaleopening + $maleopening),2); ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo round($totalfeed/$totalhatcheggs,2); ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo round($totalfeed/($totaleggs + $totalhatcheggs),2); ?>
</td>
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_flock"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_flock"], "(turkey_consumption.flock)", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_flock"], $GLOBALS["gb_flock"], $GLOBALS["gi_flock"], $GLOBALS["gq_flock"]);
	}
	return $sWrk;
}
?>
