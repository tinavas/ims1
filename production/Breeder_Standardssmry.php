...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "breeder_standards";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT breeder_standards.breed, breeder_standards.age, breeder_standards.livability, breeder_standards.ffeed, breeder_standards.mfeed, breeder_standards.fweight, breeder_standards.mweight, breeder_standards.eggwt, breeder_standards.productionper, breeder_standards.heggper, breeder_standards.cumhhp, breeder_standards.cumhhe, breeder_standards.eggbird, breeder_standards.hatchper FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
?>
<?php
$EW_REPORT_FIELD_BREED_SQL_SELECT = "SELECT DISTINCT breeder_standards.breed FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_BREED_SQL_ORDERBY = "breeder_standards.breed";
$EW_REPORT_FIELD_AGE_SQL_SELECT = "SELECT DISTINCT breeder_standards.age FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_AGE_SQL_ORDERBY = "breeder_standards.age";
?>
<?php
...
<table align="center" border="0">
          <tr>
            <td style="text-align:center" colspan="2"><strong><font color="#3e3276">Breeder Standards Report</font></strong></td>
          </tr>
        </table>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Breeder_Standardssmry.php?export=html&breed=<?php echo $breed; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="Breeder_Standardssmry.php?export=excel&breed=<?php echo $breed; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="Breeder_Standardssmry.php?export=word&breed=<?php echo $breed; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="Breeder_Standardssmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="Breeder_Standardssmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<?php
  $query = "SELECT distinct(breed) as breed from breeder_standards order by breed";
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_breed"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_breed"], "breeder_standards.breed", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_breed"]);
	}
	if (is_array($GLOBALS["sel_age"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_age"], "breeder_standards.age", EW_REPORT_DATATYPE_NUMBER, $GLOBALS["af_age"]);
	}
	return $sWrk;
}
?>
...
function reloadpage()
{
	...
	document.location = "Breeder_Standardssmry.php?breed=" + breed;
}
</script>