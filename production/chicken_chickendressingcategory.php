...
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">Chicken Dressing Category</font></strong></td>
</tr>
<tr height="5px"></tr>
<tr>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="chicken_chickendressingcategory.php?export=html&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&unit=<?php echo $unit;?> ">Printer Friendly</a>
&nbsp;&nbsp;<a href="chicken_chickendressingcategory.php?export=excel&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&unit=<?php echo $unit;?> ">Export to Excel</a>
&nbsp;&nbsp;<a href="chicken_chickendressingcategory.php?export=word&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?> &unit=<?php echo $unit;?> ">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="chicken_chickendressingcategory.php?cmd=reset&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?> &unit=<?php echo $unit;?> ">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
$ikgs=0;
$okgs=0;
 $query="SELECT distinct(tid) FROM `chicken_chickentransferdressingcategory` $cond ";
$result=mysql_query($query,$conn1);
while($row=mysql_fetch_array($result))
{$count=0;
 $query1 ="SELECT * FROM `chicken_chickentransferdressingcategory` where tid='$row[tid]' ";
$result1=mysql_query($query1,$conn1);
while($row1=mysql_fetch_array($result1))
{$yeild=($row1['kgs']/$row1['weight'])*100;
$query2="select sum(kgs) as opweight from `chicken_chickentransferdressingcategory` where tid='$row[tid]' ";
...
function reloadpage()
{
	...
	document.location = "chicken_chickendressingcategory.php?fromdate=" + fdate + "&todate=" + tdate+"&unit="+units;
}
</script>