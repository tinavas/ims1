...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="lbindiflockshed.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="lbindiflockshed.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="lbindiflockshed.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php
$ceggs = 0;
 $q1 = "select * from layerbreeder_flock where shedcode = '$shed' and client = '$client'";
...
$bweight = 0;
$eweight = 0;
$query1 = "SELECT * FROM layerbreeder_standards where client = '$client' and (age <= $weeks) and breed = '$breed' ORDER BY age ASC ";
$r = mysql_query($query1,$conn1);
while($qr = mysql_fetch_assoc($r))
{
if($qr['age'] == " ")
{
$q = "select * from layerbreeder_flock where shed = '$shed' and client = '$client'";
