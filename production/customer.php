...
<tr>
 <td colspan="2" align="center"><strong><font color="#3e3276">Customer Report</font></strong></td>
</tr>
<tr height="5px"></tr>
</table>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="customer.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="customer.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="customer.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="customer.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<?php } ?>
	...
	<tbody>
<?php 
$q="SELECT name, address, place, phone, mobile, cgroup,id,code FROM  `contactdetails` WHERE TYPE like '%party%' order by cgroup,name";
$r=mysql_query($q);
...
<td class="ewRptGrpField2">
<?php echo ewrpt_ViewValue($a[code]) ?></td> <?php } ?>
