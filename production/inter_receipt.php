...
<tr>
 <td colspan="2" align="center"><strong><font color="#3e3276"><h2>Intermediate Receipt Report</h2></font></strong></td>
</tr>
<tr>
<?php
if($_GET['fdate']!="" )
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;
<a href="inter_receipt.php?export=html&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&wh=<?php echo $wh;?>&cat=<?php echo $cat;?>&code=<?php echo $code;?>&desc=<?php echo $desc;?>&coa=<?php echo $coa;?>">Printer Friendly</a>
&nbsp;&nbsp;
<a href="inter_receipt.php?export=excel&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&wh=<?php echo $wh;?>&cat=<?php echo $cat;?>&code=<?php echo $code;?>&desc=<?php echo $desc;?>&coa=<?php echo $coa;?>">Export to Excel</a>
&nbsp;&nbsp;
<a href="inter_receipt.php?export=word&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&wh=<?php echo $wh;?>&cat=<?php echo $cat;?>&code=<?php echo $code;?>&desc=<?php echo $desc;?>&coa=<?php echo $coa;?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="inter_receipt.php?cmd=reset&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&wh=<?php echo $wh;?>&cat=<?php echo $cat;?>&code=<?php echo $code;?>&desc=<?php echo $desc;?>&coa=<?php echo $coa;?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
{ 
  ...
  $total=0;
  $totalqty=0;
 $query="select date,warehouse,cat,code,description,quantity,rateperunit,amount,coa from ims_intermediatereceipt $cond and riflag='R' order by date,warehouse,cat,code,description";
...
function send()
{
  ...
  document.location="inter_receipt.php?fdate="+fdate+"&tdate="+tdate+"&wh="+wh1+"&cat="+cat1+"&code="+code+"&desc="+desc+"&coa="+coa1;
...
function send1(a)
{
  ...
  document.location="inter_receipt.php?wh="+wh1;
}
...
function load_code(a)
{
  ...
  <?php } ?>
  document.location="inter_receipt.php?desc="+desc+"&code="+document.getElementById("code").value+"&fdate="+fdate+"&tdate="+tdate+"&wh="+wh1+"&cat="+cat1+"&coa="+coa1;
}
