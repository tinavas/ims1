...
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">Ageing Analysis(All)</font></strong></td>
</tr>
<tr>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="vendorageingall.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="vendorageingall.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="vendorageingall.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
$onacctot = 0;
$grandtot = 0;
  $q111 = "select * from contactdetails where type = 'party' or type = 'vendor and party' order by name ";
	$qrs111 = mysql_query($q111,$conn1) ;
...
$eibal = 0;
	 ...
	 $q = "select adate,finaltotal,invoice from oc_cobi where party = '$ven' and adate <= '$tdate' group by invoice order by invoice  ";
	...
	while($qr = mysql_fetch_assoc($qrs))
	{
	  ...
	  { 
		 ...
		 {
		    $amountpaid = $amountpaid + $row111['sum(sourceamount)'];
		 }
...
<td align="right">
<?php if($onaccpay <> "") { echo ewrpt_ViewValue(changeprice($onaccpay)); $onacctot = $onacctot + $onaccpay; } else { echo ewrpt_ViewValue("0.00"); } ?>
</td>
<td align="right">
<?php echo ewrpt_ViewValue(changeprice($sumbal - $onaccpay)); $grandtot = $grandtot + $sumbal - $onaccpay;  ?>
</td>
...
<td align="right">
<?php echo ewrpt_ViewValue(changeprice($nutotal)); 
 ?>
</td>
		<td align="right">
<?php echo ewrpt_ViewValue(changeprice($thtotal));  ?>
</td>
<td align="right">
<?php echo ewrpt_ViewValue(changeprice($sitotal));  ?>
</td>
<td align="right">
<?php echo ewrpt_ViewValue(changeprice($nitotal)); ?>
</td>
<td align="right">
<?php echo ewrpt_ViewValue(changeprice($twtotal));  ?>
</td>
<td align="right">
<?php echo ewrpt_ViewValue(changeprice($fitotal));  ?>
</td>
<td align="right">
<?php echo ewrpt_ViewValue(changeprice($eitotal));?>
</td>
<td align="right">
