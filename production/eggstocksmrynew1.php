...
<?php
$q = "select distinct(unitcode) from layer_unit order by unitcode";
$qrs = mysql_query($q,$conn1);
$n1 = mysql_num_rows($qrs);
while($qr = mysql_fetch_assoc($qrs))
{
...
&nbsp;&nbsp;&nbsp;
Type&nbsp;
<select id="etypr" name="etype" onChange="reloadpage();">
<option value="">-Select-</option>
<?php
...
{
?>
<option  value="<?php echo $qr1['d']; ?>" <?php if($etype == $qr['d']) { ?> selected="selected" <?php } ?> ><?php echo $qr1['d']; ?></option>
<?php } ?>
</select>
&nbsp;&nbsp;&nbsp;
From Date&nbsp;
