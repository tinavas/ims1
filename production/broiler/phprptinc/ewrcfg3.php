...
define("EW_REPORT_CONN_USER", "poultry", TRUE);
define("EW_REPORT_CONN_PASS", "4(vQLs+#-b", TRUE);
define("EW_REPORT_CONN_DB", $_SESSION['db'], TRUE);
...
define("EW_REPORT_RANDOM_KEY", 'vGOMT0ioTx7b#y87', TRUE); // Random key for encryption
...
define("EW_REPORT_PROJECT_NAME", "project9", TRUE); // Project Name
define("EW_REPORT_PROJECT_VAR", "project9", TRUE); // Project Name
