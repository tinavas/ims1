	   ...
	   if($_SESSION['db'] == "feedatives")
		{
		   ...
		   $EW_REPORT_TABLE_SQL_WHERE = "broiler_daily_entry.place = '$sectorr'";
		   }
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="broilerfeedmortality.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="broilerfeedmortality.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="broilerfeedmortality.php?export=word">Export to Word</a>
...
else
{
 ...
 $feedtype = "";
 $feeddesc = "";
  $query111 = "SELECT feedtype from broiler_daily_entry where place = '$x_place' and flock = '$x_flock' and farm = '$x_farm' and supervisior = '$x_supervisior' and entrydate = '$x_entrydate'  ";  $result111 = mysql_query($query111,$conn1);   $rows = mysql_num_rows($result111);
  if ( $rows > 0) {  while($row111 = mysql_fetch_assoc($result111))  {   $feedtype = $row111['feedtype'];  } }
  $query111 = "SELECT description from ims_itemcodes where code = '$feedtype'  ";  $result111 = mysql_query($query111,$conn1);   $rows = mysql_num_rows($result111);
