...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Broiler Feed Consumed And Mortality</font></strong></td>
</tr>
<tr>
...
&nbsp;&nbsp;<a href="broilerfeedmortality.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="broilerfeedmortality.php" name="ewpagerform" id="ewpagerform" class="ewForm">
<table>
 <tr>
 <td>From Date </td>
...
<!--first page button-->
	...
	<td><a href="broilerfeedmortality.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="broilerfeedmortality.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="broilerfeedmortality.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="broilerfeedmortality.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Supervisor</td>
			<td align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'broilersmry_supervisior', false, '<?php echo $rf_UserName; ?>', '<?php echo $rt_UserName; ?>');return false;" name="x_UserName<?php echo $cnt[0][0]; ?>" id="x_UserName<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Farmer</td>
			<td  align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'broilersmry_farm', false, '<?php echo $rf_Farm_Name; ?>', '<?php echo $rt_Farm_Name; ?>');return false;" name="x_Farm_Name<?php echo $cnt[0][0]; ?>" id="x_Farm_Name<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Flock</td>
			<td  align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'broilersmry_flock', false, '<?php echo $rf_flock; ?>', '<?php echo $rt_flock; ?>');return false;" name="x_flock<?php echo $cnt[0][0]; ?>" id="x_flock<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Entrydate</td>
			<td  align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'broilersmry_entrydate', true, '<?php echo $rf_entrydate; ?>', '<?php echo $rt_entrydate; ?>');return false;" name="x_entrydate<?php echo $cnt[0][0]; ?>" id="x_entrydate<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Average Weight">Birds</td>
			</tr></table>
		</td>
<?php } ?>
...
$sentbirds = 0;
$sentweight = 0;
$queryaa = "SELECT entrytype,phoneno,updated FROM broiler_daily_entry WHERE flock = '$x_flock' and entrydate = '$x_entrydate'";
...
$feedtype = "";
 $feeddesc = "";
  $query111 = "SELECT feedtype from broiler_daily_entry where place = '$x_place' and flock = '$x_flock' and farm = '$x_farm' and supervisior = '$x_supervisior' and entrydate = '$x_entrydate'  ";  $result111 = mysql_query($query111,$conn1);   
  $rows = mysql_num_rows($result111);
  if ( $rows > 0) {
    while($row111 = mysql_fetch_assoc($result111))  
	{ $feedtype = $row111['feedtype'];  } 
	}
  $query111 = "SELECT description from ims_itemcodes where code = '$feedtype'  ";  
  $result111 = mysql_query($query111,$conn1);   
  $rows = mysql_num_rows($result111);
  if ( $rows > 0) { 
   while($row111 = mysql_fetch_assoc($result111))  {   $feeddesc = $row111['description'];  } }
...
<?php echo $mortcumm ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo round(($mortcumm / ($mortcumm + $birds)) * 100,2) ?>
</td>
<?php 
if($_SESSION['db'] == 'central')
{?>
...
<?php echo $cummfeed; ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo $birds-$previousbirdssent;
?>
</td>
...
?>
	...
	<!--<tr>
		...
		<td colspan="4" class="ewRptGrpSummary4">SUM for Flock:<?php echo ewrpt_ViewValue($x_flock) ?><?php $x_flock = $t_flock; $previousbirdssent = 0; ?> </td>
...
?>
	...
	<!--<tr>
		<td colspan="4" class="ewRptGrpSummary1">SUM for Place:<?php echo ewrpt_ViewValue($x_place) ?></td>
...
document.location = 'broilerfeedmortality.php?flocktype=' + type + '&export=' + a + '&fromdate=' + fdate + '&todate=' + tdate;
}
</script>
