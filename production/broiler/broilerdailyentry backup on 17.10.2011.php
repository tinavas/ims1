...
$EW_REPORT_TABLE_SQL_WHERE = "broiler_daily_entry.place $pc '$place' and broiler_daily_entry.supervisior $sc '$supervisor' and broiler_daily_entry.farm $fc '$farm' and broiler_daily_entry.flock $flc '$flock' ";
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="broilerdailyentry.php?export=html&place=<?php echo $place; ?>&supervisor=<?php echo $supervisor; ?>&farm=<?php echo $farm; ?>&flock=<?php echo $flock; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="broilerdailyentry.php?export=excel&place=<?php echo $place; ?>&supervisor=<?php echo $supervisor; ?>&farm=<?php echo $farm; ?>&flock=<?php echo $flock; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="broilerdailyentry.php?export=word&place=<?php echo $place; ?>&supervisor=<?php echo $supervisor; ?>&farm=<?php echo $farm; ?>&flock=<?php echo $flock; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="broilerdailyentry.php?cmd=reset&place=<?php echo $place; ?>&supervisor=<?php echo $supervisor; ?>&farm=<?php echo $farm; ?>&flock=<?php echo $flock; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
function reloadpage()
{
	...
	document.location = "broilerdailyentry.php?place=" + place + "&supervisor=" + supervisor + "&farm=" + farm + "&flock=" + flock ;
}
