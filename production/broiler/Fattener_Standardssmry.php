...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "quail_broiler_allstandards";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT quail_broiler_allstandards.age, quail_broiler_allstandards.avgweight, quail_broiler_allstandards.fcr, quail_broiler_allstandards.feed, quail_broiler_allstandards.cumfeed,quail_broiler_allstandards.breed FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "quail_broiler_allstandards.breed = '$breed'";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "quail_broiler_allstandards.age";
...
?>
<?php
$EW_REPORT_FIELD_AGE_SQL_SELECT = "SELECT DISTINCT quail_broiler_allstandards.age FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_AGE_SQL_ORDERBY = "quail_broiler_allstandards.age";
?>
<?php
...
<tr>
<td ><strong><font color="#3e3276">Fattener Standards</font></strong></td>
</tr>
</table>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Fattener_Standardssmry.php?export=html&breed=<?php echo $breed; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="Fattener_Standardssmry.php?export=excel&breed=<?php echo $breed; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="Fattener_Standardssmry.php?export=word&breed=<?php echo $breed; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="Fattener_Standardssmry.php?cmd=reset&breed=<?php echo $breed; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="Fattener_Standardssmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<?php
 $query = "SELECT distinct(breed) as breed from quail_broiler_allstandards where breed <> '' order by breed";
...
<!--first page button-->
	...
	<td><a href="Fattener_Standardssmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="Fattener_Standardssmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="Fattener_Standardssmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="Fattener_Standardssmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_age"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_age"], "quail_broiler_allstandards.age", EW_REPORT_DATATYPE_NUMBER, $GLOBALS["af_age"]);
	}
	return $sWrk;
}
?>
...
function reloadpage()
{
document.location='Fattener_Standardssmry.php?breed=' + document.getElementById('breed').value;
}
</script>'
