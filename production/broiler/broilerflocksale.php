...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="broilerflocksale.php?export=html&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="broilerflocksale.php?export=excel&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="broilerflocksale.php?export=word&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Export to Word</a>
...
document.location = 'broilerflocksale.php?export=' + a + '&fromdate=' + fdate + '&todate=' + tdate;
}
</script>