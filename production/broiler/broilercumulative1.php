...
$EW_REPORT_TABLE_SQL_ORDERBY = "broiler_daily_entry.age DESC,broiler_daily_entry.supervisior ASC,broiler_daily_entry.place ASC, broiler_daily_entry.farm ASC";
...
$bodywtstd = 0;
 ...
 $query1 = "SELECT max(entrydate) as maxdate,max(age) as maxage,max(average_weight) as maxwt,sum(mortality) as totmort,sum(feedconsumed) as feedcons FROM broiler_daily_entry WHERE place = '$x_place' AND supervisior = '$x_supervisior' AND farm = '$x_farm' AND flock = '$x_flock' ";
