...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Broiler Medicine & Vaccine Transfer</font></strong></td>
</tr>
<tr>
...
if($_SESSION['db'] == "feedatives")
{
   ...
   {
	$EW_REPORT_TABLE_SQL_WHERE = "(ims_stocktransfer.cat = 'Vaccines' or ims_stocktransfer.cat = 'Medicines') and ims_stocktransfer.date >= '$fromdate' and ims_stocktransfer.date <= '$todate'";
   }
   else
   { 
   $sectorr = $_SESSION['sectorr'];
   $EW_REPORT_TABLE_SQL_WHERE = "(ims_stocktransfer.cat = 'Vaccines' or ims_stocktransfer.cat = 'Medicines') and ims_stocktransfer.date >= '$fromdate' and ims_stocktransfer.date <= '$todate' AND (ims_stocktransfer.towarehouse IN (select distinct(broiler_farm.farm) from broiler_farm where broiler_farm.place = '$sectorr' and broiler_farm.type <> 'rental'))";
   }   
 }
else
{
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="medicinetransfer.php?export=html&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="medicinetransfer.php?export=excel&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="medicinetransfer.php?export=word&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="medicinetransfer.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="medicinetransfer.php" name="ewpagerform" id="ewpagerform" class="ewForm">
<table>
 <tr>
 <td>From Date </td>
...
<!--first page button-->
	...
	<td><a href="medicinetransfer.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="medicinetransfer.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="medicinetransfer.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="medicinetransfer.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
?>
	<!--<tr>
		...
		<td colspan="9" class="ewRptGrpSummary2">Summary for Fromwarehouse: <?php $t_fromwarehouse = $x_fromwarehouse; $x_fromwarehouse = $o_fromwarehouse; ?>
<?php echo ewrpt_ViewValue($x_fromwarehouse) ?>
<?php $x_fromwarehouse = $t_fromwarehouse; ?> (<?php echo ewrpt_FormatNumber($cnt[2][0],0,-2,-2,-2); ?> Detail Records)</td></tr>
	<tr>
		<td class="ewRptGrpField1">&nbsp;</td>
...
?>
	<!--<tr>
		<td colspan="10" class="ewRptGrpSummary1">Summary for Date: <?php $t_date = $x_date; $x_date = $o_date; ?>
...
document.location = 'medicinetransfer.php?export=' + a + '&fromdate=' + fdate + '&todate=' + tdate;
}
</script>