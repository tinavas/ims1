...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Broiler Feed Return</font></strong></td>
</tr>
<tr>
...
if($_SESSION['db'] == "feedatives")
{
   ...
   {
	$EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.fromwarehouse not in (select tbl_sector.type from tbl_sector where type1 = 'Feedmill') and ims_stocktransfer.cat = 'Broiler Feed' and ims_stocktransfer.date >= '$fromdate' and ims_stocktransfer.date <= '$todate'";
   }
   else
   { 
   $sectorr = $_SESSION['sectorr'];
 $EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.fromwarehouse not in (select tbl_sector.type from tbl_sector where type1 = 'Feedmill') and ims_stocktransfer.cat = 'Broiler Feed' and ims_stocktransfer.date >= '$fromdate' and ims_stocktransfer.date <= '$todate' AND (ims_stocktransfer.towarehouse IN (select distinct(broiler_farm.farm) from broiler_farm where broiler_farm.place = '$sectorr' and broiler_farm.type <> 'rental'))";
   }   
 }
else
{
...
$EW_REPORT_TABLE_SQL_GROUPBY = "ims_stocktransfer.tmno";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "ims_stocktransfer.fromwarehouse ASC, ims_stocktransfer.towarehouse ASC, ims_stocktransfer.code ASC, ims_stocktransfer.date ASC";
...
$EW_REPORT_TABLE_SQL_SELECT_AGG = "SELECT SUM(ims_stocktransfer.quantity) AS SUM_quantity, SUM(`(ims_stocktransfer.quantity * ims_stocktransfer.price )`) AS SUM_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
$af_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = NULL; // Popup filter for (ims_stocktransfer.quantity * ims_stocktransfer.price )
?>
<?php
...
$x_quantity = NULL;
$x_price = NULL;
$x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = NULL;
...
$o_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = NULL; $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = NULL; $ft_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = 5; $rf_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = NULL; $rt_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = NULL;
?>
<?php
...
$col = array(FALSE, FALSE, TRUE, FALSE, TRUE);
...
ewrpt_CreatePopup("Report1_tmno", [<?php echo $jsdata ?>]);
</script>
...
<div id="Report1_tmno_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="broilerfeedreturn.php?export=html&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="broilerfeedreturn.php?export=excel&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="broilerfeedreturn.php?export=word&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="broilerfeedreturn.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="broilerfeedreturn.php" name="ewpagerform" id="ewpagerform" class="ewForm">
<table>
 <tr>
 <td>From Date </td>
...
<!--first page button-->
	...
	<td><a href="broilerfeedreturn.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="broilerfeedreturn.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="broilerfeedreturn.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="broilerfeedreturn.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Tmno</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'Report1_tmno', false, '<?php echo $rf_tmno; ?>', '<?php echo $rt_tmno; ?>');return false;" name="x_tmno<?php echo $cnt[0][0]; ?>" id="x_tmno<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php echo ewrpt_ViewValue($x_towarehouse) ?>
	...
	<?php
	$desc = "";
		 $query = "SELECT description FROM ims_itemcodes where code = '$x_code' ";
...
<?php echo ewrpt_ViewValue($x_code."/".$desc); ?>
...
<?php echo ewrpt_ViewValue($x_price) ?>
		...
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29) ?>
</td>
	</tr>
<?php
...
?>
	<!--<tr>
		...
		<td colspan="6" class="ewRptGrpSummary3">Summary for Code: <?php $t_code = $x_code; $x_code = $o_code; ?>
<?php echo ewrpt_ViewValue($x_code) ?>
<?php $x_code = $t_code; ?> (<?php echo ewrpt_FormatNumber($cnt[3][0],0,-2,-2,-2); ?> Detail Records)</td></tr>
	<tr>
		<td class="ewRptGrpField1">&nbsp;</td>
		<td class="ewRptGrpField2">&nbsp;</td>
...
<?php echo ewrpt_ViewValue($x_quantity) ?>
		...
		<td class="ewRptGrpSummary3">&nbsp;</td>
		<td class="ewRptGrpSummary3" align="right">
		<?php $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29; ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = $smry[3][4]; // Load SUM ?>
<?php echo ewrpt_ViewValue($x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29) ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29; ?>
		</td>
	</tr>-->
<?php
...
?>
	<!--<tr>
		<td colspan="8" class="ewRptGrpSummary1">Summary for Fromwarehouse: <?php $t_fromwarehouse = $x_fromwarehouse; $x_fromwarehouse = $o_fromwarehouse; ?>
<?php echo ewrpt_ViewValue($x_fromwarehouse) ?>
<?php $x_fromwarehouse = $t_fromwarehouse; ?> (<?php echo ewrpt_FormatNumber($cnt[1][0],0,-2,-2,-2); ?> Detail Records)</td></tr>
	<tr>
...
<?php echo ewrpt_ViewValue($x_quantity) ?>
		...
		<td class="ewRptGrpSummary1" align="right">
		<?php $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29; ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = $smry[1][4]; // Load SUM ?>
<?php echo ewrpt_ViewValue($x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29) ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29; ?>
		</td>
	</tr>-->
...
<?php
	...
	if ($rsagg) {
		...
		$grandsmry[4] = $rsagg->fields("SUM_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29");
	}
	else {
...
<?php echo ewrpt_ViewValue($x_quantity) ?>
		...
		<td align="right">
		<?php $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29; ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = $grandsmry[4]; // Load SUM ?>
<?php echo ewrpt_ViewValue($x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29) ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29 = $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29; ?>
		</td>
	</tr>
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$GLOBALS['x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29'] = $rs->fields('(ims_stocktransfer.quantity * ims_stocktransfer.price )');
		$val[1] = $GLOBALS['x_tmno'];
		$val[2] = $GLOBALS['x_quantity'];
		$val[3] = $GLOBALS['x_price'];
		$val[4] = $GLOBALS['x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29'];
	} else {
		...
		$GLOBALS['x_quantity'] = "";
		$GLOBALS['x_price'] = "";
		$GLOBALS['x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29'] = "";
	}
}
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_Report1_tmno"])) {
		LoadSelectionFromSession('tmno');
	} elseif (@$_SESSION["sel_Report1_tmno"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_tmno"] = "";
	}
}
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_Report1_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice_29"] = "";
		}
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] = "ims_stocktransfer.tmno ASC";
		$_SESSION["sort_Report1_tmno"] = "ASC";
	}
...
document.location = 'broilerfeedreturn.php?export=' + a + '&fromdate=' + fdate + '&todate=' + tdate;
}
</script>