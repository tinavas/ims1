...
$EW_REPORT_TABLE_SQL_WHERE = "broiler_daily_entry.cullflag = 1";
...
<?php } ?>
<center>
<h5>Tentative Chick Placement Report</h5>
<?php if (@$sExport <> "") { ?>
<span >
...
<option value="ALL"<?php if (@$_SESSION[EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE] == -1) echo " selected" ?>>All</option>
		...
		</td><td>&nbsp;Cull Age&nbsp;<input type="text" id="cullage" name="cullage" style="width:50px" value="<?php if($_GET['cullage']) echo $_GET['cullage']; else echo "0"; ?>" />&nbsp;</td>
...
document.location = 'tentativechickstransfersmry.php?&cullage=' + document.getElementById("cullage").value + '&gapdays=' + document.getElementById("gapdays").value + '&flocktyp=' + document.getElementById('flock').value;
}
...
<?php echo ewrpt_ViewValue($x_flock) ?>
		...
		<td align="center" <?php echo $sItemRowClass;?>><?php echo date("d-m-Y",strtotime($details['date'])); ?></td>
		<td align="center" <?php echo $sItemRowClass;?>><?php
		if($_GET['cullage'])
		{
		$dateseconds = strtotime($details['date']);
		$dateseconds += $cullseconds;
		echo date("d-m-Y",$dateseconds); 
		}
		else
		echo "&nbsp;";
		 ?></td>
...
document.location = 'tentativechickstransfersmry.php?flocktype=' + type + '&export=' + a + '&cullage=' + document.getElementById("cullage").value + '&gapdays=' + document.getElementById("gapdays").value;
}
</script>