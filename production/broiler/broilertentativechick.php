...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Gap Days</font></strong></td>
</tr>
...
<center>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="broilertentativechick.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="broilertentativechick.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="broilertentativechick.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="broilertentativechick.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="broilertentativechick.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="broilertentativechick.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="broilertentativechick.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="broilertentativechick.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="broilertentativechick.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Supervisior</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'Report1_supervisior', false, '<?php echo $rf_supervisior; ?>', '<?php echo $rt_supervisior; ?>');return false;" name="x_supervisior<?php echo $cnt[0][0]; ?>" id="x_supervisior<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
$gap = "";
$nxtdate = "";
 $query1 = "SELECT max(entrydate) as maxdate,min(entrydate) as mindate,max(age) as maxage,max(cullflag) as cullflag FROM broiler_daily_entry WHERE place = '$x_place' AND supervisior = '$x_supervisior' AND farm = '$x_farm' AND flock = '$x_flock' ";
	 $result1 = mysql_query($query1,$conn1);
	 while($row1 = mysql_fetch_assoc($result1))
	 {
	   $age = $row1['maxage'];
	   $startdate = date("d-m-Y",strtotime($row1['mindate']));
	   if($row1['cullflag'] == "1")
	   {
	   $enddate = date("d-m-Y",strtotime($row1['maxdate']));
	   $query11 = "SELECT entrydate FROM broiler_daily_entry WHERE place = '$x_place' AND supervisior = '$x_supervisior' AND farm = '$x_farm'  and entrydate > '$row1[maxdate]' order by entrydate DESC ";
	 $result11 = mysql_query($query11,$conn1);
	 
	 while($row11 = mysql_fetch_assoc($result11))
	 {
	   $nxtdate = $row11['entrydate'];
	 }
	 if($nxtdate == "")
	 {
	 $gap = "Flock Awaiting";
	 ...
	 {
	 $gap = strtotime($nxtdate) - strtotime($row1['maxdate']);
	 $gap = $gap/(60 * 60 * 24);
	 }
...
<td<?php echo $sItemRowClass; ?>>
<?php if(date("d.m.Y",strtotime($startdate)) <> "01.01.1970") echo ewrpt_ViewValue(date($datephp,strtotime($startdate))); else echo ewrpt_ViewValue(); ?>
</td>
<td<?php echo $sItemRowClass; ?>>
