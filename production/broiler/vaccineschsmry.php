...
define("EW_REPORT_TABLE_VAR", "Vaccination_Schedule", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "Vaccination_Schedule_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "Vaccination_Schedule_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "Vaccination_Schedule_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "Vaccination_Schedule_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "Vaccination_Schedule_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "broiler_daily_entry Inner Join vaccination On broiler_daily_entry.farm = vaccination.farmer And broiler_daily_entry.flock = vaccination.flock";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT Distinct (broiler_daily_entry.farm), broiler_daily_entry.place, broiler_daily_entry.supervisior, vaccination.vaccination, vaccination.age, broiler_daily_entry.flock FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "broiler_daily_entry.place ASC, broiler_daily_entry.supervisior ASC, (broiler_daily_entry.farm) ASC, (broiler_daily_entry.flock) ASC, (vaccination.age) ASC";
...
$af_vaccination = NULL; // Popup filter for vaccination
...
$EW_REPORT_FIELD_VACCINATION_SQL_SELECT = "SELECT DISTINCT vaccination.vaccination FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_VACCINATION_SQL_ORDERBY = "vaccination.vaccination";
$EW_REPORT_FIELD_AGE_SQL_SELECT = "SELECT DISTINCT vaccination.age FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_AGE_SQL_ORDERBY = "vaccination.age";
...
// Detail variables
$o_vaccination = NULL; $t_vaccination = NULL; $ft_vaccination = 200; $rf_vaccination = NULL; $rt_vaccination = NULL;
$o_age = NULL; $t_age = NULL; $ft_age = 200; $rf_age = NULL; $rt_age = NULL;
...
ewrpt_CreatePopup("Vaccination_Schedule_place", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_supervisior, $sel_supervisior, $ft_supervisior) ?>
ewrpt_CreatePopup("Vaccination_Schedule_supervisior", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_farm, $sel_farm, $ft_farm) ?>
ewrpt_CreatePopup("Vaccination_Schedule_farm", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_vaccination, $sel_vaccination, $ft_vaccination) ?>
ewrpt_CreatePopup("Vaccination_Schedule_vaccination", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_age, $sel_age, $ft_age) ?>
ewrpt_CreatePopup("Vaccination_Schedule_age", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_flock, $sel_flock, $ft_flock) ?>
ewrpt_CreatePopup("Vaccination_Schedule_flock", [<?php echo $jsdata ?>]);
</script>
<div id="Vaccination_Schedule_place_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="Vaccination_Schedule_supervisior_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="Vaccination_Schedule_farm_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="Vaccination_Schedule_vaccination_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="Vaccination_Schedule_age_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="Vaccination_Schedule_flock_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="vaccineschsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="vaccineschsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="vaccineschsmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="vaccineschsmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="vaccineschsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="vaccineschsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="vaccineschsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="vaccineschsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="vaccineschsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Place</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'Vaccination_Schedule_place', false, '<?php echo $rf_place; ?>', '<?php echo $rt_place; ?>');return false;" name="x_place<?php echo $cnt[0][0]; ?>" id="x_place<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Supervisior</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'Vaccination_Schedule_supervisior', false, '<?php echo $rf_supervisior; ?>', '<?php echo $rt_supervisior; ?>');return false;" name="x_supervisior<?php echo $cnt[0][0]; ?>" id="x_supervisior<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Farm</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'Vaccination_Schedule_farm', false, '<?php echo $rf_farm; ?>', '<?php echo $rt_farm; ?>');return false;" name="x_farm<?php echo $cnt[0][0]; ?>" id="x_farm<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Flock</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'Vaccination_Schedule_flock', false, '<?php echo $rf_flock; ?>', '<?php echo $rt_flock; ?>');return false;" name="x_flock<?php echo $cnt[0][0]; ?>" id="x_flock<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Age</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'Vaccination_Schedule_age', false, '<?php echo $rf_age; ?>', '<?php echo $rt_age; ?>');return false;" name="x_age<?php echo $cnt[0][0]; ?>" id="x_age<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Vaccine Name</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'Vaccination_Schedule_vaccination', false, '<?php echo $rf_vaccination; ?>', '<?php echo $rt_vaccination; ?>');return false;" name="x_vaccination<?php echo $cnt[0][0]; ?>" id="x_vaccination<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php echo ewrpt_ViewValue($x_age) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_vaccination) ?>
</td>

<?php

 include "../config.php";
 $query1 = "SELECT min(age) as age,min(entrydate) as entrydate FROM broiler_daily_entry where farm = '$x_farm' and flock = '$x_flock' ORDER BY farm ASC ";
 $result1 = mysql_query($query1,$conn1);
 while($row1 = mysql_fetch_assoc($result1))
 {
    $age = $row1['age'];
    $olddate = $row1['entrydate'];
    $date = dateadd($olddate,$x_age);
 }
?>
		<td<?php echo $sItemRowClass; ?>>
...
function SetupPopup() {
	...
	// Build distinct values for vaccination
	$bNullValue = FALSE;
	$bEmptyValue = FALSE;
	$sSql = ewrpt_BuildReportSql($GLOBALS["EW_REPORT_FIELD_VACCINATION_SQL_SELECT"], $GLOBALS["EW_REPORT_TABLE_SQL_WHERE"], $GLOBALS["EW_REPORT_TABLE_SQL_GROUPBY"], $GLOBALS["EW_REPORT_TABLE_SQL_HAVING"], $GLOBALS["EW_REPORT_FIELD_VACCINATION_SQL_ORDERBY"], $sFilter, "");
	$rswrk = $conn->Execute($sSql);
	while ($rswrk && !$rswrk->EOF) {
		$x_vaccination = $rswrk->fields[0];
		if (is_null($x_vaccination)) {
			$bNullValue = TRUE;
		} elseif ($x_vaccination == "") {
			$bEmptyValue = TRUE;
		} else {
			$t_vaccination = $x_vaccination;
			ewrpt_SetupDistinctValues($GLOBALS["val_vaccination"], $x_vaccination, $t_vaccination, FALSE);
		}
		$rswrk->MoveNext();
	}
	if ($rswrk)
		$rswrk->Close();
	if ($bEmptyValue)
		ewrpt_SetupDistinctValues($GLOBALS["val_vaccination"], EW_REPORT_EMPTY_VALUE, EW_REPORT_EMPTY_LABEL, FALSE);
	if ($bNullValue)
		ewrpt_SetupDistinctValues($GLOBALS["val_vaccination"], EW_REPORT_NULL_VALUE, EW_REPORT_NULL_LABEL, FALSE);
	...
	// Get 'reset' command
		...
		if (strtolower($sCmd) == "reset") {
			...
			ClearSessionSelection('vaccination');
	...
	if (is_array(@$_SESSION["sel_Vaccination_Schedule_place"])) {
		LoadSelectionFromSession('place');
	} elseif (@$_SESSION["sel_Vaccination_Schedule_place"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_place"] = "";
	}

	// Get Supervisior selected values
	if (is_array(@$_SESSION["sel_Vaccination_Schedule_supervisior"])) {
		LoadSelectionFromSession('supervisior');
	} elseif (@$_SESSION["sel_Vaccination_Schedule_supervisior"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_supervisior"] = "";
	}

	// Get Farm selected values
	if (is_array(@$_SESSION["sel_Vaccination_Schedule_farm"])) {
		LoadSelectionFromSession('farm');
	} elseif (@$_SESSION["sel_Vaccination_Schedule_farm"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_farm"] = "";
	}

	// Get Vaccination selected values
	if (is_array(@$_SESSION["sel_Vaccination_Schedule_vaccination"])) {
		LoadSelectionFromSession('vaccination');
	} elseif (@$_SESSION["sel_Vaccination_Schedule_vaccination"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_vaccination"] = "";
	}

	// Get Age selected values
	if (is_array(@$_SESSION["sel_Vaccination_Schedule_age"])) {
		LoadSelectionFromSession('age');
	} elseif (@$_SESSION["sel_Vaccination_Schedule_age"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_age"] = "";
	}

	// Get Flock selected values
	if (is_array(@$_SESSION["sel_Vaccination_Schedule_flock"])) {
		LoadSelectionFromSession('flock');
	} elseif (@$_SESSION["sel_Vaccination_Schedule_flock"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_flock"] = "";
	}
}
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_Vaccination_Schedule_$parm"] = "";
	$_SESSION["rf_Vaccination_Schedule_$parm"] = "";
	$_SESSION["rt_Vaccination_Schedule_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_Vaccination_Schedule_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_Vaccination_Schedule_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_Vaccination_Schedule_$parm"];
}
...
function LoadDefaultFilters() {
	...
	*/
	...
	// Field vaccination
	// Setup your default values for the popup filter below, e.g.
	// $seld_vaccination = array("val1", "val2");

	$GLOBALS["seld_vaccination"] = "";
	$GLOBALS["sel_vaccination"] =  $GLOBALS["seld_vaccination"];
...
function CheckFilter() {
	...
	// Check vaccination popup filter
	if (!ewrpt_MatchedArray($GLOBALS["seld_vaccination"], $GLOBALS["sel_vaccination"]))
		return TRUE;
...
function ShowFilterList() {
	...
	$sExtWrk = "";
	$sWrk = "";
	if (is_array($GLOBALS["sel_vaccination"]))
		$sWrk = ewrpt_JoinArray($GLOBALS["sel_vaccination"], ", ", EW_REPORT_DATATYPE_STRING);
	if ($sExtWrk <> "" || $sWrk <> "")
		$sFilterList .= "Vaccination<br />";
	if ($sExtWrk <> "")
		$sFilterList .= "&nbsp;&nbsp;$sExtWrk<br />";
	if ($sWrk <> "")
		$sFilterList .= "&nbsp;&nbsp;$sWrk<br />";
	...
	if (is_array($GLOBALS["sel_age"]))
		$sWrk = ewrpt_JoinArray($GLOBALS["sel_age"], ", ", EW_REPORT_DATATYPE_STRING);
	if ($sExtWrk <> "" || $sWrk <> "")
		$sFilterList .= "Age<br />";
	if ($sExtWrk <> "")
		$sFilterList .= "&nbsp;&nbsp;$sExtWrk<br />";
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_vaccination"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_vaccination"], "vaccination.vaccination", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_vaccination"]);
	}
	if (is_array($GLOBALS["sel_age"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_age"], "vaccination.age", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_age"]);
	}
	if (is_array($GLOBALS["sel_flock"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_Vaccination_Schedule_place"] = "";
			$_SESSION["sort_Vaccination_Schedule_supervisior"] = "";
			$_SESSION["sort_Vaccination_Schedule_farm"] = "";
			$_SESSION["sort_Vaccination_Schedule_vaccination"] = "";
			$_SESSION["sort_Vaccination_Schedule_age"] = "";
			$_SESSION["sort_Vaccination_Schedule_flock"] = "";
		}
