...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Broiler Feed Issue</font></strong></td>
</tr>
<tr>
...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "ims_stocktransfer, tbl_sector";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT ims_stocktransfer.fromwarehouse, ims_stocktransfer.towarehouse, ims_stocktransfer.code, ims_stocktransfer.date, ims_stocktransfer.tmno, ims_stocktransfer.quantity, ims_stocktransfer.price, (ims_stocktransfer.quantity * ims_stocktransfer.price) FROM " . $EW_REPORT_TABLE_SQL_FROM;

if($_SESSION['db'] == "feedatives")
{
   if($_SESSION['sectorr'] == "all")
   {
	$EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.fromwarehouse In (Select tbl_sector.type From tbl_sector Where (tbl_sector.type1 = 'Feedmill' or tbl_sector.type1 = 'Warehouse')) And ims_stocktransfer.cat = 'Broiler Feed' and ims_stocktransfer.date >= '$fromdate' and ims_stocktransfer.date <= '$todate'";

   }
   else
   { 
   $sectorr = $_SESSION['sectorr'];
   $EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.fromwarehouse In (Select tbl_sector.type From tbl_sector Where (tbl_sector.type1 = 'Feedmill' or tbl_sector.type1 = 'Warehouse')) And ims_stocktransfer.cat = 'Broiler Feed' and ims_stocktransfer.date >= '$fromdate' and ims_stocktransfer.date <= '$todate' AND (ims_stocktransfer.towarehouse IN (select distinct(broiler_farm.farm) from broiler_farm where broiler_farm.place = '$sectorr' and broiler_farm.type <> 'rental'))";
   }   
 }
else
{
   $EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.fromwarehouse In (Select tbl_sector.sector From tbl_sector Where (tbl_sector.type1 = 'Feedmill' or tbl_sector.type1 = 'Warehouse')) And ims_stocktransfer.cat = 'Broiler Feed' and ims_stocktransfer.date >= '$fromdate' and ims_stocktransfer.date <= '$todate'";
}

$EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.fromwarehouse In (Select tbl_sector.sector From tbl_sector Where (tbl_sector.type1 = 'Feedmill' or tbl_sector.type1 = 'Warehouse')) And ims_stocktransfer.cat = 'Broiler Feed' and ims_stocktransfer.date >= '$fromdate' and ims_stocktransfer.date <= '$todate'";
$EW_REPORT_TABLE_SQL_GROUPBY = "ims_stocktransfer.tid";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "ims_stocktransfer.fromwarehouse ASC, ims_stocktransfer.towarehouse ASC, ims_stocktransfer.tmno ASC, ims_stocktransfer.date ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "ims_stocktransfer.fromwarehouse", TRUE);
$EW_REPORT_TABLE_SQL_SELECT_GROUP = "SELECT DISTINCT " . EW_REPORT_TABLE_FIRST_GROUP_FIELD . " AS `fromwarehouse` FROM " . $EW_REPORT_TABLE_SQL_FROM;

// Table Level Aggregate SQL
$EW_REPORT_TABLE_SQL_SELECT_AGG = "SELECT SUM(ims_stocktransfer.quantity) AS SUM_quantity, SUM(ims_stocktransfer.price) AS SUM_price, SUM(`(ims_stocktransfer.quantity * ims_stocktransfer.price)`) AS SUM_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
$af_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = NULL; // Popup filter for (ims_stocktransfer.quantity * ims_stocktransfer.price)
?>
<?php
...
$x_quantity = NULL;
$x_price = NULL;
$x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = NULL;
...
$o_tmno = NULL; $g_tmno = NULL; $dg_tmno = NULL; $t_tmno = NULL; $ft_tmno = 200; $gf_tmno = $ft_tmno; $gb_tmno = ""; $gi_tmno = "0"; $gq_tmno = ""; $rf_tmno = NULL; $rt_tmno = NULL;
...
$o_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = NULL; $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = NULL; $ft_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = 5; $rf_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = NULL; $rt_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = NULL;
?>
<?php
...
$col = array(FALSE, FALSE, TRUE, TRUE, TRUE);
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="broilerfeedissue1.php?export=html&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="broilerfeedissue1.php?export=excel&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="broilerfeedissue1.php?export=word&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="broilerfeedissue1.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="broilerfeedissue1.php" name="ewpagerform" id="ewpagerform" class="ewForm">
<table>
 <tr>
 <td>From Date </td>
...
<!--first page button-->
	...
	<td><a href="broilerfeedissue1.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="broilerfeedissue1.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="broilerfeedissue1.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="broilerfeedissue1.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Fromwarehouse</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'Report1_fromwarehouse', false, '<?php echo $rf_fromwarehouse; ?>', '<?php echo $rt_fromwarehouse; ?>');return false;" name="x_fromwarehouse<?php echo $cnt[0][0]; ?>" id="x_fromwarehouse<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Code</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'Report1_code', false, '<?php echo $rf_code; ?>', '<?php echo $rt_code; ?>');return false;" name="x_code<?php echo $cnt[0][0]; ?>" id="x_code<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php
	...
	// Build detail SQL
	//$sWhere = EW_REPORT_TABLE_FIRST_GROUP_FIELD . " = " . ewrpt_QuotedValue($x_fromwarehouse, EW_REPORT_DATATYPE_STRING);

	$sWhere = ewrpt_DetailFilterSQL(EW_REPORT_TABLE_FIRST_GROUP_FIELD, $x_fromwarehouse, EW_REPORT_DATATYPE_STRING, $gb_fromwarehouse, $gi_fromwarehouse, $gq_fromwarehouse);
	if ($sFilter != "")
...
//	echo "sql: " . $sSql . "<br>";
	...
	while ($rs && !$rs->EOF) { // Loop detail records
		...
		if ((is_null($x_fromwarehouse) && is_null($o_fromwarehouse)) ||
			(($x_fromwarehouse <> "" && $o_fromwarehouse == $dg_fromwarehouse) && !ChkLvlBreak(1))) {
			$dg_fromwarehouse = "&nbsp;";
		...
		if ((is_null($x_towarehouse) && is_null($o_towarehouse)) ||
			(($x_towarehouse <> "" && $o_towarehouse == $dg_towarehouse) && !ChkLvlBreak(2))) {
			$dg_towarehouse = "&nbsp;";
		...
		$dg_tmno = $x_tmno;
		if ((is_null($x_tmno) && is_null($o_tmno)) ||
			(($x_tmno <> "" && $o_tmno == $dg_tmno) && !ChkLvlBreak(3))) {
			$dg_tmno = "&nbsp;";
		} elseif (is_null($x_tmno)) {
			$dg_tmno = EW_REPORT_NULL_LABEL;
		} elseif ($x_tmno == "") {
			$dg_tmno = EW_REPORT_EMPTY_LABEL;
		}
		$dg_date = $x_date;
...
<?php echo ewrpt_ViewValue($x_towarehouse) ?>
		...
		<?php $t_tmno = $x_tmno; $x_tmno = $dg_tmno; ?>
<?php echo ewrpt_ViewValue($x_tmno) ?>
		<?php $x_tmno = $t_tmno; ?></td>
...
<?php if(date("d.m.Y",strtotime($x_date)) <> "01.01.1970") echo ewrpt_ViewValue(date($datephp,strtotime($x_date))); else echo ewrpt_ViewValue(); ?>
		...
		<?php
		$feeddesc = "";
		 $query111 = "SELECT description from ims_itemcodes where code = '$x_code'  ";  $result111 = mysql_query($query111,$conn1);   $rows = mysql_num_rows($result111);
  if ( $rows > 0) {  while($row111 = mysql_fetch_assoc($result111))  {   $feeddesc = $row111['description'];  } }
		?>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_code."/".$feeddesc); ?>
</td>
...
<?php echo ewrpt_ViewValue($x_price) ?>
		...
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue(changeprice($x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29)) ?>
</td>
	</tr>
<?php
...
<?php
		if (ChkLvlBreak(2)) {
?>
	<?php $t_towarehouse = $x_towarehouse; $x_towarehouse = $o_towarehouse; ?>


	<!--<tr>
		<td class="ewRptGrpField1">&nbsp;</td>
		<td colspan="4" class="ewRptGrpSummary2">SUM for <?php echo ewrpt_ViewValue($x_towarehouse) ?><?php $x_towarehouse = $t_towarehouse; ?>  </td>
...
<?php echo ewrpt_ViewValue($x_quantity) ?>
		...
		<td class="ewRptGrpSummary2" align="right">
		<?php $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29; ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = $smry[2][4]; // Load SUM ?>
<?php echo ewrpt_ViewValue($x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29) ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29; ?>
		</td>
	</tr>-->
...
?>
	...
	<tr>
		<td colspan="5" class="ewRptGrpSummary1">SUM for:<?php echo ewrpt_ViewValue($x_fromwarehouse) ?><?php $x_fromwarehouse = $t_fromwarehouse; ?> </td>
		<td class="ewRptGrpSummary1" align="right">
		<?php $t_quantity = $x_quantity; ?>
		<?php $x_quantity = $smry[1][2]; // Load SUM ?>
<?php echo ewrpt_ViewValue($x_quantity) ?>
		<?php $x_quantity = $t_quantity; ?>
		</td>
		...
		<td class="ewRptGrpSummary1" align="right">
		<?php $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29; ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = $smry[1][4]; // Load SUM ?>
<?php echo ewrpt_ViewValue($x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29) ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29; ?>
		</td>
	</tr>-->
...
<?php
	...
	// Next group
	$o_fromwarehouse = $x_fromwarehouse; // Save old group value
	GetGrpRow(2);
	$nGrpCount++;
} // End while
?>
...
<?php
	...
	if ($rsagg) {
		...
		$grandsmry[3] = $rsagg->fields("SUM_price");
		$grandsmry[4] = $rsagg->fields("SUM_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29");
	}
	else {
...
<?php echo ewrpt_ViewValue($x_quantity) ?>
		...
		<td align="right">
		<?php $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29; ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = $grandsmry[4]; // Load SUM ?>
<?php echo ewrpt_ViewValue($x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29) ?>
		<?php $x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29 = $t_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29; ?>
		</td>
	</tr>
	...
	switch ($lvl) {
		case 1:
			return (is_null($GLOBALS["x_fromwarehouse"]) && !is_null($GLOBALS["o_fromwarehouse"])) ||
				...
				($GLOBALS["x_fromwarehouse"] <> $GLOBALS["o_fromwarehouse"]);
		case 2:
			return (is_null($GLOBALS["x_towarehouse"]) && !is_null($GLOBALS["o_towarehouse"])) ||
				...
				($GLOBALS["x_towarehouse"] <> $GLOBALS["o_towarehouse"]) || ChkLvlBreak(1); // Recurse upper level
		case 3:
			return (is_null($GLOBALS["x_tmno"]) && !is_null($GLOBALS["o_tmno"])) ||
				(!is_null($GLOBALS["x_tmno"]) && is_null($GLOBALS["o_tmno"])) ||
				($GLOBALS["x_tmno"] <> $GLOBALS["o_tmno"]) || ChkLvlBreak(2); // Recurse upper level
		case 4:
...
function ResetLevelSummary($lvl) {
	...
	// Clear old values
	if ($lvl <= 1) $GLOBALS["o_fromwarehouse"] = "";
	if ($lvl <= 2) $GLOBALS["o_towarehouse"] = "";
	if ($lvl <= 3) $GLOBALS["o_tmno"] = "";
...
function GetGrpRow($opt) {
	...
	if ($rsgrp->EOF) {
		...
		$GLOBALS['x_fromwarehouse'] = $rsgrp->fields('fromwarehouse');
	}
}
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$GLOBALS['x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29'] = $rs->fields('(ims_stocktransfer.quantity * ims_stocktransfer.price)');
		$val[1] = $GLOBALS['x_code'];
		$val[2] = $GLOBALS['x_quantity'];
		$val[3] = $GLOBALS['x_price'];
		$val[4] = $GLOBALS['x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29'];
	} else {
		...
		$GLOBALS['x_quantity'] = "";
		$GLOBALS['x_price'] = "";
		$GLOBALS['x_z28ims_stocktransfer2Equantity_2A_ims_stocktransfer2Eprice29'] = "";
	}
}
...
function getSort()
{
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] = "ims_stocktransfer.code ASC";
...
document.location = 'broilerfeedissue1.php?export=' + a + '&fromdate=' + fdate + '&todate=' + tdate;
}
</script>