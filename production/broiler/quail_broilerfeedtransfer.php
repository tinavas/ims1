...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Quail Feed Transfer</font></strong></td>
</tr>
<tr>
...
if($_SESSION['db'] == "feedatives")
{
   ...
   {
	$EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.cat = 'Fattener Feed' and ims_stocktransfer.date >= '$fromdate' and ims_stocktransfer.date <= '$todate'";
   }
   else
   { 
   $sectorr = $_SESSION['sectorr'];
  $EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.cat = 'Fattener Feed' and ims_stocktransfer.date >= '$fromdate' and ims_stocktransfer.date <= '$todate' AND (ims_stocktransfer.towarehouse IN (select distinct(quail_broilerfarm.farm) from quail_broilerfarm where quail_broilerfarm.place = '$sectorr' and quail_broilerfarm.type <> 'rental'))";
   }   
 }
else
{
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quail_broilerfeedtransfer.php?export=html&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="quail_broilerfeedtransfer.php?export=excel&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="quail_broilerfeedtransfer.php?export=word&fromdate=<?php echo date($datephp,strtotime($fromdate)); ?>&todate=<?php echo date($datephp,strtotime($todate)); ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="quail_broilerfeedtransfer.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="quail_broilerfeedtransfer.php" name="ewpagerform" id="ewpagerform" class="ewForm">
<table>
 <tr>
 <td>From Date </td>
...
<!--first page button-->
	...
	<td><a href="quail_broilerfeedtransfer.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quail_broilerfeedtransfer.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quail_broilerfeedtransfer.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quail_broilerfeedtransfer.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
document.location = 'quail_broilerfeedtransfer.php?export=' + a + '&fromdate=' + fdate + '&todate=' + tdate;
}
</script>