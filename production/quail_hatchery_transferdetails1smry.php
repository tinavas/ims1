...
define("EW_REPORT_TABLE_VAR", "quail_hatchery_transferdetails1", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "quail_hatchery_transferdetails1_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "quail_hatchery_transferdetails1_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "quail_hatchery_transferdetails1_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "quail_hatchery_transferdetails1_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "quail_hatchery_transferdetails1_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "quail_hatchery_transferdetails";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT quail_hatchery_transferdetails.date, quail_hatchery_transferdetails.settingno, quail_hatchery_transferdetails.hatcheryno, quail_hatchery_transferdetails.eggstransfered, quail_hatchery_transferdetails.candling, quail_hatchery_transferdetails.eggsremaining, quail_hatchery_transferdetails.weight FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "'$fromdate' <= quail_hatchery_transferdetails.date and quail_hatchery_transferdetails.date <= '$todate'";
$EW_REPORT_TABLE_SQL_GROUPBY = "quail_hatchery_transferdetails.date, quail_hatchery_transferdetails.settingno, quail_hatchery_transferdetails.hatcheryno, quail_hatchery_transferdetails.eggstransfered, quail_hatchery_transferdetails.candling, quail_hatchery_transferdetails.eggsremaining, quail_hatchery_transferdetails.weight";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "quail_hatchery_transferdetails.date ASC, quail_hatchery_transferdetails.settingno ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "quail_hatchery_transferdetails.date", TRUE);
...
$EW_REPORT_TABLE_SQL_SELECT_AGG = "SELECT SUM(quail_hatchery_transferdetails.eggstransfered) AS SUM_eggstransfered, SUM(quail_hatchery_transferdetails.candling) AS SUM_candling, SUM(quail_hatchery_transferdetails.eggsremaining) AS SUM_eggsremaining FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
?>
<?php
$EW_REPORT_FIELD_DATE_SQL_SELECT = "SELECT DISTINCT quail_hatchery_transferdetails.date FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_DATE_SQL_ORDERBY = "quail_hatchery_transferdetails.date";
$EW_REPORT_FIELD_SETTINGNO_SQL_SELECT = "SELECT DISTINCT quail_hatchery_transferdetails.settingno FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SETTINGNO_SQL_ORDERBY = "quail_hatchery_transferdetails.settingno";
$EW_REPORT_FIELD_HATCHERYNO_SQL_SELECT = "SELECT DISTINCT quail_hatchery_transferdetails.hatcheryno FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_HATCHERYNO_SQL_ORDERBY = "quail_hatchery_transferdetails.hatcheryno";
?>
<?php
...
ewrpt_CreatePopup("quail_hatchery_transferdetails1_date", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_settingno, $sel_settingno, $ft_settingno) ?>
ewrpt_CreatePopup("quail_hatchery_transferdetails1_settingno", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_hatcheryno, $sel_hatcheryno, $ft_hatcheryno) ?>
ewrpt_CreatePopup("quail_hatchery_transferdetails1_hatcheryno", [<?php echo $jsdata ?>]);
</script>
<div id="quail_hatchery_transferdetails1_date_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="quail_hatchery_transferdetails1_settingno_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="quail_hatchery_transferdetails1_hatcheryno_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quail_hatchery_transferdetails1smry.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="quail_hatchery_transferdetails1smry.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="quail_hatchery_transferdetails1smry.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="quail_hatchery_transferdetails1smry.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<?php if (@$sExport == "") { ?>
<br /><br />
...
<form action="quail_hatchery_transferdetails1smry.php<?php echo $url1; ?>" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="quail_hatchery_transferdetails1smry.php?start=<?php echo $Pager->FirstButton->Start ?><?php echo $url; ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quail_hatchery_transferdetails1smry.php?start=<?php echo $Pager->PrevButton->Start ?><?php echo $url; ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quail_hatchery_transferdetails1smry.php?start=<?php echo $Pager->NextButton->Start ?><?php echo $url; ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quail_hatchery_transferdetails1smry.php?start=<?php echo $Pager->LastButton->Start ?><?php echo $url; ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_transferdetails1_date', false, '<?php echo $rf_date; ?>', '<?php echo $rt_date; ?>');return false;" name="x_date<?php echo $cnt[0][0]; ?>" id="x_date<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Hatchery No.</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_transferdetails1_hatcheryno', false, '<?php echo $rf_hatcheryno; ?>', '<?php echo $rt_hatcheryno; ?>');return false;" name="x_hatcheryno<?php echo $cnt[0][0]; ?>" id="x_hatcheryno<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_quail_hatchery_transferdetails1_date"])) {
		LoadSelectionFromSession('date');
	} elseif (@$_SESSION["sel_quail_hatchery_transferdetails1_date"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_date"] = "";
	}

	// Get Settingno selected values
	if (is_array(@$_SESSION["sel_quail_hatchery_transferdetails1_settingno"])) {
		LoadSelectionFromSession('settingno');
	} elseif (@$_SESSION["sel_quail_hatchery_transferdetails1_settingno"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_settingno"] = "";
	}

	// Get Hatcheryno selected values
	if (is_array(@$_SESSION["sel_quail_hatchery_transferdetails1_hatcheryno"])) {
		LoadSelectionFromSession('hatcheryno');
	} elseif (@$_SESSION["sel_quail_hatchery_transferdetails1_hatcheryno"] == EW_REPORT_INIT_VALUE) { // Select all
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_quail_hatchery_transferdetails1_$parm"] = "";
	$_SESSION["rf_quail_hatchery_transferdetails1_$parm"] = "";
	$_SESSION["rt_quail_hatchery_transferdetails1_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_quail_hatchery_transferdetails1_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_quail_hatchery_transferdetails1_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_quail_hatchery_transferdetails1_$parm"];
}
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_date"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_date"], "quail_hatchery_transferdetails.date", EW_REPORT_DATATYPE_DATE, $GLOBALS["af_date"], $GLOBALS["gb_date"], $GLOBALS["gi_date"], $GLOBALS["gq_date"]);
	}
	if (is_array($GLOBALS["sel_settingno"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_settingno"], "quail_hatchery_transferdetails.settingno", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_settingno"], $GLOBALS["gb_settingno"], $GLOBALS["gi_settingno"], $GLOBALS["gq_settingno"]);
	}
	if (is_array($GLOBALS["sel_hatcheryno"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_hatcheryno"], "quail_hatchery_transferdetails.hatcheryno", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_hatcheryno"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_quail_hatchery_transferdetails1_date"] = "";
			$_SESSION["sort_quail_hatchery_transferdetails1_settingno"] = "";
			$_SESSION["sort_quail_hatchery_transferdetails1_hatcheryno"] = "";
			$_SESSION["sort_quail_hatchery_transferdetails1_eggstransfered"] = "";
			$_SESSION["sort_quail_hatchery_transferdetails1_candling"] = "";
			$_SESSION["sort_quail_hatchery_transferdetails1_eggsremaining"] = "";
			$_SESSION["sort_quail_hatchery_transferdetails1_weight"] = "";
		}
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] = "quail_hatchery_transferdetails.hatcheryno ASC";
		$_SESSION["sort_quail_hatchery_transferdetails1_hatcheryno"] = "ASC";
	}
