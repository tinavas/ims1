...
<?php } ?>
<br />
<center><strong>Flock Wise Feed Consumed Report</strong></center>
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="turkeyfeedconsumed.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="turkeyfeedconsumed.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="turkeyfeedconsumed.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="turkeyfeedconsumed.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<?php if (@$sExport == "") { ?>
<br /><br />
...
<form action="turkeyfeedconsumed.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="turkeyfeedconsumed.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="turkeyfeedconsumed.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="turkeyfeedconsumed.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="turkeyfeedconsumed.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php
              ...
              $totalfeed1 = 0;
              $query14 = "SELECT sum(quantity) as 'feed' FROM turkey_consumption where flock = '$x_flock' and itemcode in ($feedtypes1)";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
              ...
              $totalfeed2 = 0;
              $query14 = "SELECT sum(quantity) as 'feed' FROM turkey_consumption where flock = '$x_flock' and itemcode in ($feedtypes2)";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
