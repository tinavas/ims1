...
define("EW_REPORT_TABLE_VAR", "CustomView2", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "CustomView2_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "CustomView2_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "CustomView2_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "CustomView2_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "CustomView2_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "feed_productionunit";
 $EW_REPORT_TABLE_SQL_SELECT = "SELECT distinct(feed_productionunit.mash) as mash FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = " date >= '$fromdate' and date <= '$todate'";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "mash";
...
// Detail variables
$o_mash = NULL; $t_mash = NULL; $ft_mash = 200; $rf_mash = NULL; $rt_mash = NULL;
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="feed_productionunitreport.php?export=html&fromdate=<?php echo $_GET['fromdate'];?>&todate=<?php echo $_GET['todate'];?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="feed_productionunitreport.php?export=excel&fromdate=<?php echo $_GET['fromdate'];?>&todate=<?php echo $_GET['todate'];?>">Export to Excel</a>
&nbsp;&nbsp;<a href="feed_productionunitreport.php?export=word&fromdate=<?php echo $_GET['fromdate'];?>&todate=<?php echo $_GET['todate'];?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php $query = "SELECT sum(production) as quantity,sum(production*feedcostperkg)/sum(production) as avg from feed_productionunit where mash='$code' and date >= '$fromdate' and date <= '$todate'";
...
<?php echo changeprice($quantity) ?>
</td>


<td<?php echo $sItemRowClass; ?> align="right">
<?php echo changeprice($avg) ?>
</td>
	</tr>
<?php
...
<form action="feed_productionunitreport.php" name="ewpagerform" id="ewpagerform" class="ewForm">
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td nowrap>
<?php if (!isset($Pager)) $Pager = new cPrevNextPager($nStartGrp, $nDisplayGrps, $nTotalGrps) ?>
...
<!--first page button-->
	<?php if ($Pager->FirstButton->Enabled) { ?>
	<td><a href="feed_productionunitreport.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="feed_productionunitreport.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } ?>
<!--current page number-->
...
<!--next page button-->
	<?php if ($Pager->NextButton->Enabled) { ?>
	<td><a href="feed_productionunitreport.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="feed_productionunitreport.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/lastdisab.gif" alt="Last" width="16" height="16" border="0"></td>
	<?php } ?>
	<td><span class="phpreportmaker">&nbsp;of <?php echo $Pager->PageCount ?></span></td>
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$val[1] = $GLOBALS['x_mash'];
		$val[2] = $GLOBALS['x_production'];
	} else {
		$GLOBALS['x_mash'] = "";
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_CustomView2_mash"] = "";
			$_SESSION["sort_CustomView2_production"] = "";
		}
...
var tdate = document.getElementById('todate').value;
	...
	document.location='feed_productionunitreport.php?fromdate=' + fdate + '&todate=' + tdate;
