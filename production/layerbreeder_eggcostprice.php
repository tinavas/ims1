...
$EW_REPORT_TABLE_SQL_WHERE = "date1 between '$fdate' and '$tdate' and client = '$client' and itemcode in(select distinct(code) from ims_itemcodes where cat='Layer Eggs' and client = '$client')";
...
$q="select sum(quantity) as quantity from layerbreeder_consumption where date2='$x_date1' and itemcode in(select distinct(code) from ims_itemcodes where cat In ('Layer Feed') ) ";
...
$q = "select sum(quantity) as quantity from layerbreeder_consumption  where date2 = '$x_date1' and itemcode in(select distinct(code) from ims_itemcodes where description <> 'chick' and description <> 'grower' and cat in('Layer Feed')) and flock in ($productionflocks)";
...
$cgfeedmedvacc = 0;
$cgfeedtotmedvacc = 0;
$q8 = "select sum(quantity) as quantity,itemcode from layerbreeder_consumption  where date2 = '$x_date1' and itemcode in(select distinct(code) from ims_itemcodes where description <> 'chick' and description <> 'grower' and cat in('Medicines','Vaccines')) and flock in ($productionflocks) group by itemcode";
