...
$EW_REPORT_TABLE_SQL_ORDERBY = "hr_employee.sector,hr_employee.name ";
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="SalaryNewReportsmrysmry.php<?php echo $genlinkm; ?>&export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="SalaryNewReportsmrysmry.php<?php echo $genlinkm; ?>&export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="SalaryNewReportsmrysmry.php<?php echo $genlinkm; ?>&export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="SalaryNewReportsmrysmry.php<?php echo $genlinkm; ?>&cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="SalaryNewReportsmrysmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="SalaryNewReportsmrysmry.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="SalaryNewReportsmrysmry.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="SalaryNewReportsmrysmry.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="SalaryNewReportsmrysmry.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("name") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_name"]); ?>');">Name</td><td style="width: 10px;">
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("sector") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_sector"]); ?>');">Sector</td><td style="width: 10px;">
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("designation") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_designation"]); ?>');">Designation</td><td style="width: 10px;">
...
<?php } else { ?>
		<td class="ewTableHeader"  title="Days Present">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("designation") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_designation"]); ?>');">Days</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_designation"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_designation"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("salary") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_salary"]); ?>');">Salary</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_salary"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_salary"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("bfix") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_bfix"]); ?>');">Basic</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_bfix"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_bfix"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("hrafix") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_hrafix"]); ?>');">H R A</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_hrafix"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_hrafix"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="Medical Allowance">
		Med  Allow.
		</td>
<?php } else { ?>
		<td class="ewTableHeader" title="Medical Allowance">
			<table cellspacing="0" class="ewTableHeaderBtn" ><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("mafix") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_mafix"]); ?>');">Med  Allow.</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_mafix"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_mafix"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="City Compensation Allowance">
		C C  Allow.
		</td>
<?php } else { ?>
		<td class="ewTableHeader" title="City Compensation Allowance">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("ccafix") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_ccafix"]); ?>');">C C  Allow.</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_ccafix"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_ccafix"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="Travelling Allowance">
		T Allow.
		</td>
<?php } else { ?>
		<td class="ewTableHeader" title="Travelling Allowance">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("tafix") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_tafix"]); ?>');">T Allow.</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_tafix"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_tafix"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader" title="Provident Fund">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("pffix") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_pffix"]); ?>');">PF</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_pffix"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_pffix"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader" title="Professional Tax">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("ptaxfix") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_ptaxfix"]); ?>');">P Tax</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_ptaxfix"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_ptaxfix"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="Final Salary to be paid">
		Final  Sal.
		</td>
<?php } else { ?>
		<td class="ewTableHeader" title="Final Salary to be paid">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("finalsal") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_finalsal"]); ?>');">Final  Sal.</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_finalsal"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_finalsal"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'SalaryNewReportsmry_finalsal', true, '<?php echo $rf_finalsal; ?>', '<?php echo $rt_finalsal; ?>');return false;" name="x_finalsal<?php echo $cnt[0][0]; ?>" id="x_finalsal<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>

<?php if (@$sExport <> "") { ?>
        <td valign="bottom" class="ewTableHeader" title="Over Time Salary Paid"> O.T. </td>
        <?php } else { ?>
        ...
        <?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="Salary Paid">
		Paid
		</td>
<?php } else { ?>
		<td class="ewTableHeader" title="Salary Paid">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("paid") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_paid"]); ?>');">Paid</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_paid"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_paid"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'SalaryNewReportsmry_paid', true, '<?php echo $rf_paid; ?>', '<?php echo $rt_paid; ?>');return false;" name="x_paid<?php echo $cnt[0][0]; ?>" id="x_paid<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>

<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="Deduction">
		Ded.
		</td>
<?php } else { ?>
		<td class="ewTableHeader" title="Deduction">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("deduction") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_deduction"]); ?>');">Ded.</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_deduction"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_deduction"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("paymode") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_paymode"]); ?>');">Paymode</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_paymode"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_paymode"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'SalaryNewReportsmry_paymode', true, '<?php echo $rf_paymode; ?>', '<?php echo $rt_paymode; ?>');return false;" name="x_paymode<?php echo $cnt[0][0]; ?>" id="x_paymode<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
	</tr>
...
<?php $q1 = "SELECT bfix ,hrafix, mafix, ccafix, tafix,finalsal FROM hr_salaryparameters WHERE sector= '$x_sector' AND name ='$x_name' order by id limit 1";
 $q1rs = mysql_query($q1,$conn1) or die(mysql_error());
		...
		$cid = $qidr['id'];
			...
			$totaldays =0;
		$qtt ="SELECT dayspresent as noofdays,workingdays as workd FROM `hr_mnthattendance` where eid='$cid' and month='$month' and year='$cyear' and client='$client'";
...
<?php echo ewrpt_ViewValue($x_salary) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($ba)
//ewrpt_ViewValue($x_bfix) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($hra) 
//ewrpt_ViewValue($x_hrafix) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($ma)
//ewrpt_ViewValue($x_mafix) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($cca)
//ewrpt_ViewValue($x_ccafix) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($ta)
//ewrpt_ViewValue($x_tafix) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($pf)
//ewrpt_ViewValue($x_pffix) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($pta)
//ewrpt_ViewValue($x_ptaxfix) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($final)
//ewrpt_ViewValue($x_finalsal) ?>
</td>
	<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($ot)
//ewrpt_ViewValue($x_finalsal) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_paid) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_deduction)
//echo ewrpt_ViewValue($x_finalsal - $x_paid) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
...
<?php echo ewrpt_ViewValue($x_ptaxfix) ?>
		...
		<td>
		<?php $t_paid = $x_paid; ?>
		<?php $x_paid = $grandsmry[13]; // Load SUM ?>
<?php echo ewrpt_ViewValue($x_paid) ?>
		<?php $x_paid = $t_paid; ?>
		</td>
		<td>
		<?php $t_deduction = $x_deduction; ?>
		<?php $x_deduction = ewrpt_ViewValue($x_paid) -  ewrpt_ViewValue($x_salary); // Load SUM ?>
<?php echo ewrpt_ViewValue($x_deduction)//echo ewrpt_ViewValue($x_deduction) ?>
		<?php $x_deduction = $t_deduction; ?>
		</td>
		<td>&nbsp;</td>
	</tr>
<?php } ?>
...
<form action="SalaryNewReportsmrysmry.php?<?php echo $genlinkm; ?>" name="ewpagerform" id="ewpagerform" class="ewForm">
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td nowrap>
<?php if (!isset($Pager)) $Pager = new cPrevNextPager($nStartGrp, $nDisplayGrps, $nTotalGrps) ?>
