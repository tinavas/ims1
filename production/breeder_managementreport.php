...
$query = "SELECT count(*) as count,startdate,breed FROM breeder_flock WHERE flockcode LIKE '%$flock'  order by startdate LIMIT 1";
...
if($cnt == 1)
{
 $query = "SELECT femaleopening,maleopening,flockcode FROM breeder_flock WHERE flockcode LIKE '%$flock'  order by startdate LIMIT 1";
}
else
{
 //$query = "SELECT sum(femaleopening) as femaleopening,sum(maleopening) as maleopening,flockcode FROM breeder_flock WHERE flockcode LIKE '%$flock'  and startdate = '$minstdate'";
  $query = "SELECT sum(femaleopening) as femaleopening,sum(maleopening) as maleopening,flockcode FROM breeder_flock WHERE flockcode LIKE '%$flock' ";
}
$result = mysql_query($query,$conn) or die(mysql_error());
while($rows = mysql_fetch_assoc($result))
{
$q = "SELECT female,male FROM breeder_initial WHERE flock LIKE '%$flock' ORDER BY age LIMIT 1";
...
$query = "SELECT fmort,mmort  FROM breeder_consumption WHERE flock LIKE '%$flock'  group by date2,flock";
$result = mysql_query($query,$conn) or die(mysql_error());
while($rows = mysql_fetch_assoc($result))
{
...
{
$fculls = 0;$mculls = 0;
$query = "SELECT fcull,mcull  FROM breeder_consumption WHERE flock LIKE '%$flock'  group by date2,flock";
$result = mysql_query($query,$conn) or die(mysql_error());
while($rows = mysql_fetch_assoc($result))
{
 $fculls += $rows['fcull'];
...
{
$query = "SELECT fcull,mcull  FROM breeder_consumption WHERE flock LIKE '%$flock'  and date2 < '$minsaledate' group by date2,flock";
$result = mysql_query($query,$conn) or die(mysql_error());
while($rows = mysql_fetch_assoc($result))
{
$fculls += $rows['fcull'];
$mculls += $rows['mcull'];
 ...
 $query1 = "select avg(rateperunit) as price from pp_sobi where flock like '%$flock' and code in(select distinct(code) from ims_itemcodes where cat LIKE '%Birds' ) ";
$result1 = mysql_query($query1,$conn) or die(mysql_error());
$n = mysql_num_rows($result1);
$rows1 = mysql_fetch_assoc($result1);
if($n > 0)
{
$rate = round(($rows1['price']),2);
}
else
{
$rate = "21";
...
$query = "SELECT sum(fmort) as imort,sum(fcull) as icull,sum(mmort) as immort,sum(mcull) as imcull,sum(mfeedqty) as imfeed,sum(ffeedqty) as iffeed FROM breeder_initial WHERE flock LIKE '%$flock' ";
$result = mysql_query($query,$conn) or die(mysql_error());
while($rows = mysql_fetch_assoc($result))
{
...
$query = "SELECT sum(ffeedqty) as iffeed FROM breeder_initial WHERE flock LIKE '%$flock' AND ffeed IN (SELECT code FROM ims_itemcodes WHERE description LIKE '%Layer%' AND cat = 'Female Feed') ";
$result = mysql_query($query,$conn) or die(mysql_error());
while($rows = mysql_fetch_assoc($result))
 $layer_iffeed = $rows['iffeed'];


$query = "SELECT max(age) as age,max(date2) as enddate  FROM breeder_consumption WHERE flock LIKE '%$flock'  LIMIT 1";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$orgage = $age = $rows['age'];
$weeks = floor($age/7);
...
$query = "SELECT distinct(itemcode) FROM breeder_consumption WHERE flock LIKE '%$flock' AND itemcode IN (SELECT code FROM ims_itemcodes WHERE cat In ('Medicines','Vaccines')) ";
$result = mysql_query($query,$conn) or die(mysql_error());
while($rows = mysql_fetch_assoc($result))
{
$mv++;
...
$query1 = "SELECT sum(quantity) as medvacqty FROM breeder_consumption WHERE flock LIKE '%$flock' AND itemcode = '$medvac' ";
$result1 = mysql_query($query1,$conn) or die(mysql_error());
$rows1 = mysql_fetch_assoc($result1);
//echo "      quantity     ".
...
$query = "SELECT sum(quantity) as ffeed FROM breeder_consumption WHERE flock LIKE '%$flock' AND itemcode IN (SELECT code FROM ims_itemcodes WHERE cat = 'Female Feed') ";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$ffeed = $rows['ffeed'];

$query = "SELECT sum(quantity) as ffeed FROM breeder_consumption WHERE flock LIKE '%$flock' AND itemcode IN (SELECT code FROM ims_itemcodes WHERE cat = 'Female Feed' AND description LIKE '%Layer%') ";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$layer_ffeed = $rows['ffeed'];


$query = "SELECT sum(quantity) as mfeed FROM breeder_consumption  WHERE flock LIKE '%$flock' AND itemcode IN (SELECT code FROM ims_itemcodes WHERE cat = 'Male Feed') ";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$mfeed = $rows['mfeed'];

$query = "SELECT sum(quantity) as trout FROM ims_stocktransfer WHERE fromwarehouse LIKE '%$flock' AND towarehouse NOT LIKE '%$flock' AND cat = 'Female Birds' ";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$ftrout = $rows['trout'];

 $query = "SELECT sum(quantity) as trin FROM ims_stocktransfer WHERE  fromwarehouse NOT LIKE '%$flock' AND towarehouse LIKE '%$flock' AND cat = 'Female Birds' ";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$ftrin  = $rows['trin'];

$query = "SELECT sum(receivedquantity) as receivedquantity FROM `pp_sobi` WHERE code in (select distinct(code) from ims_itemcodes where cat ='Female Birds')  AND flock like '%$flock' and date > '$minstdate'";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$fpur  = $rows['receivedquantity'];

$query = "SELECT sum(receivedquantity) as receivedquantity  FROM `pp_sobi` WHERE code in (select distinct(code) from ims_itemcodes where cat ='Male Birds')  AND flock like '%$flock'  and date > '$minstdate'";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$mpur  =  $rows['receivedquantity'];


$query = "SELECT sum(quantity) as sales FROM oc_cobi WHERE flock LIKE '%$flock' AND code in (select distinct(code) from ims_itemcodes where cat = 'Female Birds') and date >= '$minsaledate'  ";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$fsales = $rows['sales'];

$query = "SELECT sum(quantity) as trout FROM ims_stocktransfer WHERE fromwarehouse LIKE '%$flock' AND towarehouse NOT LIKE '%$flock'  AND cat = 'Male Birds' ";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$mtrout = $rows['trout'];

$query = "SELECT sum(quantity) as trin FROM ims_stocktransfer WHERE fromwarehouse NOT LIKE '%$flock' AND towarehouse LIKE '%$flock' AND cat = 'Male Birds' ";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$mtrin = $rows['trin'];

$query = "SELECT sum(quantity) as sales FROM oc_cobi WHERE flock LIKE '%$flock' AND code in (select distinct(code) from ims_itemcodes where cat = 'Male Birds') and date >= '$minsaledate' ";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$msales = $rows['sales'];

$query = "SELECT sum(quantity) as production,min(date1) as mindate FROM breeder_production WHERE flock LIKE '%$flock'  and itemcode in (select code from ims_itemcodes where cat = 'Hatch Eggs' )";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$production = $rows['production'];
$mindate = $rows['mindate'];

$query = "SELECT sum(quantity) as production FROM breeder_production WHERE flock LIKE '%$flock'  and itemdesc LIKE 'TABLE EGGS'";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
...
if($flkbreed != "")
{
$query = "SELECT sum(ffeed) as stdffeed,sum(mfeed) as stdmfeed FROM breeder_standards WHERE age<=$weeks AND breed = '$flkbreed' ";
}
else
{
$query = "SELECT sum(ffeed) as stdffeed,sum(mfeed) as stdmfeed FROM breeder_standards WHERE age<=$weeks ";
}
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
...
if($flkbreed != "")
{
$query = "SELECT cumhhe as stdprod FROM breeder_standards WHERE age = '$weeks' AND breed = '$flkbreed' ";
}
else
{
$query = "SELECT cumhhe as stdprod FROM breeder_standards WHERE age = '$weeks' ";
}
$result = mysql_query($query,$conn) or die(mysql_error());
...
if($flkbreed != "")
{
$query2 = "SELECT max(cumhhe) as stdprod FROM breeder_standards WHERE breed = '$flkbreed' ";
}
else
{
$query2 = "SELECT max(cumhhe) as stdprod FROM breeder_standards";
}
$result2 = mysql_query($query2,$conn) or die(mysql_error());
$rows2 = mysql_fetch_assoc($result2);
...
$query = "SELECT min(date1) as startdate FROM breeder_production WHERE flock LIKE '%$flock' ";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
...
$query = "SELECT fmort,fcull FROM breeder_consumption WHERE flock LIKE '%$flock'  and date2 < '$lstart'";
$result = mysql_query($query,$conn) or die(mysql_error());
while($rows = mysql_fetch_assoc($result))
{
...
$q = "SELECT sum(fmort) as fmorti,sum(mmort) as mmorti,sum(fcull) as fculli,sum(mcull) as mculli FROM breeder_initial WHERE flock LIKE '%$flock'  and eggs = ''";
$r = mysql_query($q,$conn) or die(mysql_error());
$cntrrows = mysql_num_rows($r);
if($cntrrows >0)
{
...
$query = "SELECT eggs FROM breeder_initial WHERE flock LIKE '%$flock' ";
$result = mysql_query($query,$conn) or die(mysql_error());
while($rows = mysql_fetch_assoc($result))
{
...
<table border="0" style="text-align:left">
 ...
 <tr>
   ...
   <td width="10px">:</td>
   <td width="100px"><?php echo $fchickcost = $rate; ?></td>
   <td width="200px">Male Chick Cost/Bird</td>
   <td width="10px">:</td>
   <td width="100px"><?php echo $mchickcost = $rate; ?></td>
 </tr> 
...
$query = "SELECT sum(fmort) as mortality,sum(fcull) as culls  FROM breeder_consumption WHERE flock LIKE '%$flock' AND date1 <= '$mindate' ";
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
...
$query1 = "SELECT distinct(unitcode) FROM breeder_flock WHERE flockcode LIKE '%$flock' ";
$result1 = mysql_query($query1,$conn) or die(mysql_error());
while($rows1 = mysql_fetch_assoc($result1))
{
 //$flock1 = $rows1['flockcode'];
 $unit1 = $rows1['unitcode'];
 $query3 = "SELECT min(date2) as startdate,max(date2) as enddate FROM breeder_consumption WHERE flock IN (SELECT distinct(flockcode) FROM breeder_flock WHERE flockcode LIKE '%$flock' ) ";
 ...
 while($fdate <= $enddate)
 {
  ...
  $noofdays = round( $temp1 / (24 * 60 * 60)) + 1;
  	 ...
  	 $query2 = "SELECT distinct(flock) FROM breeder_consumption WHERE date2 BETWEEN '$date1' AND '$date2' AND flock IN (SELECT distinct(flockcode) FROM breeder_flock WHERE unitcode = '$unit1' ) ";
	 $result2 = mysql_query($query2,$conn) or die(mysql_error());
...
if($flkbreed != "")
{
$query = "SELECT cumhhe,cumhhp,cumchicks FROM breeder_standards WHERE age = '$weeks' AND breed='$flkbreed' ";
}
else
{
$query = "SELECT cumhhe,cumhhp,cumchicks FROM breeder_standards WHERE age = '$weeks' ";
}
$result = mysql_query($query,$conn) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
$cumhhe = $rows['cumhhe'];
...
?>   
 ...
 <tr>
   ...
   <td width="10px">:</td>
   <td width="100px"><?php echo round(($production/$lbirds),2); ?></td>
...
<?php
$q = "select sum(quantity*price) as 'total' from oc_cobi where flock LIKE '%$salesflock' AND code IN (SELECT code FROM ims_itemcodes WHERE cat = 'Hatch Eggs' OR cat = 'Eggs') "; 
