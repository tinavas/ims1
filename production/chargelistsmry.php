...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Charge List</font></strong></td>
</tr>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="chargelistsmry.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="chargelistsmry.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="chargelistsmry.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php 
$dumm = 0;
	$q = "select * from vehicle_type ";		
	$r = mysql_query($q,$conn1);
	while($qr = mysql_fetch_assoc($r))
	{
 $vtype1 = $qr['vtype'];
 $q1 = "select * from vehicle_chargemaster where vehicletype LIKE '%$vtype1%'";
	$r1= mysql_query($q1,$conn1);
	while($qr1 = mysql_fetch_assoc($r1))
	{
 $ccode = $qr1['chargecode'];
$cdesc = $qr1['chargedescription'];

?>
<tr>
<td<?php echo $sItemRowClass; ?>>
<?php if(($vtype1 <> $oldcode) or ($dumm == 0)){ echo ewrpt_ViewValue($vtype1);
     $oldcode = $vtype1; $dumm = 1; }
	 else{
...
<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($cdesc) ?>
</td>
	</tr>
	<?php 
