...
$EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.cat = 'Quail Female Feed' or ims_stocktransfer.cat = 'Quail Male Feed'";
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quail_feedtransfer.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="quail_feedtransfer.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="quail_feedtransfer.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="quail_feedtransfer.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="quail_feedtransfer.php" name="ewpagerform" id="ewpagerform" class="ewForm"><center>
...
<!--first page button-->
	...
	<td><a href="quail_feedtransfer.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quail_feedtransfer.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quail_feedtransfer.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quail_feedtransfer.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
