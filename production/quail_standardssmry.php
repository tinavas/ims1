...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "quail_standards";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT quail_standards.breed, quail_standards.age, quail_standards.livability, quail_standards.ffeed, quail_standards.mfeed, quail_standards.fweight, quail_standards.mweight, quail_standards.eggwt, quail_standards.productionper, quail_standards.heggper, quail_standards.cumhhp, quail_standards.cumhhe, quail_standards.eggbird, quail_standards.hatchper FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "$cond";
...
?>
<?php
$EW_REPORT_FIELD_BREED_SQL_SELECT = "SELECT DISTINCT quail_standards.breed FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_BREED_SQL_ORDERBY = "quail_standards.breed";
$EW_REPORT_FIELD_AGE_SQL_SELECT = "SELECT DISTINCT quail_standards.age FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_AGE_SQL_ORDERBY = "quail_standards.age";
?>
<?php
...
<table align="center" border="0">
          <tr>
            <td style="text-align:center" colspan="2"><strong><font color="#3e3276">Quail Standards Report</font></strong></td>
          </tr>
        </table>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="Quail_Standardssmry.php?export=html&breed=<?php echo $breed; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="Quail_Standardssmry.php?export=excel&breed=<?php echo $breed; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="Quail_Standardssmry.php?export=word&breed=<?php echo $breed; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="Quail_Standardssmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="Quail_Standardssmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<?php
  $query = "SELECT distinct(breed) as breed from quail_standards order by breed";
...
<!--first page button-->
	...
	<td><a href="Quail_Standardssmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="Quail_Standardssmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="Quail_Standardssmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="Quail_Standardssmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php echo ewrpt_ViewValue($x_mfeed) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(changeprice($x_fweight)) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(changeprice($x_mweight)) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_breed"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_breed"], "quail_standards.breed", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_breed"]);
	}
	if (is_array($GLOBALS["sel_age"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_age"], "quail_standards.age", EW_REPORT_DATATYPE_NUMBER, $GLOBALS["af_age"]);
	}
	return $sWrk;
}
?>
...
function reloadpage()
{
	...
	document.location = "Quail_Standardssmry.php?breed=" + breed;
}
</script>