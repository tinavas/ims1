...
<br /><br />
<center> <h1>Monthly Attendance</h1></center>
<br /><br />
<form method="post" action="hr_savemnth_attandance.php" id="salform" name="salform">
<center>
...
<br />
<?php
$query = "select * from hr_employee where sector $sc '$sector' and designation $dc '$desig' and employeeid not in (select distinct(eid) from hr_mnth_attendance where month = '$month' and year = '$year') ";
...
<tr align="center">
<td>
<input type="text" style="width: 30px; color:#FF0000" id="employeeid<?php echo $i; ?>" name="employeeid[]"  readonly value="<?php echo $r['employeeid']; ?>" />
</td>
<td width="10px">&nbsp;</td>
<td>
<input type="text" style="width: 100px; color:#FF0000" id="employeename<?php echo $i; ?>" name="employeename[]"  readonly value="<?php echo $r['name']; ?>" />
</td>
<td width="10px">&nbsp;</td>
<td>
<input type="text" style="width: 100px; color:#FF0000" id="sect<?php echo $i; ?>" name="sect[]"  readonly value="<?php echo $r['sector']; ?>" />
</td>
<td width="10px">&nbsp;</td>
<td>
<input type="text" style="width: 100px; color:#FF0000" id="designation<?php echo $i; ?>" name="designation[]"  readonly value="<?php echo $r['designation']; ?>" />
</td>
<td width="10px">&nbsp;</td>
<td>
<input type="text" style="width: 70px;text-align:right" id="days<?php echo $i; ?>" name="days[]"  value="0" />
</td>
...
function fun3()
{
	...
	document.location = "dashboardsub.php?page=hr_addmnthattendance&sector=" + sector + "&desig=" + desig + "&month=" + month + "&year=" + year ;
}
