...
define("EW_REPORT_TABLE_VAR", "turkeyunit", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "turkeyunit_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "turkeyunit_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "turkeyunit_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "turkeyunit_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "turkeyunit_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "`turkey_unit`";
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="turkeyunitsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="turkeyunitsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="turkeyunitsmry.php?export=word">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<form action="turkeyunitsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="turkeyunitsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="turkeyunitsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="turkeyunitsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="turkeyunitsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_turkeyunit_unitcode"] = "";
			$_SESSION["sort_turkeyunit_unitdescription"] = "";
		}
