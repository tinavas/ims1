...
$url1 = "?fromdate=" . $fromdate . "&todate=" . $todate . "&warehouse=" . $warehouse ."&cat=" . $cat;
		...
		$query = "SELECT code FROM ims_bagdetails WHERE client = '$client' ORDER BY code";
		$result = mysql_query($query,$conn1) or die(mysql_error());
		$i=-1;
		while($rows = mysql_fetch_assoc($result))
		  { 
		   if($_SESSION[db]=='golden' && ($rows['code']=='CON104' || $rows['code']=='CON105')) continue;
		   $bagarray[++$i]=$rows['code'];
		  }
...
// Group variables
$o_code = NULL; $g_code = NULL; $dg_code = NULL; $t_code = NULL; $ft_code = 500; $gf_code = $ft_code; $gb_code = ""; $gi_code = "0"; $gq_code = ""; $rf_code = NULL; $rt_code = NULL;

// Detail variables
$o_description = NULL; $t_description = NULL; $ft_description = 500; $rf_description = NULL; $rt_description = NULL;
$o_sunits = NULL; $t_sunits = NULL; $ft_sunits = 500; $rf_sunits = NULL; $rt_sunits = NULL;
?>
<?php
...
$q = "select distinct(type) from ims_itemtypes WHERE type <> 'Eggs' AND type <> 'Equipments' AND type <> 'Female Birds' AND type <> 'Hatch Eggs' AND type <> 'Male Birds' AND type <> 'Stationary' AND type <> 'Wastages'  AND type <> 'Layer Birds' AND type <> 'Layer Breeder Eggs' AND type <> 'Layer Eggs' AND type <> 'Layer Hatch Eggs' AND type <> 'LB Female Birds' AND type <> 'LB Male Birds'  order by type";
else
$q = "select distinct(type) from ims_itemtypes WHERE type <> 'Eggs' AND type <> 'Equipments' AND type <> 'Female Birds' AND type <> 'Hatch Eggs' AND type <> 'Male Birds' AND type <> 'Stationary' AND type <> 'Wastages' order by type";
...
<?php 
 ...
 $getop = "SELECT * FROM tbl_sector WHERE type = '$warehouse'";
  ...
  $brdunit = "";
   $getop = "SELECT * FROM tbl_sector WHERE warehouse = '$warehouse'";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $brdunit = $rowop['sector'];
  }
 ...
 $getop = "SELECT SUM(receivedquantity) as quantity FROM pp_sobi WHERE code = '$x_code' AND date < '$fromdate' AND warehouse = '$warehouse' AND dflag = '0'";
  ...
  $getop = "SELECT sum(production) as quantity FROM feed_productionunit WHERE mash = '$x_code' AND feedmill = '$feedmill' and date < '$fromdate' ";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
...
$getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE code = '$x_code' AND date < '$fromdate' AND unit = '$warehouse' and type = 'Deduct'";
  ...
  //$getop = "SELECT sum(quantity) as quantity FROM breeder_consumption WHERE itemcode = '$x_code' AND date1 < '$fromdate' AND flock = '$warehouse'";
   ...
   if(($_SESSION['db']!="gujarath")&&($cat=='Male Feed' || $cat=='Female Feed'))
  {
  
   $getop = "SELECT sum(quantity) as quantity FROM breeder_consumption WHERE itemcode = '$x_code' AND date2 < '$fromdate' AND flock  in (select distinct(flockcode) from breeder_flock where unitcode = '$brdunit')";
  $resultop = mysql_query($getop,$conn1) or die(mysql_error());
  while($rowop = mysql_fetch_assoc($resultop))
     $bcop = $rowop['quantity'];
  
  }
  else if ($cat=='Female Feed' || $cat=='Male Feed')
  {
   $getop = "SELECT sum(quantity) as quantity FROM layerbreeder_consumption WHERE itemcode = '$x_code' AND date2 < '$fromdate' AND flock in (select distinct(flockcode) from layerbreeder_flock)";
  $resultop = mysql_query($getop,$conn1) or die(mysql_error());
  while($rowop = mysql_fetch_assoc($resultop))
     $consumedop = $consumedop + $rowop['quantity'];
  }
  else if ($cat=='Layer Feed')
  {
 $getop = "SELECT sum(quantity) as quantity FROM layer_consumption WHERE itemcode = '$x_code' AND date2 < '$fromdate' AND flock in (select distinct(flockcode) from layer_flock where unitcode = '$brdunit')";
  $resultop = mysql_query($getop,$conn1) or die(mysql_error());
  while($rowop = mysql_fetch_assoc($resultop))
     $consumedop = $consumedop + $rowop['quantity'];
  }
  else if($cat=='Broiler Feed')
  {
   $getop = "SELECT sum(feedconsumed) as quantity FROM broiler_daily_entry WHERE feedtype = '$x_code' AND entrydate < '$fromdate' AND farm = '$warehouse'";
  $resultop = mysql_query($getop,$conn1) or die(mysql_error());
  while($rowop = mysql_fetch_assoc($resultop))
     $consumedop = $consumedop + $rowop['quantity'];
  }
  ...
  //echo "feed cons".$bcop;
if($cat == 'Medicines')  
  $getop = "SELECT sum(medicine_quantity) as quantity FROM broiler_daily_entry WHERE medicine_name = '$x_code' AND entrydate < '$fromdate' AND farm = '$farm'";
elseif($cat == 'Vaccines')
  $getop = "SELECT sum(vaccine_quantity) as quantity FROM broiler_daily_entry WHERE vaccine_name = '$x_code' AND entrydate < '$fromdate' AND farm = '$farm'";
...
//echo "feed cons".$bdeop;
 if($bdeop == "") $bdeop = 0; 
 $stockto = 0;
 /*if(strpos($cat,"Feed"))
  {
    $getop = "SELECT SUM(quantity) as quantity FROM ims_stocktransfer WHERE code = '$x_code' AND date < '$fromdate' and towarehouse in (select distinct(flockcode) from breeder_flock where unitcode = '$brdunit')";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
  ...
  */
  ...
  /*if(strpos($cat,"Feed"))
  {
  $getop = "SELECT SUM(quantity) as quantity FROM ims_stocktransfer WHERE code = '$x_code' AND date < '$fromdate' and fromwarehouse in (select distinct(flockcode) from breeder_flock where unitcode = '$brdunit')";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   ...
   if($cat == "Consumables" )
  {
   $query = "select sector from tbl_sector where type = '$warehouse'";
	...
	$type = $result['sector'];
	  ...
	  $query = "SELECT SUM(noofbags) AS noofbags FROM feed_productionunit WHERE bagtype = '$x_code' AND date < '$fromdate' and feedmill = '$type'";
	$result = mysql_query($query,$conn1) or die(mysql_error());
	$rows = mysql_fetch_assoc($result);
	$prod -= $rows['noofbags'];
	 $query = "SELECT bagtype as ebagtype, bags as enoofbags FROM pp_sobi WHERE bagtype LIKE '%$x_code%' AND date < '$fromdate' and warehouse = '$warehouse'";
	$result = mysql_query($query,$conn1) or die(mysql_error());
	while($rows = mysql_fetch_assoc($result))
	{
...
$opening = $firstopening + $purchasedop + $irecop + $staadd + $grop + $stockto - ($consumedop + $salesop + $iiscop + $staded + $bcop + $bdeop + $stockfrom) + $salesreturnop + $prod;
//echo $consumedop."/".$salesop."/".$iiscop."/".$staded."/".$bcop."/".$bdeop."/".$stockfrom; echo "</br>";
//echo $firstopening."/".$purchasedop."/".$irecop."/".$staadd."/".$grop."/".$stockto."/".$salesreturnop; 
 ...
 /*  if(strpos($cat,"Feed"))
  {
    $getop = "SELECT SUM(quantity) as quantity FROM ims_stocktransfer WHERE code = '$x_code' AND date >= '$fromdate' AND date <= '$todate' and towarehouse in (select distinct(flockcode) from breeder_flock where unitcode = '$brdunit')";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
    $purchased = $purchased + $rowop['quantity'];
 ...
 $getop = "SELECT sum(production) as quantity FROM feed_productionunit WHERE mash = '$x_code' AND feedmill = '$feedmill' and date >= '$fromdate' AND date <= '$todate' ";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $purchased=$purchased + $rowop['quantity'];
...
$getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE code = '$x_code' AND date >= '$fromdate' AND  date <= '$todate' and unit = '$warehouse' and type = 'Deduct'";
  ...
  if(($_SESSION['db']!="gujarath")&&($cat=='Male Feed' || $cat=='Female Feed'))
  {
  $getop = "SELECT sum(quantity) as quantity FROM breeder_consumption WHERE itemcode = '$x_code' AND date2 >= '$fromdate' AND  date2 <= '$todate' AND flock in (select distinct(flockcode) from breeder_flock where unitcode = '$brdunit')";
  $resultop = mysql_query($getop,$conn1) or die(mysql_error());
  while($rowop = mysql_fetch_assoc($resultop))
     $consumed = $consumed + $rowop['quantity'];
  }
  ...
  {
   $getop = "SELECT sum(quantity) as quantity FROM layerbreeder_consumption WHERE itemcode = '$x_code' AND date2 >= '$fromdate' AND  date2 <= '$todate' AND flock in (select distinct(flockcode) from layerbreeder_flock )";
  $resultop = mysql_query($getop,$conn1) or die(mysql_error());
  while($rowop = mysql_fetch_assoc($resultop))
     $consumed = $consumed + $rowop['quantity'];
  }
  ...
  {
   $getop = "SELECT sum(quantity) as quantity FROM layer_consumption WHERE itemcode = '$x_code' AND date2 >= '$fromdate' AND  date2 <= '$todate' AND flock in (select distinct(flockcode) from layer_flock where unitcode = '$brdunit')";
  $resultop = mysql_query($getop,$conn1) or die(mysql_error());
  while($rowop = mysql_fetch_assoc($resultop))
     $consumed = $consumed + $rowop['quantity'];
  }
  ...
  {
   $getop = "SELECT sum(feedconsumed) as quantity FROM broiler_daily_entry  WHERE feedtype = '$x_code' AND entrydate >= '$fromdate' AND  entrydate <= '$todate' AND farm='$farm'";
  $resultop = mysql_query($getop,$conn1) or die(mysql_error());
  while($rowop = mysql_fetch_assoc($resultop))
     $consumed = $consumed + $rowop['quantity'];
  }
 if($cat=='Vaccines')
  {
  	$query13="SELECT `sector` FROM `tbl_sector` where `warehouse`= '$warehouse'";
	$result13=mysql_query($query13,$conn1);
	while($rows13=mysql_fetch_assoc($result13))
	{
		$query14="SELECT `flockcode` FROM `breeder_flock` where `unitcode`='$rows13[sector]'";
		$result14=mysql_query($query14,$conn1);
		while($rows14=mysql_fetch_assoc($result14))
		{
		$query12="SELECT sum(quantity) as quantity  FROM `breeder_consumption` WHERE `flock`='$rows14[flockcode]' and itemcode = '$x_code' AND date2 >= '$fromdate' AND  date2 <= '$todate'";
		$result12=mysql_query($query12,$conn1);
		while($rows12=mysql_fetch_assoc($result12))
		{
			$rows12['quantity']."<br/>";
			 $consumed = $consumed + $rows12['quantity'];
		}
		}
	}
  } 
...
if($cat == 'Medicines')  
  $getop = "SELECT sum(medicine_quantity) as quantity FROM broiler_daily_entry WHERE medicine_name = '$x_code' AND entrydate >= '$fromdate' AND  entrydate <= '$todate' AND farm='$farm'";
elseif($cat == 'Vaccines')
  $getop = "SELECT sum(vaccine_quantity) as quantity FROM broiler_daily_entry WHERE vaccine_name = '$x_code' AND entrydate >= '$fromdate' AND  entrydate <= '$todate' AND farm = '$farm'";
if($cat == 'Medicines' OR $cat == 'Vaccines')
{
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   ...
   $consumed = $consumed + $rowop['quantity'];
	 ...
	 /*if(strpos($cat,"Feed"))
  {
    $getop = "SELECT SUM(quantity) as quantity FROM ims_stocktransfer WHERE code = '$x_code' AND date >= '$fromdate' AND date <= '$todate' and fromwarehouse in (select distinct(flockcode) from breeder_flock where unitcode = '$brdunit')";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $consumed = $consumed + $rowop['quantity'];
  ...
  if($cat == "Consumables" )
   {
	...
	$result = mysql_fetch_assoc($result);
	$type = $result['sector'];
	$query = "SELECT SUM(noofbags) AS noofbags FROM feed_productionunit WHERE bagtype = '$x_code' AND date BETWEEN '$fromdate' AND '$todate' and feedmill = '$type'";
	$result = mysql_query($query,$conn1) or die(mysql_error());
	$rows = mysql_fetch_assoc($result);
	$consumed += $rows['noofbags'];
	 $query = "SELECT bagtype as ebagtype, bags as enoofbags FROM pp_sobi WHERE bagtype LIKE '%$x_code%' AND date BETWEEN '$fromdate' AND '$todate' and warehouse = '$warehouse'";
	$result = mysql_query($query,$conn1) or die(mysql_error());
	while($rows = mysql_fetch_assoc($result))
	{
	 $temp1 = explode(',',$rows['ebagtype']);
...
if($cat=='Ingredients' || $cat=='Vacciens' || $cat=='Medicines' || $cat=='Broiler Chicks' ) 
 ...
 //echo $closing;
  ...
  $query1 = "select distinct(iac) from ims_itemcodes where cat = '$cat' and client = '$client'   ";
...
if(( $opening  == 0) && ( $purchased  == 0) && ( $closing  == 0) && ( $consumed  == 0) && ( $sales  == 0) )
{
 ...
 in_array($x_code,$bagarray);

if($cat != "Consumables" || in_array($x_code,$bagarray)) {
?>
	<tr>
		...
		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
			<?php echo changeprice(round($opening,2)); $total_opening+=round(($opening),2); ?>
		</td>
		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
			<?php echo changeprice(round($purchased,2)); $total_purchase+=$purchased; ?>			        </td>
		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
			<?php echo changeprice(round($consumed,2)); $total_consumed+=$consumed; ?>
		</td>

		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
			<?php echo changeprice($sales); $total_sold+=$sales; ?></td>
		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
			<?php echo changeprice($salesreturn); $total_salesreturn+=$salesreturn; ?>
		</td>
		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
			<?php echo changeprice(round(($closing),2)); $total_closing+=$closing; ?>
		</td>
		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
			<?php echo changeprice(round(($ratepunit),2));$totalratepunit=$totalratepunit+$ratepunit;?></td>
		
		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
			<?php echo changeprice(round(($inginitbal),2));$totalvalue=$totalvalue+$inginitbal;?></td>
		<?php if($_SESSION[db]=='maharashtra') {  ?>
		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
			<?php echo changeprice(round(($avgcost),2)); ?></td>
		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
			<?php echo changeprice(round(($closing*$avgcost),2)); $total_amount+=($closing*$avgcost); ?>
		</td>
		<?php } ?>
	</tr>
<?php } }
...
<tr>
	...
	<td align="right" ><?php echo changeprice(round($total_opening,2)) ;?></td>
	<td align="right" ><?php echo changeprice(round($total_purchase,2)) ;?></td>
	<td align="right" ><?php echo changeprice(round($total_consumed,2)) ;?></td>
	<td align="right" ><?php echo changeprice(round($total_sold,2)) ;?></td>
	<td align="right" ><?php echo changeprice(round($total_salesreturn,2)) ;?></td>
	
	<td align="right" ><?php echo changeprice(round($total_closing,2)) ;?></td>
	<td align="right" ><?php echo changeprice(round($totalratepunit,2)) ;?></td>
	<td align="right" ><?php echo changeprice(round($totalvalue,2)) ;?></td>
	<?php if($_SESSION[db]=='maharashtra') {  ?> 
	<td align="right" ><?php echo '&nbsp;' ?></td>
	<td align="right" ><?php echo changeprice(round($total_amount,2)) ;?></td> <?php } ?>
</tr>
	</tbody>
	<tfoot>
<?php
