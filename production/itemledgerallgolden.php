...
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">From Date&nbsp;</strong></font>
<?php echo $fdatedump;; ?>
               <strong><font color="#3e3276"> To Date &nbsp;</font></strong><?php echo $tdatedump;?></td>
</tr>
</table>
<br/>
...
$url = "&fromdate=" . $_GET['fromdate'] . "&todate=" . $_GET['todate'] . "&warehouse=" . $_GET['warehouse'];
// Get page start time
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="itemledgerallgolden.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="itemledgerallgolden.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="itemledgerallgolden.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<?php ?>
<td align="right">
<?php  echo ewrpt_ViewValue(round($totissqty,3));  ?>
</td>
<td align="right">
<?php  echo ewrpt_ViewValue();  ?>
</td>
