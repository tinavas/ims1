...
define("EW_REPORT_TABLE_VAR", "agglutination", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "agglutination_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "agglutination_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "agglutination_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "agglutination_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "agglutination_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "lab_agglutination";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT lab_agglutination.sampledate, lab_agglutination.reportdate, lab_agglutination.source, lab_agglutination.collectedby, lab_agglutination.positivebirds, lab_agglutination.totalbirds FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "lab_agglutination.sampledate ASC, lab_agglutination.reportdate ASC, lab_agglutination.source ASC, lab_agglutination.collectedby ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "lab_agglutination.sampledate", TRUE);
...
$af_positivebirds = NULL; // Popup filter for positivebirds
$af_totalbirds = NULL; // Popup filter for totalbirds
?>
<?php
...
?>
<?php
$EW_REPORT_FIELD_SAMPLEDATE_SQL_SELECT = "SELECT DISTINCT lab_agglutination.sampledate FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SAMPLEDATE_SQL_ORDERBY = "lab_agglutination.sampledate";
$EW_REPORT_FIELD_SOURCE_SQL_SELECT = "SELECT DISTINCT lab_agglutination.source FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SOURCE_SQL_ORDERBY = "lab_agglutination.source";
$EW_REPORT_FIELD_COLLECTEDBY_SQL_SELECT = "SELECT DISTINCT lab_agglutination.collectedby FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_COLLECTEDBY_SQL_ORDERBY = "lab_agglutination.collectedby";
?>
<?php
...
// Detail variables
$o_positivebirds = NULL; $t_positivebirds = NULL; $ft_positivebirds = 5; $rf_positivebirds = NULL; $rt_positivebirds = NULL;
$o_totalbirds = NULL; $t_totalbirds = NULL; $ft_totalbirds = 5; $rf_totalbirds = NULL; $rt_totalbirds = NULL;
?>
<?php
...
ewrpt_CreatePopup("agglutination_sampledate", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_source, $sel_source, $ft_source) ?>
ewrpt_CreatePopup("agglutination_source", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_collectedby, $sel_collectedby, $ft_collectedby) ?>
ewrpt_CreatePopup("agglutination_collectedby", [<?php echo $jsdata ?>]);
</script>
<div id="agglutination_sampledate_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="agglutination_source_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="agglutination_collectedby_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="agglutinationsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="agglutinationsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="agglutinationsmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="agglutinationsmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="agglutinationsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="agglutinationsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="agglutinationsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="agglutinationsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="agglutinationsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Sample Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'agglutination_sampledate', false, '<?php echo $rf_sampledate; ?>', '<?php echo $rt_sampledate; ?>');return false;" name="x_sampledate<?php echo $cnt[0][0]; ?>" id="x_sampledate<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Source</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'agglutination_source', false, '<?php echo $rf_source; ?>', '<?php echo $rt_source; ?>');return false;" name="x_source<?php echo $cnt[0][0]; ?>" id="x_source<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Collected By</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'agglutination_collectedby', false, '<?php echo $rf_collectedby; ?>', '<?php echo $rt_collectedby; ?>');return false;" name="x_collectedby<?php echo $cnt[0][0]; ?>" id="x_collectedby<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php echo ewrpt_ViewValue($x_positivebirds) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_totalbirds) ?>
</td>
	</tr>
<?php
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$GLOBALS['x_positivebirds'] = $rs->fields('positivebirds');
		$GLOBALS['x_totalbirds'] = $rs->fields('totalbirds');
		$val[1] = $GLOBALS['x_positivebirds'];
		$val[2] = $GLOBALS['x_totalbirds'];
	} else {
		$GLOBALS['x_reportdate'] = "";
		$GLOBALS['x_source'] = "";
		$GLOBALS['x_collectedby'] = "";
		$GLOBALS['x_positivebirds'] = "";
		$GLOBALS['x_totalbirds'] = "";
	}
}
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_agglutination_sampledate"])) {
		LoadSelectionFromSession('sampledate');
	} elseif (@$_SESSION["sel_agglutination_sampledate"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_sampledate"] = "";
	}

	// Get Source selected values
	if (is_array(@$_SESSION["sel_agglutination_source"])) {
		LoadSelectionFromSession('source');
	} elseif (@$_SESSION["sel_agglutination_source"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_source"] = "";
	}

	// Get Collectedby selected values
	if (is_array(@$_SESSION["sel_agglutination_collectedby"])) {
		LoadSelectionFromSession('collectedby');
	} elseif (@$_SESSION["sel_agglutination_collectedby"] == EW_REPORT_INIT_VALUE) { // Select all
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_agglutination_$parm"] = "";
	$_SESSION["rf_agglutination_$parm"] = "";
	$_SESSION["rt_agglutination_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_agglutination_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_agglutination_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_agglutination_$parm"];
}
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_sampledate"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_sampledate"], "lab_agglutination.sampledate", EW_REPORT_DATATYPE_DATE, $GLOBALS["af_sampledate"], $GLOBALS["gb_sampledate"], $GLOBALS["gi_sampledate"], $GLOBALS["gq_sampledate"]);
	}
	if (is_array($GLOBALS["sel_source"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_source"], "lab_agglutination.source", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_source"], $GLOBALS["gb_source"], $GLOBALS["gi_source"], $GLOBALS["gq_source"]);
	}
	if (is_array($GLOBALS["sel_collectedby"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_collectedby"], "lab_agglutination.collectedby", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_collectedby"], $GLOBALS["gb_collectedby"], $GLOBALS["gi_collectedby"], $GLOBALS["gq_collectedby"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_agglutination_sampledate"] = "";
			$_SESSION["sort_agglutination_reportdate"] = "";
			$_SESSION["sort_agglutination_source"] = "";
			$_SESSION["sort_agglutination_collectedby"] = "";
			$_SESSION["sort_agglutination_positivebirds"] = "";
			$_SESSION["sort_agglutination_totalbirds"] = "";
		}
