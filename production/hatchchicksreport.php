...
<tr>
<td style="text-align:center" colspan="3"><strong><font color="#3e3276">Chicks Stock Report </font></strong></td></tr>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="hatchchicksreport.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="hatchchicksreport.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="hatchchicksreport.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
$q = "select distinct(type) from ims_itemtypes WHERE (type = 'Broiler Chicks') order by type";
...
&nbsp;&nbsp;&nbsp;
<form action="hatchchicksreport.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
$irecop = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE date < '$fromdate' AND (warehouse in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || warehouse =  '$warehouse') and cat = '$cat' and riflag = 'R' ";
...
///////////////Intermediate Issue
$iiscop = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE date < '$fromdate' AND (warehouse in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || warehouse =  '$warehouse') and riflag = 'I' and cat = '$cat' ";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
...
$staadd = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE date < '$fromdate' AND (unit in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || unit =  '$warehouse') and type = 'Add' and category = '$cat' ";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
...
$staded = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE date < '$fromdate' AND (unit in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || unit =  '$warehouse') and type = 'Deduct' and category = '$cat' ";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
...
////////////Eggs Received
$eggreceive = 0;
$getop = "select sum(toeggs) as toeggs from ims_eggreceiving where date < '$fromdate' and tocode in (select distinct(code) from ims_itemcodes where cat = '$cat') and (towarehouse in (select distinct(warehouse) from tbl_sector where sector = '$warehouse') || (towarehouse =  '$warehouse')) ";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
...
////////////////////////////Sales
$sales = 0;
$getop = "SELECT SUM(quantity) as quantity FROM oc_cobi WHERE date < '$fromdate' and (warehouse in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || warehouse =  '$warehouse') and code in (select distinct(code) from ims_itemcodes where cat = 'Hatch Eggs') and dflag = 0";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
...
///////////////////////Pack Slip
$packslip = 0;
$getop = "SELECT SUM(quantity) as quantity FROM oc_packslip WHERE date < '$fromdate' and (warehouse in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || warehouse =  '$warehouse') and code in (select distinct(code) from ims_itemcodes where cat = 'Hatch Eggs')";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
...
///////////Eggs Received
$eggreceive = 0;
$getop = "select sum(toeggs) as toeggs from ims_eggreceiving where date >= '$fromdate' AND  date <= '$todate' and tocode in (select distinct(code) from ims_itemcodes where cat = '$cat') and (towarehouse in (select distinct(warehouse) from tbl_sector where sector = '$warehouse') || (towarehouse =  '$warehouse')) ";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$eggreceive = $rowop['toeggs'];
$staadd = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE date >= '$fromdate' AND  date <= '$todate' AND (unit in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || unit =  '$warehouse') and type = 'Add' and category = '$cat' ";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$staadd = $rowop['quantity'];
if($staadd == "") $staadd = 0;
///////////////Stock Adjustment (Deduct)
$staded = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE date >= '$fromdate' AND  date <= '$todate' AND (unit in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || unit =  '$warehouse') and type = 'Deduct' and category = '$cat' ";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$staded = $rowop['quantity'];
if($staded == "") $staded = 0;
...
///////////////Intermediate Receipt
$irecop = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE date >= '$fromdate' AND  date <= '$todate' AND (warehouse in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || warehouse =  '$warehouse') and cat = '$cat' and riflag = 'R' ";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$irecop = $rowop['quantity'];
if($irecop == "") $irecop = 0;

$getop = "SELECT SUM(saleablechicks) as salablechicks FROM hatchery_hatchrecord WHERE hatchdate >= '$fromdate' AND  hatchdate <= '$todate' and (hatchery in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || hatchery =  '$warehouse') ";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$trayop =$rowop['salablechicks'];
...
$sales = 0;
 $getop = "SELECT SUM(quantity) as quantity FROM oc_cobi WHERE date >= '$fromdate' AND date <= '$todate' and (warehouse in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || warehouse =  '$warehouse') and code in (select distinct(code) from ims_itemcodes where cat = 'Hatch Eggs') and dflag = 0 ";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$sales = $rowop['quantity'];
///////////////////////Pack Slip
$packslip = 0;
$getop = "SELECT SUM(quantity) as quantity FROM oc_packslip WHERE date >= '$fromdate' AND date <= '$todate' and (warehouse in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || warehouse =  '$warehouse') and code in (select distinct(code) from ims_itemcodes where cat = 'Hatch Eggs')";
$resultop = mysql_query($getop,$conn1);
...
{
$getop = "SELECT SUM(quantity) as chicksales FROM oc_cobi WHERE date >= '$fromdate' AND date <= '$todate' and (warehouse in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || warehouse =  '$warehouse') and code in (select distinct(code) from ims_itemcodes where cat = 'Broiler Chicks') and client = '$client' and dflag = 0";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
...
$stockfrom = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stocktransfer WHERE date >= '$fromdate' AND  date <= '$todate' and (fromwarehouse in(select distinct(warehouse) from tbl_sector where sector = '$warehouse') || fromwarehouse =  '$warehouse') and cat = 'Broiler Chicks' and client = '$client'";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$stockfrom = $rowop['quantity'];
...
<td <?php echo $sItemRowClass; ?> align="right"><b><?php echo '&nbsp';?></b></td>
...
<td <?php echo $sItemRowClass; ?> align="right"><b><?php echo '&nbsp;'?></b></td>
	</tbody>
	<tfoot>
<?php
...
if(Date.parse(date1) <= Date.parse(date2))
	{
	document.location = "hatchchicksreport.php?fromdate=" + fromdate + "&todate=" + todate + "&warehouse=" + warehouse + "&cat=" + cat;
	}
	else
	{
