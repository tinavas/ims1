...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "layerbreeder_farm";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT layerbreeder_farm.code, layerbreeder_farm.description, layerbreeder_farm.capacity FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Farm</font></strong></td>
</tr>
</table>
<br/>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="lbfarmsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="lbfarmsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="lbfarmsmry.php?export=word">Export to Word</a><br /><br />
<?php } ?>
...
<form action="lbfarmsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="lbfarmsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="lbfarmsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="lbfarmsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="lbfarmsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php
	...
	//}
$query = "select * from layerbreeder_farm order by code";
...
<?php echo ewrpt_ViewValue($rows['code']) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(str_replace(chr(10), "<br>", $rows['description'])); ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($rows['capacity']) ?>
</td>
	</tr>
<?php
}
...
function getSort()
{
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] = "layerbreeder_farm.code ASC";
