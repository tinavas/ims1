...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "breeder_unit";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT breeder_unit.unitcode, breeder_unit.unitdescription, breeder_unit.farmcode, breeder_unit.farmdescription, breeder_unit.ohtcapacity, breeder_unit.sumpcapacity, breeder_unit.labour FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "breeder_unit.farmcode ASC, breeder_unit.farmdescription ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "breeder_unit.farmcode", TRUE);
...
$EW_REPORT_TABLE_SQL_SELECT_AGG = "SELECT SUM(breeder_unit.ohtcapacity) AS SUM_ohtcapacity, SUM(breeder_unit.sumpcapacity) AS SUM_sumpcapacity, SUM(breeder_unit.labour) AS SUM_labour FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
?>
<?php
$EW_REPORT_FIELD_FARMCODE_SQL_SELECT = "SELECT DISTINCT breeder_unit.farmcode FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_FARMCODE_SQL_ORDERBY = "breeder_unit.farmcode";
?>
<?php
...
<br/>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="unitsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="unitsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="unitsmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="unitsmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<br /><br />
<?php } ?>
...
<form action="unitsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_farmcode"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_farmcode"], "breeder_unit.farmcode", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_farmcode"], $GLOBALS["gb_farmcode"], $GLOBALS["gi_farmcode"], $GLOBALS["gq_farmcode"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] = "breeder_unit.unitcode ASC";
