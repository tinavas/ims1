...
<td align="right">
<?php if ( $row2['crdr'] == "Dr" ) { echo ewrpt_ViewValue(changeprice($row21['cramount'])); $drtotal = $drtotal + $row21['cramount']; }
      else { echo ewrpt_ViewValue("&nbsp;"); } ?>
</td>
<td align="right">
<?php if ( $row2['crdr'] == "Cr" ) { echo ewrpt_ViewValue(changeprice($row21['dramount'])); $crtotal = $crtotal + $row21['dramount']; } 
      else { echo ewrpt_ViewValue("&nbsp;"); }?>
</td>
	</tr>
		<?php	 
...
<td align="right">
<?php if ( $row21['crdr'] == "Cr" ) { echo ewrpt_ViewValue(changeprice($row21['cramount'])); $drtotal = $drtotal + $row21['cramount']; }
      else { echo ewrpt_ViewValue("&nbsp;"); } ?>
</td>
<td align="right">
<?php if ( $row21['crdr'] == "Dr" ) { echo ewrpt_ViewValue(changeprice($row21['dramount'])); $crtotal = $crtotal + $row21['dramount']; } 
      else { echo ewrpt_ViewValue("&nbsp;"); }?>
</td>
	</tr>
		<?php
		...
		?>
<?php if($typename <> "PV-Payment Voucher" && $typename <> "RV-Receipt Voucher")	{  ?>			
	<tr>
		<td class="ewRptGrpField1">
		<?php echo ewrpt_ViewValue(date($datephp,strtotime($row2['date']))) ?>
		</td>
