...
define("EW_REPORT_TABLE_VAR", "hatchery_hatchrecord1", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "hatchery_hatchrecord1_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "hatchery_hatchrecord1_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "hatchery_hatchrecord1_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "hatchery_hatchrecord1_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "hatchery_hatchrecord1_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "hatchery_hatchrecord";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT hatchery_hatchrecord.hatchdate, hatchery_hatchrecord.settingno, hatchery_hatchrecord.unit, hatchery_hatchrecord.shed, hatchery_hatchrecord.flock, hatchery_hatchrecord.noofeggsset, hatchery_hatchrecord.code, hatchery_hatchrecord.rejections, hatchery_hatchrecord.percentage, hatchery_hatchrecord.totalrejections, hatchery_hatchrecord.hatch, hatchery_hatchrecord.hatchper, hatchery_hatchrecord.culls, hatchery_hatchrecord.cullsper, hatchery_hatchrecord.saleablechicks, hatchery_hatchrecord.saleableper, hatchery_hatchrecord.avgweight, hatchery_hatchrecord.waterlossper, hatchery_hatchrecord.before12, hatchery_hatchrecord.before24,hatchery_hatchrecord.hatchery FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "'$fromdate' <= hatchery_hatchrecord.hatchdate and hatchery_hatchrecord.hatchdate <= '$todate'";
$EW_REPORT_TABLE_SQL_GROUPBY = "hatchery_hatchrecord.hatchdate, hatchery_hatchrecord.settingno, hatchery_hatchrecord.unit, hatchery_hatchrecord.shed, hatchery_hatchrecord.flock, hatchery_hatchrecord.noofeggsset, hatchery_hatchrecord.code, hatchery_hatchrecord.rejections, hatchery_hatchrecord.percentage, hatchery_hatchrecord.totalrejections, hatchery_hatchrecord.hatch, hatchery_hatchrecord.hatchper, hatchery_hatchrecord.culls, hatchery_hatchrecord.cullsper, hatchery_hatchrecord.saleablechicks, hatchery_hatchrecord.saleableper, hatchery_hatchrecord.avgweight, hatchery_hatchrecord.waterlossper, hatchery_hatchrecord.before12, hatchery_hatchrecord.before24";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "hatchery_hatchrecord.hatchdate ASC, hatchery_hatchrecord.settingno ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "hatchery_hatchrecord.hatchdate", TRUE);
...
$EW_REPORT_TABLE_SQL_SELECT_AGG = "SELECT SUM(hatchery_hatchrecord.noofeggsset) AS SUM_noofeggsset, SUM(hatchery_hatchrecord.totalrejections) AS SUM_totalrejections, SUM(hatchery_hatchrecord.hatch) AS SUM_hatch, SUM(hatchery_hatchrecord.culls) AS SUM_culls, SUM(hatchery_hatchrecord.saleablechicks) AS SUM_saleablechicks FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
?>
<?php
$EW_REPORT_FIELD_HATCHDATE_SQL_SELECT = "SELECT DISTINCT hatchery_hatchrecord.hatchdate FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_HATCHDATE_SQL_ORDERBY = "hatchery_hatchrecord.hatchdate";
$EW_REPORT_FIELD_SETTINGNO_SQL_SELECT = "SELECT DISTINCT hatchery_hatchrecord.settingno FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SETTINGNO_SQL_ORDERBY = "hatchery_hatchrecord.settingno";
$EW_REPORT_FIELD_UNIT_SQL_SELECT = "SELECT DISTINCT hatchery_hatchrecord.unit FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_UNIT_SQL_ORDERBY = "hatchery_hatchrecord.unit";
$EW_REPORT_FIELD_SHED_SQL_SELECT = "SELECT DISTINCT hatchery_hatchrecord.shed FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SHED_SQL_ORDERBY = "hatchery_hatchrecord.shed";
$EW_REPORT_FIELD_FLOCK_SQL_SELECT = "SELECT DISTINCT hatchery_hatchrecord.flock FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_FLOCK_SQL_ORDERBY = "hatchery_hatchrecord.flock";
?>
<?php
...
//$o_hatchery = NULL; $g_hatchery = NULL; $dg_hatchery = NULL; $t_hatchery = NULL; $ft_hatchery = 133; $gf_hatchery = $ft_hatchery; $gb_hatchery = ""; $gi_hatchery = "0"; $gq_hatchery = ""; $rf_hatchery = NULL; $rt_hatchery = NULL;
...
$o_hatchery = NULL; $t_hatchery = NULL; $ft_hatchery = 200; $rf_hatchery = NULL; $rt_hatchery = NULL;
...
ewrpt_CreatePopup("hatchery_hatchrecord1_hatchdate", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_settingno, $sel_settingno, $ft_settingno) ?>
ewrpt_CreatePopup("hatchery_hatchrecord1_settingno", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_hatchery, $sel_hatchery, $ft_hatchery) ?>
ewrpt_CreatePopup("hatchery_hatchrecord1_hatchery", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_unit, $sel_unit, $ft_unit) ?>
ewrpt_CreatePopup("hatchery_hatchrecord1_unit", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_shed, $sel_shed, $ft_shed) ?>
ewrpt_CreatePopup("hatchery_hatchrecord1_shed", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_flock, $sel_flock, $ft_flock) ?>
ewrpt_CreatePopup("hatchery_hatchrecord1_flock", [<?php echo $jsdata ?>]);
</script>
<div id="hatchery_hatchrecord1_hatchdate_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_hatchrecord1_settingno_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_hatchrecord1_hatchery_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_hatchrecord1_unit_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_hatchrecord1_shed_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_hatchrecord1_flock_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">From Date&nbsp;</font></strong><?php echo date($datephp,strtotime($_GET['fromdate'])); ?>&nbsp;&nbsp;<strong><font color="#3e3276">To Date &nbsp;</font></strong><?php echo date($datephp,strtotime($_GET['todate']));?></font></td>
</tr>
</table>
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="hatchery_hatchrecord1smry.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="hatchery_hatchrecord1smry.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="hatchery_hatchrecord1smry.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="hatchery_hatchrecord1smry.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<br /><br />
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<form action="hatchery_hatchrecord1smry.php<?php echo $url1; ?>" name="ewpagerform" id="ewpagerform" class="ewForm">
<table border="0" cellspacing="0" cellpadding="0" style="visibility:hidden">
	<tr>
		<td nowrap>
<?php if (!isset($Pager)) $Pager = new cPrevNextPager($nStartGrp, $nDisplayGrps, $nTotalGrps) ?>
<?php if ($Pager->RecordCount > 0) { ?>
	<table border="0" cellspacing="0" cellpadding="0" style="visibility:hidden"><tr><td><span class="phpreportmaker">Page&nbsp;</span></td>
<!--first page button-->
	<?php if ($Pager->FirstButton->Enabled) { ?>
	<td><a href="hatchery_hatchrecord1smry.php?start=<?php echo $Pager->FirstButton->Start ?><?php echo $url; ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="hatchery_hatchrecord1smry.php?start=<?php echo $Pager->PrevButton->Start ?><?php echo $url; ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="hatchery_hatchrecord1smry.php?start=<?php echo $Pager->NextButton->Start ?><?php echo $url; ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="hatchery_hatchrecord1smry.php?start=<?php echo $Pager->LastButton->Start ?><?php echo $url; ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_hatchrecord1_hatchdate', false, '<?php echo $rf_hatchdate; ?>', '<?php echo $rt_hatchdate; ?>');return false;" name="x_hatchdate<?php echo $cnt[0][0]; ?>" id="x_hatchdate<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if($_SESSION['client'] != 'ALKHUBRD') { ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Hatchery
		</td>
...
<?php if($_SESSION[db]!='alkhumasiyabrd') if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Setting<br/>No.
		</td>
<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Hatchery</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_hatchrecord1_hatchery', false, '<?php echo $rf_hatchery; ?>', '<?php echo $rt_hatchery; ?>');return false;" name="x_hatchery<?php echo $cnt[0][0]; ?>" id="x_hatchery<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php }*/ ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Unit</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_hatchrecord1_unit', false, '<?php echo $rf_unit; ?>', '<?php echo $rt_unit; ?>');return false;" name="x_unit<?php echo $cnt[0][0]; ?>" id="x_unit<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if($_SESSION[db]!='alkhumasiyabrd') if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Shed</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_hatchrecord1_shed', false, '<?php echo $rf_shed; ?>', '<?php echo $rt_shed; ?>');return false;" name="x_shed<?php echo $cnt[0][0]; ?>" id="x_shed<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Flock</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_hatchrecord1_flock', false, '<?php echo $rf_flock; ?>', '<?php echo $rt_flock; ?>');return false;" name="x_flock<?php echo $cnt[0][0]; ?>" id="x_flock<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if($_SESSION['db'] == "farmvalley") { ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Hatch No:
		</td>
...
<?php if(date("d.m.Y",strtotime($x_hatchdate)) <> "01.01.1970") echo ewrpt_ViewValue(date($datephp,strtotime($x_hatchdate))); else echo ewrpt_ViewValue(); ?>
...
<?php } ?>
	...
	<?php if($_SESSION[db]!='alkhumasiyabrd') { ?>	<td class="ewRptGrpField2">
...
<?php 
if($_SESSION['db'] == "farmvalley") { 
$q1 = "select settingno from hatchery_traysetting where flock = '$x_flock' and unit = '$x_unit' AND hatchdate = '$x_hatchdate' AND eggsset = '$x_noofeggsset' and client = '$client'";
$r1 = mysql_query($q1,$conn1) or die(mysql_error());
$qr1 = mysql_fetch_assoc($r1);

$hnum = $qr1['settingno'];
?>

<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($hnum) ?>
</td> 
<?php } ?>
...
<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue(round($x_saleablechicks,2)) ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue(round($x_saleableper,2)) ?>
</td>
<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($x_culls) ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($x_cullsper) ?>
</td>
<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($x_hatch) ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue(round($x_hatchper,2)) ?>
</td>
<?php 
$dih = 0;
$dihper = 0;
$sdih = 0;
$sdihper = 0;
$q = "select * from hatchery_hatchrecord where settingno = '$x_settingno' order by code";
$qrs = mysql_query($q,$conn1) or die(mysql_error());
while($qr = mysql_fetch_assoc($qrs))
{
 $dih = $qr['dih'];
...
$q = "select sum(dih) as sdih from hatchery_hatchrecord where hatchdate = '$x_hatchdate'";
$qrs = mysql_query($q,$conn1) or die(mysql_error());
while($qr = mysql_fetch_assoc($qrs))
{
 $sdih = $qr['sdih'];
...
$q = "select sum(dih) as gdih from hatchery_hatchrecord  where hatchdate = '$x_hatchdate'";
$qrs = mysql_query($q,$conn1) or die(mysql_error());
while($qr = mysql_fetch_assoc($qrs))
{
 $gdih = $qr['gdih'];
...
<?php if($_SESSION['db'] == "feedatives") { 
 $q = "select cost from hatchery_hatchrecord  where hatchdate = '$x_hatchdate' AND flock = '$x_flock' LIMIT 1";
$qrs = mysql_query($q,$conn1) or die(mysql_error());
$qr = mysql_fetch_assoc($qrs);
$cost = round($qr['cost'],2); ?>
		<td <?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($cost) ?>
</td>
<?php } ?>
		<!--<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($x_waterlossper) ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($x_before12) ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($x_before24) ?>
</td>-->
	</tr>
<?php
...
?>
	<tr style="display:none">
		...
		<td colspan="<?php echo 17 + $count *2 ; ?>" class="ewRptGrpSummary2">Summary for Settingno: <?php $t_settingno = $x_settingno; $x_settingno = $o_settingno; ?>
<?php echo ewrpt_ViewValue($x_settingno) ?>
...
?>
	<tr style="display:none">
		<td colspan="<?php echo 17 + $count * 2; ?>" class="ewRptGrpSummary1">Summary for Hatchdate: <?php $t_hatchdate = $x_hatchdate; $x_hatchdate = $o_hatchdate; ?>
...
<?php echo $g_totalrejections; #ewrpt_ViewValue($x_totalrejections) ?>
		...
		<td>&nbsp;</td>
		<?php if($_SESSION['db'] == "feedatives") { ?> <td>&nbsp;</td> <?php } ?>
		<!--<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>-->
	</tr>
...
function SetupPopup() {
	...
	while ($rswrk && !$rswrk->EOF) {
		...
		if (is_null($x_hatchery)) {
			...
			$t_hatchery = $x_hatchery;
			ewrpt_SetupDistinctValues($GLOBALS["val_hatchery"], $x_hatchery, $t_hatchery, FALSE);
		}
		$rswrk->MoveNext();
	}
	if ($rswrk)
	...
	if (is_array(@$_SESSION["sel_hatchery_hatchrecord1_hatchdate"])) {
		LoadSelectionFromSession('hatchdate');
	} elseif (@$_SESSION["sel_hatchery_hatchrecord1_hatchdate"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_hatchdate"] = "";
	}

	// Get Settingno selected values
	if (is_array(@$_SESSION["sel_hatchery_hatchrecord1_settingno"])) {
		LoadSelectionFromSession('settingno');
	} elseif (@$_SESSION["sel_hatchery_hatchrecord1_settingno"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_settingno"] = "";
	}
	
	// Get Unit selected values
	if (is_array(@$_SESSION["sel_hatchery_hatchrecord1_hatchery"])) {
		LoadSelectionFromSession('hatchery');
	} elseif (@$_SESSION["sel_hatchery_hatchrecord1_hatchery"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_hatchery"] = "";
	}

	// Get Unit selected values
	if (is_array(@$_SESSION["sel_hatchery_hatchrecord1_unit"])) {
		LoadSelectionFromSession('unit');
	} elseif (@$_SESSION["sel_hatchery_hatchrecord1_unit"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_unit"] = "";
	}

	// Get Shed selected values
	if (is_array(@$_SESSION["sel_hatchery_hatchrecord1_shed"])) {
		LoadSelectionFromSession('shed');
	} elseif (@$_SESSION["sel_hatchery_hatchrecord1_shed"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_shed"] = "";
	}

	// Get Flock selected values
	if (is_array(@$_SESSION["sel_hatchery_hatchrecord1_flock"])) {
		LoadSelectionFromSession('flock');
	} elseif (@$_SESSION["sel_hatchery_hatchrecord1_flock"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_flock"] = "";
	}
}
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_hatchery_hatchrecord1_$parm"] = "";
	$_SESSION["rf_hatchery_hatchrecord1_$parm"] = "";
	$_SESSION["rt_hatchery_hatchrecord1_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_hatchery_hatchrecord1_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_hatchery_hatchrecord1_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_hatchery_hatchrecord1_$parm"];
}
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_hatchdate"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_hatchdate"], "hatchery_hatchrecord.hatchdate", EW_REPORT_DATATYPE_DATE, $GLOBALS["af_hatchdate"], $GLOBALS["gb_hatchdate"], $GLOBALS["gi_hatchdate"], $GLOBALS["gq_hatchdate"]);
	}
	if (is_array($GLOBALS["sel_settingno"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_settingno"], "hatchery_hatchrecord.settingno", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_settingno"], $GLOBALS["gb_settingno"], $GLOBALS["gi_settingno"], $GLOBALS["gq_settingno"]);
	}
	if (is_array($GLOBALS["sel_hatchery"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_hatchery"], "hatchery_hatchrecord.hatchery", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_hatchery"]);
	}
	if (is_array($GLOBALS["sel_unit"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_unit"], "hatchery_hatchrecord.unit", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_unit"]);
	}
	if (is_array($GLOBALS["sel_shed"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_shed"], "hatchery_hatchrecord.shed", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_shed"]);
	}
	if (is_array($GLOBALS["sel_flock"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_flock"], "hatchery_hatchrecord.flock", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_flock"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_hatchery_hatchrecord1_hatchdate"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_settingno"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_hatchery"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_unit"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_shed"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_flock"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_noofeggsset"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_code"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_rejections"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_percentage"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_totalrejections"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_hatch"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_hatchper"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_culls"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_cullsper"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_saleablechicks"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_saleableper"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_avgweight"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_waterlossper"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_before12"] = "";
			$_SESSION["sort_hatchery_hatchrecord1_before24"] = "";
		}
