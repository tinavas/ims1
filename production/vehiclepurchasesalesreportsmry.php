...
define("EW_REPORT_TABLE_VAR", "vehiclepurchasesalesreport", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "vehiclepurchasesalesreport_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "vehiclepurchasesalesreport_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "vehiclepurchasesalesreport_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "vehiclepurchasesalesreport_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "vehiclepurchasesalesreport_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "vehicle_master";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT vehicle_master.unit, vehicle_master.vtype, vehicle_master.vnumber, vehicle_master.purchasedate FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
ewrpt_CreatePopup("vehiclepurchasesalesreport_unit", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_vtype, $sel_vtype, $ft_vtype) ?>
ewrpt_CreatePopup("vehiclepurchasesalesreport_vtype", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_vnumber, $sel_vnumber, $ft_vnumber) ?>
ewrpt_CreatePopup("vehiclepurchasesalesreport_vnumber", [<?php echo $jsdata ?>]);
</script>
<div id="vehiclepurchasesalesreport_unit_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="vehiclepurchasesalesreport_vtype_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="vehiclepurchasesalesreport_vnumber_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Carried Items<br /> </font></strong></td>
</tr>
</table>
<br/>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="vehiclepurchasesalesreportsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="vehiclepurchasesalesreportsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="vehiclepurchasesalesreportsmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="vehiclepurchasesalesreportsmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="vehiclepurchasesalesreportsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="vehiclepurchasesalesreportsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="vehiclepurchasesalesreportsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="vehiclepurchasesalesreportsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="vehiclepurchasesalesreportsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Unit</td>
			<td style="width: 20px;" align="right"><?php /*?><a href="#" onClick="ewrpt_ShowPopup(this.name, 'vehiclepurchasesalesreport_unit', false, '<?php echo $rf_unit; ?>', '<?php echo $rt_unit; ?>');return false;" name="x_unit<?php echo $cnt[0][0]; ?>" id="x_unit<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a><?php */?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Vehicle Type</td>
			<td style="width: 20px;" align="right"><?php /*?><a href="#" onClick="ewrpt_ShowPopup(this.name, 'vehiclepurchasesalesreport_vtype', false, '<?php echo $rf_vtype; ?>', '<?php echo $rt_vtype; ?>');return false;" name="x_vtype<?php echo $cnt[0][0]; ?>" id="x_vtype<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a><?php */?></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
//	echo "sql: " . $sSql . "<br>";
	...
	while ($rs && !$rs->EOF) { // Loop detail records
		...
		$dumm3 = 0;
		$dumm4 = 0;
		$date = date("d.m.Y",strtotime($x_purchasedate));
	  $q1 = "select distinct(invoice) from pp_sobi where vno = '$x_vnumber'";
		$r1 =mysql_query($q1);
		while($qr1 = mysql_fetch_assoc($r1))
		{
		$inv = $qr1['invoice'];
		$ic = "";
	  $q = "select * from pp_sobi where vno = '$x_vnumber' and invoice = '$inv'";
...
<?php if(($x_unit <> $oldcode) or ($dumm == 0)){ echo ewrpt_ViewValue($x_unit);
     $oldcode = $x_unit; $dumm = 1; }
	 else{
...
<td<?php echo $sItemRowClass; ?>>
<?php if(($x_vtype <> $oldcode1) or ($dumm1 == 0)){ echo ewrpt_ViewValue($x_vtype);
     $oldcode1 = $x_vtype; $dumm1 = 1; }
	 else{
	 echo ewrpt_ViewValue("&nbsp;");
	 } ?>
...
<td<?php echo $sItemRowClass; ?>>
<?php if(($x_vnumber <> $oldcode2) or ($dumm2 == 0)){ echo ewrpt_ViewValue($x_vnumber);
     $oldcode2 = $x_vnumber; $dumm2 = 1; }
	 else{
	 echo ewrpt_ViewValue("&nbsp;");
	 } ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php if(($date <> $oldcode4) or ($dumm4 == 0)){ echo ewrpt_ViewValue($date);
     $oldcode4 = $date; $dumm4 = 1; }
	 else{
	 echo ewrpt_ViewValue("&nbsp;");
	 } ?>
...
<td<?php echo $sItemRowClass; ?>>
<?php if(($type <> $oldcode3) or ($dumm3 == 0)){ echo ewrpt_ViewValue($type);
     $oldcode3 = $type; $dumm3 = 1; }
	 else{
	 echo ewrpt_ViewValue("&nbsp;");
	 } ?>
...
<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($ic) ?>
</td>
<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($vendor) ?>
</td>
 ...
 $dumm = 0;
		...
		$dumm3 = 0;
		$dumm4 = 0;
	$q1 = "select distinct(invoice) from oc_cobi where vno = '$x_vnumber'";
		$r1 =mysql_query($q1,$conn1);
		while($qr1 = mysql_fetch_assoc($r1))
		{
		$inv = $qr1['invoice'];
		$ic = "";
		 $q = "select * from oc_cobi where vno = '$x_vnumber' and invoice = '$inv'";
		$r = mysql_query($q,$conn1);
		$n = mysql_num_rows($r);
		while($qr = mysql_fetch_assoc($r))
		{
...
<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($party) ?>
</td>
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_vehiclepurchasesalesreport_unit"])) {
		LoadSelectionFromSession('unit');
	} elseif (@$_SESSION["sel_vehiclepurchasesalesreport_unit"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_unit"] = "";
	}

	// Get Vtype selected values
	if (is_array(@$_SESSION["sel_vehiclepurchasesalesreport_vtype"])) {
		LoadSelectionFromSession('vtype');
	} elseif (@$_SESSION["sel_vehiclepurchasesalesreport_vtype"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_vtype"] = "";
	}

	// Get Vnumber selected values
	if (is_array(@$_SESSION["sel_vehiclepurchasesalesreport_vnumber"])) {
		LoadSelectionFromSession('vnumber');
	} elseif (@$_SESSION["sel_vehiclepurchasesalesreport_vnumber"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_vnumber"] = "";
	}
}
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_vehiclepurchasesalesreport_$parm"] = "";
	$_SESSION["rf_vehiclepurchasesalesreport_$parm"] = "";
	$_SESSION["rt_vehiclepurchasesalesreport_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_vehiclepurchasesalesreport_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_vehiclepurchasesalesreport_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_vehiclepurchasesalesreport_$parm"];
}
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_vehiclepurchasesalesreport_unit"] = "";
			$_SESSION["sort_vehiclepurchasesalesreport_vtype"] = "";
			$_SESSION["sort_vehiclepurchasesalesreport_vnumber"] = "";
			$_SESSION["sort_vehiclepurchasesalesreport_purchasedate"] = "";
		}
