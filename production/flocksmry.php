...
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="flocksmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="flocksmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="flocksmry.php?export=word">Export to Word</a><br /><br />
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="flocksmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
...
<form action="flocksmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="flocksmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="flocksmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="flocksmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="flocksmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
///////////// Opening Birds ///////////////////
		 ...
		 while($qr = mysql_fetch_assoc($qrs))
		 {
             ...
             $q = "select sum(quantity) as 'quantity' from ims_stocktransfer where cat = 'Birds' and client = '$client'  and fromwarehouse = '$x_flock' and date < '$x_date2'"; 
    		 $qrs = mysql_query($q,$conn1) or die(mysql_error());
		   ...
		   while($qr = mysql_fetch_assoc($qrs))
             ...
             $q = "select sum(quantity) as 'quantity' from oc_cobi where flock = '$x_flock' and client = '$client'  and date < '$x_date2' and code in (select distinct(code) from ims_itemcodes where cat = 'Birds' and client = '$client')"; 
    		 $qrs = mysql_query($q,$conn1) or die(mysql_error());
             if(mysql_num_rows($qrs))
             {
		   while($qr = mysql_fetch_assoc($qrs))
             ...
             $q = "select sum(quantity) as 'quantity' from ims_stocktransfer where cat = 'Birds' and client = '$client'  and towarehouse = '$x_flock' and date < '$x_date2'"; 
    		 $qrs = mysql_query($q,$conn1) or die(mysql_error());
             if(mysql_num_rows($qrs))
             {
		   while($qr = mysql_fetch_assoc($qrs))
             ...
             $q = "select sum(receivedquantity) as 'quantity' from pp_sobi where warehouse = '$x_flock' and client = '$client'  and date < '$x_date2' and code in (select distinct(code) from ims_itemcodes where cat = 'Birds' and client = '$client')"; 
    		 $qrs = mysql_query($q,$conn1) or die(mysql_error());
             if(mysql_num_rows($qrs))
             {
		   while($qr = mysql_fetch_assoc($qrs))
...
<?php echo round(($totaleggs/$remaining) * 100,2); ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo round(($x_quantity / $totaleggs) * 1000,2); ?>
</td>
<?php
  
  $query467 = "SELECT * FROM feed_productionunit where mash = '$x_itemcode' and client = '$client' and date <= '$x_date2' ORDER BY date ASC ";
  $result467 = mysql_query($query467,$conn1); 
  while($row467 = mysql_fetch_assoc($result467))
  { 
      $feedcost = $row467['feedcostperkg'];
  } 
?>
		<td<?php echo $sItemRowClass; ?>>
<?php echo round(($x_quantity * $feedcost) / $totaleggs,2); ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
