...
<tr>
<td align="center"><strong><font color="#3e3276">Sector:&nbsp;<?php echo $_GET['sector']; ?></font></strong></td>
<td align="center"><strong><font color="#3e3276">Item Code:&nbsp;<?php echo $_GET['code']; ?></font></strong></td>
</tr>
...
define("EW_REPORT_TABLE_VAR", "quailitemledger", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "quailitemledger_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "quailitemledger_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "quailitemledger_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "quailitemledger_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "quailitemledger_orderby", TRUE);
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quailitemledger.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="quailitemledger.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="quailitemledger.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<form action="quailitemledger.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="quailitemledger.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quailitemledger.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quailitemledger.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quailitemledger.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewRptGrpHeader3" align="center">
		Date
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
...
$q = "select * from ims_itemcodes where code  = '$code'  ";
	...
	//Issues
$q = "select amount,quantity,type,trnum from ac_financialpostings where crdr = 'Cr' and itemcode  = '$code' and coacode = '$itemcode' and date < '$fdate' AND warehouse = '$sector' order by date ";
	$qrs = mysql_query($q,$conn1) or die(mysql_error());
	while($qr = mysql_fetch_assoc($qrs))
	{
    ...
    // Receipts 
  $q = "select amount,quantity,type,trnum from ac_financialpostings where itemcode  = '$code' and crdr = 'Dr' and coacode = '$itemcode' and date < '$fdate' AND warehouse = '$sector' order by date ";
	$qrs = mysql_query($q,$conn1) or die(mysql_error());
	while($qr = mysql_fetch_assoc($qrs))
	{
...
<td align="right"><?php  echo ewrpt_ViewValue( changeprice($obval)) ?></td>
	...
	$isval = 0;
	 include "config.php";
    $query1 = "SELECT type,trnum,date,quantity,amount,crdr,venname from ac_financialpostings where itemcode = '$code' and coacode = '$itemcode'  and date >= '$fdate' and date <= '$tdate' AND warehouse = '$sector' order by date ";
      $result1 = mysql_query($query1,$conn1);
	   while($row2 = mysql_fetch_assoc($result1))
      {
	   if(($row2['type'] == 'COBI') && ($row2['venname'] == 'MORTALITY'))
	   $type = 'Sales Mortality'; 
	   else if(($row2['type'] == 'TR') && ($row2['venname'] == 'MORTALITY'))
	   $type = 'Transfer Mortality'; 
	   else
	   $type = $row2['type']; 
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_quailitemledger_type"] = "";
			$_SESSION["sort_quailitemledger_schedule"] = "";
			$_SESSION["sort_quailitemledger_controltype"] = "";
			$_SESSION["sort_quailitemledger_code"] = "";
			$_SESSION["sort_quailitemledger_description"] = "";
		}
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		...
		$_SESSION["sort_quailitemledger_code"] = "ASC";
		$_SESSION["sort_quailitemledger_description"] = "ASC";
	}
