...
<tr>
 <td colspan="2" align="center"><strong><font color="#3e3276">Super Stockist Report</font></strong></td>
</tr>
<tr height="5px"></tr>
</table>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="distribution_superstockistreport.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="distribution_superstockistreport.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="distribution_superstockistreport.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="distribution_superstockistreport.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<?php } ?>
	...
	<tbody>
<?php 
$q="SELECT name, address, place, phone, mobile, cgroup,id,code,state FROM  `contactdetails` WHERE TYPE like '%party%' and superstockist='YES' order by cgroup,name";
$r=mysql_query($q);
...
<?php echo ewrpt_ViewValue($a[id]) ?></td>
	<td class="ewRptGrpField1"  >
<?php echo ewrpt_ViewValue($a[cgroup]); ?></td>
		<td class="ewRptGrpField2">
...
<td class="ewRptGrpField1"  >
<?php echo ewrpt_ViewValue($a[state]); ?></td>
