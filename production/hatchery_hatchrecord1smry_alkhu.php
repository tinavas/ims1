...
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader" title="Machine Number">
		MC/No
		</td>
<?php } else { ?>
		<td class="ewTableHeader" title="Machine Number">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>MC/No</td>
			</tr></table>
		</td>
...
<?php 
$q1 = "select * from hatchery_traysetting where flock = '$x_flock' and hatchdate='$x_hatchdate' and unit = '$x_unit' and client = '$client'";
