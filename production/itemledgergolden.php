...
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">Item Code&nbsp;</font></strong><?php echo $_GET['code']; ?></td>
</tr>
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">Description&nbsp;</font></strong><?php echo $_GET['description']; ?></td>
</tr>
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">Warehouse&nbsp;</font></strong><?php echo $_GET['warehouse']; ?></td>
</tr>

<tr>
<td colspan="2" align="center"><strong><font size="2">From Date&nbsp;</font></strong><?php echo $fdatedump; ?>
               <strong><font size="2"> To Date &nbsp;</font></strong><?php echo $tdatedump;?></td>
</tr>
</table>
<br/>
...
$code = $_GET['code'];
$url = "&fromdate=" . $_GET['fromdate'] . "&todate=" . $_GET['todate']."&code=" . $_GET['code']."&description=".$_GET['description']."&warehouse=".$_GET['warehouse'];
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="itemledgergolden.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="itemledgergolden.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="itemledgergolden.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<form action="itemledgergolden.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="itemledgergolden.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="itemledgergolden.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="itemledgergolden.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="itemledgergolden.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<td align="right"><?php  echo ewrpt_ViewValue(changeprice($obval/$obqty)); ?></td>
<td align="right"><?php  echo ewrpt_ViewValue( changeprice($obval)) ?></td>
	...
	$isval = 0;
	 include "config.php";
     $query1 = "SELECT type,trnum,date,quantity,amount,crdr from ac_financialpostings where itemcode = '$code' and coacode = '$itemcode'  and date >= '$fdate' and date <= '$tdate' AND warehouse = '$warehouse' order by date,updated ";
...
?>
	<tr>
		...
		<td align="right">
         <?php if ( $row2['crdr'] == "Dr"   ) { echo ewrpt_ViewValue(changeprice(($row2['amount']/$row2['quantity']))); }
		 else { echo ewrpt_ViewValue(); } ?>
        </td>
         <td align="right"> 
...
<td align="right">
<?php if ( $row2['crdr'] == "Cr"  ) { echo ewrpt_ViewValue(round($row2['quantity'],5)); $isqty = $isqty + $row2['quantity']; }
 else { echo ewrpt_ViewValue(); }?>
</td>
<td align="right">
<?php if ( $row2['crdr'] == "Cr"  ) { echo ewrpt_ViewValue(changeprice(($row2['amount']/$row2['quantity']))); } 
 else { echo ewrpt_ViewValue(); } ?>
</td>
<td align="right">
...
<?php  ?><td align="right"><?php echo ewrpt_ViewValue(changeprice($obqty+$rcvqty-$isqty)); ?></td>
<td align="right"><?php echo ewrpt_ViewValue(changeprice((($obval + $rcvval - $isval)/($obqty + $rcvqty - $isqty)))); ?></td>
...
<?php echo ewrpt_ViewValue(changeprice($rcvqty)) ?>
		...
		echo ewrpt_ViewValue(changeprice($rcvval/$rcvqty)) ?>
		</td>
		<td align="right">
...
<td align="right">
<?php  echo ewrpt_ViewValue(round($isqty,5));  ?>
</td>
<td align="right">
<?php  echo ewrpt_ViewValue(changeprice(($isval/$isqty)));  ?>
</td>
<td align="right">
...
<td align="right">
<?php echo ewrpt_ViewValue(changeprice((($obval + $rcvval - $isval)/($obqty + $rcvqty - $isqty)))); ?>
</td>
<td align="right">
