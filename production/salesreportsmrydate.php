...
$EW_REPORT_TABLE_SQL_SELECT = "SELECT oc_cobi.party,oc_cobi.partycode,oc_cobi.bookinvoice, oc_cobi.date, oc_cobi.invoice, oc_cobi.totalquantity, oc_cobi.finaltotal, oc_cobi.code,oc_cobi.description FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
$EW_REPORT_TABLE_SQL_WHERE = "oc_cobi.party $pc '$party' and oc_cobi.date >= '$fdate' and oc_cobi.date <= '$tdate' ";
}
$EW_REPORT_TABLE_SQL_GROUPBY = " oc_cobi.date , oc_cobi.party, oc_cobi.invoice, oc_cobi.totalquantity, oc_cobi.finaltotal , oc_cobi.code,oc_cobi.description";
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="salesreportsmrydate.php?export=html&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&party=<?php echo $party; ?>&warehouse=<?php echo $warehouse; ?> ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="salesreportsmrydate.php?export=excel&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&party=<?php echo $party; ?>&warehouse=<?php echo $warehouse; ?> ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="salesreportsmrydate.php?export=word&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&party=<?php echo $party; ?>&warehouse=<?php echo $warehouse; ?> ?>">Export to Word</a>
<?php } ?>
...
<?php } ?>
<?php if($_SESSION[db]=='albustanlayer') if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Customer Code
		</td>
<?php } else { ?>
...
<?php if($_SESSION['db'] == "albustanlayer") {
    if (@$sExport <> "") { ?>
		<td valign="bottom" align="center" style="width:150px" class="ewTableHeader">
		Narration
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" align="center" class="ewTableHeaderBtn"><tr>
			<td style="width:150px">Narration</td>
			</tr></table>
		</td>
<?php } } ?>
<?php if($_SESSION['db'] != "albustanlayer") {
...
$q = "select quantity as quantity,code,description,flock,price as price,partycode,party,remarks from oc_cobi where date = '$x_date' and invoice = '$x_invoice' order by code";
$qrs = mysql_query($q,$conn1) or die(mysql_error());
while($qr = mysql_fetch_assoc($qrs))
{
$narration = $qr['remarks'];
	$code.= $qr['code'] . "/";
...
<?php if($date1 != $x_date) echo ewrpt_ViewValue(ewrpt_FormatDateTime($x_date,7)); else echo "&nbsp;";   ?>
</td>	
		<td class="ewRptGrpField1" align="left">
		<?php if($dup_partycode!=$party || $date1 != $x_date) echo $party; else echo '&nbsp;'; ?>
		</td>
		<?php if($_SESSION[db]=='albustan' || $_SESSION[db]=='albustanlayer') { ?>
		<td class="ewRptGrpField1" align="left">
<?php if($dup_partycode!=$party || $date1 != $x_date) echo $partycode; else echo '&nbsp;'; ?>
		<?php $dup_partycode = $party; $date1 = $x_date ?></td>
...
<?php } ?>	
		...
		<td class="ewRptGrpSummary1">&nbsp;</td>
		<td class="ewRptGrpSummary1">&nbsp;</td>
		<td class="ewRptGrpSummary1">&nbsp;</td><?php } ?>
		<td class="ewRptGrpSummary1">&nbsp;</td> 
	  <?php if($_SESSION[db]!='albustanlayer') { ?>
...
<?php echo changeprice($grandamount);  #ewrpt_ViewValue($x_finaltotal) ?></b>
	...
	<?php } else if($_SESSION[db]=='albustanlayer' || $_SESSION[db]=='golden' ) { ?>
		<tr><td colspan="7" class="ewRptGrpSummary1" align="left">&nbsp;</td></tr>
	<?php } else { ?>
		<tr><td colspan="10" class="ewRptGrpSummary1" align="left">&nbsp;</td></tr>
	<?php } ?>
...
<form action="salesreportsmrydate.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="salesreportsmrydate.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="salesreportsmrydate.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="salesreportsmrydate.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="salesreportsmrydate.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
{	?>
	...
	document.location = "salesreportsmrydate.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" + description + "&warehouse=" + warehouse;
<?php } else { ?>	
	document.location = "salesreportsmrydate.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party ;
<?php } ?>
...
{	?>
	var warehouse = document.getElementById('warehouse').value;
	document.location = "salesreportsmrydate.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" + "All" + "&warehouse=" + warehouse;
<?php } else { ?>	
	document.location = "salesreportsmrydate.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" + "All" ;
<?php } ?>
}
...
{	?>
	var warehouse = document.getElementById('warehouse').value;
	document.location = "salesreportsmrydate.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + "All" + "&description=" + description + "&warehouse=" + warehouse;
<?php } else { ?>	
	document.location = "salesreportsmrydate.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + "All" + "&description=" + description ;
<?php } ?>
}
else
{
...
{	?>
	...
	document.location = "salesreportsmrydate.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" + description + "&warehouse=" + warehouse;
<?php } else { ?>	
	document.location = "salesreportsmrydate.php?fdate=" + date + "&tdate=" + date1 + "&party=" + party + "&code=" + code + "&description=" +description ;
<?php } ?>
}
}
