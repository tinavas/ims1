...
//$EW_REPORT_TABLE_SQL_FROM = "hr_employee Inner Join hr_salaryparameters On hr_salaryparameters.eid =  hr_employee.employeeid";
...
<?php
	...
	$nRecCount++;
		...
		$q1 = "SELECT hr_employee.employeeid,hr_employee.salary,hr_employee.name, hr_employee.sector, hr_employee.designation, hr_employee.salary, hr_salaryparameters.bfix, hr_salaryparameters.hrafix, hr_salaryparameters.mafix, hr_salaryparameters.ccafix, hr_salaryparameters.tafix, hr_salaryparameters.pffix, hr_salaryparameters.ptaxfix, hr_salaryparameters.finalsal,  hr_salaryparameters.id FROM hr_employee Inner Join hr_salaryparameters On hr_salaryparameters.eid = hr_employee.employeeid WHERE hr_employee.sector $sc '$_GET[sector]' and hr_employee.name $nc '$_GET[empname]'  ORDER BY hr_employee.sector,hr_employee.designation,hr_employee.name ";
...
<?php $sino = $sino+1; echo ewrpt_ViewValue(str_replace(chr(10), "<br>", $sino)); ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(str_replace(chr(10), "<br>", $q1r['name'])); ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(str_replace(chr(10), "<br>", $q1r['sector'])); ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(str_replace(chr(10), "<br>", $q1r['designation'])); ?>
</td>
<?php 
$ba =0 ;
$ba = $q1r['bfix'];
...
/*$q1 = "SELECT bfix ,hrafix, mafix, ccafix, tafix,finalsal FROM hr_salaryparameters WHERE sector= '$x_sector' AND name ='$x_name' order by id limit 1";
 $q1rs = mysql_query($q1,$conn1) or die(mysql_error());
		...
		$totaldays =0;$workingd=0;$extdays=0;
...
<td<?php echo $sItemRowClass; ?> width="350px" >
