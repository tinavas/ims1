...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "quail_flock";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT quail_flock.flockcode, quail_flock.flockdescription, quail_flock.age, quail_flock.startdate, quail_flock.femaleopening, quail_flock.maleopening, quail_flock.shedcode, quail_flock.sheddescription, quail_flock.farmcode, quail_flock.farmdescription, quail_flock.unitcode, quail_flock.unitdescription FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "quail_flock.cullflag <> 1";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "quail_flock.farmcode ASC, quail_flock.unitcode ASC, quail_flock.shedcode ASC, quail_flock.sheddescription ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "quail_flock.farmcode", TRUE);
...
$EW_REPORT_TABLE_SQL_SELECT_AGG = "SELECT SUM(quail_flock.femaleopening) AS SUM_femaleopening, SUM(quail_flock.maleopening) AS SUM_maleopening FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
?>
<?php
$EW_REPORT_FIELD_FARMCODE_SQL_SELECT = "SELECT DISTINCT quail_flock.farmcode FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_FARMCODE_SQL_ORDERBY = "quail_flock.farmcode";
$EW_REPORT_FIELD_UNITCODE_SQL_SELECT = "SELECT DISTINCT quail_flock.unitcode FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_UNITCODE_SQL_ORDERBY = "quail_flock.unitcode";
$EW_REPORT_FIELD_SHEDCODE_SQL_SELECT = "SELECT DISTINCT quail_flock.shedcode FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SHEDCODE_SQL_ORDERBY = "quail_flock.shedcode";
$EW_REPORT_FIELD_STARTDATE_SQL_SELECT = "SELECT DISTINCT quail_flock.startdate FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_STARTDATE_SQL_ORDERBY = "quail_flock.startdate";
?>
<?php
...
<br/>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quail_flockreportsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="quail_flockreportsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="quail_flockreportsmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="quail_flockreportsmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="quail_flockreportsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="quail_flockreportsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quail_flockreportsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quail_flockreportsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quail_flockreportsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php
 $qj = "select min(date2) as mindate,max(age) as age from quail_consumption where flock = '$x_flockcode'"; 
...
{
$q2a = "select age,startdate from quail_flock where flockcode = '$x_flockcode'";
...
$nu = floor(($a / 7));
 ...
 $ftransfer = 0;
           $qj = "select * from ims_stocktransfer where cat = 'Quail Female Birds' and towarehouse = '$x_flockcode' and date <= '$startdate' "; 
    		 $qrsj = mysql_query($qj,$conn1) or die(mysql_error());
 ...
 $mtransfer = 0;
             $qj = "select * from ims_stocktransfer where cat = 'Quail Male Birds' and towarehouse = '$x_flockcode' and date <= '$startdate' "; 
    		 $qrsj = mysql_query($qj,$conn1) or die(mysql_error());
             if(mysql_num_rows($qrsj))
             {
		   while($qrj = mysql_fetch_assoc($qrsj))
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_startdate"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_startdate"], "quail_flock.startdate", EW_REPORT_DATATYPE_DATE, $GLOBALS["af_startdate"]);
	}
	if (is_array($GLOBALS["sel_shedcode"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_shedcode"], "quail_flock.shedcode", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_shedcode"], $GLOBALS["gb_shedcode"], $GLOBALS["gi_shedcode"], $GLOBALS["gq_shedcode"]);
	}
	if (is_array($GLOBALS["sel_farmcode"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_farmcode"], "quail_flock.farmcode", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_farmcode"], $GLOBALS["gb_farmcode"], $GLOBALS["gi_farmcode"], $GLOBALS["gq_farmcode"]);
	}
	if (is_array($GLOBALS["sel_unitcode"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_unitcode"], "quail_flock.unitcode", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_unitcode"], $GLOBALS["gb_unitcode"], $GLOBALS["gi_unitcode"], $GLOBALS["gq_unitcode"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] = "quail_flock.flockcode ASC";
