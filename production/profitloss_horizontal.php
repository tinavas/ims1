...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="profitloss_horizontal.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="profitloss_horizontal.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="profitloss_horizontal.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<form action="profitloss_horizontal.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<?php if ($Pager->RecordCount > 0) { ?>
	...
	<td><a href="profitloss_horizontal.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="profitloss_horizontal.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/prevdisab.gif" alt="Previous" width="16" height="16" border="0"></td>
	<?php } ?>
	<td><input type="text" name="pageno" id="pageno" value="<?php echo $Pager->CurrentPage ?>" size="4"></td>
	<?php if ($Pager->NextButton->Enabled) { ?>
	<td><a href="profitloss_horizontal.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="profitloss_horizontal.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
$rightcount = 0;
  ...
  $query1 = "select * from ac_coa where schedule in (select schedule from ac_schedule where (type = 'Expense' or type = 'Revenue') and ptype = 'Direct') order by type,code   ";
	...
	if ( $nflag == "E") 
	{
		...
		$rightarray2[$rightcount] = "Gross Loss";
...

	{
	   ...
	   $leftarray1[$leftcount] = "";
		$leftarray2[$leftcount] = "Gross Profit";
...
<?php $finflag = "";
  ...
  <?php $dumm = $dumm + 1;  }  ?>
	...
	<tr>
		...
		<td class="ewRptGrpField2">
		<?php if ( $finflag == "R") { echo ewrpt_ViewValue("Net Profit"); } else { echo ewrpt_ViewValue("&nbsp;"); } ?>
		</td>
		<td class="ewRptGrpField3" align="right">
	...
	<tr>
		...
		<td class="ewRptGrpField2"><b>
		<?php echo ewrpt_ViewValue("Total") ?></b>
		</td>
		<td class="ewRptGrpField3" align="right"><b>
		<?php  echo ewrpt_ViewValue(changeprice($tot));  ?></b>
		</td>
	</tr>
	<tr>
<?php if (@$sExport <> "") { ?>
...
<?php echo ewrpt_ViewValue("&nbsp;") ?>
		...
		<td>
<?php if ( $finflag == "E") { echo ewrpt_ViewValue("Net Loss"); } else { echo ewrpt_ViewValue("&nbsp;"); } ?>
</td>
<td align="right">
