...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="eggstocksmry2.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="eggstocksmry2.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="eggstocksmry2.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="eggstocksmry2.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
...
{
?>
<option value="<?php echo $qr['unitcode']; ?>" <?php if($n1 == 1) { ?> selected=selected<?php } ?> <?php if($warehouse == $qr['unitcode'] or $warehouse == "") { $warehouse = $qr['unitcode']; ?> selected="selected" <?php } ?> ><?php echo $qr['unitcode']; ?></option>
<?php } ?>
</select>
&nbsp;&nbsp;&nbsp;
From Date&nbsp;
...
<form action="eggstocksmry2.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="eggstocksmry2.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="eggstocksmry2.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="eggstocksmry2.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="eggstocksmry2.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
//	echo "sql: " . $sSql . "<br>";
	...
	if (1) { // Loop detail records
		...
		/*echo $get = "SELECT distinct(flkmain) from breeder_flock where unitcode = '$warehouse' and flockcode in (select distinct(flock) from breeder_production) order by flkmain";
  $result = mysql_query($get,$conn1);
  while($row = mysql_fetch_assoc($result))
  { */?>
   <tr>
   <td class="ewRptGrpField1">Total</td>
<?php
  ...
  //Opening Calculation
   ...
   $getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE code = '$rowop1[code]' AND date < '$fromdate'  AND warehouse = '$warehouse' ";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $obrec = $obrec +  $rowop['quantity'];
  }
  $getop = "SELECT SUM(quantity) as quantity FROM breeder_production WHERE itemcode = '$rowop1[code]' AND date1 < '$fromdate' AND flock in (select distinct(flockcode) from breeder_flock where unitcode = '$warehouse')";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
    $obrec = $obrec +  $rowop['quantity'];
  }
   $getop = "SELECT SUM(quantity) as quantity FROM oc_cobi where code in (select distinct(code) from ims_itemcodes where cat = 'Hatch Eggs') AND date < '$fromdate' AND unit = '$warehouse' ";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
 ...
 $query = "SELECT sum(noofeggs) as eggsset FROM hatchery_traysetting WHERE unit = '$warehouse' AND client = '$client' AND settingdate < '$fromdate'";
...
<?php if($obhe[$rowop1['code']] <> 0){ echo ewrpt_ViewValue(changequantity($obhe[$rowop1['code']])); } else { echo ewrpt_ViewValue("0"); } ?></td>
  ...
  while($rowop = mysql_fetch_assoc($resultop))
  {
   ...
   $getop = "SELECT SUM(quantity) as quantity FROM oc_cobi where code = '$rowop1[code]' AND date < '$fromdate' AND unit = '$warehouse'";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $obiss = $obiss +  $rowop['quantity'];
...
<?php if($obhe[$rowop1['code']] <> 0){ echo ewrpt_ViewValue(changequantity($obhe[$rowop1['code']])); } else { echo ewrpt_ViewValue("0"); } ?></td>
  ...
  $rhe = 0;
   ...
   $getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE code = '$rowop1[code]' AND date >= '$fromdate' and date <= '$todate' AND warehouse = '$warehouse' ";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $rrec[$rowop1['code']] = $rrec[$rowop1['code']] +  $rowop['quantity'];
  }
  $getop = "SELECT SUM(quantity) as quantity FROM breeder_production WHERE itemcode = '$rowop1[code]' AND date1 >= '$fromdate' and date1 <= '$todate' AND flock in (select distinct(flockcode) from breeder_flock where unitcode = '$warehouse')";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
   $rrec[$rowop1['code']] = $rrec[$rowop1['code']] +  $rowop['quantity'];
 ...
 $query = "SELECT sum(noofeggs) as eggsset FROM hatchery_traysetting WHERE unit = '$warehouse' AND client = '$client' AND settingdate >= '$fromdate' and settingdate <= '$todate'";
  $result = mysql_query($query,$conn1);
  $rows = mysql_fetch_assoc($result);
...
<?php if($rrec[$rowop1['code']] <> 0){ echo ewrpt_ViewValue(changequantity($rrec[$rowop1['code']])); } else { echo ewrpt_ViewValue("0"); } ?></td>
 ...
 <?php
  ...
  {
  $issue[$rowop1['code']] = 0;
  $getop = "SELECT sum(quantity) as quant from oc_cobi where date >= '$fromdate' and date <= '$todate' and unit = '$warehouse' and code in (select distinct(code) from ims_itemcodes where cat = 'Hatch Eggs') ";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
  //echo $rowop['code'];
...
<?php if($issue[$rowop1['code']] <> 0){ echo ewrpt_ViewValue(changequantity($issue[$rowop1['code']])); } else { echo ewrpt_ViewValue("0"); } ?></td>
  ...
  $getop = "SELECT SUM(quantity) as quantity FROM oc_cobi where code = '$rowop1[code]' AND date >= '$fromdate' and date <= '$todate' AND unit = '$warehouse'";
  $resultop = mysql_query($getop,$conn1);
  while($rowop = mysql_fetch_assoc($resultop))
  {
...
<?php if($issue[$rowop1['code']] <> 0){ echo ewrpt_ViewValue(changequantity($issue[$rowop1['code']])); } else { echo ewrpt_ViewValue("0"); } ?></td>
 ...
 $query = "SELECT sum(noofeggs) as eggsset FROM hatchery_traysetting WHERE unit = '$warehouse' AND client = '$client'";
  $result = mysql_query($query,$conn1);
  $rows = mysql_fetch_assoc($result);
...
function reloadpage()
{
	...
	var warehouse = document.getElementById('warehouse').value;
		//document.location = "eggstocksmry2.php?fromdate=" + fromdate + "&todate=" + todate + "&warehouse=" + warehouse;
