...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="SalaryNewReportsmrysmry_golden.php<?php echo $genlinkm; ?>&export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="SalaryNewReportsmrysmry_golden.php<?php echo $genlinkm; ?>&export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="SalaryNewReportsmrysmry_golden.php<?php echo $genlinkm; ?>&export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="SalaryNewReportsmrysmry_golden.php<?php echo $genlinkm; ?>&cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="SalaryNewReportsmrysmry_golden.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="SalaryNewReportsmrysmry_golden.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="SalaryNewReportsmrysmry_golden.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="SalaryNewReportsmrysmry_golden.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="SalaryNewReportsmrysmry_golden.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry_golden.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("name") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_name"]); ?>');">Name</td><td style="width: 10px;">
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry_golden.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("sector") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_sector"]); ?>');">Sector</td><td style="width: 10px;">
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry_golden.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("designation") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_designation"]); ?>');">Designation</td><td style="width: 10px;">
...
<?php } else { ?>
		<td class="ewTableHeader"  title="Days Present">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry_golden.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("designation") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_designation"]); ?>');">Days</td><td style="width: 10px;">
			<?php if (@$_SESSION["sort_SalaryNewReportsmry_designation"] == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif (@$_SESSION["sort_SalaryNewReportsmry_designation"] == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
			</tr></table>		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
        <td valign="bottom" class="ewTableHeader" title="Extra Days Worked"> Extra </td>
        <?php } else { ?>
        <td class="ewTableHeader"  title="Extra Days Worked"><table cellspacing="0" class="ewTableHeaderBtn">
            <tr>
              <td>Extra</td>
            </tr>
        </table></td>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry_golden.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("salary") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_salary"]); ?>');">Salary</td><td style="width: 10px;">
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry_golden.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("bfix") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_bfix"]); ?>');">Basic</td><td style="width: 10px;">
...
<?php } ?>
<?php if (@$sExport <> "") { ?>
        <td valign="bottom" class="ewTableHeader" title="Allowance"> Allowance </td>
        <?php } else { ?>
        <td class="ewTableHeader"  title="Allowance"><table cellspacing="0" class="ewTableHeaderBtn">
            <tr>
              <td>Allowance</td>
            </tr>
        </table></td>
...
<?php if (@$sExport <> "") { ?>
		...
		Final  Sal.		</td>
		 <?php } else { ?>
        <td class="ewTableHeader"  title="Final Salary to be paid"><table cellspacing="0" class="ewTableHeaderBtn">
            <tr>
              <td>Final  Sal.</td>
            </tr>
        </table></td>
...
<?php } else { ?>
		<td class="ewTableHeader" title="Salary Paid">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry_golden.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("paid") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_paid"]); ?>');">Paid</td><td style="width: 10px;">
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td class="ewPointer" onmousedown="ewrpt_Sort(event, 'SalaryNewReportsmrysmry_golden.php?<?php echo EW_REPORT_TABLE_ORDER_BY . "=" . urlencode("paymode") . "&" . EW_REPORT_TABLE_ORDER_BY_TYPE . "=" . ewrpt_ReverseSort(@$_SESSION["sort_SalaryNewReportsmry_paymode"]); ?>');">Paymode</td><td style="width: 10px;">
...
<?php echo ewrpt_ViewValue(str_replace(chr(10), "<br>", $x_name)); ?></td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(str_replace(chr(10), "<br>", $x_sector)); ?></td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(str_replace(chr(10), "<br>", $x_designation)); ?></td>
<?php $q1 = "SELECT bfix ,hrafix, mafix, ccafix, tafix,finalsal FROM hr_salaryparameters WHERE sector= '$x_sector' AND name ='$x_name' order by id limit 1";
 $q1rs = mysql_query($q1,$conn1) or die(mysql_error());
		...
		$cid = $qidr['id'];
			...
			$totaldays =0;$extra =0;
		$qtt ="SELECT dayspresent as noofdays,extra FROM `hr_mnthattendance` where eid='$cid' and month='$month' and year='$cyear' and client='$client'";
 $qttr = mysql_query($qtt,$conn1) ;
	  ...
	  $ot =0;
	  $qott ="SELECT ot  FROM `hr_payment` where eid='$cid' and month1='$month' and year1='$cyear'";
 ...
 $qttr = mysql_query($qtt,$conn1) ;
	  ...
	  $totaldays = $nooffull + ($noofhalf/2);*/
		...
		?>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($totaldays) ?></td>
<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($extra) ?></td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_salary) ?></td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($ba)
//ewrpt_ViewValue($x_bfix) ?></td>
<?php 
$allow =0;
$allow = $x_salary-$ba;?>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($allow) 
//ewrpt_ViewValue($x_hrafix) ?></td>
		<?php $final = $allow + $ba;?>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_salary)
//ewrpt_ViewValue($x_finalsal) ?></td>
	<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($ot)
//ewrpt_ViewValue($x_finalsal) ?></td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_paid) ?></td>
		
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_paymode) ?></td>
	</tr>
<?php
...
<form action="SalaryNewReportsmrysmry_golden.php?<?php echo $genlinkm; ?>" name="ewpagerform" id="ewpagerform" class="ewForm">
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td nowrap>
<?php if (!isset($Pager)) $Pager = new cPrevNextPager($nStartGrp, $nDisplayGrps, $nTotalGrps) ?>
