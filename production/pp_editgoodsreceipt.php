...
<?php if(($_SESSION['db'] == "central" or $_SESSION['db'] == "alwadi") && $aflag == 0) { ?>
 <form id="form1" name="form1" method="post" action="pp_savegoodsreceiptc.php">
 <?php } else { ?>
<form id="form1" name="form1" method="post" action="pp_updategoodsreceipt.php"> 
 <?php } ?>
...
<td align="left"><select id="vendor" name="vendor" onChange="getges(this.value);">
<?php if($gres['vendor']!='') {?>
<option value="<?php echo $gres['vendor']; ?>"><?php echo $gres['vendorcode']; ?></option>
<?php } else {?>
<option value="<?php echo $gres['broker']; ?>"><?php echo $gres['broker']; ?></option>
<?php } ?>
</select>&nbsp;
...
<td width="10px"></td>
<td align="center"><input readonly size="7" type="text" style="background:none; border:none;text-align:right;" name="bird[]" id="bird<?php echo $i; ?>" value="<?php echo $gres['bird'];?>" /></td>
...
<td align="center"><input  size="7" type="text"  value="<?php echo $gres['rateperunit']; ?>"  id="rateperunit<?php echo $i; ?>" name="rateperunit[]"  style="text-align:right" /></td>
<td width="10px"></td>
...
<input type="hidden" id="tot<?php echo $i;?>" name="tot[]" value="<?php echo $tot = ($gres['receivedquantity'] * $gres['rateperunit']) + $gres['taxamount'] + $gres['freightamount'] - $gres['discountamount'];?>" />
...
<input type="submit" id="save" value="Update" />&nbsp;&nbsp;<input type="button" id="cancel" value="Cancel" onClick="document.location='dashboardsub.php?page=pp_goodsreceipt'"/>
...
function fun()
{
	...
	document.location = "dashboardsub.php?page=pp_addgoodsreceipt&ge=" + "&vendor=" + vendor;
}
...
function fun1()
{
	...
	document.location = "dashboardsub.php?page=pp_addgoodsreceipt&ge=" + ge + "&vendor=" + vendor + "&type=" +type;
}
