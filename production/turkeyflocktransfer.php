...
define("EW_REPORT_TABLE_VAR", "CustomView1", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "CustomView1_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "CustomView1_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "CustomView1_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "CustomView1_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "CustomView1_orderby", TRUE);
...
$EW_REPORT_TABLE_SQL_WHERE = "ims_stocktransfer.cat Like 'Turkey %Birds%'";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "ims_stocktransfer.date";
...
ewrpt_CreatePopup("CustomView1_date", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_fromwarehouse, $sel_fromwarehouse, $ft_fromwarehouse) ?>
ewrpt_CreatePopup("CustomView1_fromwarehouse", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_towarehouse, $sel_towarehouse, $ft_towarehouse) ?>
ewrpt_CreatePopup("CustomView1_towarehouse", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_code, $sel_code, $ft_code) ?>
ewrpt_CreatePopup("CustomView1_code", [<?php echo $jsdata ?>]);
</script>
<div id="CustomView1_date_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="CustomView1_fromwarehouse_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="CustomView1_towarehouse_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="CustomView1_code_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="turkeyflocktransfer.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="turkeyflocktransfer.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="turkeyflocktransfer.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="turkeyflocktransfer.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="turkeyflocktransfer.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="turkeyflocktransfer.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="turkeyflocktransfer.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="turkeyflocktransfer.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="turkeyflocktransfer.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'CustomView1_date', true, '<?php echo $rf_date; ?>', '<?php echo $rt_date; ?>');return false;" name="x_date<?php echo $cnt[0][0]; ?>" id="x_date<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>From Flock</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'CustomView1_fromwarehouse', false, '<?php echo $rf_fromwarehouse; ?>', '<?php echo $rt_fromwarehouse; ?>');return false;" name="x_fromwarehouse<?php echo $cnt[0][0]; ?>" id="x_fromwarehouse<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Item</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'CustomView1_code', false, '<?php echo $rf_code; ?>', '<?php echo $rt_code; ?>');return false;" name="x_code<?php echo $cnt[0][0]; ?>" id="x_code<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php echo ewrpt_ViewValue($x_quantity) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_fromunits) ?>
</td>
	</tr>
<?php
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_CustomView1_date"])) {
		LoadSelectionFromSession('date');
	} elseif (@$_SESSION["sel_CustomView1_date"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_date"] = "";
	}

	// Get Fromwarehouse selected values
	if (is_array(@$_SESSION["sel_CustomView1_fromwarehouse"])) {
		LoadSelectionFromSession('fromwarehouse');
	} elseif (@$_SESSION["sel_CustomView1_fromwarehouse"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_fromwarehouse"] = "";
	}

	// Get Towarehouse selected values
	if (is_array(@$_SESSION["sel_CustomView1_towarehouse"])) {
		LoadSelectionFromSession('towarehouse');
	} elseif (@$_SESSION["sel_CustomView1_towarehouse"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_towarehouse"] = "";
	}

	// Get Code selected values
	if (is_array(@$_SESSION["sel_CustomView1_code"])) {
		LoadSelectionFromSession('code');
	} elseif (@$_SESSION["sel_CustomView1_code"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_code"] = "";
	}
}
...
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_CustomView1_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_CustomView1_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_CustomView1_$parm"];
}
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_date"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_date"], "ims_stocktransfer.date", EW_REPORT_DATATYPE_DATE, $GLOBALS["af_date"]);
	}
	if (is_array($GLOBALS["sel_fromwarehouse"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_CustomView1_date"] = "";
			$_SESSION["sort_CustomView1_fromwarehouse"] = "";
			$_SESSION["sort_CustomView1_towarehouse"] = "";
			$_SESSION["sort_CustomView1_code"] = "";
			$_SESSION["sort_CustomView1_quantity"] = "";
			$_SESSION["sort_CustomView1_fromunits"] = "";
		}
