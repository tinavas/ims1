...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Flock Wise Feed Consumed Report</font></strong></td>
</tr>
</table>
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="lbfeedconsumed.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="lbfeedconsumed.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="lbfeedconsumed.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="lbfeedconsumed.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<?php if (@$sExport == "") { ?>
<br /><br />
...
<form action="lbfeedconsumed.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="lbfeedconsumed.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="lbfeedconsumed.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="lbfeedconsumed.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="lbfeedconsumed.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Total Female Feed Consumed
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Total Female Feed Consumed</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Total Male Feed Consumed
		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Total Male Feed Consumed</td>
			</tr></table>
		</td>
<?php } ?>
	</tr>
...
$q = "select age,date2 from layerbreeder_consumption where flock = '$x_flock' order by date2 DESC "; 
		...
		if($qr = mysql_fetch_assoc($qrs))
		{
			  ...
			  $flockdate = date("d-m-Y",strtotime($qr['date2']));
		}
		 $mindate = "";
		  $maxdate = "";
...
<?php
		   ...
		   while($qr = mysql_fetch_assoc($r))
             ...
             else
             {
              ...
              while($row14 = mysql_fetch_assoc($result14)) 
              {
                 $feedtypes1 = $feedtypes1 . ",'" . $row14['code'] . "'";
              }
              ...
              while($row14 = mysql_fetch_assoc($result14)) 
              {
                 $feedtypes2 = $feedtypes2 . ",'" . $row14['code'] . "'";
              }


              $totalfeed1 = 0;
              $query14 = "SELECT sum(quantity) as 'feed' FROM layerbreeder_consumption where flock = '$x_flock' and itemcode in ($feedtypes1)";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
                 $totalfeed1 = $row14['feed'];
              }

              $totalfeed2 = 0;
              $query14 = "SELECT sum(quantity) as 'feed' FROM layerbreeder_consumption where flock = '$x_flock' and itemcode in ($feedtypes2)";
              $result14 = mysql_query($query14,$conn1);  
              while($row14 = mysql_fetch_assoc($result14)) 
              {
                 $totalfeed2 = $row14['feed'];
              }
...
<?php  echo ($maleopening + $mtin + $mpur); ?>
		...
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo round($totalfeed1,2); ?>
</td>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo round($totalfeed2,2); ?>
</td>
