...
$af_shortage = NULL; // Popup filter for secondset
...
{
$x_customhatchery = NULL;
$o_customhatchery = NULL; $t_customhatchery = NULL; $ft_customhatchery = 200; $rf_customhatchery = NULL;$rt_customhatchery = NULL;
...
<td align="center"><strong><font color="#3e3276">Tray Setting Report</font></strong></td>
</tr>
</table>
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="hatchery_traysetting.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="hatchery_traysetting.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="hatchery_traysetting.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="hatchery_traysetting.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<br /><br />
<?php } ?>
...
<form action="hatchery_traysetting.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="hatchery_traysetting.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="hatchery_traysetting.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="hatchery_traysetting.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="hatchery_traysetting.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		<?php if($_SESSION['db'] == "alkhumasiyabrd") { ?>Unit<?php } else {?> Flock <?php }?>		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
...
<?php } ?>
<?php if (@$sExport <> "" && $_SESSION['db'] == 'farmvalley') { ?>
		<td valign="bottom" class="ewTableHeader">
		Shortage		</td>
<?php } elseif($_SESSION['db'] == 'farmvalley') { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Shortage</td>
			</tr></table>		</td>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Expected Chicks</td>
			</tr></table>		</td>
<?php } ?>

<?php if($_SESSION['db']=='naidu')
{?>
<?php if (@$sExport <> "") { ?>
		<td valign="bottom" class="ewTableHeader">
		Custom Hatcher/Own		</td>
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td align="right">Custom Hatcher/Own</td>
			</tr></table>		</td>
<?php } ?>
<?php } ?>
	</tr>
...
?>
	<tr>
		<td class="ewRptGrpField1"><?php $t_settingdate = $x_settingdate; $x_settingdate = $dg_settingdate; ?>
...
<?php echo ewrpt_ViewValue($x_hatchery) ?></td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_flock) ?></td>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue(changeprice1($x_eggsset)); $totaleggsset+=$x_eggsset; ?></td>
<?php if($_SESSION['db'] == 'farmvalley') { 
$query = "SELECT shortage FROM hatchery_traysetting WHERE settingdate='$x_settingdate' AND flock = '$x_flock'";
$result = mysql_query($query,$conn1) or die(mysql_error());
$rows = mysql_fetch_assoc($result);
?>

		<td<?php echo $sItemRowClass; ?> align="right"><?php echo ewrpt_ViewValue(changeprice1($rows['shortage']));  ?></td>
<?php } ?>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue(changeprice1($x_reject)); $totalreject+=$x_reject; ?></td>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue(changeprice1($x_waste)); $totalwaset+=$x_waste;?></td>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue(changeprice1($x_noofeggs)); $totalnoofeggs+=$x_noofeggs;?></td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_loadingtime) ?></td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_loadedby) ?></td>
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue(ewrpt_FormatDateTime($x_hatchdate,7)) ?></td>
		<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue(changeprice1($x_expectedchicks)); $totalexpectedchicks+=$x_expectedchicks;?></td>
	<?php if($_SESSION['db']=='naidu') {?>
	<td<?php echo $sItemRowClass; ?> align="left">
<?php echo ewrpt_ViewValue($x_customhatchery); ?></td>
	<?php } ?>
...
<tr >
		...
		<td align="right"><b><?php echo changeprice1($totaleggsset); ?></b></td>
		<td align="right"><b><?php echo changeprice1($totalreject); ?></b></td>
		<td align="right"><b><?php echo changeprice1($totalwaset); ?></b></td>
		<td align="right"><b><?php echo changeprice1($totalnoofeggs); ?></b></td>
		<td colspan="3">&nbsp;</td>
		<td align="right"><b><?php echo changeprice1($totalexpectedchicks); ?></b></td>
		<?php if($_SESSION['db']=='naidu'){?>
		<td >&nbsp;</td>
		<?php } ?>
	</tr>
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		if($_SESSION['db']=='naidu'){
		$GLOBALS['x_customhatchery'] = $rs->fields('customhatchery');
		}
		...
		if($_SESSION['db']=='naidu'){
			$val[11] = $GLOBALS['x_customhatchery'];
		}
