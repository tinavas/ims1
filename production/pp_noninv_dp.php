...
&nbsp;&nbsp;<a href="pp_noninv_dp.php?export=html&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&vendor=<?php echo $vendor; ?>&warehouse=<?php echo $warehouse; ?>&code=<?php echo $code; ?>&description=<?php echo $description; ?>">Printer Friendly</a>

&nbsp;&nbsp;<a href="pp_noninv_dp.php?export=excel&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&vendor=<?php echo $vendor; ?>&warehouse=<?php echo $warehouse; ?>&code=<?php echo $code; ?>&description=<?php echo $description; ?>">Export to Excel</a>

&nbsp;&nbsp;<a href="pp_noninv_dp.php?export=word&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&vendor=<?php echo $vendor; ?>&warehouse=<?php echo $warehouse; ?>&code=<?php echo $code; ?>&description=<?php echo $description; ?>">Export to Word</a>

<?php if ($bFilterApplied) { ?>

&nbsp;&nbsp;<a href="pp_noninv_dp.php?cmd=reset&fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&vendor=<?php echo $vendor; ?>&warehouse=<?php echo $warehouse; ?>&code=<?php echo $code; ?>&description=<?php echo $description; ?>">Reset All Filters</a>
...
$q = "select distinct(vendor) as vendor from pp_sobi where niflag='1' order by vendor";
...
$q = "select distinct(code) as code,description from pp_sobi where niflag='1' order by code";
...
$q = "select distinct(description) from pp_sobi where niflag='1' order by description";
...
$qall = "SELECT vendor,broker,date, so,totalquantity,grandtotal ,code , description , vendorcode FROM pp_sobi where vendor $vc '$vendor' and code $cod '$code' and description $desc '$description'and date >= '$fdate' and date <= '$tdate' and niflag='1' group by vendor,date,so, totalquantity, grandtotal,code,description order by  date ASC ";
...
$code = $description = $quantity = $price =$gr = $binvoice = ""; $totqty = 0;
 ...
 $q = "select * from pp_sobi where date = '$x_date' and vendor = '$x_vendor' and so = '$x_so' and niflag='1'  $cond22    order by date,code";
...
$sobiflag=$qr['flag'];
	if($sobiflag==0)
	{
	$temp1="SOBI Not Authorized";
	}
	else
	{
	$temp1="SOBI  Authorized";
	}
  ...
  { 
	...
	$x_grandtotal=$qr['totalamount']-$qr['discountamount'];
	...
	$quantity.= changeprice1($qr['totalamount']) . "/<br>";
	...
	$quantity.= changeprice1($qr['totalamount']) . "/";
...
<form action="pp_noninv_dp.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="pp_noninv_dp.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
...
<!--previous page button-->
	...
	<td><a href="pp_noninv_dp.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
...
<!--next page button-->
	...
	<td><a href="pp_noninv_dp.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
...
<!--last page button-->
	...
	<td><a href="pp_noninv_dp.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
...
var date = document.getElementById('date').value;
	...
	document.location = "pp_noninv_dp.php?fdate=" + date + "&tdate=" + date1 + "&vendor=" + vendor + "&code=" + code + "&description=" + "All";
...
var date = document.getElementById('date').value;
	...
	document.location = "pp_noninv_dp.php?fdate=" + date + "&tdate=" + date1 + "&vendor=" + vendor + "&code=" +"All" + "&description=" + "All";
...

{
	...
	document.location = "pp_noninv_dp.php?fdate=" + date + "&tdate=" + date1 + "&vendor=" + vendor + "&code=" + code + "&description=" + description;
...
<?php	if($_SESSION['db'] == 'golden' or $_SESSION['db'] == 'mlcf' or $_SESSION['db'] == 'maharashtra' or $_SESSION['db'] == 'mbcf') { ?>

    var warehouse = document.getElementById('warehouse').value;

	document.location = "pp_noninv_dp.php?fdate=" + date + "&tdate=" + date1 + "&vendor=" + vendor + "&warehouse=" + warehouse + "&code=" + code + "&description=" + description;
