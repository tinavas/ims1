...
<?php
$ceggs = 0;
 $q1 = "select * from layer_flock where shedcode = '$shed' and client = '$client'";
...
$bweight = 0;
$eweight = 0;
$query1 = "SELECT * FROM layer_pstandards where client = '$client' and (age <= $weeks) ORDER BY age ASC ";
...
if($qr['age'] == " ")
{
$q = "select * from layer_flock where shed = '$shed' and client = '$client'";
...
//echo $qr['heperweek']."/".$female;
$totaleggs = round(($qr['heperweek'] * $female),0);
$ffeed = $qr['fm'];
$fmortpercen = 0.01;
//echo $ffeed."/".$female; echo "<br/>";
...
<td<?php echo $sItemRowClass; ?> align="right">
<?php if($totaleggs  > 0) {  echo ewrpt_ViewValue($totaleggs ); } else { echo ewrpt_ViewValue("0"); } $tottotaleggs  = $tottotaleggs  + $totaleggs ;?></td>

</td>

<td<?php echo $sItemRowClass; ?> align="right">
<?php if($feedintake > 0) {  echo ewrpt_ViewValue($feedintake); } else { echo ewrpt_ViewValue("0"); } $totfeedintake = $totfeedintake + $feedintake; ?>
</td>
<td<?php echo $sItemRowClass; ?> align="right">
