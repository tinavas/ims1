...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="stockreportsmry1.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="stockreportsmry1.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="stockreportsmry1.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="stockreportsmry1.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
...
&nbsp;&nbsp;&nbsp;
<form action="stockreportsmry1.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="stockreportsmry1.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="stockreportsmry1.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="stockreportsmry1.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="stockreportsmry1.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php echo changeprice1(round($opening,2)); ?>
</td>

		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
<?php echo changeprice1(round($purchased,2)); ?>
</td>

		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
<?php echo changeprice1(round($consumed,2)); ?>
</td>

<td<?php echo $sItemRowClass; ?> style="text-align:right;">
<?php echo changeprice1($sales); ?>
</td>

		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
<?php echo changeprice1(round(($closing),2)); ?>
</td>
...
<td<?php echo $sItemRowClass; ?> style="text-align:right;">
<?php echo changeprice1(round(($closing*$avgcost),2)); ?>
</td>
<?php } ?>
	</tr>
<?php }
...
function reloadpage()
{
	...
	//document.location = "stockreportsmry1.php?fromdate=" + fromdate + "&todate=" + todate + "&cat=" + cat + "&warehouse=" + warehouse;
