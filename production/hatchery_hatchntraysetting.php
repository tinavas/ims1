...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "`hatchery_traysetting`";
...
<?php } ?>
<br />
<center><strong>Hatch Record and Tray Setting Report</strong></center>
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="hatchery_hatchntraysetting.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="hatchery_hatchntraysetting.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="hatchery_hatchntraysetting.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="hatchery_hatchntraysetting.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="hatchery_hatchntraysetting.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="hatchery_hatchntraysetting.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="hatchery_hatchntraysetting.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="hatchery_hatchntraysetting.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="hatchery_hatchntraysetting.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Chick Cost before Hatching">CCBH</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Infertile Percentage">Inf.%</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Chicks-A Percentage">Ch.A %</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Hatch Percentage">Hatch %</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Un Hatched Eggs">U.HatchEggs</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Culled Chicks">C.Chicks</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Dead Chicks">D.Chicks</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Hatching Cost">H.Cost</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Transport Cost">T.Cost</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td title="Chicks Cost">Ch.Cost</td>
			</tr></table>
		</td>
<?php } ?>
...
<?php
$get_flock = $x_flock;
$get_date = $x_settingdate;

$query0 = "SELECT * FROM hatchery_traysetting WHERE settingdate = '$get_date' AND flock = '$get_flock' and client ='$client'";
$result0 = mysql_query($query0,$conn1) or die(mysql_error());
$rows0 = mysql_fetch_assoc($result0);
$reject = $rows0['reject'] + $rows0['waste'];

$query1 = "SELECT * FROM ims_itemcodes WHERE description = 'INFERTILE'";
$result1 = mysql_query($query1,$conn1) or die(mysql_error());
$rows1 = mysql_fetch_assoc($result1);
$infercode = $rows1['code'];

$query1 = "SELECT * FROM ims_itemcodes WHERE description = 'BLAST'";
$result1 = mysql_query($query1,$conn1) or die(mysql_error());
$rows1 = mysql_fetch_assoc($result1);
$blastcode = $rows1['code'];

$hatchcost = 0;
$transportcost = 0;

$query1 = "SELECT * FROM hatchery_costsettings WHERE fromdate <= '$get_date' and todate >= '$get_date'";
$result1 = mysql_query($query1,$conn1) or die(mysql_error());
$rows1 = mysql_fetch_assoc($result1);
$hatchcost = $rows1['hatchcost'];
$transfercost = $rows1['transferpackagecost'];


$query = "SELECT * FROM hatchery_hatchrecord WHERE settingdate = '$get_date' AND flock = '$get_flock' and client ='$client'";
$result = mysql_query($query,$conn1) or die(mysql_error());
$numrows = mysql_num_rows($result);
$rows = mysql_fetch_assoc($result);
$chicksA = $rows['chicksA'];
$chicksB = $rows['chicksB'];
$culledchicks = $rows['culls'];
$deadchicks = $rows['dih'];
$hatchper = $rows['hatchper'];
$code = $rows['code'];
$rejections = $rows['rejections'];
$percentage = $rows['percentage'];
$chickscost = round($rows['cost'],2);
$codetemp = explode(',',$code);
$rejecttemp = explode(',',$rejections);
$percentagetemp = explode(',',$percentage);
$j=0;
while($codetemp[$j])
{
$codetemp[$j];
if($codetemp[$j] == $infercode)
{
$infertile = $rejecttemp[$j];
$infertileper = $percentagetemp[$j];
}
if($codetemp[$j] == $blastcode)
{
$blast = $rejections[$j];
}
$j++;
...
$chicksAper = round((($chicksA * 100) / $x_eggsset),2);
$hatchper = round(((($chicksA + $chicksB + $culledchicks + $deadchicks) / $x_eggsset) * 100),2);
$unhatchedeggs = $x_eggsset - ($blast + $infertile + $chicksA + $chicksB + $culledchicks + $deadchicks);
?>
<?php
if($numrows)
{
...
<?php echo ewrpt_ViewValue("Cobb 400") ?>
</td>
...
<?php echo ewrpt_ViewValue($x_noofeggs) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($reject) ?>
</td>
...
<?php echo ewrpt_ViewValue($x_eggsset) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($eggprice) ?>
</td>
		
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($chickcost) ?>
</td>

		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($blast) ?>
</td>
		
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($infertile) ?>
</td>
		
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($infertileper) ?>
</td>
		
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($chicksA) ?>
</td>

		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($chicksAper) ?>
</td>
		
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($chicksB) ?>
</td>

		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($hatchper) ?>
</td>

		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($unhatchedeggs) ?>
</td>
		
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($culledchicks) ?>
</td>

		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($deadchicks) ?>
</td>
		
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($hatchcost) ?>
</td>
		
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($transportcost) ?>
</td>
		
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($chickscost) ?>
</td>
<!--
		<td<?php //echo $sItemRowClass; ?>>
<?php //echo ewrpt_ViewValue($eggweight) ?>
</td>
...
?>
	<tr>
		<td colspan="22" class="ewRptGrpSummary1">Summary for Settingdate: <?php $t_settingdate = $x_settingdate; $x_settingdate = $o_settingdate; ?>
<?php echo ewrpt_ViewValue(ewrpt_FormatDateTime($x_settingdate,7)) ?>
