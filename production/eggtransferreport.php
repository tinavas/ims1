...
$EW_REPORT_TABLE_SQL_SELECT = "SELECT ims_eggtransfer.date, ims_eggtransfer.fromwarehouse, ims_eggtransfer.towarehouse, ims_eggtransfer.tocode, ims_eggtransfer.todescription, ims_eggtransfer.toeggs, ims_eggtransfer.price FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "ims_eggtransfer.towarehouse IN (SELECT tbl_sector.sector FROM tbl_sector WHERE tbl_sector.type1 = 'Egg Center')";
...
$af_toeggs = NULL; // Popup filter for toeggs
...
$o_toeggs = NULL; $t_toeggs = NULL; $ft_toeggs = 3; $rf_toeggs = NULL; $rt_toeggs = NULL;
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="eggtransferreport.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="eggtransferreport.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="eggtransferreport.php?export=word">Export to Word</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<form action="eggtransferreport.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="eggtransferreport.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="eggtransferreport.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="eggtransferreport.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="eggtransferreport.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php echo ewrpt_ViewValue($x_todescription) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_toeggs) ?>
</td>
		<td<?php echo $sItemRowClass; ?>>
...
function GetRow($opt) {
	...
	if (!$rs->EOF) {
		...
		$GLOBALS['x_toeggs'] = $rs->fields('toeggs');
		...
		$val[6] = $GLOBALS['x_toeggs'];
		$val[7] = $GLOBALS['x_price'];
	} else {
		$GLOBALS['x_date'] = "";
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_CustomView1_tocode"] = "";
			$_SESSION["sort_CustomView1_todescription"] = "";
			$_SESSION["sort_CustomView1_toeggs"] = "";
			$_SESSION["sort_CustomView1_price"] = "";
		}
