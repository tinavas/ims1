...
define("EW_REPORT_TABLE_VAR", "hatchery_loadingdetails2", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "hatchery_loadingdetails2_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "hatchery_loadingdetails2_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "hatchery_loadingdetails2_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "hatchery_loadingdetails2_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "hatchery_loadingdetails2_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "hatchery_loadingdetails";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT hatchery_loadingdetails.date, hatchery_loadingdetails.unit, hatchery_loadingdetails.shed, hatchery_loadingdetails.flock, hatchery_loadingdetails.settingno, hatchery_loadingdetails.setterno, hatchery_loadingdetails.time, hatchery_loadingdetails.partitionno, hatchery_loadingdetails.transferdate, hatchery_loadingdetails.hatchdate, hatchery_loadingdetails.eggweight, hatchery_loadingdetails.avgegg, hatchery_loadingdetails.loadedby FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "'$fromdate' <= hatchery_loadingdetails.date and hatchery_loadingdetails.date <= '$todate'";
$EW_REPORT_TABLE_SQL_GROUPBY = "hatchery_loadingdetails.date, hatchery_loadingdetails.unit, hatchery_loadingdetails.shed, hatchery_loadingdetails.flock, hatchery_loadingdetails.settingno, hatchery_loadingdetails.setterno, hatchery_loadingdetails.time, hatchery_loadingdetails.partitionno, hatchery_loadingdetails.transferdate, hatchery_loadingdetails.hatchdate, hatchery_loadingdetails.eggweight, hatchery_loadingdetails.avgegg, hatchery_loadingdetails.loadedby";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "hatchery_loadingdetails.date DESC, hatchery_loadingdetails.flock ASC, hatchery_loadingdetails.settingno ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "hatchery_loadingdetails.date", TRUE);
...
ewrpt_CreatePopup("hatchery_loadingdetails2_date", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_flock, $sel_flock, $ft_flock) ?>
ewrpt_CreatePopup("hatchery_loadingdetails2_flock", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_unit, $sel_unit, $ft_unit) ?>
ewrpt_CreatePopup("hatchery_loadingdetails2_unit", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_shed, $sel_shed, $ft_shed) ?>
ewrpt_CreatePopup("hatchery_loadingdetails2_shed", [<?php echo $jsdata ?>]);
</script>
<div id="hatchery_loadingdetails2_date_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_loadingdetails2_flock_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_loadingdetails2_unit_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="hatchery_loadingdetails2_shed_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="hatchery_loadingdetails2smry.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="hatchery_loadingdetails2smry.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="hatchery_loadingdetails2smry.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="hatchery_loadingdetails2smry.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="hatchery_loadingdetails2smry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="hatchery_loadingdetails2smry.php?start=<?php echo $Pager->FirstButton->Start ?><?php echo $url; ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="hatchery_loadingdetails2smry.php?start=<?php echo $Pager->PrevButton->Start ?><?php echo $url; ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="hatchery_loadingdetails2smry.php?start=<?php echo $Pager->NextButton->Start ?><?php echo $url; ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="hatchery_loadingdetails2smry.php?start=<?php echo $Pager->LastButton->Start ?><?php echo $url; ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_loadingdetails2_date', false, '<?php echo $rf_date; ?>', '<?php echo $rt_date; ?>');return false;" name="x_date<?php echo $cnt[0][0]; ?>" id="x_date<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Flock</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_loadingdetails2_flock', false, '<?php echo $rf_flock; ?>', '<?php echo $rt_flock; ?>');return false;" name="x_flock<?php echo $cnt[0][0]; ?>" id="x_flock<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Unit</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_loadingdetails2_unit', false, '<?php echo $rf_unit; ?>', '<?php echo $rt_unit; ?>');return false;" name="x_unit<?php echo $cnt[0][0]; ?>" id="x_unit<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Shed</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'hatchery_loadingdetails2_shed', false, '<?php echo $rf_shed; ?>', '<?php echo $rt_shed; ?>');return false;" name="x_shed<?php echo $cnt[0][0]; ?>" id="x_shed<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
-->
...
<?php 
 ...
 include "config.php";
 $query = "SELECT SUM(eggsset) as sume,eggspertray FROM hatchery_loadingdetails WHERE settingno = '$x_settingno'";
 ...
 $query = "SELECT SUM(eggsset) as sume FROM hatchery_loadingdetails WHERE date = '$x_date'";
 $result = mysql_query($query,$conn1);
 while($row = mysql_fetch_assoc($result))
 {
...
$q = "select code,rejections from hatchery_loadingdetails where settingno = '$x_settingno'";
$qrs = mysql_query($q,$conn1) or die(mysql_error());
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_hatchery_loadingdetails2_date"])) {
		LoadSelectionFromSession('date');
	} elseif (@$_SESSION["sel_hatchery_loadingdetails2_date"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_date"] = "";
	}

	// Get Flock selected values
	if (is_array(@$_SESSION["sel_hatchery_loadingdetails2_flock"])) {
		LoadSelectionFromSession('flock');
	} elseif (@$_SESSION["sel_hatchery_loadingdetails2_flock"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_flock"] = "";
	}

	// Get Unit selected values
	if (is_array(@$_SESSION["sel_hatchery_loadingdetails2_unit"])) {
		LoadSelectionFromSession('unit');
	} elseif (@$_SESSION["sel_hatchery_loadingdetails2_unit"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_unit"] = "";
	}

	// Get Shed selected values
	if (is_array(@$_SESSION["sel_hatchery_loadingdetails2_shed"])) {
		LoadSelectionFromSession('shed');
	} elseif (@$_SESSION["sel_hatchery_loadingdetails2_shed"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_shed"] = "";
	}
}
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_hatchery_loadingdetails2_$parm"] = "";
	$_SESSION["rf_hatchery_loadingdetails2_$parm"] = "";
	$_SESSION["rt_hatchery_loadingdetails2_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_hatchery_loadingdetails2_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_hatchery_loadingdetails2_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_hatchery_loadingdetails2_$parm"];
}
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_flock"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_flock"], "hatchery_loadingdetails.flock", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_flock"], $GLOBALS["gb_flock"], $GLOBALS["gi_flock"], $GLOBALS["gq_flock"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_hatchery_loadingdetails2_date"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_flock"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_settingno"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_unit"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_shed"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_setterno"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_time"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_partitionno"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_transferdate"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_hatchdate"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_eggweight"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_avgegg"] = "";
			$_SESSION["sort_hatchery_loadingdetails2_loadedby"] = "";
		}
