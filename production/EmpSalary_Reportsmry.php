...
$genlink = "&sector=".$_GET['sector']."&desig=".$_GET['desig']."&employee=".$_GET['employee'];
...
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Salary Report for <?php echo $_GET['employee'].", ".$desig. " of ".$_GET['sector']; ?>,  <?php echo $cyear; ?></font></strong></td>
</tr>
...
$EW_REPORT_TABLE_SQL_SELECT = "SELECT hr_salary_payment.name, hr_employee.sector, hr_employee.designation, hr_salary_payment.totalsal, hr_salary_payment.advdeduction, hr_salary_payment.deduction, hr_salary_payment.pbonus, hr_salary_payment.bonus, hr_salary_payment.ot, hr_salary_payment.paid, hr_salary_payment.paymode, hr_salary_payment.leavesded, hr_salary_payment.cddno, hr_salary_payment.salparamid FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
$EW_REPORT_FIELD_ADVDEDUCTION_SQL_SELECT = "SELECT DISTINCT hr_salary_payment.advdeduction FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_ADVDEDUCTION_SQL_ORDERBY = "hr_salary_payment.advdeduction";
$EW_REPORT_FIELD_DEDUCTION_SQL_SELECT = "SELECT DISTINCT hr_salary_payment.deduction FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_DEDUCTION_SQL_ORDERBY = "hr_salary_payment.deduction";
$EW_REPORT_FIELD_PBONUS_SQL_SELECT = "SELECT DISTINCT hr_salary_payment.pbonus FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_PBONUS_SQL_ORDERBY = "hr_salary_payment.pbonus";
$EW_REPORT_FIELD_BONUS_SQL_SELECT = "SELECT DISTINCT hr_salary_payment.bonus FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_BONUS_SQL_ORDERBY = "hr_salary_payment.bonus";
$EW_REPORT_FIELD_OT_SQL_SELECT = "SELECT DISTINCT hr_salary_payment.ot FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_OT_SQL_ORDERBY = "hr_salary_payment.ot";
...
<?php $jsdata = ewrpt_GetJsData($val_pbonus, $sel_pbonus, $ft_pbonus) ?>
ewrpt_CreatePopup("Salary_Report_pbonus", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_bonus, $sel_bonus, $ft_bonus) ?>
ewrpt_CreatePopup("Salary_Report_bonus", [<?php echo $jsdata ?>]);
...
<?php } ?>
<center>
<?php $genlinkm = "&sector=".$_GET['sector']."&desig=".$_GET['desig']."&employee=".$_GET['employee'];?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="EmpSalary_Reportsmry.php?<?php echo $genlinkm; ?>&export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="EmpSalary_Reportsmry.php?<?php echo $genlinkm; ?>&export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="EmpSalary_Reportsmry.php?<?php echo $genlinkm; ?>&export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="EmpSalary_Reportsmry.php?<?php echo $genlinkm; ?>&cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="EmpSalary_Reportsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="EmpSalary_Reportsmry.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="EmpSalary_Reportsmry.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="EmpSalary_Reportsmry.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="EmpSalary_Reportsmry.php?<?php echo $genlinkm; ?>&start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
?>
    <thead>
      <tr>
        <?php if (@$sExport <> "") { ?>
        <td valign="bottom" class="ewTableHeader"> Date </td>
        <?php } else { ?>
        ...
        <?php } ?>
        <?php if (@$sExport <> "") { ?>
        <td valign="bottom" class="ewRptGrpHeader">Description</td>
        <?php } else { ?>
        <td class="ewTableHeader"><table cellspacing="0" class="ewTableHeaderBtn">
            <tr>
              <td>Description</td>
        ...
        <?php } ?>
        <?php if (@$sExport <> "") { ?>
        <td valign="bottom" class="ewRptGrpHeader">Loan </td>
        <?php } else { ?>
        <td class="ewTableHeader"><table cellspacing="0" class="ewTableHeaderBtn">
            <tr>
              <td>Loan </td>
...
?>
      <?php
		...
		$totrec =0;
		include "config.php";
		$eid=0;$loanac="";$advance =0;
		$qc = "Select employeeid,loanac from hr_employee where sector = '$sector' and designation = '$desig' and name='$empname'";
		$qcrs = mysql_query($qc,$conn1) or die(mysql_error());
		while($qcr = mysql_fetch_assoc($qcrs))
		{
		$eid = $qcr['employeeid'];
		$loanac = $qcr['loanac'];
	 	//$advance = $qcr['advance'];
		}
		$sumdramount =0;  $sumcramount=0;$totalsal =0;$totadvded=0;$totothded =0;$totpbonus=0;$totbonus=0;$totot=0;$totsalpaid=0;
		$d1 = 0;$d2=0;
		$qd1 = "SELECT distinct(date) FROM  ac_financialpostings where venname='$empname' and crdr='Dr' and coacode = '$loanac' order by date asc ";
		...
		$qd2 = "SELECT distinct(date) FROM `hr_salary_payment` where eid='$eid' order by date asc ";
		...
		else if($datearr1 != "" && $datearr2 == "")
		{
		$datearr = $datearr1;
		}
		else if($datearr1 != "" && $datearr2 != "")
		{
		$datearr = array_merge($datearr1, $datearr2);
		}
		
		$datearru = array_unique($datearr);
		sort($datearru);
		...
		{?>
      <tr>
        <td class="ewRptGrpField1" style="color:#FFFFFF"><?php echo $z; ?></td>
        <td<?php echo $sItemRowClass; ?>><?php echo "Initial Advance Given"?></td>
        <td class="ewRptGrpField3"><?php echo $advance; ?></td>
        <td<?php echo $sItemRowClass; ?> style="color:#FFFFFF"><?php echo $z; ?></td>
        <td<?php echo $sItemRowClass; ?> style="color:#FFFFFF" ><?php echo $z; ?></td>
        <td class="ewRptGrpField3" style="color:#FFFFFF"><?php echo $z; ?></td>
        <td<?php echo $sItemRowClass; ?> style="color:#FFFFFF"><?php echo $z; ?></td>
        <td<?php echo $sItemRowClass; ?> style="color:#FFFFFF" ><?php echo $z; ?></td>
        <td<?php echo $sItemRowClass; ?> style="color:#FFFFFF" ><?php echo $z; ?></td>
		<td<?php echo $sItemRowClass; ?> style="color:#FFFFFF" ><?php echo $z; ?></td>
      </tr>
      <?php $totrec = $totrec+1;}	<?php */?>	
		<?php 
		for($i=0;$i<count($datearru);$i++)
		{
		 $datecmp = $datearru[$i];
		$datec = date("d-m-Y",strtotime($datecmp));

		$qr = "Select amount,crdr FROM ac_financialpostings where venname='$empname'  and crdr='Dr'  and coacode = '$loanac' and date ='$datecmp' ";
		$qrrs = mysql_query($qr,$conn1);
		while($qrr = mysql_fetch_assoc($qrrs))
		{
			$sumdramount = $sumdramount + $qrr['amount']; 
		
		
		?>
      <tr>
        <td class="ewRptGrpField1"><?php echo $datec; ?></td>
        <td<?php echo $sItemRowClass; ?>><?php echo "Loan "?></td>
        <td class="ewRptGrpField3"><?php echo $qrr['amount']; ?></td>
        <td<?php echo $sItemRowClass; ?> style="color:#FFFFFF"><?php echo $z; ?></td>
        <td<?php echo $sItemRowClass; ?> style="color:#FFFFFF" ><?php echo $z ; ?></td>
        <td class="ewRptGrpField3" style="color:#FFFFFF"><?php echo $z; ?></td>
        <td<?php echo $sItemRowClass; ?> style="color:#FFFFFF"><?php echo $z; ?></td>
        <td<?php echo $sItemRowClass; ?> style="color:#FFFFFF" ><?php echo $z; ?></td>
       <?php /*?> <td<?php echo $sItemRowClass; ?> style="color:#FFFFFF" ><?php echo $z; ?></td>
		<td<?php echo $sItemRowClass; ?> style="color:#FFFFFF" ><?php echo $z; ?></td><?php */?>
      </tr>
      <?php
		$totrec = $totrec+1; } 
		$qr1 = "Select * FROM hr_salary_payment where eid='$eid' and date ='$datecmp'";
		$qrrs1 = mysql_query($qr1,$conn1) or die(mysql_error());
		while($qrr1 = mysql_fetch_assoc($qrrs1))
		{
		
		?>
      <tr>
        <td class="ewRptGrpField1"><?php echo $datec; ?></td>
        <td<?php echo $sItemRowClass; ?>><?php echo "Salary for " .$montharr[$qrr1['month1']-1]. " , ".$qrr1['year1']; ?></td>
        <td<?php echo $sItemRowClass; ?> style="color:#FFFFFF" ><?php echo $z; ?></td>
        <td class="ewRptGrpField3"><?php echo $qrr1['totalsal']; $totalsal = $totalsal + $qrr1['totalsal'];?></td>
        <td<?php echo $sItemRowClass; ?>><?php echo $qrr1['advded']; $totadvded = $totadvded + $qrr1['advded'];?></td>
        <td<?php echo $sItemRowClass; ?> ><?php echo $qrr1['oded']; $totothded= $totothded + $qrr1['oded'];?></td>
       <?php /*?> <td class="ewRptGrpField3"><?php echo $qrr1['pbonus']; $totpbonus= $totpbonus + $qrr1['pbonus'];?></td>
        <td<?php echo $sItemRowClass; ?>><?php echo $qrr1['bonus']; $totbonus = $totbonus + $qrr1['bonus'];?></td><?php */?>
        <td<?php echo $sItemRowClass; ?> ><?php echo $qrr1['incometax']; $totot = $totot+ $qrr1['incometax'];?></td>
        <td<?php echo $sItemRowClass; ?> ><?php echo $qrr1['paid']; $totsalpaid = $totsalpaid + $qrr1['paid'];?></td>
...
?>
      ...
      <tr class="ewRptGrandSummary">
        <td colspan="14">Grand Total (<?php echo ewrpt_FormatNumber($totrec,0,-2,-2,-2); ?> Detail Records)</td>
      </tr>
      <tr class="ewRptGrandSummary">
        <td colspan="2" class="ewRptGrpAggregate">SUM</td>
        <td><b><?php echo ewrpt_ViewValue($sumdramount + $advance) ?></b></td>
		
        <td><b><?php echo ewrpt_ViewValue($totalsal) ?></b>
            </td>
        <td>
            <b><?php echo ewrpt_ViewValue($totadvded) ?></b>
                  </td>
        <td>
            <b><?php echo ewrpt_ViewValue($totothded) ?></b>
                   </td>
        <?php /*?><td>
            <b><?php echo ewrpt_ViewValue($totpbonus) ?></b>
            </td>
        <td>
            <b><?php echo ewrpt_ViewValue($totbonus) ?></b>
           </td><?php */?>
        <td>
            <b><?php echo ewrpt_ViewValue($totot) ?></b>
            </td>
        <td>
            <b><?php echo ewrpt_ViewValue($totsalpaid) ?></b>
            </td>
...
function SetupPopup() {
	...
	// Get 'reset' command
		...
		if (strtolower($sCmd) == "reset") {
			...
			ClearSessionSelection('advdeduction');
			ClearSessionSelection('deduction');
			ClearSessionSelection('pbonus');
			ClearSessionSelection('bonus');
			ClearSessionSelection('ot');
...
function CheckFilter() {
	...
	if (!ewrpt_MatchedArray($GLOBALS["seld_advdeduction"], $GLOBALS["sel_advdeduction"]))
		return TRUE;

	// Check deduction popup filter
	if (!ewrpt_MatchedArray($GLOBALS["seld_deduction"], $GLOBALS["sel_deduction"]))
		return TRUE;
	...
	if (!ewrpt_MatchedArray($GLOBALS["seld_ot"], $GLOBALS["sel_ot"]))
		return TRUE;
