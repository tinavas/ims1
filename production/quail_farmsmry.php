...
// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "quail_farm";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT quail_farm.code, quail_farm.description, quail_farm.capacity FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Farm Details</font></strong></td>
</tr>
</table>
<br/>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quail_farmsmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="quail_farmsmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="quail_farmsmry.php?export=word">Export to Word</a><br /><br />
<?php } ?>
...
<form action="quail_farmsmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="quail_farmsmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quail_farmsmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quail_farmsmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quail_farmsmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php echo ewrpt_ViewValue(changeprice1($x_capacity)); ?>
</td>
	</tr>
<?php
...
function getSort()
{
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] = "quail_farm.code ASC";
