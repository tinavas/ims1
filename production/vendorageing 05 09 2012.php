...
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">Supplier/Customer Name&nbsp;<?php echo $ven; ?></font></strong></td>
</tr>
<?php if($_SESSION[db]=='albustan' || $_SESSION[db]=='albustanlayer') {?>
<tr>
<td colspan="2" align="center"><strong><font color="#3e3276">Supplier/Customer Code&nbsp;<?php echo $vendorcode; ?></font></strong></td>
</tr>
<?php } ?>
<tr>
...
?>
   <tr>
		...
		<?php  echo ewrpt_ViewValue(date($datephp,strtotime($qr['adate']))) ?>
		</td>
