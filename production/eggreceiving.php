...
<tr>
 <td colspan="2" align="center"><strong><font color="#3e3276">Egg Receiving Report</font></strong></td>
</tr>
<tr height="5px"></tr>
<tr>
...
<tr>
 <td align="center" colspan="2"><strong> Hatchery : </strong><?php echo $hatchery; ?></td>
...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="eggreceiving.php?export=html&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&hatchery=<?php echo $hatchery; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="eggreceiving.php?export=excel&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&hatchery=<?php echo $hatchery; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="eggreceiving.php?export=word&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&hatchery=<?php echo $hatchery; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="eggreceiving.php?cmd=reset&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&hatchery=<?php echo $hatchery; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
while($array=mysql_fetch_assoc($result))
 ...
 $query="SELECT distinct(tocode),lower(todescription) as todescription FROM ims_eggreceiving where client = '$client'  and date >= '$fromdate' and date <= '$todate' and tocode not in (select code from ims_itemcodes where cat='Hatch Eggs') order by tocode";
$result=mysql_query($query);
$eggcodecount=-1;
while($array=mysql_fetch_assoc($result))
 {
...
<?php } ?>
	...
	<tbody>
<?php 
  $query = "SELECT distinct(tid) FROM ims_eggreceiving where client = '$client'  and date >= '$fromdate' and date <= '$todate' order by date";
           $result = mysql_query($query,$conn1) or die(mysql_error()); 
           while($row1 = mysql_fetch_assoc($result))
           {  
           $query1 = "SELECT * FROM ims_eggreceiving where client = '$client' and date >= '$fromdate' and date <= '$todate' and tid = '$row1[tid]'";
...
<td class="ewRptGrpField1" align="right" style="padding-right:15px;">
<?php echo changeprice1($shortage); $total_shortage+=$shortage; ?></td> 
<td class="ewRptGrpField1" align="right" style="padding-right:15px;">
<?php echo changeprice1($totaleggs+$shortage); $total+=($totaleggs+$shortage) ?></td>
	</tr>
<?php
}
?>
<tr>
		<td colspan="3" align="right" class="ewRptGrpField2">
...
<td class="ewRptGrpField1" align="right" style="padding-right:15px;">
<strong><?php echo changeprice1($total_shortage); ?></strong></td>
<td class="ewRptGrpField1" align="right" style="padding-right:15px;">
<strong><?php echo changeprice1($total); ?></strong></td>
	</tr>
	</tbody>
	<tfoot>
...
function reloadpage()
{
	...
	document.location = "eggreceiving.php?fromdate=" + fdate+'&todate=' + tdate+'&hatchery=' + hatchery;
}
</script>
