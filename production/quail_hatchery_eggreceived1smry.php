...
define("EW_REPORT_TABLE_VAR", "quail_hatchery_eggreceived1", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "quail_hatchery_eggreceived1_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "quail_hatchery_eggreceived1_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "quail_hatchery_eggreceived1_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "quail_hatchery_eggreceived1_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "quail_hatchery_eggreceived1_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "quail_hatchery_eggreceived";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT quail_hatchery_eggreceived.unit, quail_hatchery_eggreceived.shed, quail_hatchery_eggreceived.flock, quail_hatchery_eggreceived.date, quail_hatchery_eggreceived.time, quail_hatchery_eggreceived.lotno, quail_hatchery_eggreceived.eggsreceived, quail_hatchery_eggreceived.totalrejections, quail_hatchery_eggreceived.totaleggs, quail_hatchery_eggreceived.fst, quail_hatchery_eggreceived.fet, quail_hatchery_eggreceived.placeofstorage, quail_hatchery_eggreceived.driver, quail_hatchery_eggreceived.vehicleno, quail_hatchery_eggreceived.receivedby FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "'$fromdate' <= quail_hatchery_eggreceived.date and quail_hatchery_eggreceived.date <= '$todate'";
$EW_REPORT_TABLE_SQL_GROUPBY = "quail_hatchery_eggreceived.unit, quail_hatchery_eggreceived.shed, quail_hatchery_eggreceived.flock, quail_hatchery_eggreceived.date, quail_hatchery_eggreceived.time, quail_hatchery_eggreceived.lotno, quail_hatchery_eggreceived.eggsreceived, quail_hatchery_eggreceived.totalrejections, quail_hatchery_eggreceived.totaleggs, quail_hatchery_eggreceived.fst, quail_hatchery_eggreceived.fet, quail_hatchery_eggreceived.placeofstorage, quail_hatchery_eggreceived.driver, quail_hatchery_eggreceived.vehicleno, quail_hatchery_eggreceived.receivedby";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "quail_hatchery_eggreceived.unit ASC, quail_hatchery_eggreceived.shed ASC, quail_hatchery_eggreceived.flock ASC, quail_hatchery_eggreceived.date ASC";
$EW_REPORT_TABLE_SQL_USERID_FILTER = "";
$EW_REPORT_TABLE_SQL_CHART_BASE = "";

// Table Level Group SQL
define("EW_REPORT_TABLE_FIRST_GROUP_FIELD", "quail_hatchery_eggreceived.unit", TRUE);
...
$EW_REPORT_TABLE_SQL_SELECT_AGG = "SELECT SUM(quail_hatchery_eggreceived.eggsreceived) AS SUM_eggsreceived, SUM(quail_hatchery_eggreceived.totaleggs) AS SUM_totaleggs FROM " . $EW_REPORT_TABLE_SQL_FROM;
...
?>
<?php
$EW_REPORT_FIELD_UNIT_SQL_SELECT = "SELECT DISTINCT quail_hatchery_eggreceived.unit FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_UNIT_SQL_ORDERBY = "quail_hatchery_eggreceived.unit";
$EW_REPORT_FIELD_SHED_SQL_SELECT = "SELECT DISTINCT quail_hatchery_eggreceived.shed FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_SHED_SQL_ORDERBY = "quail_hatchery_eggreceived.shed";
$EW_REPORT_FIELD_FLOCK_SQL_SELECT = "SELECT DISTINCT quail_hatchery_eggreceived.flock FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_FLOCK_SQL_ORDERBY = "quail_hatchery_eggreceived.flock";
$EW_REPORT_FIELD_DATE_SQL_SELECT = "SELECT DISTINCT quail_hatchery_eggreceived.date FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_DATE_SQL_ORDERBY = "quail_hatchery_eggreceived.date";
?>
<?php
...
ewrpt_CreatePopup("quail_hatchery_eggreceived1_unit", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_shed, $sel_shed, $ft_shed) ?>
ewrpt_CreatePopup("quail_hatchery_eggreceived1_shed", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_flock, $sel_flock, $ft_flock) ?>
ewrpt_CreatePopup("quail_hatchery_eggreceived1_flock", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_date, $sel_date, $ft_date) ?>
ewrpt_CreatePopup("quail_hatchery_eggreceived1_date", [<?php echo $jsdata ?>]);
</script>
<div id="quail_hatchery_eggreceived1_unit_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="quail_hatchery_eggreceived1_shed_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="quail_hatchery_eggreceived1_flock_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="quail_hatchery_eggreceived1_date_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<?php if (@$sExport == "") { ?>
...
<br />
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quail_hatchery_eggreceived1smry.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="quail_hatchery_eggreceived1smry.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="quail_hatchery_eggreceived1smry.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="quail_hatchery_eggreceived1smry.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<?php if (@$sExport == "") { ?>
<br /><br />
...
<form action="quail_hatchery_eggreceived1smry.php<?php echo $url1; ?>" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="quail_hatchery_eggreceived1smry.php?start=<?php echo $Pager->FirstButton->Start ?><?php echo $url; ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quail_hatchery_eggreceived1smry.php?start=<?php echo $Pager->PrevButton->Start ?><?php echo $url; ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quail_hatchery_eggreceived1smry.php?start=<?php echo $Pager->NextButton->Start ?><?php echo $url; ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quail_hatchery_eggreceived1smry.php?start=<?php echo $Pager->LastButton->Start ?><?php echo $url; ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Unit</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_eggreceived1_unit', false, '<?php echo $rf_unit; ?>', '<?php echo $rt_unit; ?>');return false;" name="x_unit<?php echo $cnt[0][0]; ?>" id="x_unit<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Shed</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_eggreceived1_shed', false, '<?php echo $rf_shed; ?>', '<?php echo $rt_shed; ?>');return false;" name="x_shed<?php echo $cnt[0][0]; ?>" id="x_shed<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Flock</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_eggreceived1_flock', false, '<?php echo $rf_flock; ?>', '<?php echo $rt_flock; ?>');return false;" name="x_flock<?php echo $cnt[0][0]; ?>" id="x_flock<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'quail_hatchery_eggreceived1_date', false, '<?php echo $rf_date; ?>', '<?php echo $rt_date; ?>');return false;" name="x_date<?php echo $cnt[0][0]; ?>" id="x_date<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php 
$q = "select code,rejections from quail_hatchery_eggreceived where lotno = '$x_lotno'";
$qrs = mysql_query($q,$conn1) or die(mysql_error());
...
function SetupPopup() {
	...
	if (is_array(@$_SESSION["sel_quail_hatchery_eggreceived1_unit"])) {
		LoadSelectionFromSession('unit');
	} elseif (@$_SESSION["sel_quail_hatchery_eggreceived1_unit"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_unit"] = "";
	}

	// Get Shed selected values
	if (is_array(@$_SESSION["sel_quail_hatchery_eggreceived1_shed"])) {
		LoadSelectionFromSession('shed');
	} elseif (@$_SESSION["sel_quail_hatchery_eggreceived1_shed"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_shed"] = "";
	}

	// Get Flock selected values
	if (is_array(@$_SESSION["sel_quail_hatchery_eggreceived1_flock"])) {
		LoadSelectionFromSession('flock');
	} elseif (@$_SESSION["sel_quail_hatchery_eggreceived1_flock"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_flock"] = "";
	}

	// Get Date selected values
	if (is_array(@$_SESSION["sel_quail_hatchery_eggreceived1_date"])) {
		LoadSelectionFromSession('date');
	} elseif (@$_SESSION["sel_quail_hatchery_eggreceived1_date"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_date"] = "";
	}
}
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_quail_hatchery_eggreceived1_$parm"] = "";
	$_SESSION["rf_quail_hatchery_eggreceived1_$parm"] = "";
	$_SESSION["rt_quail_hatchery_eggreceived1_$parm"] = "";
}

// Load selection from session
function LoadSelectionFromSession($parm) {
	$GLOBALS["sel_$parm"] = @$_SESSION["sel_quail_hatchery_eggreceived1_$parm"];
	$GLOBALS["rf_$parm"] = @$_SESSION["rf_quail_hatchery_eggreceived1_$parm"];
	$GLOBALS["rt_$parm"] = @$_SESSION["rt_quail_hatchery_eggreceived1_$parm"];
}
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_unit"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_unit"], "quail_hatchery_eggreceived.unit", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_unit"], $GLOBALS["gb_unit"], $GLOBALS["gi_unit"], $GLOBALS["gq_unit"]);
	}
	if (is_array($GLOBALS["sel_shed"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_shed"], "quail_hatchery_eggreceived.shed", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_shed"], $GLOBALS["gb_shed"], $GLOBALS["gi_shed"], $GLOBALS["gq_shed"]);
	}
	if (is_array($GLOBALS["sel_flock"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_flock"], "quail_hatchery_eggreceived.flock", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_flock"], $GLOBALS["gb_flock"], $GLOBALS["gi_flock"], $GLOBALS["gq_flock"]);
	}
	if (is_array($GLOBALS["sel_date"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_date"], "quail_hatchery_eggreceived.date", EW_REPORT_DATATYPE_DATE, $GLOBALS["af_date"], $GLOBALS["gb_date"], $GLOBALS["gi_date"], $GLOBALS["gq_date"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_quail_hatchery_eggreceived1_unit"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_shed"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_flock"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_date"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_time"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_lotno"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_eggsreceived"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_totalrejections"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_totaleggs"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_fst"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_fet"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_placeofstorage"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_driver"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_vehicleno"] = "";
			$_SESSION["sort_quail_hatchery_eggreceived1_receivedby"] = "";
		}
	...
	if (@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] == "") {
		@$_SESSION[EW_REPORT_TABLE_SESSION_ORDER_BY] = "quail_hatchery_eggreceived.lotno ASC, quail_hatchery_eggreceived.eggsreceived ASC";
		$_SESSION["sort_quail_hatchery_eggreceived1_lotno"] = "ASC";
		$_SESSION["sort_quail_hatchery_eggreceived1_eggsreceived"] = "ASC";
	}
