...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Chicken Stock Report from &nbsp;<?php echo date("d.m.Y",strtotime($fromdate)); ?>&nbsp;&nbsp;to&nbsp;<?php echo date("d.m.Y",strtotime($todate)); ?></font></strong></td>
</tr>
</table>
<br/>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="chickenstockreport.php?export=html<?php echo $url; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="chickenstockreport.php?export=excel<?php echo $url; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="chickenstockreport.php?export=word<?php echo $url; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="chickenstockreport.php?cmd=reset<?php echo $url; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
...
$q = "select distinct(cat) from chicken_category order by cat";
...
<?php
$q = "select distinct(sector) from tbl_sector WHERE (type1 = 'Chicken Center' || type1 = 'Processing Unit') order by sector";
$qrs = mysql_query($q,$conn1);
...
&nbsp;&nbsp;&nbsp;
<form action="chickenstockreport.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="chickenstockreport.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="chickenstockreport.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="chickenstockreport.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="chickenstockreport.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php 
  /////////getting the OPENING/////////
//////Purchases
$getop = "SELECT SUM(receivedquantity) as quantity FROM pp_sobi WHERE code = '$x_code' AND date < '$fromdate' AND (warehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || warehouse =  '$warehouse') AND dflag = '0'";
...
$irecop = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE code = '$x_code' AND date < '$fromdate' AND (warehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || warehouse =  '$warehouse') and riflag = 'R'";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
...
///////////////Intermediate Issue
$iiscop = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE code = '$x_code' AND date < '$fromdate' AND (warehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || warehouse =  '$warehouse') and riflag = 'I'";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
...
$staadd = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE code = '$x_code' AND date < '$fromdate' AND (unit in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || unit =  '$warehouse') and type = 'Add'";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
...
$staded = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE code = '$x_code' AND date < '$fromdate' AND (unit in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || unit =  '$warehouse') and type = 'Deduct'";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
...
////////////Stock Transfer in
$stockto = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stocktransfer WHERE code = '$x_code' AND date < '$fromdate' and (towarehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || towarehouse =  '$warehouse')";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$stockto = $rowop['quantity'];
////////////Stock Transfer out
$stockfrom = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stocktransfer WHERE code = '$x_code' AND date < '$fromdate' and (fromwarehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || fromwarehouse =  '$warehouse')";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$stockfrom = $rowop['quantity'];
/////////////////////Chicken Processing
$chickentrans = 0;
$getop = "SELECT SUM(quantity) as quantity FROM chicken_chickentransfer WHERE tocode = '$x_code' AND date < '$fromdate' and (unit in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || unit =  '$warehouse')";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$chickentrans = $rowop['quantity'];
///////////////////Sales
$sales = 0;
$getop = "SELECT SUM(quantity) as quantity FROM oc_cobi WHERE code = '$x_code' AND date < '$fromdate' and (warehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || warehouse =  '$warehouse')";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$sales = $rowop['quantity'];

/////////end of getting the OPENING/////////
//echo $purchasedop."/".$staadd."/".$grop."/".$chickentrans."/".$stockto."/".$irecop."/".$staded."/".$stockfrom."/".$iiscop."/".$sales;
$opening = $purchasedop + $staadd + $stockto + $chickentrans + $irecop - ($staded + $stockfrom + $iiscop + $sales);
...
/////////////////////Chicken Processing
$prod = 0;
$getop = "SELECT SUM(quantity) as quantity FROM chicken_chickentransfer WHERE tocode = '$x_code' AND date >= '$fromdate' AND  date <= '$todate' and (unit in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || unit =  '$warehouse')";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$prod = $rowop['quantity'];
...
/////////////////////Sales
$sales = 0;
$getop = "SELECT SUM(quantity) as quantity FROM oc_cobi WHERE code = '$x_code' AND date >= '$fromdate' AND  date <= '$todate' and (warehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || warehouse =  '$warehouse')";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$sales = $rowop['quantity'];
////////////Stock Transfer out
$stockfrom = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stocktransfer WHERE code = '$x_code' AND date >= '$fromdate' AND  date <= '$todate' and (fromwarehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || fromwarehouse =  '$warehouse')";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$stockfrom = $rowop['quantity'];
///////////////Intermediate Issue
$iiscop = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE code = '$x_code' AND date >= '$fromdate' AND  date <= '$todate' AND (warehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || warehouse =  '$warehouse') and riflag = 'I'";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$iiscop = $rowop['quantity'];
if($iiscop == "") $iiscop = 0;
$issued = $sales + $stockfrom + $iiscop;
...
//////////////////////Return
$irecop = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_intermediatereceipt WHERE code = '$x_code' AND date >= '$fromdate' AND  date <= '$todate' AND (warehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || warehouse =  '$warehouse') and riflag = 'R'";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$irecop = $rowop['quantity'];
if($irecop == "") $irecop = 0;
////////////Stock Transfer in
$stockto = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stocktransfer WHERE code = '$x_code' AND date >= '$fromdate' AND  date <= '$todate' and (towarehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || towarehouse =  '$warehouse')";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$stockto = $rowop['quantity'];
//////////////////Sales Return
$salesret = 0;
$getop = "SELECT SUM(quantity) as quantity FROM oc_salesreturn WHERE code = '$x_code' AND date >= '$fromdate' AND  date <= '$todate'";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$salesret = $rowop['quantity'];
//////////////////Purchase
$purchase = 0;
$getop = "SELECT SUM(receivedquantity) as quantity FROM pp_sobi WHERE code = '$x_code' AND date >= '$fromdate' AND  date <= '$todate' AND (warehouse in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || warehouse =  '$warehouse') AND dflag = '0'";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$purchase = $rowop['quantity'];
if($purchase == "") $purchase = 0;
$return = $irecop + $salesret + $stockto + $purchase;
...
/////////////////////Wastage
$stadeduct = 0;
$getop = "SELECT SUM(quantity) as quantity FROM ims_stockadjustment WHERE code = '$x_code' AND date >= '$fromdate' AND  date <= '$todate' AND (unit in(select distinct(sector) from tbl_sector where type1 = 'Chicken Center') || unit =  '$warehouse') and type = 'Deduct'";
$resultop = mysql_query($getop,$conn1);
$rowop = mysql_fetch_assoc($resultop);
$stadeduct = $rowop['quantity'];
if($stadeduct == "") $stadeduct = 0;

//////////////////Closing
$closing = ($opening + $prod + $return)- ($issued + $stadeduct);
...
<?php echo changequantity($opening); $total_opening+=$opening; ?>
		...
		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
<?php echo changequantity($prod); $total_prod+=$prod; ?>
</td>

		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
<?php echo changequantity($issued); $total_issued+=$issued; ?>
</td>

<td<?php echo $sItemRowClass; ?> style="text-align:right;">
<?php echo changequantity($return); $total_return+=$return; ?>
</td>
<td<?php echo $sItemRowClass; ?> style="text-align:right;">
<?php echo changequantity($stadeduct); $total_stadeduct+=$stadeduct; ?>
</td>
		<td<?php echo $sItemRowClass; ?> style="text-align:right;">
...
?>
<tr><td colspan="3" align="right">Total</td><td align="right" ><?php echo changequantity(round($total_opening,2)) ;?></td><td align="right" ><?php echo round($total_prod,2) ;?></td><td align="right" ><?php echo changequantity(round($total_issued,2)) ;?></td><td align="right" ><?php echo changequantity(round($total_return,2)) ;?></td><td align="right" ><?php echo round($total_stadeduct,2) ;?></td><td align="right" ><?php echo changequantity(round($total_closing,2)) ;?></td></tr>
	</tbody>
	<tfoot>
<?php
...
function reloadpage()
{
	...
	//document.location = "chickenstockreport.php?fromdate=" + fromdate + "&todate=" + todate + "&cat=" + cat + "&warehouse=" + warehouse;
...
if(Date.parse(date1) <= Date.parse(date2))
	{
	document.location = "chickenstockreport.php?fromdate=" + fromdate + "&todate=" + todate + "&warehouse=" + warehouse + "&cat=" + cat;
	}
	else
	{
