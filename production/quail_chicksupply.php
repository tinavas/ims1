...
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Quail Chicks Supply Report</font></strong></td>
</tr>
<tr>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="quail_chicksupply.php?fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="quail_chicksupply.php?fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="quail_chicksupply.php?fdate=<?php echo $fdate; ?>&tdate=<?php echo $tdate; ?>&export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="quail_chicksupply.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<br /><br />
<?php } ?>
...
//	echo "sql: " . $sSql . "<br>";
	...
	if (1) { // Loop detail records
		...
		echo $qc = "Select distinct(code) from ims_itemcodes where cat like '%Quail Chicks%' or cat like '%Layer%Chicks%'";
		else
		$qc = "Select distinct(code) from ims_itemcodes where cat like '%Quail Chicks%'";		
		...
		if($_SESSION['db'] == "central")
		{
$query = "SELECT * FROM ims_itemcodes WHERE cat like '%Quail Chicks%' or cat like '%Layer Chicks%'";
}
else
{
$query = "SELECT * FROM ims_itemcodes WHERE cat like '%Quail Chicks%'";
}
...
{ 
  $codelist = $codelist . ",'" . $row1['code'] . "'";
		...
		$d1 = 0;$d2=0;
		if($_SESSION['db'] == "central")
		  $qd1 = "SELECT distinct(date) FROM `ims_stocktransfer` where code IN (select distinct(code) from ims_itemcodes where cat like '%Quail Chicks%' or cat like '%Layer Chicks%') and date >= '$fdate' and date <= '$tdate' order by date asc ";
		else
		 $qd1 = "SELECT distinct(date) FROM `ims_stocktransfer` where code IN (select distinct(code) from ims_itemcodes where cat like '%Quail Chicks%') and date >= '$fdate' and date <= '$tdate' order by date asc ";
		...
		if($_SESSION['db'] == "central")
		$qd2 = "SELECT distinct(date) FROM `oc_cobi` where code IN (select distinct(code) from ims_itemcodes where cat like '%Quail Chicks%' or cat like '%Layer Chicks%') and date >= '$fdate' and date <= '$tdate' order by date asc ";
		else
		$qd2 = "SELECT distinct(date) FROM `oc_cobi` where code IN (select distinct(code) from ims_itemcodes where cat like '%Quail Chicks%') and date >= '$fdate' and date <= '$tdate' order by date asc ";
		...
		if($_SESSION['db'] == "central")
		$qr = "Select * FROM `ims_stocktransfer` where code IN (Select distinct(code) from ims_itemcodes where cat like '%Quail Chicks%' or cat like '%Layer Chicks%') and date ='$datecmp'";
		else
		 $qr = "Select * FROM `ims_stocktransfer` where code IN (Select distinct(code) from ims_itemcodes where cat like '%Quail Chicks%') and date ='$datecmp'";
...
<form action="quail_chicksupply.php" name="ewpagerform" id="ewpagerform" class="ewForm">
<table border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td nowrap>
...
<!--first page button-->
	...
	<td><a href="quail_chicksupply.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="quail_chicksupply.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="quail_chicksupply.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="quail_chicksupply.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
function reloadpage()
{
	...
	document.location = 'quail_chicksupply.php?fdate='+fdate +'&tdate='+tdate;
