...
$q = "delete from ims_intermediatereceipt where tid = '$tid' and riflag = 'I'";
$qr = mysql_query($q,$conn);

$q1q = "select * from ac_financialpostings where trnum = '$tid' and type = 'II' and itemcode = '$code' and client='$client'";
...
$get_entriess = "DELETE FROM ac_financialpostings WHERE  trnum = '$tid' and coacode = '$coacode' and type = 'II'  ";
