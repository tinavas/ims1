 ...
 <?php include "config.php";
	 ...
	 $q2 = mysql_query("select distinct(aflock) as newflock,date,towarehouse as farmer from ims_stocktransfer where towarehouse = '$farmer' AND (cat = 'Broiler Chicks' or cat = 'Broiler Day Old Chicks') AND client = '$client' order by date DESC",$conn) or die(mysql_error());
