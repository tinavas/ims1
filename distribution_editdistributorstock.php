...
$q1="select date,superstockist,distributor from  distribution_distributorstock where trnum='$trnum' limit 1";
...
$k=-1;
 ...
 $q1="select *  from  distribution_distributorstock where trnum='$trnum'";
...
document.location="dashboardsub.php?page=distribution_editdistributorstock&date="+date+"&superstockist="+superstockist+"&trnum=<?php echo $trnum;?>";
