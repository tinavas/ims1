...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			...
			<button type="button" onClick="document.location='dashboardsub.php?page=packing'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16">New Add</button> 
		</div>
...
<tbody>
   ...
   $cont=$desc=$pack="";
    ...
    $q1="select date,location,trnum,totalamount,concat(\"'\",group_concat(code separator \"','\"),\"'\") as codes,addempname from packing_dailypacking where date between '$fromdate' and '$todate' group by trnum order by date desc";
  }
		   else
		   {
		   
		 $sectorlist = $_SESSION['sectorlist'];
		  $q1="select date,location,trnum,totalamount,concat(\"'\",group_concat(code separator \"','\"),\"'\") as codes,addempname from packing_dailypacking where date between '$fromdate' and '$todate' and location in ($sectorlist) group by trnum order by date desc";
		 }
   ...
   while($r1=mysql_fetch_assoc($q1))
    ...
    <a href="dashboardsub.php?page=editpacking&trnum=<?php echo $r1['trnum'];?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="New Edit"/></a>&nbsp;&nbsp;
         <a onclick="if(confirm('Are you sure,want to delete'))document.location='dashboardsub.php?page=deletepacking&trnum=<?php echo $r1['trnum'];?>'"><img src="images/icons/fugue/cross-circle.png" style="border:0px;" title="Delete" /></a>
    </td>
    <?php }else
	{
	?>
...
document.location = "dashboardsub.php?page=dailypacking&month=" + month + "&year=" + year;
}
</script>
