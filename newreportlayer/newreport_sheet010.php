...
<center>
  <table><tr><td style="font-size:13px"><b>Egg/Bird Graph For Flock <?php session_start(); echo $_SESSION['flock']; ?></b></td></tr></table>
</center>
...
$query = "SELECT * FROM breeder_pstandards where breed = '$breedi' and client = '$client' ORDER BY age ASC ";
//$query = "SELECT * FROM breeder_pstandards where client = '$client' ORDER BY age ASC ";
...
?>
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl676 align=right><?php echo $_SESSION['eggbird'][$age]; ?></td>
  <td class=xl673 align=right><?php echo number_format($row1['hecum'],1); ?></td>
 </tr>
<?php } } ?>
...
[<?php echo $age = $row1['age']; ?>,<?php echo $_SESSION['eggbird'][$age]; ?>],
<?php } } ?>
[<?php echo $age; ?>,<?php echo $_SESSION['eggbird'][$age]; ?>]];
...
[<?php echo $age = $row1['age']; ?>,<?php echo $row1['hecum']; ?>],
<?php //}
        } ?>
[<?php echo $age; ?>,<?php echo $row1['hecum']; ?>]];
...
<!-- , dashes: { show: true }, hoverable: true  -->
           ...
           { 
            ...
            points: { show: true },
             ...
             xaxis: { min: 18,tickSize: 1,max:<?php echo $maxage; ?>,label: "test"},
             yaxis: { min: 0, tickSize: 20, max:300 },
