...
?>
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl673 align=right style="color:#006600"><?php echo $row1['bodyweight']; ?></td>
 </tr>
<?php } } ?>
...
$query = "SELECT * FROM breeder_pstandards where breed = '$breedi' and client = '$client' and age <= '$maxage' ORDER BY age ASC ";
$result = mysql_query($query,$conn); 
while($row1 = mysql_fetch_assoc($result))
{ 
 if(in_array($row1['age'],$arrage)) {
...
[<?php echo $age = $row1['age']; ?>,<?php echo $row1['bodyweight']; ?>],
<?php //}
        } ?>
[<?php echo $age; ?>,<?php echo $row1['bodyweight']; ?>]];
