...
<tr>
<td style="vertical-align:middle" align="left"  ><img src="../logo/thumbnails/<?php echo $image; ?>" border="0px" /></td>
<td style="vertical-align:middle; font-family:Georgia, 'Times New Roman', Times, serif; font-size:16px"  align="right" ><?php echo html_entity_decode($address); ?></td>
</tr>
</table>
<?php } else {?>
