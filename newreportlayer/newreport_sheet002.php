...
//$query1 = "SELECT * FROM breeder_consumption WHERE flock like '$flockget' and date2 < '$untildate' group by date2,flock";
...
$query = "SELECT max(date2) as 'date2' FROM breeder_consumption WHERE flock like '$flockget' ";
$result = mysql_query($query,$conn); 
while($row1 = mysql_fetch_assoc($result))
{
...
$femalet = 0;$malet=0;
$query1t = "SELECT cat,quantity FROM `ims_stocktransfer` WHERE cat Like 'Birds' AND client = '$client' AND towarehouse like '$flockget' AND date<='$mincmpdate'";
...
<table border=0 cellpadding=0 cellspacing=0 width=2526 style='border-collapse:
 ...
 width:20pt'>
 <col class=xl198 width=38 style='mso-width-source:userset;mso-width-alt:694;
 width:30pt'>
 <col class=xl198 width=28 style='mso-width-source:userset;mso-width-alt:804;
 width:23pt'>
 <col class=xl198 width=28 style='mso-width-source:userset;mso-width-alt:658;
 width:23pt'>
 <col class=xl280 width=43 span=2 style='mso-width-source:userset;mso-width-alt:
 1572;width:32pt'>
 <col class=xl198 width=43 span=4 style='mso-width-source:userset;mso-width-alt:
 694;width:40pt'>
 <col class=xl198 width=28 style='mso-width-source:userset;mso-width-alt:658;
 width:23pt'>
 <col class=xl280 width=43 span=2 style='mso-width-source:userset;mso-width-alt:
 1572;width:32pt'>
 <col class=xl280 width=45 span=4 style='mso-width-source:userset;mso-width-alt:
 914;width:40pt'>
<!-- <col class=xl198 width=50 style='mso-width-source:userset;mso-width-alt:1572;
 width:45pt'>-->
<!-- <col class=xl280 width=50 style='mso-width-source:userset;mso-width-alt:1792;
 width:45pt'>-->
 <col class=xl198 width=159 style='mso-width-source:userset;mso-width-alt:1572;
 width:150pt'>
 <col class=xl280 width=159 style='mso-width-source:userset;mso-width-alt:1682;
 width:150pt'>
<!-- <col class=xl198 width=45 style='mso-width-source:userset;mso-width-alt:1280;
 width:40t'>
 <col class=xl198 width=45 style='mso-width-source:userset;mso-width-alt:1389;
 width:40pt'>
 <col class=xl198 width=102 span=2 style='mso-width-source:userset;mso-width-alt:
 1901;width:100pt'>
...
<?php } ?>
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  <td colspan=6 class=xl245 style='mso-ignore:colspan'>&nbsp;</td>
    <td colspan=2 class=xl245 style='mso-ignore:colspan'>&nbsp;</td>
 ...
 <td class=xl250></td>
  <td colspan=5 class=xl753><?php echo $startfemale; ?></td>
 ...
 <!-- <td class=xl254>&nbsp;</td>-->
  <td class=xl255>&nbsp;</td>
  <td colspan=3 class=xl717 style='border-right:2.0pt double black;border-left:
  none'>MORTALITY</td>
  <td colspan=3 class=xl721 style='border-right:2.0pt double black;border-left:
  none'>CULLS</td>
  <td colspan=1 rowspan=2 class=xl737 width=50 style='border-right:2.0pt double black;
  border-bottom:.5pt solid black;width:38pt'>Sales</td>
  <td colspan=6 class=xl735 style='border-right:2.0pt double black;border-bottom:
  1.0pt solid black;border-left:none'>TOTAL PROUCRION</td>
  <td class=xl256>&nbsp;</td>
  <td colspan=3 class=xl731 style='border-right:2.0pt double black'>FEED CONSUMPTION</td>
  <td colspan=1 class=xl731 style='border-right:2.0pt double black'>Body Wt</td>
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  <td colspan=1 class=xl717 style='border-right:1.0pt solid black;border-left:
  none'>Birds</td>
  <td  class=xl724 style='border-right:.5pt solid black'>Daily<span style='mso-spacerun:yes'>&nbsp;</span></td>
  <td  class=xl719 style='border-right:.5pt solid black;border-left:
  none'>Cum</td>
  <td  class=xl310 width=50 style='border-right:2.0pt double black;border-left:
  none;width:38pt'>%</td>
  <td class=xl724 style='border-right:.5pt solid black'>Daily</td>
  <td  class=xl307 style='border-left:none'>Cum</td>
  <td  class=xl307 style='border-right:2.0pt double black;border-left:
  none'>%</td>
  ...
  none'>Incr / Decr</td>
  <td  class=xl722 style='border-right:2.0pt double black'><span style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp; </span><span
 ...
 <?php /*?> <td colspan=<?php echo $r * 2; ?> class=xl721 style='border-right:2.0pt double black;border-left:
  none'>R e j e c t i o n s<span style='mso-spacerun:yes'>&nbsp;</span></td><?php */?>
  <!--<td class=xl256>&nbsp;</td>-->
    <td rowspan=2 colspan=1 class=xl733 style='border-right:1.0pt solid black'>Feed Kg</td>
	<td rowspan=2 colspan=1 class=xl743 style='border-right:1.0pt solid black'>Feed gms</td>
  <!--<td  rowspan=2 colspan=1 class=xl733 style='border-right:2.0pt double black;border-left:
  none'>Feed gms</td>-->
  ...
  /egg</td>
  <td rowspan=2 colspan=1 class=xl733 style='border-right:2.0pt double black'>Actual</td>
 ...
 <tr height=16 style='height:12.0pt'>
  ...
  <td class=xl310 style='border-top:none;border-left:none'></td>
  <!--<td class=xl311 style='border-top:none;border-left:none'>M</td>-->
  <td class=xl312 style='border-left:none'></td>
 <!-- <td class=xl313>M</td>-->
...
<!--  <td class=xl258>M</td>-->
  ...
  <td class=xl317 style='border-top:none;'></td>
  <!--<td class=xl302 style='border-top:none;border-left:none'>M</td>-->

  <!--<td class=xl259>M</td>-->
  <td class=xl317 style='border-left:2.0pt double black' ></td>
 <?php /*?> <td class=xl320 style='border-top:none'>M</td><?php */?>
  <td class=xl321 >Nos.</td>
  <td class=xl322 style='border-top:none;border-left:none'>HD %</td>
  <td class=xl323 style='border-top:none;border-left:none'>Cum</td>
  <td class=xl324  style='border-top:none;border-left:none; text-align:center'>Eg/Brd</td>
  <td class=xl325 style='text-align:center'>Nos.</td>
  <td class=xl260 style='text-align:center'>%</td>
    
 <!-- <td class=xl326 style='border-top:none;border-left:none'>Nos.</td>
  <td class=xl327 style='border-top:none;border-left:none'>%</td>-->
  <!--<td class=xl263 style='border-top:none'>Diff</td>-->
 <!-- <td>&nbsp;</td>-->
<!--  <td class=xl330 style='border-top:none;border-left:none'>HE/BIRD</td>-->
  <td class=xl261 style='border-top:none'>Egg Wt</td>
...
<?php } } ?><?php */?>
 ...
 <!-- <td class=xl335 style='border-top:none;border-left:none'>M</td>-->
  ...
  <!--<td class=xl264>F</td>-->
  <!--<td class=xl265 style='border-top:none'>F</td>
...
while($row1 = mysql_fetch_assoc($result))
{
   ...
   $allfweight = 0;
   $allmweight = 0;
   $queryff = "SELECT max(eggwt) as 'eggwt',max(fweight) as 'fweight' FROM breeder_consumption WHERE flock like '$flockget' and date2 = '$row1[date2]' GROUP BY date2,flock ORDER BY date2 ASC";
   $resultff = mysql_query($queryff,$conn); 
   while($rowff = mysql_fetch_assoc($resultff))
   {
...
?>
 ...
 <td class=xl345 width="50pt" ><?php echo number_format(round(($tfmort/$female)*100,2),2); ?></td>
  ...
  <?php /*?><td class=xl343 style='border-left:none'><?php echo $allmcull; $weekmcull = $weekmcull + $allmcull; ?></td><?php */?>
  <td class=xl302 ><?php echo $tfcull; ?></td>
<?php /*?>  <td class=xl300 style='border-top:none'><?php echo $tmcull; ?></td><?php */?>
  <td class=xl345 style='border-left:none'><?php echo number_format(round(($tfcull/$female)*100,2),2); ?></td>
  <?php /*?><td class=xl345 style='border-left:none'><?php echo number_format(round(($tmcull/$female)*100,2),2); ?></td><?php */?>
  <td class=xl345 style='border-left:none'>0</td>
  ...
  <?php /*?><td class=xl347 style='border-top:none'><?php echo $tdayhatcheggs; ?></td>
  ...
  <td class=xl351 style='border-top:none'><?php echo number_format(round(($thatcheggs/$female),2),2); ?></td><?php */?>
...
<?php } } ?> <?php */?>
  ...
  <?php /*?><td class=xl355 style='border-left:none'><?php echo $tdayeggs - $tdayhatcheggs; ?></td><?php */?>
  <td class=xl356 ><?php echo number_format($fdayfeed,2); $weekffeed = $weekffeed + $fdayfeed; ?></td>
 <?php /*?> <td class=xl357 style='border-top:none;border-left:none'><?php echo number_format($mdayfeed,2); $weekmfeed = $weekmfeed + $mdayfeed; ?></td><?php */?>
  ...
  <?php /*?><td class=xl359 style='border-top:none;border-left:none'><?php echo number_format(round(($mdayfeed/$male)*1000,3),3); $weekmfeedg = $weekmfeedg + round(($mdayfeed/$male)*1000,3); ?></td>
  <td class=xl354><?php echo $tdayfeed = number_format($fdayfeed ,2); ?></td><?php */?>
  <td class=xl345 style='border-left:none'><?php echo number_format(round($fdayfeed/$tdayeggs,2),2); ?></td>
  <td class=xl346 ><?php echo $fweight = $allfweight; ?></td>
  <?php /*?><td class=xl346 style='border-left:none'><?php echo $mweight = $allmweight; ?></td><?php */?>
...
// $male = $startmale - ($tmmort + $tmcull);
 ...
 if($nrDaysPassed == 7)
 {
   ...
   $cummeggs = $cummeggs + $weekeggs;
   // $cummhatcheggs = $cummhatcheggs + $weekhatcheggs;
...
?>
 ...
 <?php /*?> <td class=xl268><?php echo $weekmmort; $_SESSION['immort'][$tempage] = $weekmmort; $_SESSION['mmort'][$tempage] = $weekmmort; ?></td><?php */?>
  <td colspan=1 class=xl268 style='mso-ignore:colspan'>&nbsp;</td>
  ...
  <?php /*?><td class=xl268><?php echo $weekmcull; $_SESSION['imcull'][$tempage] = $weekmcull; ?></td><?php */?>
  <td colspan=1 class=xl268 style='mso-ignore:colspan'>&nbsp;</td>
...
<?php /*?>  <?php for($i = 0; $i < sizeof($rejections); $i++)
  ...
  <?php /*?><td class=xl269><?php echo $weekmfeed; $_SESSION['imfeed'][$tempage] = $weekmfeed; ?></td><?php */?>
  <td class=xl269><?php echo $temp3 = round($weekffeedg/7,2); $_SESSION['iffeedpb'][$tempage] = $temp3; $cummffeedg = $cummffeedg + $temp3; ?></td>
 <?php /*?> <td class=xl269><?php echo $temp4 = round($weekmfeedg/7,2); $_SESSION['imfeedpb'][$tempage] = $temp4; $cummmfeedg = $cummmfeedg + $temp4; ?></td>
  <td class=xl269><?php echo $t1 = $weekffeed + $weekmfeed; ?></td><?php */?>
  <?php  $t1 = $weekffeed; ?>
 ...
 <?php /*?> <td class=xl268><?php echo $tempcomp7 = $mweight; $_SESSION['mbweight'][$tempage] = $mweight; $_SESSION['imbweight'][$tempage] = $mweight; ?></td><?php */?>
 ...
 <tr height=15 style='height:11.25pt'>
  ...
  <td class=xl270>&nbsp;</td>
  <td class=xl271>&nbsp;</td>
  <td colspan=1 class=xl272 style='mso-ignore:colspan'>&nbsp;</td>
...
<?php /*?>  <td class=xl272><?php echo $cummmmort; ?></td><?php */?>
 ...
 <?php /*?> <td class=xl272><?php echo number_format(round(($cummmmort/$startmale)*100,3),3); $_SESSION['cmmort'][$tempage] = number_format(round(($cummmmort/$startmale)*100,3),3); ?></td><?php */?>
  <td class=xl272><?php echo $cummfcull; ?></td>
<?php /*?>  <td class=xl272><?php echo $cummmcull; ?></td><?php */?>
  <td colspan=1 class=xl272 style='mso-ignore:colspan'>&nbsp;</td>
  <td class=xl272><?php echo number_format(round(($cummfcull/$startfemale)*100,3),3); ?></td>
  <?php /*?><td class=xl272><?php echo number_format(round(($cummmcull/$startmale)*100,3),3); ?></td><?php */?>
  <td class=xl272>0</td>
  <!--<td class=xl272>0</td>-->
  ...
  <td colspan=2 class=xl272 style='mso-ignore:colspan'>&nbsp;</td>
 <?php /*?> <td class=xl272><?php echo $cummhatcheggs; ?></td>
  <td class=xl273><?php echo $tempcomp3 = round(($cummhatcheggs/$cummeggs)*100,2); ?></td>
  <td colspan=2 class=xl272 style='mso-ignore:colspan'>&nbsp;</td>
  <td class=xl273><?php echo $tempcomp4 = round($cummhatcheggs/$startfemale,2);  $_SESSION['hebird'][$tempage] = $tempcomp4;?></td><?php */?>
  <td class=xl272>&nbsp;</td>
<?php /*?>  <?php for($i = 0; $i < sizeof($rejections); $i++)
  {
  ?>
 ...
 <?php /*?> <td class=xl273><?php echo $cummmfeed; ?></td><?php */?>
  <td class=xl273><?php echo $cummffeedg; ?></td>
  <?php /*?><td class=xl273><?php echo $cummmfeedg; ?></td><?php */?>
<?php /*?>  <td class=xl273><?php echo  $cummffeed ; ?></td><?php */?>
  <td class=xl273>&nbsp;</td>
  <td colspan=1 class=xl272 style='mso-ignore:colspan'>&nbsp;</td>
...
<?php
  ...
  $qb = "SELECT breed FROM breeder_flock WHERE flockcode like '$flockget'";
...
?>
 <tr height=15 style='height:11.25pt'>
  ...
  <td class=xl274>&nbsp;</td>
  <!--<td class=xl275>&nbsp;</td>-->
  <td colspan=1 class=xl276 style='mso-ignore:colspan'>&nbsp;</td>
  <td colspan=1 class=xl276 style='mso-ignore:colspan'>&nbsp;</td>
  ...
  <?php /*?><td colspan=10 class=xl276 style='mso-ignore:colspan'>&nbsp;</td><?php */?>
  ...
  <?php /*?><td colspan=1 class=xl276 style='mso-ignore:colspan'>&nbsp;</td>
  <td class=xl276><?php echo $stdheggper; $_SESSION['heperstd'][$tempage] = $stdheggper; ?></td>
  <td colspan=2 class=xl276 style='mso-ignore:colspan'>&nbsp;</td>
  <td class=xl277><?php echo $stdheggbird;  $_SESSION['hebirdstd'][$tempage] =  $stdheggbird;?></td><?php */?>
  <td class=xl276><?php echo $stdeggwt; $_SESSION['ieggwtstd'][$tempage] = $stdeggwt;?></td>
  <?php /*?><td colspan=<?php echo $r * 2; ?> class=xl276 style='mso-ignore:colspan'>&nbsp;</td><?php */?>
  <td class=xl276>&nbsp;</td>
   <td class=xl276>&nbsp;</td>
     <td class=xl276>&nbsp;</td>
	  <!--<td class=xl276>&nbsp;</td>-->
  ...
  <?php /*?><td class=xl276><?php echo $stdmw; $_SESSION['mbweightstd'][$tempage] = $stdmw;?></td><?php */?>
 ...
 <!-- <td class=xl399>&nbsp;</td>-->
  ...
  <td colspan=7 class=xl400 style='mso-ignore:colspan'>&nbsp;</td>
  <td class=xl401><?php echo round($tempcomp1 - $hdper,2); ?></td>
  <td class=xl400>&nbsp;</td>
  <td class=xl401><?php echo round($tempcomp2 - $stdeggbird,2); ?></td>
  <td colspan=2 class=xl400 style='mso-ignore:colspan'>&nbsp;</td>
 <?php /*?> <td class=xl401><?php echo round($tempcomp3 - $stdheggper,2); ?></td>
  <td colspan=2 class=xl400 style='mso-ignore:colspan'>&nbsp;</td>
  <td class=xl401><?php echo round($tempcomp4 - $stdheggbird,2); ?></td><?php */?>
  <td class=xl400><?php echo round($tempcomp5 - $stdeggwt,2); ?></td>
  <?php /*?><td colspan=<?php echo $r * 2; ?> class=xl400 style='mso-ignore:colspan'>&nbsp;</td><?php */?>
  <!--<td class=xl400>&nbsp;</td>-->
  <td class=xl400>&nbsp;</td>
  <td colspan=2 class=xl400 style='mso-ignore:colspan'>&nbsp;</td>
  <?php /*?><td colspan=1 class=xl401 style='mso-ignore:colspan'>&nbsp;</td><?php */?>
  <td class=xl400><?php echo round($tempcomp6 - $stdfw,2); ?></td>
<?php /*?>  <td class=xl400><?php echo round($tempcomp7 - $stdmw,2); ?></td><?php */?>
  <td class=xl400>&nbsp;</td>
