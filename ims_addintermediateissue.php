...
$query="select cat,group_concat(concat(code,'@',description,'@',cunits) ) as cd from ims_itemcodes  group by cat";
...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" id="complex_form" method="post" action="ims_saveintermediateissue.php" onsubmit="return warehousechecking();" >		
...
<br>
 <table border="0" id="maintable">
     <tr>
		...
		<th style=""><strong>Warehouse<font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font></strong></th>
        <th width="10px"></th>
...
<?php } ?>
       ...
       <td width="10px"></td>
	      ...
	      <td >
         <input type="text" name="units[]" id="units@0"  size="8" readonly style="background:none; border:0px;"	 />
       </td>
       <td width="10px"></td>


       <td >
         <input type="text" name="quantity[]" id="quantity@0"  size="8" onfocus="makeRow();"  />
       </td>
       <td width="10px"></td>
...
<?php } ?> 
       ...
       <td>
         <select name="warehouse[]" id="warehouse@0" style=" width:100px">
...
<th style=""><strong>Narration<font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font></strong></th>
        <th width="10px"></th>
<td><textarea rows="3" cols="30" id="remarks" name="remarks"></textarea></td>
...
if(j<index)
{
if(document.getElementById("quantity@" +j).value == "" || document.getElementById("quantity@" + j).value==0)
return false;
}
...
<script type="text/javascript">
function script1() {
window.open('IMSHelp/help_t_addintermediateissue.php','IMS','width=500,height=600,toolbar=no,menubar=yes,scrollbars=yes,resizable=yes');
}
</script>
