...
if($flag <> '')
{
 ...
 $query="INSERT INTO contactdetails (id,name,address,phone,mobile,type,note,place,pan,cterm,vgroup,va,vppa,cgroup,ca,cac,client)
 VALUES (NULL,'$name','$addr','$phone','$mobile','$type','$note','$place','$pan','$cterm','$vgroup','$va','$vppa','$cgroup','$ca','$cac','$client')";
