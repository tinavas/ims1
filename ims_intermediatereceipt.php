...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			<button type="button" onClick="document.location='dashboardsub.php?page=ims_addintermediatereceipt'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
		   		       ...
		   		       if($_SESSION['sectorall'] == "all" || ($_SESSION['sectorall'] == "" && $_SESSION['sectorlist'] == ""))
	{
	 ...
	 $sectorlist = $_SESSION['sectorlist'];
		...
		if($sectorlist=="")   
		   ...
		   $query1="select distinct(tid),date,flag from ims_intermediatereceipt WHERE date BETWEEN '$fromdate' AND '$todate' AND riflag = 'R' order by date DESC";
		   
		   else
		   
	  $query1="select distinct(tid),date,flag from ims_intermediatereceipt WHERE date BETWEEN '$fromdate' AND '$todate' AND riflag = 'R' and warehouse in ($sectorlist) order by date DESC";  
           ...
           $query = "SELECT cat,code,description,quantity,rateperunit,units,empname FROM ims_intermediatereceipt WHERE date BETWEEN '$fromdate' AND '$todate' AND riflag = 'R' and tid='$rows[tid]' order by date DESC";
      ...
      ?>
            <tr>
			 ...
			 <?php if($_SESSION['valid_user']==$user || ($_SESSION['superadmin']=="1") ||($_SESSION['admin']=="1") ){?> 
			  &nbsp;<a href="dashboardsub.php?page=ims_editintermediatereceipt&id=<?php echo $rows['tid']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a>&nbsp;
			   <a onclick="if(confirm('Are you sure,want to delete')) document.location ='<?php echo 'ims_deleteintermediatereceipt.php?tid='.$rows['tid']; ?>'" >
...
document.location = "dashboardsub.php?page=ims_intermediatereceipt&month=" + month + "&year=" + year;
}
</script>
