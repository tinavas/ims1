...
<section class="grid_8">
  <div class="block-border">
     ...
     <form class="block-content form" id="complex_form" name="form1" method="post" action="pp_savepayment.php" onsubmit="return checkform1(this);">
...
<td width="10px">&nbsp;</td>
<td>
<input type="text" id="date" name="date" onchange="check_limit(this);check_tdslimit(dis)" size="15" value="<?php echo $date;?>" class="datepicker" />
</td>
...
<br />
<br />
<table id="TDStable" align="center" border="0px">
<tr>
<td>
...
<td width="10px">&nbsp;</td>
<td>
<input type="text" id="amount" name="amount" size="10" value="0" onkeyup="enablesave(this.value);check_limit(this);" style="text-align:right"/>
</td>
<td width="10px">&nbsp;</td>
...
<td width="10px">&nbsp;</td>
<td>
<input type="text" style="text-align:right" id="tdsamount@0" name="tdsamount[]" onkeyup="check_tdslimit(this);" size="10" value="0" />
</td>
</tr>
</table>
