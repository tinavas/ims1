...
<br/>
<br/>
<form id="form1" name="form1" method="post" action="pp_savetaxmasters.php"  onsubmit="return checkform(this);">
<table align="center">
...
<br />
<center>
<input type="submit" value="Save" />&nbsp;&nbsp;&nbsp;<input type="button" value="Cancel" onclick="document.location='dashboardsub.php?page=pp_taxmasters';">
</center>
</td>
</tr>
</table>
