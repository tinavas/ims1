...
<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
	...
	<button type="button" onClick="document.location='dashboardsub.php?page=tds_add_limit'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>		
	</div>		
</div></div>
...
<tbody>
      ...
      ?>
            <tr>
			 ...
			 <td>
            <?php
					$q=mysql_query("SELECT * FROM pp_payment WHERE date BETWEEN '".$row1['fromDate']."' AND '".$row1['toDate']."' AND paymentmode='Cash'");
					$re=mysql_num_rows($q);
					if($re!=0 )
					{
				?>
             ...
             <?php
					...
					{
				?>
                    <a onClick="if(confirm('Are you sure,want to delete')) document.location ='tds_delete_limit.php?id=<?php echo $row1['id']; ?>'">
