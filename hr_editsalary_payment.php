...
include "jquery.php";
$id = $_GET['id'];
$q = "select * from hr_salary_payment where id = '$id'";
...
<br /><br />
<form method="post" action="hr_updatesalary_payment.php" id="salform" name="salform">
<center>
...
<td width="10px">&nbsp;</td>
<td>
<input type="text"  style="width: 50px;text-align:right" id="advdeduction<?php echo $i; ?>" name="advdeduction" value="<?php echo $advdeduction;?>" onkeyup="bala(<?php echo $i; ?>);"/></td>


<td width="10px">&nbsp;</td>
<td><input type="text"  style="width: 50px;text-align:right" id="deduction<?php echo $i; ?>" name="deduction" value="<?php echo $deduction;?>" onkeyup="bala(<?php echo $i; ?>);"/>
  ...
  <td width="10px">&nbsp;</td>
<td><input type="text"  style="width: 50px;text-align:right" id="advbonus<?php echo $i; ?>" name="advbonus" value="<?php echo $pbonus;?>" onkeyup="bala(<?php echo $i; ?>);"/></td>

	

  <td width="10px">&nbsp;</td>
<td>
<input type="text"  style="width: 50px;text-align:right" id="bonus<?php echo $i; ?>" name="bonus" value="<?php echo $bonus;?>" onkeyup="bala(<?php echo $i; ?>);"/></td>

<td width="10px">&nbsp;</td>
<td><input type="text"  style="width: 50px;text-align:right" id="ot<?php echo $i; ?>" name="ot" value="<?php echo $ot;?>" onkeyup="bala(<?php echo $i; ?>);"/></td>

<td width="10px">&nbsp;</td>
<td>
<input type="text"  style="width: 70px;text-align:right;color:#FF0000" id="paid<?php echo $i; ?>" name="paid" value="<?php echo $paid;?>"  /></td>
<td width="10px">&nbsp;</td>
<td>
...
<input type="text" style="position:absolute;width:50px;visibility:hidden" id="cddno<?php echo $i; ?>" name="cddno" value="<?php echo $cddno;?>"/>
