...
<section class="grid_8">
  <div class="block-border">
     ...
     <form class="block-content form" id="complex_form" name="form1" method="post" action="pp_updatecreditnotedetails.php" onsubmit="return checkform(this);">
...
<td align="left"><input type="text" style="text-align:right;" size="15" id="vendamount" name="vendamount" value="<?php echo $totalamount; ?>" onKeyUp="total();"  /></td>
</tr>
</table>
...
<td><select id="drcr<?php echo $i; ?>" name="drcr[]" onChange="enabledrcr(this.id);"><option value="">-Select-</option>

<option value="Cr" <?php if($crdr=='Cr') echo "selected='selected'"; ?>>Cr</option>

<option value="Dr" <?php if($crdr=='Dr') echo "selected='selected'"; ?>>Dr</option>

</select>
</td>

<td width="10px"></td>
<td><input type="text" id="dramount<?php echo $i; ?>" name="dramount[]" value="<?php echo $dramount; ?>" style="text-align:right" size="8" onKeyUp="total();" <?php if($crdr == 'Cr') { ?> readonly <?php }?> /></td>
<td width="10px"></td>
<td><input type="text" id="cramount<?php echo $i; ?>" name="cramount[]" value="<?php echo $cramount; ?>" style="text-align:right" size="8" onKeyUp="total();" onFocus="makeForm();"  <?php if($crdr == 'Dr') { ?> readonly <?php }?> /></td>
</tr>
<?php
...
<td width="10px"></td>
<td align="right"><input type="text" id="drtotal" style="text-align:right;background:none;border:none;" name="drtotal" value="<?php echo $drtotal;?>" size="8" align="right" readonly  /></td>
<td width="10px"></td>
