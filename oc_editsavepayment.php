...
$q = "select * from ac_financialpostings where trnum = '$deltid' and type = 'OCPMT' and client = '$client'";
...
$tempamount+= ($poamountpaid - $poactualamount);
 ...
 $q = "insert into oc_payment (partycode,remarks,tid,date,party,paymentmethod,tds,tdscode,tdsdescription,tdscr,tdsamount,tdsamount1,paymentmode,code,code1,description,cr,amount,totalamount,bank,branch,cheque,cdate,choice,flag,empname,unit) 

values('$partycode','$remarks','$tid','$date','$party','$paymentmethod','$tds','$tdscode','$tdsdescription','$tdscr','$tdsamount','$tdsamount1','$paymentmode','$code','$code1','$description','$cr','$amount','$totalamount','$bank','$branch','$cheque','$cdate','$choice','$flag','$addemp','$unit')";
...
{ 
	...
	//{
		...
		$q = "insert into oc_payment (remarks,tid,date,party,paymentmethod,tds,tdscode,tdsdescription,tdscr,tdsamount,tdsamount1,paymentmode,code,code1,description,cr,amount,totalamount,bank,branch,cheque,cdate,choice,flag,empname,unit) 

values('$remarks','$tid','$date','$party','$paymentmethod','$tds','$tdscode','$tdsdescription','$tdscr','$tdsamount','$tdsamount1','$paymentmode','$code','$code1','$description','$cr','$amount','$totalamount','$bank','$branch','$cheque','$cdate','$choice','$flag','$addemp','$unit')";
...

{
...

 {
    ...
    $query4 = "INSERT INTO ac_financialpostings(date,itemcode,crdr,coacode,quantity,amount,trnum,type,venname,warehouse) 
	          ...
	          VALUES('".$adate."','','Cr','".$tdscode[$i]."','$quantity','".$tdsamount1[$i]."','".$tid."','".$type."','".$party."','".$unit."')";
   ...
   $amount = $amount;
     ...
     $query3 = "INSERT INTO ac_financialpostings(date,itemcode,crdr,coacode,quantity,amount,trnum,type,venname,warehouse) 
               ...
               VALUES('".$adate."','','Cr','".$code."','$quantity','".$amount."','".$tid."','".$type."','".$party."','".$unit."')";
	...
	$q = "select distinct(vppa) as code1 from contactdetails where name = '$venname' and (type = 'party' OR type = 'vendor and party') order by vppa";

	else if($paymentmethod == "Payment")

	$q = "select distinct(va) as code1 from contactdetails where name = '$venname' and (type = 'party' OR type = 'vendor and party') order by va";
    ...
    $query4 = "INSERT INTO ac_financialpostings(date,itemcode,crdr,coacode,quantity,amount,trnum,type,venname,warehouse) 
               ...
               VALUES('".$adate."','','Dr','".$code1."','$quantity','".$grandtotal."','".$tid."','".$type."','".$party."','".$unit."')";
