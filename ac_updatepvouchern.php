...
$q = "select * from ac_financialpostings where trnum = '$transactioncode' and type = 'PV' and client = '$client'";
...
$q = "insert into ac_gl (username,mode,transactioncode,bccodeno,code,description,type,controltype,schedule,crdr,cramount,dramount,rremarks,crtotal,drtotal,name,pmode,chequeno,date,status,voucher,vstatus,client,warehouse,vouchernumber,empname,adate) VALUES ('$username','$m','$transactioncode','$bccodeno','$code','$desc','$type','$controltype','$schedule','$crdr','$cramount','$dramount','$remarks','$crtotal','$drtotal','$name','$pmode','$chno','$date','U','P','A','$client','$unit','$vno','$username','$adate')"; 
$qrs = mysql_query($q,$conn) or die(mysql_error());
...
//End
 ...
 if($sectoremp == "")
{
$q1 = "insert into ac_financialpostings(date,crdr,coacode,amount,trnum,type,client,warehouse,venname,cash,bank,cashcode,bankcode,schedule,empname,adate) VALUES ('$date','$crdr','$code','$amount','$transactioncode','PV','$client','$unit','$empname','$cash','$bank','$cashcode','$bankcode','$schedule','$empname','$adate') ";
}
else
{
$q1 = "insert into ac_financialpostings(date,crdr,coacode,amount,trnum,type,client,warehouse,venname,cash,bank,cashcode,bankcode,schedule,empname,adate) VALUES ('$date','$crdr','$code','$amount','$transactioncode','PV','$client','$sectoremp','$empname','$cash','$bank','$cashcode','$bankcode','$schedule','$empname','$adate') ";
}
