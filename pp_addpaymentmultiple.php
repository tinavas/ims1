...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" style="height:600px" id="complex_form" method="post" action="pp_savepaymentmultiple.php" >
	  <h1 id="title1">Payment Multiple</h1>
...
<?php
		$q = "select distinct(name) from contactdetails where (type = 'vendor' OR type = 'vendor and party') and client = '$client' order by name";
...
<?php
$query = "select distinct(name) from contactdetails where (type = 'vendor' OR type = 'vendor and party') and client = '$client' order by name";
