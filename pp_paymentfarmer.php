...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			<button type="button" onClick="document.location='dashboardsub.php?page=pp_addpaymentfarmer'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
<tbody>
	  <?php
           include "config.php"; 
          $query = "SELECT id,tid,date,farmer,flock,amount,paymentmode FROM pp_paymentfarmer where date >= '$fromdate' and date <= '$todate' order by date DESC";
           ...
           ?>
	        ...
	        <tr>
			 ...
			 <td><?php echo $row1['farmer']; ?></td>
			 <td><?php echo $row1['flock']; ?></td>
			 <td><?php echo $row1['amount']; ?></td>
             <td ><?php echo $row1['paymentmode']; ?></td>
			 <td>
			 
			 <a href="<?php echo 'dashboardsub.php?page=pp_editpaymentfarmer&id='.$row1['tid']; ?>" ><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a>&nbsp;	
			 		 
		 <a onclick="if(confirm('Are you sure,want to delete')) document.location ='pp_deletepaymentfarmer.php?id=<?php echo $row1['tid']; ?>'" ><img src="images/icons/fugue/<?php echo "cross-circle.png";?>" style="border:0px" title="<?php echo "Delete";?>" /></a>&nbsp;
...
document.location = "dashboardsub.php?page=pp_paymentfarmer&month=" + month + "&year=" + year;
}
</script>