...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			<button type="button" onClick="document.location='dashboardsub.php?page=pp_addgoodsreceipt_a'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
<a href="dashboardsub.php?page=pp_editgoodsreceipt_a&id=<?php echo $row2['gr']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a>
&nbsp;&nbsp;&nbsp;<a onClick="if(confirm('Do you really want to delete this row?')) document.location='pp_deletegoodsreceipt_a.php?id=<?php echo $row2['gr']; ?>'"><img src="images/icons/fugue/cross-circle.png" style="border:0px" title="Delete" /></a>&nbsp;
<?php } else { ?>
<?php if ( strlen(strstr(','.$_SESSION['authorizesectors'],',GR,' ))>0 ) { ?>	<!-- If he has authority power -->
<a href="dashboardsub.php?page=pp_editgoodsreceipt_a&id=<?php echo $row2['gr']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a>
&nbsp;&nbsp;&nbsp;<a onClick="if(confirm('Do you really want to delete this row?')) document.location='pp_deletegoodsreceipt_a.php?id=<?php echo $row2['gr']; ?>'"><img src="images/icons/fugue/cross-circle.png" style="border:0px" title="Delete" /></a>&nbsp;
...
document.location = "dashboardsub.php?page=pp_goodsreceipt_a&month=" + month + "&year=" + year;
}
</script>
