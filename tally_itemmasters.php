...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" id="complex_form"style="height:500px" enctype="multipart/form-data" method="post" onsubmit="return checkform();" action="dashboardsub.php?page=import_itemmasters" >
	  <h1 id="title1">Import Item Masters</h1>
...
<tr height="15px"></tr>
<tr align="left">
 <td> 7. You can also download the sample format <input type="button" value="Download" onclick="document.location='./IMSHelp/ItemMasters.xlsx'"/></td>
</tr> 
<tr height="15px"></tr>
<tr align="center">
 ...
 <td><input type="submit" value="Import" id="import" name="import" />&nbsp;<input type="button" value="Cancel" onClick="javascript: history.go(-1)" /></td>
	...
	<footer>
		<div class="float-left">
			...
			<a href="./IMSHelp/Contacts.xls" class="button" >Item Masters Sample Format</a>
		</div>
