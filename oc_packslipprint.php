...
for($i = 0,$j = 770;$i < count($temp); $i++)
{
 ...
 $width = $pdf->getTextWidth(10,$temp2);
  ...
  {
   $j-=13;  
   $temp2=$pdf->addTextWrap(25,$j,250,8,"<b>$temp2</b>","");
  }
}
//$temp2=$pdf->addTextWrap(25,770,550,10,"<b>$address1</b>","left");	 
	$pdf->addTextWrap(25,775,550,12,"<b>DELIVERY NOTE</b>","center");
     $pdf->addText(115,700,8,"<b>$party</b>");
	 if($_SESSION['db']=="vista")
	 $pdf->addText(115,680,8,"<b>$ps($cop)</b>");
	 else
