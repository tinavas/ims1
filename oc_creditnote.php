<?php include "jquery.php";
 ...
 if($type == 'Credit') $mode = 'Customer Credit';
 else if($type == 'Debit') $mode = 'Customer Debit';
...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			<button type="button" onClick="document.location='dashboardsub.php?page=oc_addcreditnote&type=<?php echo $type; ?>'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
		...
		if($sectorlist=="")   
           ...
           ?>
            <tr>
			 ...
			 <a href="dashboardsub.php?page=oc_editcreditnotedetails&id=<?php echo $row1['crnum']; ?>&type=<?php echo $type; ?>&mode=<?php echo $row1['mode']; ?>&tid=<?php echo $row1['tid']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit" /></a>&nbsp;
			 
			 
			  <a onclick="if(confirm('Are you sure,want to delete')) document.location ='oc_deletecreditnote.php?id=<?php echo $row1['crnum']; ?>&type=<?php echo $type; ?>&mode=<?php echo $row1['mode']; ?>&tid=<?php echo $row1['tid']; ?>'"><img src="images/icons/fugue/cross-circle.png" style="border:0px" title="Delete" /></a>&nbsp;
...
<?php  }?>
            ...
            <a href="oc_crdrnoteprint.php?id=<?php echo $row1['crnum']; ?>&type=<?php echo $type; ?>&mode=<?php echo $row1['mode']; ?>" target="_new"><img src="images/icons/fugue/report.png" style="border:0px" title="print" /></a>&nbsp;&nbsp;</td>
...
document.location = "dashboardsub.php?page=oc_creditnote&month=" + month + "&year=" + year + "&type=" + type;
}
</script>