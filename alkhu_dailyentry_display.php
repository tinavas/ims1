...
<th width="10px"></th>-->
  ...
  <tr>
    ...
    <th width="10px"></th>
    <?php
             include "config.php"; $str=strtotime('2012-05-20');
...
if ( $row > 0 )
      ...
      /*  if ($col == "18") { $data18 = htmlentities($data, ENT_QUOTES); }
       ...
       <td width="10px"></td>
        <td style="text-align:left;"><input type="text" name="date[]" id="date0" value="<?php $str+=(60*60*24);  echo date('d.m.Y',$str);; ?>" size="10" /></td>
    <td width="10px"></td>
    ...
    <td style="text-align:left;"><select name="ffeedtype[]" id="ffeedtype0" >
      ...
      <?php
              ...
              {
           ?>
      <option <?php if($row1['code']=='FD102') echo 'selected="selected"'; ?> value="<?php echo $row1['code']; ?>" title="<?php echo $row1['description']; ?>"><?php echo $row1['code']; ?></option>
      <?php } ?>
    </select>    </td>
    ...
    <td style="text-align:left;"><select name="mfeedtype[]" id="mfeedtype0" >
      ...
      <?php
              ...
              {
           ?>
      <option <?php if($row1['code']=='FD106') echo 'selected="selected"'; ?> value="<?php echo $row1['code']; ?>" title="<?php echo $row1['description']; ?>"><?php echo $row1['code']; ?></option>
      <?php } ?>
    </select>    </td>
    <td width="10px"></td>
