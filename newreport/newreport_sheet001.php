...
?>
 <tr height=16 style='height:12.0pt;display:none'>
  ...
  <td class=xl269><?php echo $tempcomp1 = round((($weekeggs/$inc1)/$weekfemale)*100,2); ?></td>
  <td class=xl268>&nbsp;</td>
  ...
  <td class=xl268><?php echo $tempcomp5 = round($weekeggwt/$inc1,2); ?></td>
...
?>
 ...
 <tr height=15 style='height:11.25pt'>
  ...
  <td class=xl82 align=right><?php echo $weekmmort; $_SESSION['jmmort'][$tempage] = $weekmmort; $_SESSION['mmort'][$tempage] = $weekmmort;  ?></td>
  ...
  <td class=xl91 align=right><?php echo $a = round(((($weekffeed/$weekfemale)*1000)/$inc1),2);$_SESSION['jffeedpb'][$tempage] = $a; ?></td>
  <td class=xl82 align=right><?php echo $weekmfeed; $_SESSION['jmfeed'][$tempage] = $weekmfeed; ?></td>
  <td class=xl91 align=right><?php echo $a = round(((($weekmfeed/$weekfemale)*1000)/$inc1),2); $_SESSION['jmfeedpb'][$tempage] = $a; ?></td>
 ...
 <tr height=15 style='height:11.25pt'>
  ...
  <td class=xl91 align=right><?php echo round(((($weekffeed/$weekfemale)*1000)/$inc1),2); ?></td>
