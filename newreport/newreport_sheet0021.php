...
<table border=0 cellpadding=0 cellspacing=0 width=2526 style='border-collapse:
 ...
 width:44pt'>
 <col class=xl198 width=64 span=2 style='width:48pt'>
 <col class=xl462 width=64 style='width:48pt'>
 <col class=xl462 width=43 style='mso-width-source:userset;mso-width-alt:1572;
 width:32pt'>
 <col class=xl198 width=35 span=2 style='mso-width-source:userset;mso-width-alt:
 1280;width:26pt'>
 ...
 4681;width:96pt'>
 <col class=xl198 width=64 span=4 style='width:48pt'>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl198></td>
  <td class=xl250>F :</td>
  <td colspan=2 class=xl753>3144<![if !supportAnnotations]><span
  ...
  <td class=xl251>M :</td>
  <td colspan=2 class=xl751>293</td>
  <td class=xl247>&nbsp;</td>
  <td class=xl246>&nbsp;</td>
  <td class=xl248>&nbsp;</td>
  <td colspan=13 class=xl245 style='mso-ignore:colspan'>&nbsp;</td>
 ...
 <tr height=16 style='height:12.0pt'>
  ...
  <td colspan=20 class=xl735 style='border-right:2.0pt double black;border-bottom:
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  <td colspan=8 class=xl721 style='border-right:2.0pt double black;border-left:
  ...
  none'>Feed gms</td>
  <td rowspan=2 class=xl743 width=64 style='width:48pt'>Total Feed</td>
  <td rowspan=2 class=xl744 width=43 style='border-top:none;width:32pt'>Feed
  /egg</td>
...
<?php } } ?> 
  ...
  <td class=xl342>&nbsp;</td>
  <td class=xl360 style='border-left:none'>&nbsp;</td>
 </tr>
<?php 
 ...
 if($nrDaysPassed == 7)
 {
   ...
   $cummffeedg = $cummffeedg + $weekffeedg;
   $cummmfeedg = $cummmfeedg + $weekmfeedg;
   for($i = 0; $i < sizeof($rejections); $i++)
   {
      $cummrej[$i] = $cummrej[$i] + $rej[$i];
   }
?>
 <tr height=16 style='height:12.0pt'>
  <td height=16 class=xl473 style='height:12.0pt'>Week</td>
  <td class=xl392><?php echo $nrWeeksPassed + 1; ?></td>
  ...
  <td class=xl269><?php echo round((($weekeggs/7)/$weekfemale)*100,2); ?></td>
  <td class=xl268>&nbsp;</td>
  ...
  <td class=xl268><?php echo round($weekeggwt/7,2); ?></td>
  <?php for($i = 0; $i < sizeof($rejections); $i++)
  {
  ?>
  <td class=xl268><?php echo $rej[$i]; ?></td>
  <td class=xl269><?php echo round(($rej[$i]/$weekeggs)*100,2); ?></td>
  <?php } ?>

  <td class=xl268>&nbsp;</td>
  <td class=xl269><?php echo $weekffeed; ?></td>
  <td class=xl269><?php echo $weekmfeed; ?></td>
  <td class=xl269><?php echo round($weekffeed/7,2); ?></td>
  <td class=xl269><?php echo round($weekmfeed/7,2); ?></td>
  <td class=xl269><?php echo $t1 = $weekffeed + $weekmfeed; ?></td>
  <td class=xl394><?php echo number_format(round($t1/$weekhatcheggs,2),2); ?></td>
  <td class=xl268><?php echo $fweight; ?></td>
  <td class=xl268><?php echo $mweight; ?></td>
  <td class=xl268>&nbsp;</td>
  <td class=xl395>&nbsp;</td>
 </tr>
 <tr height=15 style='height:11.25pt'>
  ...
  <td colspan=2 class=xl272 style='mso-ignore:colspan'>&nbsp;</td>
  <td class=xl272><?php echo number_format(round(($cummfmort/$startfemale)*100,3),3); ?></td>
  ...
  <td colspan=2 class=xl272 style='mso-ignore:colspan'>&nbsp;</td>
  <td class=xl273><?php echo round($cummeggs/$startfemale,2); ?></td>
  <td colspan=2 class=xl272 style='mso-ignore:colspan'>&nbsp;</td>
  <td class=xl272><?php echo $cummhatcheggs; ?></td>
  <td class=xl273><?php echo round(($cummhatcheggs/$cummeggs)*100,2); ?></td>
  <td colspan=2 class=xl272 style='mso-ignore:colspan'>&nbsp;</td>
  <td class=xl273><?php echo round($cummhatcheggs/$startfemale,2); ?></td>
  <td class=xl272>&nbsp;</td>
  <?php for($i = 0; $i < sizeof($rejections); $i++)
  {
  ?>
  ...
  <td class=xl273>q</td>
  <td class=xl273>&nbsp;</td>
  <td colspan=3 class=xl272 style='mso-ignore:colspan'>&nbsp;</td>
  <td class=xl397>&nbsp;</td>
 </tr>
 <tr height=15 style='height:11.25pt'>
