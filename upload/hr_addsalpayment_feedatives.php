...
<td width="10px">&nbsp;</td>
<td>
<input type="text"  style="width: 50px;text-align:right;color:#0000FF" id="paid<?php echo $i; ?>" name="paid[]" value="<?php echo $salsal; ?>"/></td>
<td width="10px">&nbsp;</td>
<td>
...
function fun3()
{
	...
	//var date = document.getElementById('date').value;
	document.location = "dashboardsub.php?page=hr_addsalpayment_feedatives&sector=" + sector + "&desig=" + desig + "&date=" + date;
}
function funmnth()
{
