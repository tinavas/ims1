...
$totaldays =0;$nooffull=0;$noofhalf=0;
$qtt ="SELECT dayspresent as noofdays,extra as workd FROM `hr_mnthattendance` where eid='$eid' and month='$month1' and year='$year1' and client='$client'";
...
$query1="select noofdays from hr_workingdays where month = '$month1' AND year = '$year1'";
