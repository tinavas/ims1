	  ...
	  <?php
           ...
           ?>
            <tr>
			 ...
			 <td><a href="dashboardsub.php?page=hr_editsalaryparameters&eid=<?php echo $row1['eid']; ?>&id=<?php echo $row1['id']; ?>&name=<?php echo $row1['name'];?>&sector=<?php echo $row1['sector'];?>">
			
			<img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a></td>
           </tr>
           <?php 
           }
           ?>   
