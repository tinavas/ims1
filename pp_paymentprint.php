...
$pdf->addText(27,695,8,"<b>SUPPLIER NAME</b>");	
...
$pdf->addText(310,708,8,"<b>CHEQUE DATE</b>");	
    ...
    //AMOUNT
	 ...
	 $pdf->addText(470,695,8,"<b>LOCATION</b>");	
...
$img = ImageCreatefromjpeg('logo/thumbnails/LOGO.jpg');
 $pdf->addImage($img,40,747,45,35);
	 ...
	 $pdf->addText(493,77,10,"");
	  ...
	  $pdf->addText(250,740,9,"<b>PROCUREMENT PAYMENT </b>");
...
$rowline = 0;
$stopped = 0;
$query = "SELECT distinct(tid),date,amount,vendor,unit,cr,tid,description,code,code1,paymentmode,cheque,cdate,remarks,aempname FROM pp_payment WHERE  tid = '$trno' AND client = '$client'";
$result = mysql_query($query,$conn) or die(mysql_error());
while($row = mysql_fetch_assoc($result))
{

$username1=$row['empname'];
$username11=$row['empname'];
 $date = $row['date'];
...
$narration11 = $row['remarks'];
 ...
 $amount1=$amount;
	 ...
	 $pdf->addText(175,$rowindex1,8,"<b>$cashcode</b>");
	 $pdf->addText(45,$rowindex1,8,"<b>$code1</b>");
...
$pdf->addText(490,708,8,"<b>$cdate<b>");
$finaltotal = $amount1; 

$amount15=$amount1;

$finaltotal1 = changeprice($amount1);
$amount13 = changeprice($amount1);	
$amount14 = changeprice($amount1);
$pdf->addText(525,675,8,"<b>$amount13<b>");
$pdf->addText(525,695,8,"<b>$unit<b>");
...
$pdf->addText(110,435,8,"<b>$username<b>");
$pdf->addText(140,695,8,"<b>$desc</b>");

$pdf->addText(470,435,8,"<b>$username11<b>");
...
if($len<67)
{
	$pdf->addText(110,490,7,"<b>$word1 ONLY</b>");
}
else {
...
$amount16=changeprice1($amount15);
$pdf->addText(450,480,8,"<b>$amount16</b>");
$pdf->addText(530,480,8,"<b>$amount16</b>");
