...
<td align="right">
<?php if ( $row2['crdr'] == "Cr"  ) { echo ewrpt_ViewValue(round($row2['quantity'],3)); $isqty = $isqty + $row2['quantity']; }
 else { echo ewrpt_ViewValue(); }?>
</td>
<td align="right">
...
<?php echo ewrpt_ViewValue(changeprice($rcvqty)) ?>
		...
		echo ewrpt_ViewValue(changeprice(round(($rcvval/$rcvqty),3))) ?>
		</td>
		<td align="right">
...
<td align="right">
<?php  echo ewrpt_ViewValue(round($isqty,3));  ?>
</td>
<td align="right">
