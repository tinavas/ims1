...
<center>
<br />
<h1>Customer Statement Of Account</h1> 
<br /><br /><br />
<form target="_new">
<table align="center">
<tr>
...
<?php 
		$q = "select * from contactdetails where type = 'party' or type = 'vendor and party' order by name  ";
...
if(vendor == "All")
{
 window.open('production/customerstatement.php?fromdate=' + fromdate + '&todate=' + todate + '&vendor=' + vendor);
}
else
{
 window.open('production/customerstatement.php?fromdate=' + fromdate + '&todate=' + todate + '&vendor=' + vendor); 
