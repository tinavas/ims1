...
if($breedi != "")
{
$query = "SELECT * FROM turkey_standards where breed = '$breedi' and client = '$client' and age <= '$maxage' ORDER BY age ASC ";
}
else
{
...
if($breedi != "")
{
$query = "SELECT * FROM turkeyr_standards where breed = '$breedi' and client = '$client' and age <= '$maxage' ORDER BY age ASC ";
}
else
{
$query = "SELECT * FROM turkey_standards where client = '$client' and age <= '$maxage' ORDER BY age ASC ";
