...
if($breedi != "")
{
$query = "SELECT * FROM turkey_standards where breed = '$breedi' and client = '$client' and age = '$currage' ORDER BY age ASC ";
}
else
{
$query = "SELECT * FROM turkey_standards where client = '$client' and age = '$currage' ORDER BY age ASC ";
}
