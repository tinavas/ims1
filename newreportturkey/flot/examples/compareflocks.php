...
$(function () {
    ...
    var d2 = [
        <?php
           include "config.php";
           $query3 = "SELECT avg(hatchper) as `hatchper` FROM hatchrecord GROUP BY flock ASC ";
           $result3 = mysql_query($query3,$conn1); 
           $i = 2;
           while($row3 = mysql_fetch_assoc($result3))
           {
    ...
    var d1 = [
        <?php
           include "config.php";
           $query3 = "SELECT avg(saleableper) as `saleper` FROM hatchrecord GROUP BY flock ASC ";
           $result3 = mysql_query($query3,$conn1); 
           $j = 3;
           while($row3 = mysql_fetch_assoc($result3))
           {
