...
<center>
  <table><tr><td style="font-size:13px"><b>H.Egg % Graph For Flock <?php session_start(); echo $_SESSION['flock']; ?></b></td></tr></table>
</center>
...
if($breedi != "")
{
$query = "SELECT * FROM turkey_standards where breed = '$breedi' and client = '$client' ORDER BY age ASC ";
}
else
{
$query = "SELECT * FROM turkey_standards where client = '$client' ORDER BY age ASC ";
}
