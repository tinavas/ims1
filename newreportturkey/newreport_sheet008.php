...
<center>
  <table><tr><td style="font-size:13px"><b>Production Graph For Flock <?php session_start(); echo $_SESSION['flock']; ?></b></td></tr></table>
</center>
...
$query = "SELECT * FROM turkey_standards where client = '$client' and breed = '$breedi' and age <= '$maxage' ORDER BY age ASC ";

}
else
{
$query = "SELECT * FROM turkey_standards where client = '$client' and age <= '$maxage' ORDER BY age ASC ";
}
