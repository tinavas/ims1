...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" enctype="multipart/form-data" id="complex_form" method="post" action="hr_saveemployee.php">
	  <h1>Add Employee</h1>
...
<center>   <br />    <br /> 
 <table border="0" id="table-po">
	...
	<tr>
		...
		<?php
		$query = "SELECT distinct(reportingto),name FROM hr_employee where designation='Manager' or designation = 'Supervisor' ORDER BY name ASC ";
		 $result = mysql_query($query,$conn); $i = 0;
		 while($row1 = mysql_fetch_assoc($result))
		 {
		?>
...
<br />
      ...
      <tr>
		...
		<td align="left">
		<input type="text" value="<?php echo date('d.m.Y') ?>" readonly class="datepicker" name="dob" id="dob" size="12">
		</td>
		...
		<td align="left">
		<input type="text" value="<?php echo date('d.m.Y') ?>" readonly name="expdlicense" id="expdlicense" size="12" class="datepicker" style="visibility:hidden">
		</td>
		</tr>
