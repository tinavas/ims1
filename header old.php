	...
	<nav id="main-nav">
		...
		<ul class="container_12">
                 ...
                 ?>
             			...
             			<li class="<?php echo $row1['icon']; if($main == $row1['refid']) { echo " current"; }?>"><a href="<?php echo $row1['link']; ?>" title="<?php echo $row1['title']; ?>" target="<?php echo $row1['target']; ?>" ><?php echo $row1['name']; ?></a>
