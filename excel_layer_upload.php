...
<form action="excel_layer_dailyentry.php?" method="post" enctype="multipart/form-data">

flock <input id="flock" name="flock" >

start age <input id="age" name="age" >
<br><br>
Excel file: <input type=file name="excel_file"> <br><br>
