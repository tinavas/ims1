...
<form id="form1" name="form1" method="post" action="pp_savesobi_a.php">
<br />
...
?>
<tr>
<td><input type="hidden" id="units<?php echo $i;?>" name="units[]" value="<?php echo $qr['units']; ?>" />
<input style="background:none;border:none;text-align:right"type="text" id="sno<?php echo $i; ?>" size="4" name="sno[]" value="<?php echo " ".$i; ?>" readonly/></td>
<td width="10px"></td>
...
<td width="10px"></td>
<td><input style="border:none;background:none;text-align:right" type="text" id="receivedquantity<?php echo $i; ?>" size="8" name="receivedquantity[]" value="<?php echo $qr['acceptedquantity']; ?>" readonly/></td>
<td width="10px"></td>
...
<td width="10px"></td>
<td><input style="border:none;background:none;text-align:right" type="text" id="totalamount<?php echo $i; ?>" size="10" name="totalamount[]" value="<?php $tot = ($qr['acceptedquantity'] * $qr['rateperunit']) + $qr['taxamount'] + $qr['freightamount'] - $qr['discountamount']; echo $tot; $sum+=$tot;  ?>" readonly/></td>
<td width="10px"></td>
</tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="Cancel" onClick="document.location='dashboardsub.php?page=pp_sobi_a';" />
...
function fun()
{
	...
	document.location = "dashboardsub.php?page=pp_addsobi_a&gr=" + grs + "&vendor=" + vendor + "&type=" + type + "&brok=" + brok + "&inv=" + inv + "&date=" + date;
}
