...
$id = $_POST['id'];
 ...
 $query1="select transactioncode,empname from vehicle_renewal where id = '$id'";
...
$query = "delete from vehicle_renewal where id = '$_POST[id]'";
...
$q1 = "insert into ac_financialpostings(date,crdr,coacode,amount,trnum,type,client,warehouse,venname,cash,bank,cashcode,bankcode,schedule,empname,adate) VALUES ('$date','Cr','$expensecoa','$amount','$transactioncode','RW','$client','$unit','$empname','$cash','$bank','$cashcode','$bankcode','$schedule','$empname','$adate') ";
