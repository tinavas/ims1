...
$q1="select group_concat(name separator '$') as names from distribution_distributor where id!='$id'";
...
$details="select * from distribution_distributor where id='$id'";
...
<tr>
<td>
<input type="submit" value="Update" id="save" />&nbsp;&nbsp;&nbsp;<input type="button" value="Cancel" onClick="document.location='dashboardsub.php?page=distribution_distributor';" id="cancel">
