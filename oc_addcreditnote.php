...
<section class="grid_8">
  <div class="block-border">
     ...
     <form class="block-content form" id="complex_form" name="form1" method="post" action="oc_savecreditnote.php" onsubmit="return checkform();">
...
<td align="left"><input type="text" id="tno" name="tno" value="<?php echo $tid; ?>" readonly style="border:0px;background:none" />&nbsp;&nbsp;</td>
...
<tr>
<td align="right"><strong>Customer</strong><font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font>&nbsp;&nbsp;&nbsp;</td>
...
<tr style="height:20px"></tr>
<tr>
<td><label id="sno1" style="text-align:center;">1</label></td>
<td width="10px"></td>
<td><select id="code1" name="code[]" onchange="getdesc(this.id);" style="width:80px"><option value="">-Select-</option>
	<?php 
...
<br />
<center>
<input type="submit" value="Save" id="Save" disabled="disabled" name="Save"/>&nbsp;&nbsp;&nbsp;<input type="button" value="Cancel" onclick="document.location = 'dashboardsub.php?page=oc_creditnote&type=<?php echo $type; ?>';">
</center>
<br />
<!-- </center> -->
...
<script type="text/javascript">
function script1() {
window.open('O2CHelp/help_p_addcdnote.php','BIMS','width=500,height=600,toolbar=no,menubar=yes,scrollbars=yes,resizable=yes');
}
</script>
