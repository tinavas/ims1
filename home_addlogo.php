...
<td align="left"><textarea rows="6" cols="30" name="address" class="ckeditor"></textarea></td>
</tr>
...
<br />
<center>
<input type="submit" value="Save" />&nbsp;&nbsp;&nbsp;<input type="button" value="Cancel" onclick="document.location='dashboardsub.php?page=home_logo';">
</center>
</td>
</tr>
</table>
