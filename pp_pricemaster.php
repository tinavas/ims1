...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			<button type="button" onClick="document.location='dashboardsub.php?page=pp_addpricemasters'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
<tbody>
	  <?php
           include "config.php";
		   		     ...
		   		     $query = "SELECT * FROM pp_pricemaster order by fromdate desc";
...
<?php
$flag = $row1['flag'];			 
$tquery	= "SELECT * FROM oc_cobi WHERE date between '$row1[fromdate]' and '$row1[todate]' and party='$row1[customer]' and code='$row1[code]' and description='$row1[desc]' ";
...
?>			 
	...
	<?php if($_SESSION['valid_user']==$user || ($_SESSION['superadmin']=="1") ||($_SESSION['admin']=="0") ){?> 
<a href="dashboardsub.php?page=pp_editpricemasters&id=<?php echo $row1['id']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit" /></a>
              &nbsp; <a onclick="if(confirm('Are you sure,want to delete')) document.location ='pp_deletepricemasters.php?id=<?php echo $row1['id']; ?>'"><img src="images/icons/fugue/cross-circle.png" style="border:0px" title="Delete" /></a>&nbsp;
...
{
 ?><img src="images/icons/fugue/lock.png" width="16px" style="border:0px" title="Locked" /><?php
}
?>	
...
document.location = "dashboardsub.php?page=oc_pricemaster&month=" + month + "&year=" + year;
}
</script>
