...
<center>
  <table><tr><td style="font-size:13px"><b>Breeder Performance Summary For Flock <?php session_start(); echo $_SESSION['flockcode']; ?></b></td></tr></table>
</center>
...
?>
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  <td class=xl634 style='border-top:none;border-left:none'><?php echo round($_SESSION['cfmort'][$bage],2); ?></td>
  <td class=xl693 style='border-top:none;border-left:none'><?php echo round($_SESSION['cfmort'][$bage] - $_SESSION['cfmortstd'][$bage],2); ?></td>
  ...
  <td class=xl634 style='border-top:none;border-left:none'><?php echo $_SESSION['eggbird'][$bage]; ?></td>
  <td class=xl629 style='border-top:none;border-left:none'><?php echo $_SESSION['hebirdstd'][$bage]; ?></td>
  <td class=xl634 style='border-top:none;border-left:none'><?php echo $_SESSION['hebird'][$bage]; ?></td>
  ...
  <td class=xl588 align=right style='border-top:none;border-left:none'><?php echo $_SESSION['ieggwt'][$bage] - $_SESSION['ieggwtstd'][$bage]; ?></td>
  <td colspan=2 class=xl634 style='border-top:none'><?php echo round($_SESSION['cmmort'][$bage],2); ?></td>
