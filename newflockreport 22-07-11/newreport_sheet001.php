...
<center>
  <table><tr><td style="font-size:13px"><b>Brooder/Grower Report For Flock <?php session_start(); echo $_SESSION['flockcode']; ?></b></td></tr></table>
</center>
...
?>
 ...
 <tr height=15 style='height:11.25pt'>
  ...
  Wk. Total</td>
  <td class=xl82></td>
  <td class=xl82 align=right><?php echo $weekfmort; $_SESSION['jfmort'][$tempage] = $weekfmort; ?></td>
  <td class=xl82 align=right><?php echo $weekmmort; $_SESSION['jmmort'][$tempage] = $weekmmort;  ?></td>
