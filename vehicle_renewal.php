...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			<button type="button" onClick="document.location='dashboardsub.php?page=vehicle_addrenewal'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
<tbody>
	 <?php
           ...
           $query = "SELECT * FROM vehicle_renewal ";
           ...
           ?>
            <tr>
			 ...
			 <td><?php echo $row1['chargecode']; ?></td>
			 <td><?php echo $row1['amount']; ?></td>
			 <td><?php echo $row1['validtime']; ?></td>
...
<a href="dashboardsub.php?page=vehicle_editrenewal&id=<?php echo $row1['id']; ?>">
<img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit" />
</a>&nbsp;

			<a href="<?php echo 'vehicle_deleterenewal.php?id='.$row1['id']; ?>">
