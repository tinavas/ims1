...
$finalsal = $salary + $basic + $hra + $ma + $cca + $ta;
 $salparaq = "insert into hr_salaryparameters values (NULL,'$_POST[employeeid]','$_POST[sector]','$_POST[name]','$joiningdate','$joiningdate1[1]','$joiningdate1[0]','$_POST[salary]','$basic','$hra','$ma','$cca','$ta','0','0','0','0','0','$ptax','0','0','0','$finalsal','0','0')";
$salparars = mysql_query($salparaq,$conn) or die(mysql_error());


echo "<script type='text/javascript'>";
echo "top.location='dashboard.php?page=hr_employee'";
echo "</script>";
?>