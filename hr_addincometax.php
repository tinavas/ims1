...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" style="height:600px" id="complex_form" method="post" action="hr_saveincometax.php" onsubmit="return checkform()" >
	  <h1 id="title1">Income Tax Structure</h1>
...
<td><input type="text" name="fromdate" id="fromdate" class="datepicker" value="<?php echo date("d.m.Y"); ?>"  onchange="reloadpage();"/></td>
<td width="10">&nbsp;</td>
 <td style="width:100px"><strong>To Date</strong></td> 
 <td><input type="text" name="todate" id="todate" class="datepicker" value="<?php echo date("d.m.Y"); ?>"  onchange="reloadpage();"/></td>
</tr>
<tr height="10px" ></tr>
<tr>
<td style="width:150px"><strong>From Salary</strong></td> 
<td>
<input type="text" id="fromsal" name="fromsal" onkeypress="validatekey(event.keyCode)"  />
</td>
<td width="10">&nbsp;</td>
<td style="width:150px"><strong>To Salary</strong></td> 
<td>
<input type="text" id="tosal" name="tosal" onkeypress="validatekey(event.keyCode)"  />
</td>
</tr>
<tr height="10px" ></tr>
<tr>
...
<td>
<input type="text" id="balamtded" name="balamtded" onkeypress="validatekey(event.keyCode)"  />
</td>
<td width="10">&nbsp;</td>
<td style="width:150px"><strong>Amount Exceeded</strong></td> 
<td>
<input type="text" id="amtex" name="amtex" onkeypress="validatekey(event.keyCode)"  />
</td>
</tr>
<tr height="10px" ></tr>
<tr>
...
<td>
<input type="text" id="ded" name="ded" onkeypress="validatekey(event.keyCode)" />
</td>
<td width="10">&nbsp;</td>
