<?php include "jquery.php";
 ...
 if($type == 'Credit') $mode = 'Employee Credit';
 else if($type == 'Debit') $mode = 'Employee Debit';
...
document.location = "dashboardsub.php?page=hr_creditnote&type=<?php echo $type; ?>&month=" + month + "&year=" + year;
}
</script>