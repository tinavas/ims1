...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right">
			...
			<button type="button" onClick="document.location='dashboardsub.php?page=distributor_ob'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
<tbody>
	  <?php
          include "config.php"; 
           $query = "SELECT * FROM distributor_ob  where date >= '$fromdate' and date <= '$todate' ORDER BY date ASC ";
           ...
           ?>
			...
			$date=date("d.m.Y",strtotime($row['date']));
			  echo $date; ?></td>
             <td><?php echo $row['superstockist']; ?></td>
             <td><?php echo  $row['distributor']; ?></td>
             <td><?php echo  $row['openingbal']; ?></td>
             
             <td>
             <?php if($_SESSION[admin]==1){?>
             <a href="dashboardsub.php?page=distributorob_edit&id=<?php echo $row['trnum']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a>
			 &nbsp;
		 <a href="distributorob_delete.php?id=<?php echo $row['trnum']; ?>"><img src="images/icons/fugue/cross-circle.png" style="border:0px;" title="Delete" /></a>
             <?php }else { ?>
...
document.location = "dashboardsub.php?page=distributorob&month=" + month + "&year=" + year;
}
</script>
