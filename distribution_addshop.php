...
$q1="select group_concat(name separator '$') as names from distribution_shop";
...
{
?>
<option value="<?php echo $r1['areacode'];?>" title="<?php echo $r1['areaname'];?>"><?php echo $r1['areacode'];?></option>
<?php }?>
...
<td align="left">
<input type="radio" name="shoptype" id="shoptype1" value="Retailer" /><strong>Retailer</strong>&nbsp;&nbsp;&nbsp;
<input type="radio" name="shoptype" id="shoptype2" value="Wholesale" /><strong>Wholesale</strong>
