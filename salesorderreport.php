...
<?php } ?>
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="salesorderreport.php?export=html&vendor=<?php echo $vendor; ?>&item=<?php echo $item; ?>&description=<?php echo $description; ?>&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&hatchery=<?php echo $hatchery; ?>">Printer Friendly</a>
&nbsp;&nbsp;<a href="salesorderreport.php?export=excel&vendor=<?php echo $vendor; ?>&item=<?php echo $item; ?>&description=<?php echo $description; ?>&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&hatchery=<?php echo $hatchery; ?>">Export to Excel</a>
&nbsp;&nbsp;<a href="salesorderreport.php?export=word&vendor=<?php echo $vendor; ?>&item=<?php echo $item; ?>&description=<?php echo $description; ?>&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&hatchery=<?php echo $hatchery; ?>">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="salesorderreport.php?cmd=reset&vendor=<?php echo $vendor; ?>&item=<?php echo $item; ?>&description=<?php echo $description; ?>&fromdate=<?php echo $fromdate; ?>&todate=<?php echo $todate; ?>&hatchery=<?php echo $hatchery; ?>">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td style="width:70px;" align="center" title="Sent Quantity">Sent Qty.</td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
$oldvendor = $newvendor = ""; 
 $query = "SELECT * FROM oc_salesorder WHERE client = '$client' AND vendor $vop '$customer' AND code $iop '$item' and date between '$fromdate' and '$todate'  ORDER BY vendor,date,po,code";
$result = mysql_query($query,$conn1) or die(mysql_error());
while($rows = mysql_fetch_assoc($result))
{
 $rows['rateperunit'];
...
<?php echo changeprice1($rows['sentquantity']); ?></td> 
		<td class="ewRptGrpField1" align="right" >
...
{
?>
<tr><td align="right"><b>Total</b></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td align="right"><?php echo changeprice1($totqty); ?></td><td align="right"><?php echo changeprice1($totsqty); ?></td><td>&nbsp;</td><td align="right"><?php echo changeprice($totamount); ?></td></tr>
<?php } ?>
...
function reloadpage()
{
	...
	document.location = "salesorderreport.php?vendor=" + vendor +"&item=" + item1 + "&description=" + description + "&fromdate=" + fdate + "&todate=" + tdate ;
}
</script>