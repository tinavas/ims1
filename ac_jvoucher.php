...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			...
			<button type="button" onClick="document.location='dashboardsub.php?page=ac_addjvoucher'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
<!--<th style="text-align:left">Control type</th>--><th style="text-align:left"><span class="column-sort">
									<a href="javascript:void(0)" title="Sort up" class="sort-up"></a>
									<a href="javascript:void(0)" title="Sort down" class="sort-down"></a>
								</span>Code Credited</th><th style="text-align:left"><span class="column-sort">
									<a href="javascript:void(0)" title="Sort up" class="sort-up"></a>
									<a href="javascript:void(0)" title="Sort down" class="sort-down"></a>
								</span>Amount</th>
...
<tbody>
	  ...
	  $query = "SELECT * FROM ac_gl where voucher = 'J' and vstatus <> 'R' and date >= '$fromdate' and date <= '$todate' and warehouse in ($sectorlist) group by transactioncode ORDER BY transactioncode  DESC ";
	   }
		   ...
		   <a href="dashboardsub.php?page=ac_editjvoucher&id=<?php echo $row1['transactioncode']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a>&nbsp;
		     <a onClick="if(confirm('Are you sure,want to delete')) document.location ='deletejvouchern.php?id=<?php echo $row1['transactioncode']; ?>'"><img src="images/icons/fugue/cross-circle.png" style="border:0px" title="Delete" /></a>&nbsp;&nbsp;
	<?php  } else { ?>
...
document.location = "dashboardsub.php?page=ac_jvoucher&month=" + month + "&year=" + year;
}
</script>
