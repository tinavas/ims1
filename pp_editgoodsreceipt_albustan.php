...
<form id="form1" name="form1" method="post" action="pp_updategoodsreceipt_albustan.php"> 
...
<tr>
<th style="visibility:hidden"><strong>Puchase Order #</strong></th>
<th width="10px"></th>
...
<td><input type="hidden" readonly size="15" style="background:none; border:none;text-align:center;" type="text" name="po[]" id="po<?php echo $i; ?>" value="<?php echo $gres['po'];?>" /></td>
<td width="10px"></td>
...
<input type="submit" id="save" value="Update" />&nbsp;&nbsp;<input type="button" id="cancel" value="Cancel" onClick="document.location='dashboardsub.php?page=pp_goodsreceipt_albustan'"/>
...
function fun1()
{
	...
	document.location = "dashboardsub.php?page=pp_addgoodsreceipt_albustan&ge=" + ge + "&vendor=" + vendor + "&type=" +type;
}
