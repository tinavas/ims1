...
$dateqcc = date("Y-m-j", strtotime($dateq));
 $queryforsal = "select finalsal from hr_salaryparameters where eid = '$r[employeeid]' order by id desc Limit 1 ";
...
<td width="10px">&nbsp;</td>
<td>
<input type="text" style="width: 50px;text-align:right;" id="ot<?php echo $i; ?>" name="ot[]"   value="0"  onkeyup="calsalot(this.id);" /></td>

<td width="10px">&nbsp;</td>
<td>
<input type="text"  style="width: 50px;text-align:right;" id="paid<?php echo $i; ?>" name="paid[]" value="<?php echo round($salsal,2); ?>"/></td>
<td width="10px">&nbsp;</td>
<td>
