...
function stockcheck($code,$iac,$date,$wh,$qty)
{
include "config.php";
...
if( $_POST['qtys'][$i] != '0' && $_POST['qtys'][$i] != '' && $_POST['code'][$i] != '')
{
	...
	$totalquantity+= $qtyr;
	$totalquantitys+= $qtys;
$r=stockcheck($code,$iac,$date,$warehouse,$qtys);
if($r==0)
{
...
$itemcost = round($qtys * $rateperunit,5);
...
$stdcost = round($stdcost,5);
   ...
   echo   $query4 = "INSERT INTO ac_financialpostings(date,itemcode,crdr,coacode,quantity,amount,trnum,type,venname,warehouse,client,empname,adate) 
	          VALUES('".$adate."','".$code."','Cr','".$itemac."','".$qtys*$capacity."','".$stdcost."','".$so."','".$type."','".$vendor."','".$globalwarehouse."','".$client."','$empname','$adate')";
 ...
 /// COGS A/C Debit
    ...
    $query4 = "INSERT INTO ac_financialpostings(date,itemcode,crdr,coacode,quantity,amount,trnum,type,venname,warehouse,client,empname,adate) 
	          VALUES('".$adate."','".$code."','Dr','".$cogsac."','".$qtys*$capacity."','".$stdcost."','".$so."','".$type."','".$vendor."','".$globalwarehouse."','".$client."','$empname','$adate')";
    $result4 = mysql_query($query4,$conn) or die(mysql_error());

	///Sales A/C Credit Sales Transfer a/c Debit
 if($rateperunit>0)
{
