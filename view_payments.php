...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" id="complex_form"style="min-height:500px" enctype="multipart/form-data" method="post" action="dashboardsub.php?page=import_payments" >
	  <h1 id="title1">View Payments Data</h1>
...
<tr>
 ...
 <th><strong>Pay. Method</strong></th>
...
<tr>
   ...
   <td><input type="text" name="vendor[]" value="<?php echo $vendor; ?>" size="20" readonly  style="background:none; border:none"/></td>
...
<?php } ?>
<input type="button" value="Cancel" onclick="document.location='tally_payments'">
</form>
</body>
</html>