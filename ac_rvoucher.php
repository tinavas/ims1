...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			...
			<button type="button" onClick="document.location='dashboardsub.php?page=ac_addrvoucher'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
		</div>
...
<tbody>
	   ...
	   if($_SESSION['sectorall'] == "all" || ($_SESSION['sectorall'] == "" && $_SESSION['sectorlist'] == ""))
	  {
	   ...
	   $query = "SELECT * FROM ac_gl where voucher = 'R' and vstatus <> 'R' and date >= '$fromdate' and date <= '$todate' AND warehouse in ($sectorlist ) group by transactioncode ORDER BY transactioncode DESC";
	   }
...
<?php if(($_SESSION['superadmin']=="1") ||($_SESSION['admin']=="1") ){?> 
		   ...
		   <a href="dashboardsub.php?page=ac_editrvoucher&id=<?php echo $row1['transactioncode']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a>&nbsp;
		   
		   
		     <a onclick="if(confirm('Are you sure,want to delete')) document.location ='ac_deletervouchern.php?id=<?php echo $row1['transactioncode']; ?>'"><img src="images/icons/fugue/cross-circle.png" style="border:0px" title="Delete" /></a>&nbsp;&nbsp;
...
document.location = "dashboardsub.php?page=ac_rvoucher&month=" + month + "&year=" + year;
}
</script>
