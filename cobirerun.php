...
<td>From</td>
 ...
 <td><input type="text" name="fromdate" id="fromdate" class="datepickerreport" value="<?php echo date("d.m.Y",strtotime($fromdate)); ?>"/></td>

 <td>To</td>

 <td><input type="text" name="todate" id="todate" class="datepickerreport" value="<?php echo date("d.m.Y",strtotime($todate)); ?>"  onchange="reloadpage();"/></td>
 <td>Customer</td>
...
$qdif=mysql_query("select datediff('$fromdate','$todate') as days");
...
echo $qs1="select * from ims_stocktransfer where date='$dt' and fromwarehouse='$cus'";
$qs=mysql_query($qs1);
...
mysql_query($qu);
$qp="update ac_financialpostings set amount='$at' where trnum='$rs[id]' and type='STR' and itemcode='$rs[code]'";
mysql_query($qp);
if($rs[flag]=='1')
{
