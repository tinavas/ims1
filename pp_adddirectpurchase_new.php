...
<th><strong>Bags<?php if($_SESSION['db'] == 'golden' || $_SESSION['db'] == 'mlcf') { ?>/ <br />Numbers<?php } ?></strong></th><td width="10px">&nbsp;</td>
...
<td width="10px">&nbsp;</td><td>
<select style="Width:80px" name="bagtype[]" id="bagtype@-1" <?php if($_SESSION['db'] == 'golden' || $_SESSION['db']=='mlcf') { ?> onchange="calnet('');" <?php } ?>  >
	<option value="">-Select-</option>
...
<table id="batchexp" style="display:none" align="center">
 ...
 <tr id="batchexprow@-1">
  ...
  <td><input class="datepicker" type="text" size="15" id="expdate@-1" name="expdate[]">
  </tr>
</table>
<?php
}
...
<?php if($_SESSION['db'] == 'golden' || $_SESSION['db'] == 'mlcf') { ?> 
...
elseif($_SESSION['db'] == 'golden' || $_SESSION['db'] == 'mlcf')
{
?>
  if(document.getElementById("qtys@" + k).value != "" && document.getElementById("price@" + k).value != "")
  {
