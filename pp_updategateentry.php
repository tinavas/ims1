...
$query = "select combinedpo,code,warehouse,receivedquantity,aflag ,balbird from pp_gateentry where ge = '$ge'";
else
...
if($_SESSION['db'] == "central" or $_SESSION['db'] == "alwadi")
 $aflag = $res['aflag'];
if($_SESSION['db']=="vista") 
$q1 = "UPDATE pp_purchaseorder SET geflag = '0',receivedquantity = receivedquantity - $res[receivedquantity],acceptedquantity = acceptedquantity - $res[receivedquantity],recbird = recbird- $res[balbird] WHERE po = '$po' AND code = '$itemcode' and deliverylocation = '$warehouse'";
