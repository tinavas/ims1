...
$description = $qr['description'];
	...
	$q = "insert into oc_receipt (remarks,tid,date,party,paymentmethod,tds,tdscode,tdsdescription,tdsdr,tdsamount,tdsamount1,paymentmode,code,code1,description,dr,amount,totalamount,bank,branch,cheque,cdate,choice,flag,adate,aempid,aempname,asector,client) 
values('$remarks','$tid','$date','$party','Receipt','Without TDS','','','','0','0','$paymentmode','$code','$code1','$description','Dr','$amount','$amount','','','$chequeno','$cdate','On A/C','1','$date','$empid','$empname','$sector','$client')";
...
echo "document.location='dashboardsub.php?page=oc_addreceiptmultiple'";
echo "</script>";
