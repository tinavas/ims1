...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" id="complex_form" name="form1" method="post" action="pp_savepurchaseorder_a.php" onSubmit="return calculate(this);">
			  ...
			  <td align="center" colspan="14"><strong>Vendor</strong>&nbsp; &nbsp;
				...
				include "config.php";
						 ...
						 while($row = mysql_fetch_assoc($result))
							  {
				  ?>
                       <option title="<?php echo $row['code'];?>" value="<?php echo $row['name'];?>@<?php echo $row['code'];?>"><?php echo $row['name']; ?></option>
                <?php } ?>
                </select>
               &nbsp; &nbsp;<strong>Vendor Code</strong> &nbsp; &nbsp;
				...
				include "config.php";
						 ...
						 while($row = mysql_fetch_assoc($result))
							  {
				  ?>
                       <option title="<?php echo $row['name'];?>" value="<?php echo $row['name'];?>@<?php echo $row['code'];?>"><?php echo $row['code']; ?></option>
                <?php } ?>
                </select>
                </td>
			 </tr>
   ...
   <center>
      <table border="0" id="table-delivery">
        ...
        <tr>
         ...
         <td style="text-align:left;">
           <input type="text" name="" id="delivery-ing" readonly style="border:0px;background:none;cursor:hand" size="25"  />
         </td>
         <td width="10px"></td>
   ...
   <center>
      <table border="0" id="table-taxes">
        ...
        <tr>
		 ...
		 <td>
		  <?php  if($_SESSION['db']=='feedatives') { ?>   
		    <input type="text" name="taxamount1[]" size=8 id="taxamount" value="0" />
		   <?php } else { ?>
   ...
   <center>
      <table border="0" id="table-charges">
        ...
        <tr>
         ...
         <td style="text-align:left;">
           <input type="text" name="" id="charges-ing" readonly style="border:0px;background:none;cursor:hand" size="25"  />
         </td>
         <td width="10px"></td>
        ...
        <?php if($_SESSION['db'] == "feedatives") { ?>
		  ...
		  <?php if($_SESSION['db'] == "feedatives") { ?>
			<input type="text" id="brok" name="freightamount1[]" size="8" value="0" />
			<?php } else { ?> 
          ...
          <td>
		  <?php  if($_SESSION['db'] == "feedatives") { ?>
			<input type="text" id="brok" name="brokerageamount1[]" size="8" value="0" />
		  <?php } else if($_SESSION['db'] <> "maharashtra") { ?>
			...
			<?php } else { ?>
			<input type="text" id="brok" name="brokerage[]" size="8" value="0" />
			<?php } ?>
          </td>
       </tr>
     </table>
   ...
   <center>
      <table border="0" id="table-discounts">
        ...
        <tr>
		 ...
		 <?php  if($_SESSION['db'] == "feedatives") { ?>
			<input type="text" id="brok" name="discountamount1[]" size="8" value="0" />
		 <?php } else { ?>
...
<?php if($_SESSION['db'] == "feedatives") { ?>
  ...
  myselect1.style.width = "80px";
  theOption1=document.createElement("OPTION");
  theText1=document.createTextNode('Include');
   theOption1.value="Include";
  theOption1.appendChild(theText1);
  myselect1.appendChild(theOption1);
  theOption1=document.createElement("OPTION");
  theText1=document.createTextNode('Exclude');
   theOption1.value="Exclude";
  theOption1.appendChild(theText1);
  myselect1.appendChild(theOption1);	  
  myselect1.name = "freightie[]";
  myselect1.id = "frghtie" + index;	  
  
  var a1ba6a = document.createElement('td');
  a1ba6a.appendChild(myselect1);


myselect1 = document.createElement("input");
myselect1.type = "text";
myselect1.id = "brok"+index;
myselect1.name = "freightamount1[]";
myselect1.size = "8";
myselect1.value = "0";
<?php } else { ?>
...
myselect1.type = "text";
myselect1.id = "brok"+index;
myselect1.name = "discountamount1[]";
myselect1.size = "8";
myselect1.value = "0";
<?php } else { ?>
  myselect1 = document.createElement("select");
...
myselect1.type = "text";
myselect1.id = "brok"+index;
myselect1.name = "brokerageamount1[]";
myselect1.size = "8";
myselect1.value = "0";
<?php } elseif($_SESSION['db'] <> "maharashtra") { ?>
  myselect1 = document.createElement("select");
  myselect1.style.width = "80px";
  theOption1=document.createElement("OPTION");
  theText1=document.createTextNode('-Select-');
...
if((document.getElementById("type").value != "") && (document.getElementById("doffice").value == ""))
 ...
 else
 {
  ...
  {
   alert(document.getElementById("type/"+k).value);
   alert("Please select appropriate Delivery Location in Delivery Details section for row " + (k + 2));
   return false;
  }
  }
 }
