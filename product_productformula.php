...
<!--			<button type="button"><img src="images/icons/fugue/navigation-180.png" width="16" height="16"> Back to list</button> 
		...
		<div class="float-right"> 
			<button type="button" onclick="document.location='dashboardsub.php?page=product_addformula';"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
$q1="SELECT formulaid,sid,producttype,warehouse,group_concat(ingredient separator '/') as code,group_concat(quantity separator '/') as quantity FROM `product_fformula` group by formulaid";
$q1=mysql_query($q1) or die(mysql_error());
while($r1=mysql_fetch_assoc($q1))
{

 $q2="SELECT * FROM `product_formula` where id='$r1[formulaid]'";
...
?>
<tr>
<td><?php echo date("d.m.Y",strtotime($r2['date']));?></td>
<td><?php echo $r1['warehouse'];?></td>
<td><?php echo $r1['sid'];?></td>
<td><?php echo $r2['producttype']."(".$r2['productdesc'].")";?></td>
<td><?php echo $r1['code'];?></td>
<td><?php echo $r1['quantity'];?></td>
<?php

 $q3="select formula from product_productionunit where formula='$r1[sid]'";
$num=mysql_num_rows(mysql_query($q3));

if($num=="")
{
?>
<td><a href="dashboardsub.php?page=product_editproductformula&formulaid=<?php echo $r1['formulaid']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a>
			 &nbsp;
			
			 <a href="product_deleteproductformula.php?formulaid=<?php echo $r1['formulaid']; ?>"><img src="images/icons/fugue/cross-circle.png" style="border:0px;" title="Delete" /></a>
...
document.location = "dashboardsub.php?page=product_productformula&month=" + month + "&year=" + year;
}
</script>
