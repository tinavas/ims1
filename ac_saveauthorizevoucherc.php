...
$query = "INSERT INTO ac_financialpostings (date,crdr,coacode,quantity,amount,trnum,type,venname,warehouse,cash,bank,cashcode,bankcode,schedule,client) select date,crdr,code,0,(cramount+dramount),transactioncode,'$type','',costcenter,cash,bank,cashcode,bankcode,schedule,client FROM ac_gl WHERE transactioncode IN ($tids) and voucher = '$voucher' ORDER BY id";
