...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" id="complex_form"style="height:500px" enctype="multipart/form-data" method="post" onsubmit="return checkform();" <?php if($_SESSION[db]=='albustan') { ?> action="dashboardsub.php?page=import_contacts_codes"  <?php } else { ?> action="dashboardsub.php?page=import_contacts" <?php } ?> >
...
<tr height="15px"></tr>
<tr align="left">
 <td> 6. You can also download the sample format <input type="button" value="Download" <?php if($_SESSION[db]=='albustan') { ?> onclick="document.location='./P2PHelp/Contacts_code.xls'"/> <?php } else { ?> onclick="document.location='./P2PHelp/Contacts.xls'" <?php } ?>  />  </td>
</tr> 
<tr height="15px"></tr>
<tr align="center">
