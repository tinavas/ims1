...
<?php /*?>  <td class=xl300 style='border-top:none'><?php echo $tmcull; ?></td><?php */?>
  ...
  <td class=xl352 style='border-left:none'><?php echo number_format($alleggwt,1); $weekeggwt = $weekeggwt + $alleggwt; ?></td><?php */?>
<?php /*?><?php
  for($i = 0; $i < sizeof($rejections); $i++)
  {
?>
...
?>
 ...
 <?php /*?> <td class=xl268><?php echo $weekhatcheggs; $_SESSION['iheggs'][$tempage] = $weekhatcheggs; ?></td>
  ...
  <td class=xl268><?php echo $tempcomp5 = round($weekeggwt/7,2); $_SESSION['ieggwt'][$tempage] = $tempcomp5; ?></td><?php */?>
<?php /*?>  <?php for($i = 0; $i < sizeof($rejections); $i++)
 ...
 <?php /*?> <td class=xl269><?php echo $temp4 = round($weekmfeedg/7,2); $_SESSION['imfeedpb'][$tempage] = $temp4; $cummmfeedg = $cummmfeedg + $temp4; ?></td>
  ...
  <td class=xl394><?php echo number_format(round($weekffeed/$weekeggs,2),2); ?></td>
...
$query34 = "SELECT * FROM breeder_pstandards where client = '$client' and age = '$tempage' ORDER BY age ASC ";
...
?>
 <tr height=15 style='height:11.25pt'>
  ...
  <td class=xl276><?php echo $stdeggwt; $_SESSION['ieggwtstd'][$tempage] = $stdeggwt;?></td><?php */?>
 ...
 <?php /*?> <td class=xl401><?php echo round($tempcomp3 - $stdheggper,2); ?></td>
  ...
  <td class=xl400><?php echo round($tempcomp5 - $stdeggwt,2); ?></td><?php */?>
