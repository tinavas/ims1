...
if($client == "JOHNSON")
{
$query = "SELECT * FROM breeder_pstandards where breed = '$breedi' and client = '$client' and age = '$currage' ORDER BY age ASC ";
}
else
{
$query = "SELECT * FROM breeder_pstandards where client = '$client' and age = '$currage' ORDER BY age ASC ";
}
$result = mysql_query($query,$conn); 
while($row1 = mysql_fetch_assoc($result))
{ 
$stdmotper[$z] = $row1['stdmortality'] ;
}
if ( $stdmotper[$z] == "")
{
$stdmotper[$z] =0;
...
<center>
  <table><tr><td style="font-size:13px"><b>Mortality Graph For Flock <?php session_start(); echo $_SESSION['flock']; ?></b></td></tr></table>
</center>
...
?>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <?php $currmor = $currmor + $_SESSION['fmort'][$age];
   $currmorper  =   number_format(round(($currmor/$startfemale)*100,2),2) ?>
  <td class=xl676 align=right style="color:#33CC33"><?php echo $currmorper;  ?>&nbsp;,</em></td>
...
{
$age = $arrage[$z];
$currmorc = $currmorc + $_SESSION['fmort'][$age];
          ...
          /*  var plot =   $.plot($("#placeholder"),
           [ { data: fmortv, Label: 'Female Mortality', color:'#00FF00',yaxis: 1 },
             ...
             { data: std1, Label: 'Male Standard', color:'#CC0000',yaxis: 2 }],*/
			  var plot =   $.plot($("#placeholder"),
           [ { data: fmortv, Label: 'Female Mortality', color:'#33CC33',yaxis: 1 },
