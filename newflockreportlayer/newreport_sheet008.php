...
$query = "SELECT * FROM breeder_pstandards where client = '$client' and breed = '$breedi' and age <= '$maxage' ORDER BY age ASC ";

}
else
{
$query = "SELECT * FROM breeder_pstandards where client = '$client' and age <= '$maxage' ORDER BY age ASC ";
}
...
?>
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl673 align=right><?php echo number_format($row1['henday'],1); ?></td>
 </tr>
<?php } } ?>
...
[<?php echo $age = $row1['age']; ?>,<?php echo $row1['henday']; ?>],
<?php //}
        } ?>
[<?php echo $age; ?>,<?php echo $row1['henday']; ?>]];
