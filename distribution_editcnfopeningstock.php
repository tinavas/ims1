...
$q1="select date,superstockist from  distribution_cnfopeningstock where trnum='$trnum' limit 1";

$q1=mysql_query($q1) or die(mysql_error());

$r1=mysql_fetch_assoc($q1);

$date=date("d.m.Y",strtotime($r1['date']));
...
<div align="center">
<br/><br/>
<h1>Edit CNF Opening Stock </h1>
(Fields marked <font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font> are mandatory)

<br/><br/><br/>


<form  method="post" action="distribution_savecnfopeningstock.php"  onSubmit="return checkform()">
...
<input type="text" name="date" id="date" style="width:100px" value="<?php echo $date;?>" class="datepicker"  onChange="comparedate('fromdate')" />&nbsp;&nbsp;&nbsp;




<strong>superstockist<font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font></strong>
<select name="superstockist" id="superstockist" >
<option value="">-Select-</option>
<?php

$q1="SELECT name FROM `contactdetails` where superstockist='YES' and name not in (SELECT distinct superstockist FROM `distribution_cnfopeningstock` where trnum!='$trnum') and type like '%party%'";
...
<td><strong>Opening Stock<font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font></strong></td>
...
$k=-1;
 ...
 $q1="select *  from  distribution_cnfopeningstock where trnum='$trnum'";
...
<input type="button" value="Cancel" onclick="document.location='dashboardsub.php?page=distribution_cnfopeningstock'" id="cancel"/>
