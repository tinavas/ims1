...
<section class="grid_8">
  <div class="block-border">
     ...
     <form class="block-content form" id="complex_form" name="form1" method="post" action="oc_savepayment.php" onsubmit="return checkform(this);">
...
<input type="text" id="amount" name="amount" size="10" value="0" style="text-align:right"/>
...
<input type="text" id="cheque" name="cheque" onKeyUp="validatecode(this.id,this.value);"  class="form_element" size="16"  style="display:none" />

</td>
 <td width="70px"><span id="availability_status"></span> </td>

<td id="cheq_date_text">

<input type="text" id="cdate" name="cdate" size="15" class="datepicker" value="<?php echo date("d.m.Y");?>" style="display:none"/>
...
if(document.getElementById('code1').value =="" || document.getElementById('description').value =="" || Number(document.getElementById('amount').value)==0)
 ...
 var no=document.getElementById('cheque' ).value ;
...
{
<?php
$q="SELECT DISTINCT (cheque)  from oc_payment ";
...
window.open('O2CHelp/help_p_addpayment.php','IMS','width=500,height=600,toolbar=no,menubar=yes,scrollbars=yes,resizable=yes');
