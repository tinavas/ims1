...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			...
			<button type="button" onClick="document.location='dashboardsub.php?page=pp_addrtpurchase_ims'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
<tbody>
	  <?php
		 ...
		 //echo "sectorall".$_SESSION['sectorall'];
		   ...
		   {
		   $query1 = "SELECT distinct(so) FROM pp_sobi WHERE dflag = '2' and date >= '$fromdate' and date <= '$todate'  order by date DESC";
		   }
		   else
		   {
		  $sectorlist = $_SESSION['sectorlist'];
		
		    $query1 = "SELECT distinct(so) FROM pp_sobi WHERE dflag = '2' and date >= '$fromdate' and date <= '$todate' and warehouse in ($sectorlist)  order by date DESC";
		   }
...
<a href="dashboardsub.php?page=pp_editrtpurchase_ims&id=<?php echo $row1['so']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a>

&nbsp;&nbsp;&nbsp;<a onClick="if(confirm('Are you sure,want to delete')) document.location ='pp_deletertpurchase_ims.php?id=<?php echo $row1['so']; ?>'"><img src="images/icons/fugue/cross-circle.png" style="border:0px" title="Delete" /></a>&nbsp;
<?php } else {?>
...
document.location = "dashboardsub.php?page=pp_rtpurchase&month=" + month + "&year=" + year;
}
</script>
