...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" id="complex_form" method="post" action="ims_savestockadjust.php" onsubmit="return validate()" >		
...
<?php } ?>  </select>
           ...
           ?>
<option value="<?php echo $codedesc2[0];?>" title="<?php echo $codedesc2[1]; ?>"><?php echo $codedesc2[0]; ?></option>
<?php } ?>
				</td> 
...
<td width="10px">&nbsp;</td><td>
<input type="text" size="10" style="text-align:right;" id="qtys@-1" name="qtys[]" value="" onblur="makeform(this.id);" />
</td>
...
<td><textarea id="remarks" name="remarks" rows="3" cols="50"></textarea></td>
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <input type="button" value="Back" onClick="document.location='dashboardsub.php?page=ims_stockadjust';">
</center>
