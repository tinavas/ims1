...
<section class="grid_8">
  <div class="block-border">
     ...
     <form class="block-content form" id="complex_form" name="form1" method="post" action="pp_savertpurchase_ims.php" onsubmit="return checkcoa();">
...
<th><strong>Rate</strong><font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font></th><td width="10px">&nbsp;</td>
...
<td width="10px">&nbsp;</td><td><input type="text" size="7" style="text-align:right;" id="qtys@-1" name="qtys[]" value="0" onkeypress="return num1(event.keyCode)" onkeyup="return calnet('');"  onblur="return checkrcvqty(this.id,this.value),calnet('');" /></td>
<td width="10px">&nbsp;</td><td>
<input type="text" size="7" id="qtyr@-1" style="text-align:right;" name="qtyr[]" value="0" onkeyup="checkqty(this.id,this.value),calnet('');" onblur="calnet('');" onkeypress="return num1(event.keyCode)"  />
</td>
<td width="10px">&nbsp;</td>
<td>
<input type="text" size="6" id="price@-1" style="text-align:right;" name="price[]" value="0" onfocus="makeForm(this.id);" onkeyup="calnet('');" onblur="calnet('');" onkeypress="return num1(event.keyCode)"/>
</td>
	    ...
	    for($i=0;$i<count($tax);$i++)
           {
		     $tax1=explode('@',$tax[$i]);
     ?>
             <option title="<?php echo $tax1[1]; ?>" value="<?php echo $tax1[0]."@".$tax1[2]."@".$tax1[3]."@".$tax1[4]; ?>"><?php echo $tax1[0]; ?></option>
     <?php } ?>
</select>
...
<table border="0" align="center">
   ...
   <tr>
      ...
      <td align="left"><input type="text" size="12" id="basic" name="basic" value="0.00" style="text-align:right; border:0px; background:none;" readonly /></td>
  ...
  <tr>
   ...
   <td align="left"><input type="text" size="12" name="totalprice" id="totalprice" style="text-align:right; border:none; background:0px;" value="0.00" readonly/></td>
   <td></td><td></td><td></td><td></td>
...
<tr>
	  <td align="right"><strong>&nbsp;Grand&nbsp;Total</strong>&nbsp;&nbsp;</td>
        <td align="left"><input type="text" size="12" name="tpayment" id="tpayment" value="0.00" readonly style="text-align:right; border:none; background:none"/></td>
</tr>
...
<tr>
 ...
 <td align="center"><strong>COA Code</strong><font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font></td>  <td width="10px"></td>
 <td align="center"><strong>Description</strong><font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font></td>  <td width="10px"></td>
 <td align="center"><strong>Cr</strong><font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font></td>  <td width="10px"></td>
...
<?php include "config.php";
                       include "config.php"; 
                       $query = "SELECT * FROM ims_taxcodes where type = 'Tax' and (taxflag = 'P'  or taxflag='A') ORDER BY codevalue ASC";
                       $result = mysql_query($query,$conn); 
...
for(var c=0;c<cashcode.length;c++)
	{
	   
		var cashcode1=cashcode[c];
		var cashcode2=cashcode1.split('@');
		theOption1=document.createElement("OPTION");
