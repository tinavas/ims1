...
var f = 0;
   ...
   if(client == 'SKPFNEW')
   {
       window.open('report/advancereport.php' + '?m=' + fields + '&n=' + fields1 + '&empname=' + empname + '&month=' + month+ '&year=' + year+ '&sector=' + sector); 
   }
   else
   {
    window.open('report/advancereport.php' + '?m=' + fields + '&n=' + fields1 + '&empname=' + empname + '&month=' + month+ '&year=' + year+ '&sector=' + sector); 
	...
	if(client == 'SKPFNEW')
	{
	    window.open('production/advancereport.php' + '?m=' + fields + '&n=' + fields1  + '&empname=' + empname + '&month=' + month+ '&year=' + year+ '&sector=' + sector); 
	}
	else
	{
    window.open('production/advancereport.php' + '?m=' + fields + '&n=' + fields1  + '&empname=' + empname + '&month=' + month+ '&year=' + year+ '&sector=' + sector); 
