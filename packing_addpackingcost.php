...
<center>
<form class="block-content form" method="post" action="packing_savepackingcost.php"  onSubmit="return checkform()">
  <h1>Packing Cost</h1>
  
  <br/><br/>
<b>Add Packing Cost Details</b></br></br>
(Fields marked <font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font> are mandatory)

<br/><br/><br/><br/><br/>

<strong>From Date<font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font></strong>
<input type="text" name="fromdate" id="fromdate" class="datepicker" style="width:100px" onChange="comparedate('fromdate')">


<strong>To Date<font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font></strong>
<input type="text" name="todate" id="todate" class="datepicker" style="width:100px" onChange="comparedate('todate')">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Codes That You Need To Add:<font color="#FF0000"><?php echo str_replace("*","/",$_GET['codes']);?></font></strong>
...
{
?>
<option value="<?php echo $allconts[$j]['cont'];?>" title="<?php echo $allconts[$j]['cont'];?>" ><?php echo $allconts[$j]['cont'];?></option>
<?php }?>
...
var id1=id[1];
 ...
 var con=document.getElementById("cont@"+id1).value;
//alert(index);
...
if(i!=Number(id1))
{
if(document.getElementById("code@"+i).value==value && document.getElementById("cont@"+i).value==con )
{
