...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			...
			<button type="button" onClick="document.location='dashboardsub.php?page=pp_addpayment'" ><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
<tbody>
		       ...
		       if($_SESSION['sectorall'] == "all" || ($_SESSION['sectorall'] == "" && $_SESSION['sectorlist'] == ""))
	{
	 ...
	 if($sectorlist=="") 
	 $query = "SELECT distinct(tid),date,vendor FROM pp_payment where date >= '$fromdate' and date <= '$todate' group by tid order by date DESC";
	 
	 else
	 $query = "SELECT distinct(tid),date,vendor FROM pp_payment where date >= '$fromdate' and date <= '$todate' and unit in ($sectorlist) group by tid order by date DESC";
           ...
           ?>
            <tr>
			 ...
			 <a href="<?php  echo 'dashboardsub.php?page=pp_editpayment&id='.$row1['tid']; ?>" ><img src="images/icons/fugue/pencil.png" style="border:0px" title="Edit"/></a>&nbsp;			 
			 <a onclick="if(confirm('Are you sure,want to delete')) document.location ='<?php echo 'pp_deletepayment.php?id='.$row1['tid']; ?>'" ><img src="images/icons/fugue/<?php echo "cross-circle.png";?>" style="border:0px" title="<?php echo "Delete";?>" /></a>
...
<?php  }?>
             ...
             <a href="pp_paymentprint.php?id=<?php echo $row1['tid']; ?>" target="_new"><img src="images/icons/fugue/report.png" style="border:0px" title="print" /></a>&nbsp;&nbsp;
			 </td>
           </tr>
           <?php 
           }
...
document.location = "dashboardsub.php?page=pp_payment&month=" + month + "&year=" + year;
}
</script>