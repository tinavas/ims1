...
<script type="text/javascript">
	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right">
			...
			<button type="button" onClick="document.location='dashboardsub.php?page=distribution_addsalesreceipt'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
<tbody>
	  <?php
		 ...
		 if($_SESSION['sectorall'] == "all" || ($_SESSION['sectorall'] == "" && $_SESSION['sectorlist'] == ""))
		   {
		 $q1="select date,invoice,party,group_concat(description separator '/') as items,group_concat(squantity separator '/') as quantity,finaltotal,trnum from distribution_salesreceipt where date between '$fromdate' and '$todate' group by trnum order by date desc";
		   }
		   else
		   {
		 $sectorlist = $_SESSION['sectorlist'];
		 
$q1="select date,invoice,party,group_concat(description separator '/') as items,group_concat(squantity separator '/') as quantity,finaltotal,trnum from distribution_salesreceipt where date between '$fromdate' and '$todate' and  warehouse In ($sectorlist) group by trnum order by date desc";
		   }
...
<td><?php echo $r1['invoice'];?></td>
<td><?php echo $r1['party'];?></td>
<td><?php echo $r1['items'];?></td>
<td><?php echo $r1['quantity'];?></td>
<td><?php echo $r1['finaltotal'];?></td>
<td>

<?php if($_SESSION[admin]==1)
{?>
 <a onclick="if(confirm('Are you sure,want to delete'))document.location='dashboardsub.php?page=distribution_deletesalesreceipt&trnum=<?php echo $r1['trnum'];?>&cobi=<?php echo $r1['invoice'];?>'"><img src="images/icons/fugue/cross-circle.png" style="border:0px;" title="Delete" /></a>
<?php } else {?>
<img src="images/icons/fugue/lock.png" style="border:0px;" title="Locked" />
<?php }?>
</td>
...
document.location = "dashboardsub.php?page=distribution_salesreceipt&month=" + month + "&year=" + year;
}
</script>
