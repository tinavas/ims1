...
$tfmort = 0;$tmmort = 0;$tfcull = 0;$tmcull = 0;$weekeggs = 0;$weekheggs = 0;
...
while($row1 = mysql_fetch_assoc($result))
{
  ...
  while($row11 = mysql_fetch_assoc($result1))
  {
     ...
     if(array_search($row11['itemcode'],$heggtype))
     {
        $weekheggs = $weekheggs + $row11['quantity'];
     }
  }
...
?>
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl676 align=right><?php echo round(($arrheggs[$age] / $arreggs[$age])*100,2); ?></td>
...
[<?php echo $age = $row1['age']; ?>,<?php echo round(($arrheggs[$age] / $arreggs[$age])*100,2); ?>],
<?php } } ?>
[<?php echo $age; ?>,<?php echo round(($arrheggs[$age] / $arreggs[$age])*100,2); ?>]];
...
<!-- , dashes: { show: true }, hoverable: true  -->
           ...
           { 
            ...
            points: { show: true },
             ...
             xaxis: { min: 22,tickSize: 2,max:68,label: "test"},
