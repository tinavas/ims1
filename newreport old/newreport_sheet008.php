...
$query = "SELECT * FROM breeder_standards where client = '$client' and age <= '60' ORDER BY age ASC ";
$result = mysql_query($query,$conn); 
while($row1 = mysql_fetch_assoc($result))
{ 
...
?>
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl676 align=right><?php echo round((($arreggs[$age] / 7)/$arrfemale[$age])*100,2); ?></td>
...
[<?php echo $age = $row1['age']; ?>,<?php echo round((($arreggs[$age] / 7)/$arrfemale[$age])*100,2); ?>],
<?php } } ?>
[<?php echo $age; ?>,<?php echo round((($arreggs[$age] / 7)/$arrfemale[$age])*100,2); ?>]];
...
<!-- , dashes: { show: true }, hoverable: true  -->
           ...
           { 
            ...
            points: { show: true },
             ...
             xaxis: { min: 24,tickSize: 2,max:60,label: "test"},
