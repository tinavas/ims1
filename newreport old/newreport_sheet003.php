...
<table border=0 cellpadding=0 cellspacing=0 width=1202 style='border-collapse:
 ...
 <tr height=13 style='mso-height-source:userset;height:9.75pt'>
  <td colspan=27 height=13 class=xl69 style='height:9.75pt'>Weekly Report</td>
  <td colspan=3 class=xl128 style='mso-ignore:colspan'></td>
 </tr>
...
?>
 ...
 <tr height=18 style='height:13.5pt'>
  ...
  <td class=xl516 style='border-top:none'>&nbsp;</td>
  <td class=xl535 align=right style='border-top:none'><?php echo $cummfmort; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummmmort; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummfcull; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummmcull; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummfsexing; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummmsexing; ?></td>
  ...
  <td class=xl128></td>
  <td class=xl128></td>
  <td class=xl535 align=right style='border-top:none'><?php echo $cummffeed + $cummmfeed; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummffeed; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummffeedg; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummmfeed; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummmfeedg; ?></td>
  <td class=xl537 style='border-top:none'>&nbsp;</td>
  <td class=xl128></td>
  <td class=xl128></td>
  <td class=xl566></td>
...
?>
 <tr height=15 style='height:11.25pt;display:none'>
  ...
  <td class=xl342 style='border-top:none'><?php echo $row1['fmort']; $weekfmort = $weekfmort + $row1['fmort']; $weekfsexing = $weekfsexing + $row1['fsexing']; ?></td>
  <td class=xl343 style='border-left:none'><?php echo $row1['mmort']; $weekmmort = $weekmmort + $row1['mmort']; $weekmsexing = $weekmsexing + $row1['msexing']; ?></td>
  ...
  <td class=xl342 style='border-top:none'><?php echo $row1['fcull']; $weekfcull = $weekfcull + $row1['fcull']; ?></td>
  <td class=xl343 style='border-left:none'><?php echo $row1['mcull']; $weekmcull = $weekmcull + $row1['mcull']; ?></td>
...
<tr height=17 style='height:12.75pt'>
  ...
  <td class=xl547 align=right style='border-top:none;border-left:none'><?php if($row1['date2'] >= $untildate) { ?><?php echo $tempcomp1 = round((($weekeggs/7)/$weekfemale)*100,1); ?><?php } ?></td>
  ...
  <td class=xl554 align=right style='border-top:none;border-left:none'><?php echo $fweight; ?></td>
  <td class=xl529 align=right style='border-top:none;border-left:none'><?php echo $fweight - $stdfw; ?></td>
  <td class=xl558 align=right style='border-top:none;border-left:none'><?php echo $stdmw; ?></td>
  <td class=xl554 align=right style='border-top:none;border-left:none'><?php echo $mweight; ?></td>
  <td class=xl529 align=right style='border-top:none;border-left:none'><?php echo $mweight - $stdmw; ?></td>
  <td class=xl558 align=right style='border-left:none'><?php if($row1['date2'] >= $untildate) { ?><?php echo $stdeggwt; ?><?php } ?></td>
  <td class=xl554 align=right style='border-top:none;border-left:none'><?php if($row1['date2'] >= $untildate) { ?><?php echo $tempcomp5 = round($weekeggwt/7,1); ?><?php } ?></td>
...
?>
  ...
  <td class=xl536 align=right style='border-top:none'><?php echo $cummfsexing; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummmsexing; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummeggs; ?></td>
  <td class=xl536 align=right style='border-top:none'></td>
  <td class=xl536 align=right style='border-top:none'></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummhatcheggs; ?></td>
  <td class=xl537 style='border-top:none'>&nbsp;</td>
  <td class=xl511></td>
  <td class=xl535 align=right style='border-top:none'><?php echo $cummffeed + $cummmfeed; ?></td>
  <td class=xl536 align=right style='border-top:none'><?php echo $cummffeed; ?></td>
