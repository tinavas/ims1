...
$query1="select noofdays from hr_workingdays where month = '$monthq' AND year = '$yearq'";
...
<td width="10px">&nbsp;</td>
<td  title="Extra Days Present" width="50px"><strong>Extra Days</strong></td>
<td width="10px">&nbsp;</td>
...
<td width="10px">&nbsp;</td>
<td title="Over Time Salary to be paid" width="50px">
<strong>O.T. </strong></td>
<td width="10px">&nbsp;</td>
<td title="Over Time Salary Paid" width="50px">
<strong>O.T. Paid</strong></td>
<td width="10px">&nbsp;</td>
...
$dateqcc = date("Y-m-j", strtotime($dateq));
 $queryforsal = "select bfix,finalsal from hr_salaryparameters where eid = '$r[employeeid]' order by id desc Limit 1 ";
...
$totaldays =0;$nooffull=0;$noofhalf=0;$extra =0;
$qtt ="SELECT dayspresent as noofdays,extra FROM `hr_mnthattendance` where eid='$r[employeeid]' and month='$monthq' and year='$yearq' and client='$client'";
...
<td width="10px">&nbsp;</td>
<td>
<input type="text" style="width: 50px;text-align:right;color:#0000FF" id="edays<?php echo $i; ?>" name="edays[]"  readonly value="<?php echo $extra; ?>" /></td>
...
<td width="10px">&nbsp;</td>
<td><input type="text" style="width: 50px;text-align:right;color:#0000FF" id="totalsalary<?php echo $i; ?>" name="totalsalary[]"  readonly value="<?php echo round($salsal,2); ?>" /></td>

<td width="10px">&nbsp;</td>
<td>
<input type="text" style="width: 50px;text-align:right;color:#0000FF" id="ot1<?php echo $i; ?>" name="ot1[]"   value="<?php echo round($extsal);?>"  readonly /></td>

<td width="10px">&nbsp;</td>
<td>
<input type="text" style="width: 50px;text-align:right;" id="ot<?php echo $i; ?>" name="ot[]"   value="<?php echo round($extsal);?>"  onkeyup="calsalot(this.id);" /></td>

<td width="10px">&nbsp;</td>
<td>
<input type="text"  style="width: 50px;text-align:right;" id="paid<?php echo $i; ?>" name="paid[]" value="<?php echo round($salsal); ?>"/></td>
<td width="10px">&nbsp;</td>
<td>
...
var sector = document.getElementById('sector').value;
	...
	document.location = "dashboardsub.php?page=hr_addsalpayment_golden&sector=" + sector + "&desig=" + desig ;
}
...
function fun3()
{
	...
	var date = document.getElementById('date').value;
	var month = document.getElementById('month').value;
	document.location = "dashboardsub.php?page=hr_addsalpayment_golden&sector=" + sector + "&desig=" + desig + "&date=" + date+ "&month=" + month;
}
function funmnth()
{
