...
<br/>
<br/>
<form id="form1" name="form1" method="post" action="oc_updatetaxmasters.php"  onsubmit="return checkform(this);">
<table align="center">
...
<br />
<center>
<input type="submit" value="Update" />&nbsp;&nbsp;&nbsp;<input type="button" value="Cancel" onclick="document.location='dashboardsub.php?page=oc_taxmasters';">
</center>
</td>
</tr>
</table>
