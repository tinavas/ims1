...
{
alert(code);
  window.open('production/stockdifference1.php?fromdate=' + fromdate + '&todate=' + todate + '&code=' + code + '&description=' + desc+'&warehouse='+warehouse); 
...

{
 ...
 window.open('production/stockdifference.php?fromdate=' + fromdate + '&todate=' + todate + '&code=' + code + '&description=' + desc+'&warehouse='+warehouse); 
