...
<table align="center">
<tr align = "center">
<td align="right"><strong>Supplier Name&nbsp;&nbsp;</strong></td>
<td width="10px"></td>
<td align="left">
<select <?php if($_SESSION['db']=='albustan' || $_SESSION['db']=='albustanlayer'){ ?> onchange="document.getElementById('vcodecode').value=this.value" <?php } ?> name = "vcode" id = "vcode" style = "width:180px">
<option value = "-select-">-select-</option>
<option value = "All">All</option>
<?php 
$q  = "select distinct(vcode) from ac_crdrnote where mode = 'VCN' order by vcode";
...
<tr height="15px"></tr>
<tr align = "center">
<td align="right"><strong>Supplier Code&nbsp;&nbsp;</strong></td>
<td width="10px"></td>
<td align="left">
<select onchange="document.getElementById('vcode').value=this.value" name = "vcodecode" id = "vcodecode" style = "width:180px">
<option value = "-select-">-select-</option>
<option value = "All">All</option>
<?php 
$q  = "select distinct(vcode),vpcode from ac_crdrnote where mode = 'VCN' order by vcode";
$r = mysql_query($q,$conn) or die(mysql_error());
while($qr = mysql_fetch_assoc($r))
{
?>
...
window.open('production/suppliercreditnote.php?fromdate=' + fromdate + '&todate=' + todate + '&name=' + name1);
<?php } elseif($_SESSION['db'] == "central") { ?>
window.open('production/suppliercreditnote2.php?fromdate=' + fromdate + '&todate=' + todate + '&name=' + name1);
<?php } ?>
}
}
</script>
