...
$q1="SELECT name FROM `contactdetails` where superstockist='YES' and name not in (SELECT distinct superstockist FROM `distribution_cnfopeningstock`) and type like '%party%'";
