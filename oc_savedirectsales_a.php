...
if( $_POST['qtys'][$i] != '0' && $_POST['qtys'][$i] != '' && $_POST['code'][$i] != '')
{
	...
	$query4="update ims_eggreceiving set availableeggs=availableeggs-".$_POST['qtys'][$i]." where date='".$rdate."' and flock='$flock' and tocode in (select code from ims_itemcodes where cat='hatch eggs')";
...
$query = "DELETE FROM oc_cobi WHERE invoice = '$invoice1'";
