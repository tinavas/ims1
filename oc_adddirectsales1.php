...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" id="complex_form" method="post" action="oc_savedirectsales.php" onsubmit="return checkcoa();">
...
<td width = "10px">&nbsp;</td><td>
<input type="text" size="6" id="free@-1" style="text-align:right;" name="free[]" value="" onfocus="makeForm();"/>
</td>
    </tr>
   </table>
   <br /> 
...
function getcode(cat)
{
	...
	if((cat1 == "Broiler Chicks") || (cat1 == "Broiler Day Old Chicks"))
	{
...
theOption1.title = "<?php echo $row1['flockdescription']; ?>";
theOption1.appendChild(theText1);
myselect1.appendChild(theOption1);
<?php }  ?>
	}
