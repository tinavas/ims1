...
if($_SESSION['db'] == "mlcf" || $_SESSION['db'] == "mbcf")
{
...
$warehouse = $resw['unitcode'];
	...
	$taxamount = 0;
	$totalquantity+= $qtyr;
	  $q = "insert into pp_sobi (remarks,date,sobiincr,m,y,so,invoice,vendor,broker,code,description,receivedquantity,rateperunit,itemunits,bags,bagtype,bagunits,taxvalue,taxamount,freightamount,totalamount,pocost,grandtotal,balance,empid,empname,sector,flag,vno,driver,freighttype,viaf,datedf,cashbankcode,dflag,discountamount,coa,cno,flock,warehouse,sentquantity) 
