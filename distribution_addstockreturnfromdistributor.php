...
<div align="center">
<br/><br/>
<h1>Add Stock Return From Distributor</h1>
...
<select name="distributor[]" id="distributor@0" style="width:150px" >
<option value="">-Select-</option>
...
document.location="dashboardsub.php?page=distribution_addstockreturnfromdistributor&superstockist="+superstockist+"&date="+date+"&docno="+docno;
