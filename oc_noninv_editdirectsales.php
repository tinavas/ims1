...
$ddate=$_GET['date'];	
 $query = "select * from oc_cobi where invoice='$co'";
	   ...
	   {		
		...
		$binvoice=$row1['bookinvoice'];
       $party1=$row1['party'];  
         $remarks=$row1['remarks'];
		 $gtotal=$row1['finaltotal'];
...
<input type="hidden" name="cod" id="cod" value="<?php echo $icode; ?>"/>
...
<td><input type="text" size="15" id="date" class="datepickerCOBIP" name="date" value="<?php echo $date; ?>" onChange="reloadpage(this.id);"/></td>
<td width="10px">&nbsp;</td>
<td align="right"><strong>Invoice</strong>&nbsp;&nbsp;&nbsp;</td>
<td align="left"><input type="text" id="invoice" name="invoice" value="<?php echo $invoice; ?>" readonly style="border:0px;background:none" />&nbsp;&nbsp;</td>
<td width="10px">&nbsp;</td>
 ...
 <td><strong>Party</strong></td>
                ...
                <td>&nbsp;
					...
					for($j=0;$j<count($party);$j++)
							{ 
					?>
					<option title="<?php echo $party[$j];?>" <?php if($party1==$party[$j]){?> selected="selected" <?php }?> value="<?php echo $party[$j];?>"><?php echo $party[$j]; ?></option>
					<?php   }   ?>
...
<td >
         <input type="text" name="amt[]" id="amt<?php echo $i;?>"  size="8" value="<?php echo $qtys; ?>"  style="text-align;right;" onKeyUp="calcu();"  />       </td>
       <td width="10px"></td>
 <td >
         <input type="text" name="dis[]" id="dis<?php echo $i;?>" size="6" onKeyUp="calcu();" onfocus = "makeForm(this.id)"  style="text-align;right;"  value="<?php echo $price; ?>"/>       </td>
...
&nbsp;&nbsp;&nbsp;
<input type="text" size="15" id="gtot" name="gtot" readonly="true" value="<?php echo $gtotal;?>" style="text-align:left; background:none; border:0px;"/></td>
</tr>
...
var date=document.getElementById(d).value;
 document.location = 'dashboardsub.php?page=oc_noninv_directsales&date=' + date;
}
