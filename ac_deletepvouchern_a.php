...
$q1q = "select * from ac_financialpostings where trnum = '$tno' AND type = 'PV' and  client='$client'";
...
$get_entriess1 = 
"DELETE FROM ac_financialpostings WHERE trnum = '$tno' and coacode = '$coacode' AND type = 'PV' and  client='$client'";
