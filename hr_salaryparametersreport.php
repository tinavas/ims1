...
<tr height="20"><td colspan="15"><strong>Common Fields</strong></td></tr>
...
<tr height="20"><td colspan="15"><strong>Other Fields</strong></td></tr>

<tr height="10"><td colspan="15"></td></tr>
<div style="visibility:hidden">
  <input type="checkbox" id="attendance"  name="m[]" value="attendance"   title="Please check to see Attendance Report"onClick="attendance1()" onChange=""  /></td>  
  </div>
<tr>
  <td><input type="checkbox"  id="ba" name="m[]" value="ba"  title="Please check to see Basic Allowance Report" onClick="attendance1()"/></td><td width="5px"></td><td width="150px"><strong> Basic Allowance</strong></td>
  <td><input type="checkbox"  id="hra" name="m[]" value="hra"  title="Please check to see HRA Report"onClick="attendance1()"/></td> <td width="5px"></td><td width="150px"><strong>HRA</strong></td>
  <td><input type="checkbox"  id="ma" name="m[]" value="ma" title="Please check to see Medical Allowance Report" onClick="attendance1()"/></td> <td width="5px"></td> <td width="150px"><strong>Medicial Allowance</strong></td>
  <td><input type="checkbox"  id="cca" name="m[]" value="cca" title="Please check to see City Compensation Allowance Report" onClick="attendance1()"/></td> <td width="5px"></td> <td width="150px"><strong>City Compensation Allowance</strong></td>
</tr>
<tr>
 <td><input type="checkbox"   id="ta" name="m[]" value="ta"  title="Please check to see Travelling Allowance Report" onClick="attendance1()" /></td> <td width="5px"></td> <td><strong>Travelling Allowance</strong></td>
 <td><input type="checkbox"   id="sa" name="m[]" value="sa"   title="Please check to see Special Allowance Report" onClick="attendance1()"/></td> <td width="5px"></td> <td><strong>Special Allowance</strong></td> 
 <td><input type="checkbox"   id="c" name="m[]" value="c"  title="Please check to see Conveuance Report" onClick="attendance1()" /></td> <td width="5px"></td> <td><strong>Conveyance</strong></td>
 <td><input type="checkbox"   id="ea" name="m[]" value="ea"  title="Please check to see Education Allowance Report" onClick="attendance1()"/></td> <td width="5px"></td> <td><strong>Education Allowance</strong></td> 
 <td><input type="checkbox"   id="oa" name="m[]" value="oa"  title="Please check to see Other Allowance Report" onClick="attendance1()"/></td> <td width="5px"></td> <td><strong>Other Allowance</strong></td>
</tr>
<tr>
 <td><input type="checkbox"   id="pf" name="m[]" value="pf"  title="Please check to see PF Report" onClick="attendance1()"/></td> <td width="5px"></td> <td><strong>PF</</td>
 <td><input type="checkbox"   id="pt" name="m[]" value="pt"  title="Please check to see Personal Tax Report" onClick="attendance1()" /></td> <td width="5px"></td> <td><strong>Professional Tax</strong></td>
 <td><input type="checkbox"   id="it" name="m[]" value="it"  title="Please check to see Income Tax Report"  onClick="attendance1()"/></td> <td width="5px"></td> <td><strong>Income Tax</strong></td>
 <td><input type="checkbox"   id="lr" name="m[]" value="lr"  title="Please check to see Loan Repayments Report" onClick="attendance1()" /></td> <td width="5px"></td> <td><strong>Loan Repayments</strong></td>
  <td><input type="checkbox"  id="od" name="m[]" value="od"   title="Please check to see Other Deductions Report" onClick="attendance1()"/></td> <td width="5px"></td> <td><strong>Other Deductions</strong></td>
</tr>


<tr height="30"><td></td></tr>
<tr><td><td colspan="15" style="text-align:center"><input type="button" value="Open Report" onClick="openreport(document.myform1.elements['m[]'],document.myform1.elements['n[]']);" /></td></tr>
</form>
</table>
...
function openreport(field,field1)
{
<?php echo "
...
var f = 0;
   ...
   {
   f  = 1 ;
    window.open('report/attendancesmry.php' + '?m=' + fields + '&n=' + fields1 + '&empname=' + empname + '&month=' + month+ '&year=' + year+ '&sector=' + sector); 
	}
	else if((document.getElementById('ba').checked == true)||(document.getElementById('hra').checked == true)||(document.getElementById('ma').checked == true)||(document.getElementById('cca').checked == true)||(document.getElementById('ta').checked == true)||(document.getElementById('sa').checked == true)||(document.getElementById('c').checked == true)||(document.getElementById('ea').checked == true)||(document.getElementById('oa').checked == true)||(document.getElementById('pf').checked == true)||(document.getElementById('pt').checked == true)||(document.getElementById('it').checked == true)||(document.getElementById('lr').checked == true)||(document.getElementById('od').checked == true))
	{
	f  = 1 ;
    window.open('production/PAYSLIP3smry.php' + '?m=' + fields + '&n=' + fields1  + '&empname=' + empname + '&month=' + month+ '&year=' + year+ '&sector=' + sector); 
	}
	if( f == 0 )
	{
	alert('Please check any of the salary parameters');
	}
	"; ?>
}
