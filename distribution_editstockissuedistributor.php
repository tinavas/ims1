...
<div align="center">
<br/><br/>
<h1>Edit Stock Issue To Distributor</h1>
(Fields marked <font style="color:red;font-weight:bold;padding-top:10px"><sup>*</sup></font> are mandatory)

<br/><br/><br/>


<form  method="post" action="distribution_savestockissuedistributor.php"  onSubmit="return checkform()">
...
<td>
<input type="text" name="rateperunit[]" id="rateperunit@<?php echo $k;?>" style="width:100px;" value="<?php echo $result['rateperunit'];?>" />
</td>
