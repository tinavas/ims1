...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" id="complex_form"style="min-height:500px" enctype="multipart/form-data" method="post" action="dashboardsub.php?page=import_rvoucher" >
	  <h1 id="title1">View Receipt Vouchers Data</h1>
...
<tr>
 ...
 <th><strong>Receipt Mode</strong></th>
