	...
	<div id="control-bar" class="grey-bg clearfix"><div class="container_12">
		...
		<div class="float-right"> 
			<?php if($_SESSION['db'] == "souza") { ?>
					<button type="button" onClick="document.location='dashboardsub.php?page=tally_receipts'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Tally Import</button>
			<?php } ?>		
		
			<button type="button" onClick="document.location='dashboardsub.php?page=oc_addreceipt_a'"><img src="images/icons/fugue/tick-circle.png" width="16" height="16"> Add</button>
...
<tbody>
	  <?php 
           include "config.php"; 
           $query = "SELECT * FROM oc_receipt where date >= '$fromdate' and date <= '$todate' order by date desc";
           ...
           ?>
            <tr>
			 ...
			 <td><?php if($row1['flag'] == 0)
      { ?>	<!-- Before Authorization -->
<a href="<?php echo 'dashboardsub.php?page=oc_editreceipt_a&id='.$row1['tid']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="<?php echo "Edit"; ?>"/></a>&nbsp;
<a onclick="if(confirm('Are you sure,want to delete')) document.location ='<?php echo 'oc_deletereceipt_a.php?id='.$row1['tid']; ?>'" ><img src="images/icons/fugue/<?php echo "cross-circle.png";?>" style="border:0px" title="<?php echo "Delete";?>" />
<?php } 
else { ?>					<!-- After Authorization -->
<?php if ( strlen(strstr(','.$_SESSION['authorizesectors'],',RCT,' ))>0 ) { ?>	<!-- If he has authority power -->
<a href="<?php echo 'dashboardsub.php?page=oc_editreceipt_a&id='.$row1['tid']; ?>"><img src="images/icons/fugue/pencil.png" style="border:0px" title="<?php echo "Edit"; ?>"/></a>&nbsp;
<a onclick="if(confirm('Are you sure,want to delete')) document.location ='<?php echo 'oc_deletereceipt_a.php?id='.$row1['tid']; ?>'" ><img src="images/icons/fugue/<?php echo "cross-circle.png";?>" style="border:0px" title="<?php echo "Delete";?>" />
<?php if($row1['flag'] == 1) { ?><img src="images/icons/fugue/tick-circle.png" title="Already Authorized" width="16" height="16"><?php } ?>
<?php } else { ?>
<img src="images/icons/fugue/lock.png" style="border:0px" title="<?php echo "Already Authorized"; ?>"/></a>
<?php } ?>
<?php } ?>
<a href="<?php echo 'oc_receiptprint.php?id='.$row1['tid']; ?>" target="_new" ><img src="images/icons/fugue/report.png" style="border:0px" title="<?php echo "Print Payment";?>" />			 
</a>&nbsp;			 </td>
           </tr>
           <?php 
           }
...
document.location = "dashboardsub.php?page=oc_receipt_a&month=" + month + "&year=" + year;
}
</script>