...
$year = $_GET['year'];
		$q = "select * from hr_mnth_attendance where id = '$id'";
...
<section class="grid_8">
  <div class="block-border">
     ...
     <form class="block-content form" style="height:600px" id="complex_form" method="post" action="hr_updatemnth_attandance.php" >
...
<td width="10px">&nbsp;</td>
<td>
<input type="text" style="width: 70px;text-align:right; color:#FF0000" id="pleave" name="pleave"  value="<?php echo $pleav;?>" />
</td>
