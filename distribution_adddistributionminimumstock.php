...
<div align="center">
<br/><br/>
<h1>Add Distribution Minimum Stock Level</h1>
...
$q1="SELECT areacode as name,areaname FROM `distribution_area`  where areacode not in (select distinct areacode from distribution_stocklevel)";
...
<option value="<?php echo $r1['name'];?>" title="<?php echo $r1['areaname'];?>"><?php echo $r1['name'];?></option>
