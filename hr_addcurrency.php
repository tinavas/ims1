...
<section class="grid_8">
  <div class="block-border">
     <form class="block-content form" style="height:600px" id="complex_form" method="post" action="hr_savecurrency.php" >
...
<tr>
 <td>
           <select name="country[]" id="country@0" style="width:108px;" onchange="checkcodes();">
           <option value="select">-Select-</option>
           <?php
              include "config.php"; 
              $query = "SELECT distinct(country_name) FROM countries where country_name NOT IN (SELECT country FROM currency) ORDER BY country_name ASC ";
 ...
 <td width="10px"></td>
 <td>
 <input type="text" id="currency@0" name="currency[]" onfocus="makeForm()" size="5" />
 </td>
 </tr>
</table> 
...
<tr height="30px"></tr>
<tr>
 <td><input type="submit" value="Save" name="submit" />&nbsp;&nbsp;&nbsp;<input type="button" value="Cancel" name="cancel" onclick="document.location='dashboardsub.php?page=hr_currency'" />
 </td>
 </tr>
 </table>
...
?>
theOption1=document.createElement("OPTION");
theText1=document.createTextNode("<?php echo $row1['country_name']; ?>");
theOption1.value = "<?php echo $row1['country_name']; ?>";
theOption1.title = "<?php echo $row1['country_name']; ?>";
theOption1.appendChild(theText1);
myselect1.appendChild(theOption1);
