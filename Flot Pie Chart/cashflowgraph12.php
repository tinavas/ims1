...
$cramount = $dramount = 0; $displaycrdr = "";
 ...
 while($rows2 = mysql_fetch_assoc($result2))
 {
  if($rows2['amount']!="")
 {
 $value=round($rows2['amount'],2);
 $drarray[]=array("schedule"=>$rows1[schedule],"val"=>$value);
 }
 }
  ...
  plotOptions: {
        ...
        series: [{
			...
			?>
			{
                ...
                y: <?php echo round($crarray[$i]['val'],2);?>,
				sliced:true
  ...
  plotOptions: {
        ...
        series: [{
			...
			?>
			{
                ...
                y: <?php echo round($drarray[$i]['val'],2);?>,
				sliced:true
...
<!--<script type="text/javascript"  src="include/js/DataLabels.js"></script>-->
