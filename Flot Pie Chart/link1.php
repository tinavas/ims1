...
<tr>
 ...
 <p ><iframe src="ac_assets1.php?fdate=<?php echo $fromdate;  ?>&tdate=<?php echo $tdate; ?>" align="right" height="700" width="600"  frameborder="0"  ></iframe>
      <iframe src="ac_capital.php?fdate=<?php echo $fromdate;  ?>&tdate=<?php echo $tdate; ?>" align="right" height="700" width="600"  frameborder="0"  ></iframe></p>