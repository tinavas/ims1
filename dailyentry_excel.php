...
switch ($ee->Explore($file)) {
 ...
 ?>
<form id="form1" name="form1" method="post" action="breeder_savebookentry.php">
...
if ( $row > 0 )
    ...
    <td width="10px"></td>
    <td style="text-align:left;"><input type="text" value="<?php echo $data19 ?>"  name="fweight[]" id="fweight0" value="" size="3" />    </td>
    <td width="10px"></td>
    <td style="text-align:left;"><select name="ffeedtype[]" id="ffeedtype0" >
      ...
      <?php
              ...
              {
           ?>
      <option <?php if($row1['code']==$data21) echo 'selected="selected"'; ?> value="<?php echo $row1['code']; ?>" title="<?php echo $row1['description']; ?>"><?php echo $row1['code']; ?></option>
      <?php } ?>
    </select>    </td>
    <td ID='PAVAN' width="10px"></td>
    <td style="text-align:left;"><input type="text" name="ffeedqty[]" id="ffeedqty0" value="<?php echo $data7; ?>" size="3" />    </td>
    <td width="10px"></td>
    <td style="text-align:left;"><input type="text" name="mmort[]" id="mmort0" value="<?php echo $data5 ?>" size="3" onFocus="makeForm();" />    </td>
    <td width="10px"></td>
    <td style="text-align:left;"><input type="text" name="mcull[]" id="mcull0" value="<?php echo $data6 ?>" size="3" />    </td>
    <td width="10px"></td>
    <td style="text-align:left;"><input type="text" value="<?php echo $data19 ?>"  name="mweight[]" id="mweight0" value="" size="3" />    </td>
    <td width="10px"></td>
    <td style="text-align:left;"><select name="mfeedtype[]" id="mfeedtype0" >
      ...
      <?php
              ...
              {
           ?>
      <option <?php if($row1['code']==$data22) echo 'selected="selected"'; ?> value="<?php echo $row1['code']; ?>" title="<?php echo $row1['description']; ?>"><?php echo $row1['code']; ?></option>
      <?php } ?>
    </select>    </td>
    <td width="10px"></td>
    <td style="text-align:left;"><input type="text" name="mfeedqty[]" id="mfeedqty0" value="<?php echo $data8+$data9 ?>" size="3" />    </td>
    <td width="10px"></td>
    <td style="text-align:left;"><input type="text" name="eggwt[]" id="eggwt0" value="<?php echo $data20 ?>" size="3" />    </td>
    <td width="10px"></td>
    ...
    <?php
             ...
             while($row1 = mysql_fetch_assoc($result))
             {
			   $data='data'.$i++;
        ?>
    <td style="text-align:left;"><input type="text"  name="<?php echo $row1['code']; ?>[]" id="value0" value="<?php echo $$data; ?>" size="3" />    </td>
    <td width="10px"></td>
    <?php } ?>
    <?php
             ...
             { $data='data'.$i++;
        ?>
    <td style="text-align:left;"><input type="text" name="<?php echo $row1['code']; ?>[]" id="value10" value="<?php echo $$data; ?>" size="3" />    </td>
    <td width="10px"></td>
    <?php } ?>
  </tr>
